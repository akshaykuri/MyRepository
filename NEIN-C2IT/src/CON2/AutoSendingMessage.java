...
//@WebServlet("/AutoSendingMessage")
public class AutoSendingMessage {
String driver;
	
	//Date gdate = null;
	String gdate = null;
	public String getMailAutoSendingMessage(String EMP)
	{
...
StringBuffer stringBuffer = new StringBuffer();
		...
		"</tr>");
		    ...
		    pst2 = con.prepareStatement("SELECT complain_id,DATE_FORMAT(cm_time,'%e/%m/%Y,%h:%i') as datu,cm_name,emp,cm_type,cm_problem,cm_location,cm_status,cm_date,cm_mail,mail,counting FROM complain_master_item WHERE cm_time < NOW() - INTERVAL 8 HOUR AND emp=? AND cm_status=? ORDER BY cm_date DESC");
