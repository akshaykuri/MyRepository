...
public class ResendMailAccessCard extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("Mail value Access Card...) "+mail);
		...
		String message = mailMessage.getMailMessageCard(values[1]);
		...
		postmail.postMail(values[0],values[3],"pass1234",values[2],"NEIN-C2IT ACCESS CARD No. : "+values[1]," "+  "Resent u a mail OF ACCESS CARD APPROVAL : " + " GO for the Above Form Number <br><br> C2IT LINK - https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp </br>"+message+"");
