...
public class MailMessageDSCUser {
	String driver;
	Date gdate = null;
	//String form11_no="NEIN/CS/DSC/90-127";
 public String getMailMessageDSC(String form)
	{
	StringBuffer stringBuffer = new StringBuffer();
		...
		pst= con.prepareStatement("SELECT form11_no,f_date FROM form11_dsc where form11_no=?");
	...
	//	System.out.println("inside while");
		...
		//	System.out.println("date in mail message"+gdate);
			...
			//System.out.println("form11 *******************  value : "+resultSet.getString("form11_no"));
		...
		//String cm_date,idextend,complain_id,cm_name,cm_location,cm_type,cm_problem,desg,emp,transid;
		 stringBuffer.append("<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">" +
					"<html xmlns=\"http://www.w3.org/1999/xhtml\">"+
		             ...
		             "<center>"+
		             "<label><font color=\"black\"><u><b>DSC REQUEST FORM</b></u></font></label> <br />"+
		             "</center></td></tr></table>"+
						"<br><br>");
						
						 pst2 = con.prepareStatement("select select_cin,ITusername,ITpassword,ITcreated,ITremark,branch,depart,full_name,emp_code,designation,reporting_officer,scopeOfWork,requestBy,requestOption from form11_dsc where form11_no=?");
			            pst2.setString(1, form);
			            rs2 = pst2.executeQuery();
			            System.out.println("hhhhhhhhh"+form);
			            String ITusername=null,ITpassword=null,ITcreated=null,ITremark=null,cin_no=null;
			           ...
			           while(rs2.next()){
							 ...
							 cin_no = rs2.getString("select_cin");
			           }
							        ...
							        stringBuffer.append("<table width=\"80%\" border=\"1\"  align=\"center\" bgcolor=\"#F0F0F0\" bordercolor=\"grey\">"+
						        			...
						        			"<tr>"+
						        			"<td>CIN Number</td>"+
						        			"<td colspan=\"3\" bgcolor=\"white\">"+cin_no+"</td>"+
							        ...
							        pst3 = con.prepareStatement("select form11_no,desg,emp,status,remarks,f_date from form11_dsc_item WHERE form11_no=? AND desg <> 'none' ORDER BY id ASC");
