        ...
        System.out.println("inside while");
		 ...
		 stringBuffer.append("<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">" +
					"<html xmlns=\"http://www.w3.org/1999/xhtml\">"+
		             ...
		             "<center>"+
		             "<label><font color=\"black\"><u><b>INTERNET ACCESS _ REQUEST FORM</b></u></font></label> <br />"+
		             "</center></td></tr></table>"+
						"<br><br>");
						pst2 = con.prepareStatement("select * from form6_internet where form6_no=?");
			            pst2.setString(1, form6_no);
			            rs2 = pst2.executeQuery();
			            System.out.println("hhhhhhhhh : ****** NET  :"+form6_no);
			           while(rs2.next()){
			        	   ...
			        	   String requestBy = rs2.getString("requestBy");
							        ...
							        stringBuffer.append(
							        		"<table width=\"80%\" border=\"1\"  align=\"center\" bgcolor=\"#F0F0F0\" bordercolor=\"grey\">"+
							        			...
							        			"<table width=\"80%\" border=\"1\"  align=\"center\" bgcolor=\"#F0F0F0\" bordercolor=\"grey\">"+
							        			"<tr>"+
							        			"<td   bgcolor=\"grey\" colspan=\"2\" width=\"40%\">FORM NUMBER :</td>"+
							        			"<td  bgcolor=\"white\" colspan=\"2\" width=\"40%\">"+form6_no+"</td>"+
							        			"</tr>"+
							        			"<tr>"+
							        			"<td   width=\"20%\" >Branch :</td>"+
							        			"<td  bgcolor=\"white\" width=\"20%\">"+branch+"</td>"+
							        			"<td   width=\"20%\">Department :</td>"+
							        			
							        			"<td  bgcolor=\"white\" width=\"20%\">"+depart+"</td> "+
							        			"</tr>"+
							        			"<tr>"+
							        			"<td   width=\"20%\">Full Name :</td>"+
							        			"<td  bgcolor=\"white\" width=\"20%\">"+full_name+"</td>"+
							        			"<td   width=\"20%\">Employee Code :</td>"+
							        			"<td  bgcolor=\"white\" width=\"20%\">"+emp_code+"</td>"+
							        			"</tr>"+

							        			/*"<tr>"+
							        			"<td  width=\"20%\">Designation :</td>"+
							        			"<td  bgcolor=\"white\" width=\"20%\">"+designation+"</td>"+

							        			"<td   width=\"20%\">Reporting Officer  :</td>"+
							        			"<td  bgcolor=\"white\" width=\"20%\">"+r_officer+"</td>"+


							        			"</tr>"+*/
							        			/*"<tr>"+
							        			"<td  width=\"20%\">Scope Of Work :</td>"+
							        			"<td  bgcolor=\"white\" width=\"20%\">"+scopeOfWork+"</td>"+
							        			...
							        			"<td  bgcolor=\"white\" width=\"20%\">"+requestBy+"</td>"+ 					        
							        			"</tr>"+
							        			"<tr>"+
							        			"<td   width=\"20%\">Request For :</td>"+
							        			"<td  bgcolor=\"white\" colspan=\"3\" width=\60%\">"+requestOption+"</td>"+
							        ...
							        pst3 = con.prepareStatement("select * FROM form6_internet_item  WHERE form6_no=? ORDER BY id ASC");
							  	  ...
							  	  while(rs3.next())
							  	  {
							  		 // String form1_noD= rs3.getString("form1_no");
							        	...
							        	System.out.println("------------sub end NET -----------");	
