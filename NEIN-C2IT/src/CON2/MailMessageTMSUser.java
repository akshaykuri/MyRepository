...
public class MailMessageTMSUser {
	String driver;
	//Date gdate = null;
	public String getMailMessageTMSUser(String form7_no)
	 {
...
/////////////////////////////////////////
	    ...
	    stringBuffer.append("<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">" +
					"<html xmlns=\"http://www.w3.org/1999/xhtml\">"+
		             ...
		             "<center>"+
		             "<label><font color=\"black\"><u><b>TMS USERS APPLICATION FORM</b></u></font></label> <br />"+
		             "</center></td></tr></table>"+
						"<br>");
						pst2 = con.prepareStatement("select * from form16_tmsuser where form_no=? ");
			           ...
			           while(rs2.next())
			               ...
			               String  emptype = rs2.getString("emptype");
			        	   String requestBy = rs2.getString("requestBy");
			         	   ...
			         	   stringBuffer.append(
						        			...
						        			"</tr>"+ 
						        			"<tr>" +
						        			"<td bgcolor=\"grey\">Employee Type</td>"+
						        			"<td bgcolor=\"white\" colspan=\"3\">"+emptype+"</td>"+
						        			"</tr>"+ 
						        			"<tr>" +
						        			"<td>Emp ID :</td>"+
			               ...
			               if(itusercode!=null)
			                 ...
			                 stringBuffer.append("<br>"+
				        	    ...
				        	    "</tr>"+
							        ...
							        pst3 = con.prepareStatement("select * from form16_tmsuser_item  WHERE form_no=? AND desg <> 'none' ORDER BY id ASC");
	...
	public String getMailMessageTMSCustomer(String form7_no)
	 {
	StringBuffer stringBuffer = new StringBuffer();
		Connection con = null;
		PreparedStatement pst = null,pst2=null,pst3=null,pst4=null;   
...
/////////////////////////////////////////
	    ...
	    stringBuffer.append("<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">" +
					"<html xmlns=\"http://www.w3.org/1999/xhtml\">"+
		             ...
		             "<table border=\"0\" align=\"center\" width=\"80%\"><tr><td>"+
		             "<center>"+
		             "<label><font color=\"black\"><u><b>TMS CUSTOMER APPLICATION FORM</b></u></font></label> <br />"+
		             "</center></td></tr></table>"+
						"<br>");
						pst2 = con.prepareStatement("select * from form16_tmsuser where form_no=? ");
			            pst2.setString(1, form7_no);
			           ...
			           while(rs2.next())
			        	   ...
			        	   String conperson = rs2.getString("conperson");
