...
//@WebServlet("/ResendMailDomain")
public class ResendMailDomain extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("Mail value Domain...) "+mail);
		...
		String message = mailMessage.getMailMessageDomain(values[1]);
		...
		postmail.postMail(values[0],values[3],"pass1234",values[2],"NEIN-C2IT  DOMAIN USER No. :"+values[1]," "+  "Resent u a mail OF DOMAIN USER APPROVAL : " + " GO for the Above Form Number <br><br> C2IT LINK - https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp </br>"+message+"");
