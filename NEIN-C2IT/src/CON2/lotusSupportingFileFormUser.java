 ...
 */
//@WebServlet("/lotusSupportingFileFormUser")
public class lotusSupportingFileFormUser extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public lotusSupportingFileFormUser() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(isMultipart){
			...
			try {
				...
				response.sendRedirect("LOTUS/FormLocalApproval/SupportingFile.jsp?rmsg=" +msg);
