...
<form name="form" method="post" action="Pending.jsp?msg=1&t=upload">
...
rs10=st10.executeQuery("SELECT DISTINCT form_no FROM branch_requirements WHERE ((emp='"+AdminName+"' and desg='"+desg+"') or (empid='"+EmpNo+"')) and Status='Pending' AND form_no LIKE 'NEIN/NEW%' ORDER BY form_no ASC");
