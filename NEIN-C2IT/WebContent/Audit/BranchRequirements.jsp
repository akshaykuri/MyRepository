...
<td width="67"><font size="3"><b>Name</b></font></td>
<td width="67"><font size="3"><b>Designation</b></font></td>
<td width="67"><font size="3"><b>Status</b></font></td>
<td width="67"><font size="3"><b>Remarks</b></font></td>
<td width="67"><font size="3"><b>Date</b></font></td>
</tr>
<%
cn2=con.getConnection2();
st2=cn2.createStatement();
rs2=st2.executeQuery("SELECT * FROM branch_requirements where form_no='"+req+"' And levelno='00' And Branch='"+b_no+"' order by  `id` ASC");
while(rs2.next()){
