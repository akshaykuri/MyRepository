...
<form name="form" method="post" action="Pending.jsp?msg=1&t=request">
...
/* 	cn1=con.getConnection2();
	...
	rs1=st1.executeQuery("Select * From  auditform_item ") */
...
rs9 = st9.executeQuery("SELECT DISTINCT form_no FROM auditform_item WHERE ((emp='"+AdminName+"' and desg='"+desg+"') or (empid='"+EmpNo+"')) and Status='Pending'  AND form_no LIKE 'NEIN/NEW%' ORDER BY form_no ASC");

cn10 = con.getConnection2();
st10=cn10.createStatement();
rs10=st10.executeQuery("SELECT DISTINCT form_no FROM branch_requirements WHERE ((emp='"+AdminName+"' and desg='"+desg+"') or (empid='"+EmpNo+"')) and Status='Pending' AND form_no LIKE 'NEIN/NEW%' And Date+5>CURRENT_DATE ORDER BY form_no ASC");
