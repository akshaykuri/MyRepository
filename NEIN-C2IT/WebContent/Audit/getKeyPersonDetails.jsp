...
<%@page import="java.util.ResourceBundle"%>
   ...
   b_no = (String) session.getAttribute("b_no");
    ...
    buffer = buffer + "<input type='hidden' id='b2' value='"+b_no+"'>";
           ...
           try
             {  
               ...
               ResultSet rs = stmt.executeQuery("SELECT DISTINCT u.user_name,rr.role_code,b.branch_name, d.department_name, "+
            		   " m3.user_name AS manager_name,u.email,u.mobile_number, m3.email,m3.emp_id,b.branch_type_code FROM user u "+
               ...
               System.out.println("The session branch"+b_no);
               System.out.println("The DB Branch"+branch);
               
               if(branch!=null && !b_no.equals(branch)){
            	   buffer = buffer + "<input type='text' id='p9' value='2'>";
               }else{
            	   buffer = buffer + "<input type='text' id='p9' value='1'>";
              ...
              //approverflag2=1;
              buffer = buffer + "<input type='text' id='p91' value='"+RepoOfficer+"'>";
              buffer = buffer + "<input type='text' id='p9' value='"+ro11+"'>";
              buffer = buffer + "<input type='text' id='p8' value='"+ro1+"'>";
              buffer = buffer + "<input type='text' id='p101' value='"+RepoOfficer2+"'>";
              buffer = buffer + "<input type='text' id='p11' value='"+ro21+"'>";
              buffer = buffer + "<input type='text' id='p10' value='"+ro2+"'>";
