...
<head><title>NEW OR CHANGE REQUEST FORM</title>
...
<tr align="center">
 <td bgcolor="#2f4377" class="blueLine"><strong><font size ="4" color="white">NEW OR CHANGE REQUEST FORM</font></strong></td>
</tr>
...
<form name="form" method="post" action="ViewAll.jsp">
...
rs9 = st9.executeQuery("SELECT DISTINCT form_no,empname,type FROM  audit_form WHERE  form_no LIKE 'NEIN/NEW%' AND type='"+f+"' ORDER BY idextend DESC");
