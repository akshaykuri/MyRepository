...
try
{
	...
	st.executeUpdate("update nentrymaa set idd='"+idb+"',Nname='"+Nnameb+"',Npwd='"+Npwdb+"',Naddr='"+Naddrb+"',Ncontact='"+Ncontactb+"',Npost='"+Npostb+"',NpostingCo='"+NpostingCo+"',Nmail='"+Nmail+"' where id='"+num+"'");
	response.sendRedirect("DisplayDelMaa.jsp");
}
catch(Exception e)
{
