...
rs9 = st9.executeQuery("select DISTINCT complain_id from complain_master_item  WHERE e_location='"+LocationNo+"' AND cm_date='"+dateF+"' GROUP BY complain_id");
%>
<form name="form1" method="post" action="complainPageAdminBranchAdmin.jsp?msg=1" onsubmit="return validate();">
...
<a href="complainDateWiseAdmin.jsp?msg=1"><img src="bakk.png" border="0" height="35" width="35"></a><address><font size="2">BACK</font></address> 
</td> 
</tr> 
</table> 
