 ...
 */
  ...
  <script language="javascript" type="text/javascript"> 
function resendMail(mail,form7_no,empD)
  		 {
	 alert("Working"); 
	 alert("mail :"+mail);
         ...
         xmlHttp= new XMLHttpRequest();    
           ...
           alet("Creating html http object");    
             xmlHttp= new ActiveXObject("Microsoft.XMLHTTP");  
                    ...
                    alert("Browser does not support XMLHTTP Request");    
                      return;     
                       }       var url="../../ResendMailDomain?mail="+mail+","+form7_no+","+empD+"";  
...
<td style="text-align:left;"><input type="text" name="full_name" size="31" id="fname" value="<%=empno%>" readonly="readonly"/></td>
<td  style="text-align: right;">Full Name :</td>
<td style="text-align:left;"><input type="text" name="full_name" size="31" id="fname" value="<%=full_name%>" readonly="readonly"/></td>
...
<td style="text-align:left;"><input name="depart" value="<%=depart%>" size="31" readonly="readonly"/>
...
<td style="text-align:left;"><input type="text" size="31" name="r_officer" id="rofficer" value="<%=reporting_officer%>" readonly="readonly"/></td>


</tr>
<tr>
<td  style="text-align: right;">Requested Operator Code :</td>
<td style="text-align:left;"><input type="text" name="emp_code" size="31" id="ecode" value="<%=emp_code%>" readonly="readonly"/></td>

<td  style="text-align: right;">Scope Of Work :</td>
<td style="text-align:left;">

<input type="text"    size="31" name="d_resignation" value="<%=scopeOfWork%>" readonly="readonly"  readonly="readonly" />
...
<td style="text-align:left;"><input type="text" name="emp_code" size="31" id="ecode" value="<%=requBranchCode%>" readonly="readonly"/></td>
<td  style="text-align: right;">Requested By:</td>
<td style="text-align:left;">
<input type="text"   size="31" name="d_reliving"  value="<%=requestBy%>" readonly="readonly" readonly="readonly" />
		</td> 					        
</tr>
<tr>
<td align="right">Type Of Request  :</td>
<td  colspan="3"> 
     <input style="" type ="text" size="31" name = "requestOption" readonly="readonly" value ="<%=requestOption%>" id=""/></td>
</tr>
</table>
<br>
...
<table width="895" border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
	  ...
	  rs1 = st1.executeQuery("select form7_no,desg,emp,status,remarks,DATE_FORMAT(f_date,'%d/%m/%Y'),mail from form7_newins_item WHERE form7_no='"+req+"' AND desg <> 'none'"); 
	  while(rs1.next())
	  {
		  String form7_noD= rs1.getString(1);
...
String ITdcode=null,ITdpassword=null,ITdlevel=null,ITdremark=null,group=null,access=null;
String hr = "HR/ADMIN";
//("UPDATE form7_newins SET ITdcode=?,ITdpassword=?,ITdlevel=?,ITdremark=? WHERE form7_no=?");
rs111 = st111.executeQuery("select ITdcode,ITdpassword,ITdlevel,ITdremark,groupName,accessallbranch  from form7_newins WHERE form7_no='"+form7_no+"'");
...
while(rs111.next())
{
	//ITdcode,ITdpassword,ITdlevel,ITdremark
	  ITdcode = rs111.getString(1);
	  ITdpassword = rs111.getString(2);
	  ITdlevel = rs111.getString(3);
	  ITdremark = rs111.getString(4);
	  group = rs111.getString(5);
	  access = rs111.getString(6);
}
...
PreparedStatement psmt5=null,psmt6=null;
...
<table border="1"  align="center" bgcolor="grey" bordercolor="grey">
<tr><td id="ita">HO Finance & A/C:</td></tr>
</table>
...
<%if(session.getAttribute("desg")!=null && session.getAttribute("desg").equals("SR.MANAGER IT")){ %>
<table border="1"  align="center" bgcolor="grey" bordercolor="grey" >
...
<table border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
<tr>
<td class="it2" style="text-align: right;width:23%;"><font size="2" color="black"><b> Operator Code:</b></font></td>
<td class="it2"  style="text-align:left;width:25%;"><%=ITdcode %></td>
</tr>

<tr>
<td class="it2" style="text-align: right;width:23%;"><font size="2" color="black"><b>Password :</b></font></td>
<td class="it2"  style="text-align:left;width:25%;"><%=ITdpassword %></td></tr>

<tr>
<td class="it2" style="text-align: right;width:23%;"><font size="2" color="black"><b>Level :</b></font></td>
<td class="it2"  style="text-align:left;width:25%;"><%=ITdlevel%></td></tr>
<tr>
<td class="it2" style="text-align: right;width:23%;"><font size="2" color="black"><b>Group :</b></font></td>
<td class="it2"  style="text-align:left;width:25%;"><%=group%></td></tr>
<tr>
<td class="it2" style="text-align: right;width:23%;"><font size="2" color="black"><b>Access to all branch :</b></font></td>
<td class="it2"  style="text-align:left;width:25%;"><%=access%></td></tr>
<tr>
<td class="it2" style="text-align: right;width:23%;"> <font size="2" color="black"><b>Remarks :</b></font></td>
<td class="it2"  style="text-align:left;width:25%;"><%=ITdremark %></td>
</table>
<br />
	<%} %>	
 ...
 <table style="margin-left: auto;margin-right: auto;" ><tr>
     ...
     <td style="font-size:1" id="hiderow">&nbsp;&nbsp;<!-- <input style="size:1;font-size: 1.1em;" type="button"  value="BACK" onclick="window.location.href='NewinsSelectAdmin.jsp?msg=1'"/> -->
...
if (VERSION > 3) {
  ...
  <td id="hiderow">&nbsp;&nbsp;<!-- <a href="HelpPageCS.jsp" onclick="return popitup('HelpPageCS.jsp')" id="hiderow"><font size=2>HELP</font></a> -->
