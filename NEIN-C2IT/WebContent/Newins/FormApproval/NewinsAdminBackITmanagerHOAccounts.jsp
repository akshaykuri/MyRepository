...
psmt.setString(2,itRemarksForAccount);
...
if(HRadminFromQuery != null)
{
	...
	psmt3.setString(7,part2);
	psmt3.setString(8,part3);
...
postMail.postMail(i_email_id,i_name,"pass1234",part3," NEWINS USER FORM :  " +form_no+ " ",i_name+  " "+  "request is Approved " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  http://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
			if(HRadminFromQuery != null)
				{
...
msg = "NEWINS__USER__FORM__NO__:__'"+form_no+"'__SAVED__AND__SENT__SUCCESSFULLY";
