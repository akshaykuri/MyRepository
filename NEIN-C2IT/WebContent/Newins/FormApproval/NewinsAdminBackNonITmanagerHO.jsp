...
postMail.postMail(i_email_id,i_name,"pass1234",ITmail," NEWINS USER FORM :  " +form_no+ " ",i_name+  " "+  "request is Approved SR.MANAGER IT" +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  http://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);


message = null;

msg = "NEWINS__USER__FORM__NO__:__'"+form_no+"'__SAVED__AND__SENT__SUCCESSFULLY__TO__IT-MANAGER(HEAD OFFICE)";
