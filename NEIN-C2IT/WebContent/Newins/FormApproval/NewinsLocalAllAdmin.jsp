...
rs100 = st100.executeQuery("select * from form7_newins WHERE form7_no='"+values[0]+"'"); 
while(rs100.next())
{
...
%>	 
	<table width="900">
		 <tr>
	<td colspan="4" bgcolor="grey"><font size="3" >
		<b><center><label  >
		NEWIN'S USER FROM</label> </center>
		</b></font></td>
	</tr>
	</table>	
	<table width="900">
...
<tr>
<td  style="text-align: right;">Emp Code Code :</td>
...
<td style="text-align:left;">
<input type="text"  style="width: 15em"  name="d_reliving"  value="<%=requBranchCode%>" readonly="readonly" readonly="readonly" />
...
<table id="tableData" name="tableData" width="100%" border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
	  ...
	  rs1 = st1.executeQuery("select form7_no,desg,emp,status,remarks,f_date,mail from form7_newins_item WHERE form7_no='"+values[0]+"' ORDER BY id ASC"); 
	  while(rs1.next())
	  {
