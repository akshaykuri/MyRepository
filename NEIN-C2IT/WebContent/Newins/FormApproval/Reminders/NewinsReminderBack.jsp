...
psmt11 = cn2.prepareStatement("UPDATE form7_newins SET reminder=?,f_date=? WHERE form7_no=?");
...
msg2 = "NEWINS__REMINDER__FORM__NO__:__'"+form_no+"'__SAVED__SUCCESSFULLY";
System.out.println("result..date..........."+form_date);
response.sendRedirect("NewinsReminder.jsp?msg2="+msg2);
