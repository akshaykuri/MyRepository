...
rs1 = st1.executeQuery("select * from form7_newins WHERE form7_no='"+no+"'"); 
if(!rs1.next())
{
...
rs100 = st100.executeQuery("select * from form7_newins WHERE form7_no='"+no+"'"); 
while(rs100.next())
{
...
<form name="form" action="NewinsReminderBack.jsp" method="post"  ><center>
<label> <font color="black"><u><b>NEWINS REQUEST-REMINDER</b></u></font> </label> 
<br/>
...
<input name="form_no" value="<%=form7_no%>" size="31" readonly="readonly"/> </td>
</tr>
<tr>
...
<%
			Connection cn2222=null,cn2=null;
ResultSet rsb=null,rsp=null;
		/* 	System.out.println("FOR IT MANAGER  : "+form7_no);
