...
String ITaccessbr = request.getParameter("accessbr");

//System.out.println("Group :"+ITgroup);
//System.out.println("access all branches :"+ITaccessbr);
...
System.out.println("Remarks "+ITdremark);

String allMails=null,initiatorNameIfNotApproved=null,initiatorNamee=null;
psmt4 = cn2.prepareStatement("SELECT DISTINCT mail,emp FROM form6_internet_item WHERE form6_no=? AND status=?");
...
if(ApprovalOption.equals("ContinueStatus"))
{
	...
	//psmtApOp1 = cn2.prepareStatement("UPDATE form7_newins_item SET status=?,remarks=?,f_date=?,presence=? WHERE form7_no=? AND desg=? AND emp=? ");
	psmtApOp1 = cn2.prepareStatement("UPDATE form7_newins_item f,(SELECT max(id) as idf FROM form7_newins_item WHERE form7_no=? AND desg=? AND emp=?) as p SET f.status=?,f.remarks=?,f.f_date=?,f.presence=? WHERE f.form7_no=? AND f.desg=? AND f.emp=? AND f.id=p.idf");
	...
	psmtApOp2 = cn2.prepareStatement("UPDATE form7_newins SET Approval_status=?,Approval_sttatuss=?,Approval_remarks=?,Approval_f_date=?,Approval_emp=?,Approval_desg=?,Approval_empp=?,Approval_desgg=? WHERE form7_no=?");
	...
	psmtApOp3 = cn2.prepareStatement("INSERT INTO form7_newins_item(form7_no,desg,emp,status,remarks,f_date,mail,presence) VALUES(?,?,?,?,?,?,?,?)");
...
//postMail.postMail(i_email_id,i_name,"pass1234",mailingCheck[u]," LOTUS NOTES USER FORM :  " +form_no+ " ",i_name+  " "+  "request is Approved " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> Public Domain (Outside Office) - https://203.124.152.5:8185/NEIN-C2IT/HOME.jsp  <br><br><br><br>"+message);
	...
	{  System.out.println("if Approved and sending again to Higher authority ");
		postMail.postMail(i_email_id,i_name,"pass1234",Mail1,"  NEWINS USER FORM:  " +form_no+ " ",i_name+  " "+  "request you to Approved " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
	}
	...
	{  System.out.println("if Approved and want to send directly to IT nonIT persons of HO and ONE copy to Initiator");
		postMail.postMail(i_email_id,i_name,"pass1234",Mail1,"  NEWINS USER FORM:  " +form_no+ " ",i_name+  " "+  "approved your request " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
		postMail.postMail(i_email_id,i_name,"pass1234",allMails,"  NEWINS USER FORM :  " +form_no+ " ",initiatorNameIfNotApproved+  " "+  "approved your request " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>");
	}
/* 	if((mmdradio!=null && mmdradio.equals("Not Approved"))&&(higherAuthority!=null && higherAuthority.equals("directApprove")))
	{  System.out.println("if NOT Approved , so a copy to Initaior ");
		postMail.postMail(i_email_id,i_name,"pass1234",Mail1,"  NEWINS USER FORM :  " +form_no+ " ",initiatorNameIfNotApproved+  " "+  "request Is NOT Approved " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>");
		postMail.postMail(i_email_id,i_name,"pass1234",allMails,"   NEWINS USER FORM  :  " +form_no+ " ",initiatorNameIfNotApproved+  " "+  "request Is NOT Approved " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>");
	} */
...
psmt2 = cn2.prepareStatement("UPDATE form7_newins SET ITdcode=?,ITdpassword=?,ITdlevel=?,ITdremark=?,Approval_sttatuss=?,Approval_f_date=?,	groupName=?,accessallbranch=? WHERE form7_no=?");
...
psmt2.setString(7,ITgroup);
psmt2.setString(8,ITaccessbr);
psmt2.setString(9,form_no);
...
String ccmaif="nilkanth.pawar@nittsu.co.in";
postMail.postMail(i_email_id,i_name,"pass1234",ccmaif," NEWINS USER FORM :  " +form_no+ " ",i_name+  " "+  "request is Approved " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
...
if((SendExtraMails!="NULL")||(mmdradioBcc=="Yes"))
		{ System.out.println("IF SendExtraMails in incident reported :"+SendExtraMails);
		 ...
		 //	System.out.println("MAIL MAILS replace length :"+ToMail.length());
		 //	System.out.println("MAIL MAILS replace length :"+ToMail.length());
		 /* 	postMail.postMailCC(i_email_id,i_name,"pass1234","farooq.s@nittsu.co.in",CCList," NEWINS USER FORM :  " +form_no+ " ",i_name+  " "+  "request is Approved " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
		 	 //System.out.println("IF After For loop :"+allValues);
		 	for(int u=0;u<mailingCheck.length;u++)
			{
				System.out.println("INSIDE FOR LOOP OF mailingCheck[u] main "+mailingCheck[u]);
			postMail.postMail(i_email_id,i_name,"pass1234",mailingCheck[u]," NEWINS USER FORM :  " +form_no+ " ","your request for NEWINS USER FORM "+form_no+" is Approved by " +i_name+ " <br><br><b><u> Open the following URL</u> </b><br>C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
			...
			//	postMail.postMailCC(i_email_id,i_name,"pass1234",mailingCheck[u],CCList," NEWINS USER FORM :  " +form_no+ " ",i_name+  " "+  "request is Approved " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
			} 
		 	postMail.postMail(i_email_id,i_name,"pass1234",CCList," NEWINS USER FORM :  " +form_no+ " ","your request for NEWINS USER FORM "+form_no+" is Approved by " +i_name+ " <br><br><b><u> Open the following URL</u> </b><br>C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
		 	 */
		 	postMail.sendMailCC(i_email_id,i_name,ToMail,CCList," NEWINS USER FORM :  " +form_no+ " ","your request for NEWINS USER FORM "+form_no+" is Approved by " +i_name+ " <br><br><b><u> Open the following URL</u> </b><br>C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
		}
		else
		{
			for(int u=0;u<mailingCheck.length;u++)
