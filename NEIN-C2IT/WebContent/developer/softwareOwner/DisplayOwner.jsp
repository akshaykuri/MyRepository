...
var f=document.form;    
f.method="post";    
f.action='OwnerEdit.jsp?id='+id;    
f.submit();
}
function deleteRecord(id)
{    
	if(confirm('You are above to delete a  Application Details'))
	{
var f=document.form;    
f.method="post";    
f.action='OwnerDelete.jsp?id='+id;    
f.submit();
}
	else{}
}
...
<center>
	...
	<table border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
		...
		<td height="20" bgcolor="white" width="120" align=center><font size="2" color="black"><b>APPLICATION </b></font></td>
<td bgcolor="white" width="120" align=center><font size="2" color="black"><b>DEVELOPER </b></font></td>
<td bgcolor="white" width="120" align=center><font size="2" color="black"><b>REMARKS</b></font></td>
...
String query = "select * from software_owner_master ORDER BY developer_name ASC";
