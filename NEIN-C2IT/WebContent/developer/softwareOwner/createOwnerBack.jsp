...
String developer_mail=request.getParameter("developer_mail");
String remarks=request.getParameter("remarks");

String msg = null;
PreparedStatement psmt1=null;
rs = st2.executeQuery("select app_name from software_owner_master where app_name='"+app_name+"'");
if(rs.next()){
	
	//out.println(".........'"+backup_name+"' IS ALREADY EXIST.......");
	msg = "...'"+app_name+"'__IS__ALREADY EXIST.......";
}

else{
psmt1 = cn.prepareStatement("insert into software_owner_master(app_name,developer_name,developer_mail,remarks) values(?,?,?,?)");
//int i=st.executeUpdate("insert into prob_master(p_type,bkLocation) values('"+p_type+"','"+bkLocation+"')");

psmt1.setString(1,app_name);
psmt1.setString(2,developer_name);
psmt1.setString(3,developer_mail);
psmt1.setString(4,remarks);
...
response.sendRedirect("createOwner.jsp?msg=" +msg);
%>
