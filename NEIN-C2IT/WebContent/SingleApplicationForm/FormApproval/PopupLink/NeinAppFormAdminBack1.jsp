...
String gname = request.getParameter("gname")==null?request.getParameter("newGrp"):request.getParameter("gname");
...
System.out.println("select emplCode from neinapplicationformmain where emplCode='"+emp_code+"' or emplName like '%"+full_name+"%'");
