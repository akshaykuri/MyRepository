...
<script language = "Javascript">
          ...
          function validate(){
        	  ...
        	  var emp_type1=document.form.employeeOption1;
            ...
            alert("Please enter correct emp id or emp details should must be in HRMS!");
            ...
            if ((fn.value==null)||(fn.value=="")){
                ...
                return false;
                	...
                	alert("Please enter scop of work!");
...
if((emp_type[0].checked == false) && (emp_type[1].checked == false)){
                                alert("Select Employee Type! \n \n Permanent / Probation");
                                emp_type[0].focus();
                                return false;
                            }
if((emp_type1[0].checked == false) && (emp_type1[1].checked == false)){
                                alert("Select Employee Contract Type! \n \n On Roll / Contract");
                                emp_type1[0].focus();
                                return false;
                            }
                            
if ((document.getElementById("requestOptionchange").checked == false ) && (document.getElementById("requestOptionnew").checked == false )){
...
if((requestFor[0].checked == false) && (requestFor[1].checked == false) && (requestFor[2].checked == false) && (requestFor[3].checked == false) && (requestFor[4].checked == false) && (requestFor[5].checked == false) && (requestFor[6].checked == false) && (requestFor[7].checked == false) && (requestFor[8].checked == false) && (requestFor[9].checked == false) && (requestFor[10].checked == false) && (requestFor[11].checked == false) && (requestFor[12].checked == false)){
                           ...
                           if ((mailDom.value==null)||(mailDom.value=="")){
                               ...
                               mailDom.style.bkColor = mailDom.style.backgroundColor;
                               mailDom.style.backgroundColor = bkColor;
                               mailDom.style.backgroundColor = bkColor2;
                               mailDom.focus();
                               return false;	
                           }
                           if ((empType.value==null)||(empType.value=="")){
                               alert("Please Select Employee Type!");
                               empType.style.bkColor = empType.style.backgroundColor;
                               empType.style.backgroundColor = bkColor;
                               empType.style.backgroundColor = bkColor2;
                               empType.focus();
                               return false;	
                           }
                           if ((emailCreated.value==null)||(emailCreated.value=="")){
                               alert("Please Enter Email ID Created!");
                               emailCreated.style.bkColor = emailCreated.style.backgroundColor;
                               emailCreated.style.backgroundColor = bkColor;
                               emailCreated.style.backgroundColor = bkColor2;
                               emailCreated.focus();
                               return false;	
                           }
                           if ((emailPass.value==null)||(emailPass.value=="")){
                               alert("Please Enter Email ID Created!");
                               emailPass.style.bkColor = emailPass.style.backgroundColor;
                               emailPass.style.backgroundColor = bkColor;
                               emailPass.style.backgroundColor = bkColor2;
                               emailPass.focus();
                               return false;	
                           }
                           ...
                           if ((intuneProv.value==null)||(intuneProv.value=="")){
                               ...
                               intuneProv.style.bkColor = intuneProv.style.backgroundColor;
                               intuneProv.style.backgroundColor = bkColor;
                               intuneProv.style.backgroundColor = bkColor2;
                               intuneProv.focus();
                               return false;	
                           }
                           ...
                           if (((makeModel.value==null)||(makeModel.value=="")) && ((mobileOption.value=="Yes"))){
                               ...
                               makeModel.style.bkColor = makeModel.style.backgroundColor;
                               makeModel.style.backgroundColor = bkColor;
                               makeModel.style.backgroundColor = bkColor2;
                               makeModel.focus();
                               return false;	
                           }
                           ...
                           if (((simNum.value==null)||(simNum.value=="")) && ((simOption.value=="Yes"))){
                               ...
                               simNum.style.bkColor = simNum.style.backgroundColor;
                               simNum.style.backgroundColor = bkColor;
                               simNum.style.backgroundColor = bkColor2;
                               simNum.focus();
                               return false;	
                           }
                           if ((intune.value==null)||(intune.value=="")){
                               alert("Please Select Mobile Access (Intune)!");
                               intune.style.bkColor = intune.style.backgroundColor;
                               intune.style.backgroundColor = bkColor;
                               intune.style.backgroundColor = bkColor2;
                               intune.focus();
                               return false;	
                           }
                           ...
                           if (((mobile.value==null)||(mobile.value=="") && (intune.value=="Yes"))){
                               ...
                               mobile.style.bkColor = mobile.style.backgroundColor;
                               mobile.style.backgroundColor = bkColor;
                               mobile.style.backgroundColor = bkColor2;
                               mobile.focus();
                               return false;	
                           }
                           ...
                           if (((imei1.value==null)||(imei1.value=="")) && (intune.value=="Yes")){
                               ...
                               imei1.style.bkColor = imei1.style.backgroundColor;
                               imei1.style.backgroundColor = bkColor;
                               imei1.style.backgroundColor = bkColor2;
                               imei1.focus();
                               return false;	
                           }
                           ...
                           if (((imei2.value==null)||(imei2.value=="")) && (intune.value=="Yes")){
                               ...
                               imei2.style.bkColor = imei2.style.backgroundColor;
                               imei2.style.backgroundColor = bkColor;
                               imei2.style.backgroundColor = bkColor2;
                               imei2.focus();
                               return false;	
                           }
                           if (((remarksEmail.value==null)||(remarksEmail.value==""))){
                               alert("Please Enter Email Remarks!");
                               remarksEmail.style.bkColor = remarksEmail.style.backgroundColor;
                               remarksEmail.style.backgroundColor = bkColor;
                               remarksEmail.style.backgroundColor = bkColor2;
                               remarksEmail.focus();
                               return false;	
                           }
                           }
                           ...
                           if((requestFor[2].value=="Biometric / Access Card") && (requestFor[2].checked == true)){
                               if ((bioRem.value==null)||(bioRem.value=="")){
                                   ...
                                   bioRem.style.bkColor = bioRem.style.backgroundColor;
                                   bioRem.style.backgroundColor = bkColor;
                                   bioRem.style.backgroundColor = bkColor2;
                                   bioRem.focus();
                                   return false
                                   }
                           }
                           if((requestFor[3].value=="Shared Folder") && (requestFor[3].checked == true)){
                               if ((shaRem.value==null)||(shaRem.value=="")){
                                   ...
                                   shaRem.style.bkColor = shaRem.style.backgroundColor;
                                   shaRem.style.backgroundColor = bkColor;
                                   shaRem.style.backgroundColor = bkColor2;
                                   shaRem.focus();
                                   return false
                                   }
                           }
...
if((reqTypeOpt[0].checked == false ) && (reqTypeOpt[1].checked == false ) && (reqTypeOpt[2].checked == false ) && (reqTypeOpt[3].checked == false )){
                               ...
                               if ((internetRem.value==null)||(internetRem.value=="")){
                                   ...
                                   internetRem.style.bkColor = internetRem.style.backgroundColor;
                                   internetRem.style.backgroundColor = bkColor;
                                   internetRem.style.backgroundColor = bkColor2;
                                   internetRem.focus();
                                   return false
                                   }
                           }
                           if((requestFor[5].value=="NEWINS") && (requestFor[5].checked == true)){
                                 ...
                                 if ((newinCode.value==null)||(newinCode.value=="")){
                                     ...
                                     newinCode.style.bkColor = newinCode.style.backgroundColor;
                                     newinCode.style.backgroundColor = bkColor;
                                     newinCode.style.backgroundColor = bkColor2;
                                     newinCode.focus();
                                     return false;
                                     }
                                ...
                                if (((newRem.value==null)||(newRem.value=="")) && (reqNew[1].checked == true)){
                                    ...
                                    newRem.style.bkColor = newRem.style.backgroundColor;
                                    newRem.style.backgroundColor = bkColor;
                                    newRem.style.backgroundColor = bkColor2;
                                    newRem.focus();
                                    return false;
                                } 
                           }
...
if ((opmenu[0].checked == false ) && (opmenu[1].checked == false ) && (opmenu[2].checked == false ) && (opmenu[3].checked == false )&& (opmenu[4].checked == false ) && (opmenu[5].checked == false ) && (opmenu[6].checked == false ) && (opmenu[7].checked == false ) && (opmenu[8].checked == false ) && (opmenu[9].checked == false ) && (opmenu[10].checked == false ) && (opmenu[11].checked == false ) )
                              ...
                              if (((nexasRem.value==null)||(nexasRem.value==""))){
                                  ...
                                  nexasRem.style.bkColor = nexasRem.style.backgroundColor;
                                  nexasRem.style.backgroundColor = bkColor;
                                  nexasRem.style.backgroundColor = bkColor2;
                                  nexasRem.focus();
                                  return false
                              }  
                           }
                           if((requestFor[7].value=="GS-NET") && (requestFor[7].checked == true)){
                             ...
                             if (((gsrem.value==null)||(gsrem.value==""))){
                                 ...
                                 gsrem.style.bkColor = gsrem.style.backgroundColor;
                                 gsrem.style.backgroundColor = bkColor;
                                 gsrem.style.backgroundColor = bkColor2;
                                 gsrem.focus();
                                 return false
                             }                             
                           }
                           if((requestFor[8].value=="Internal Application") && (requestFor[8].checked == true)){
                               if ((Software.value==null)||(Software.value=="")){
                                   ...
                                   Software.style.bkColor = Software.style.backgroundColor;
                                   Software.style.backgroundColor = bkColor;
                                   Software.style.backgroundColor = bkColor2;
                                   Software.focus()
                                   return false
                        	   }
                               if (((internalRem.value==null)||(internalRem.value==""))){
                                   alert("Enter Internal Application Remarks!");
                                   internalRem.style.bkColor = internalRem.style.backgroundColor;
                                   internalRem.style.backgroundColor = bkColor;
                                   internalRem.style.backgroundColor = bkColor2;
                                   internalRem.focus();
                                   return false
                               }
                           }
                           if((requestFor[9].value=="USB Access") && (requestFor[9].checked == true)){
                               if ((accessFor.value==null)||(accessFor.value=="")){
                                   ...
                                   accessFor.style.bkColor = accessFor.style.backgroundColor;
                                   accessFor.style.backgroundColor = bkColor;
                                   accessFor.style.backgroundColor = bkColor2;
                                   accessFor.focus();
                                   return false
                               }
                               if (((usbRem.value==null)||(usbRem.value==""))){
                                   alert("Enter USB Access Remarks / Reason!");
                                   usbRem.style.bkColor = usbRem.style.backgroundColor;
                                   usbRem.style.backgroundColor = bkColor;
                                   usbRem.style.backgroundColor = bkColor2;
                                   usbRem.focus();
                                   return false
                               }
                           }
                           if((requestFor[10].value=="VPN Access") && (requestFor[10].checked == true)){
                               if ((vpnEmail.value==null)||(vpnEmail.value=="")){
                                   ...
                                   vpnEmail.style.bkColor = vpnEmail.style.backgroundColor;
                                   vpnEmail.style.backgroundColor = bkColor;
                                   vpnEmail.style.backgroundColor = bkColor2;
                                   vpnEmail.focus();
                                   return false
                               }
                               if ((mlps.value==null)||(mlps.value=="")){
                                   alert("Select MPLS / Non MPLS!");
                                   mlps.style.bkColor = mlps.style.backgroundColor;
                                   mlps.style.backgroundColor = bkColor;
                                   mlps.style.backgroundColor = bkColor2;
                                   mlps.focus();
                                   return false
                               }
                               if (((domID.value==null)||(domID.value=="")) && (mlps.value=="MPLS")){
                                   alert("Enter Domain ID!");
                                   domID.style.bkColor = domID.style.backgroundColor;
                                   domID.style.backgroundColor = bkColor;
                                   domID.style.backgroundColor = bkColor2;
                                   domID.focus();
                                   return false
                               }
                           }
                           if((requestFor[11].value=="HardDisk / PenDrive") && (requestFor[11].checked == true)){
                               if ((hardRemarks.value==null)||(hardRemarks.value=="")){
                                   ...
                                   hardRemarks.style.bkColor = hardRemarks.style.backgroundColor;
                                   hardRemarks.style.backgroundColor = bkColor;
                                   hardRemarks.style.backgroundColor = bkColor2;
                                   hardRemarks.focus();
                                   return false
                                   }
                           }
                           if((requestFor[12].value=="Any Other Asset") && (requestFor[12].checked == true)){
                               if ((assetRemarks.value==null)||(assetRemarks.value=="")){
                                   ...
                                   assetRemarks.style.bkColor = assetRemarks.style.backgroundColor;
                                   assetRemarks.style.backgroundColor = bkColor;
                                   assetRemarks.style.backgroundColor = bkColor2;
                                   assetRemarks.focus();
                                   return false
                                   }
                           }
                           if((requestFor[13].value=="NEx-GLOW") && (requestFor[13].checked == true)){
                               if ((project.value==null)||(project.value=="")){
                                   alert("Enter Any Other Asset Remarks!");
                                   project.style.bkColor = project.style.backgroundColor;
                                   project.style.backgroundColor = bkColor;
                                   project.style.backgroundColor = bkColor2;
                                   project.focus();
                                   return false
                               }
                               if ((warehouse.value==null)||(warehouse.value=="")){
                                   alert("Enter Any Other Asset Remarks!");
                                   warehouse.style.bkColor = warehouse.style.backgroundColor;
                                   warehouse.style.backgroundColor = bkColor;
                                   warehouse.style.backgroundColor = bkColor2;
                                   warehouse.focus();
                                   return false
                               }
                               if ((glowID.value==null)||(glowID.value=="")){
                                   alert("Enter Any Other Asset Remarks!");
                                   glowID.style.bkColor = glowID.style.backgroundColor;
                                   glowID.style.backgroundColor = bkColor;
                                   glowID.style.backgroundColor = bkColor2;
                                   glowID.focus();
                                   return false
                               }
                               if ((glowPass.value==null)||(glowPass.value=="")){
                                   alert("Enter Any Other Asset Remarks!");
                                   glowPass.style.bkColor = glowPass.style.backgroundColor;
                                   glowPass.style.backgroundColor = bkColor;
                                   glowPass.style.backgroundColor = bkColor2;
                                   glowPass.focus();
                                   return false
                               }
                               if ((glowRemarks.value==null)||(glowRemarks.value=="")){
                                   alert("Enter Any Other Asset Remarks!");
                                   glowRemarks.style.bkColor = glowRemarks.style.backgroundColor;
                                   glowRemarks.style.backgroundColor = bkColor;
                                   glowRemarks.style.backgroundColor = bkColor2;
                                   glowRemarks.focus();
                                   return false
                               }
                               if ((glowAppRemarks.value==null)||(glowAppRemarks.value=="")){
                                   alert("Enter Any Other Asset Remarks!");
                                   glowAppRemarks.style.bkColor = glowAppRemarks.style.backgroundColor;
                                   glowAppRemarks.style.backgroundColor = bkColor;
                                   glowAppRemarks.style.backgroundColor = bkColor2;
...
if(xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
{
     ...
     document.getElementById("employeeOption11").value=document.getElementById("r2").value;
...
//	 document.getElementById("idintuneProv").value=document.getElementById("r12").value;
//	 document.getElementById("intune").value=document.getElementById("r13").value;
...
//domain
	 //document.getElementById("domainRem").value=document.getElementById("r88").value;
...
//biometric
	 ...
	 //document.getElementById("bioRemarks").value=document.getElementById("r89").value;
...
//getting last approver filled details
	 	 ...
	 	 //document.getElementById("opcAccess").value=document.getElementById("r62").value;
...
else
{
     ...
     document.getElementById("employeeOption11").value="";
...
//employee type
	var empType = document.getElementById("r2").value;
	if(empType=="Permanent"){
		document.getElementById("employeeOptionper").checked=true;
	}if(empType=="Probation"){
		document.getElementById("employeeOptiontemp").checked=true;		
	}
...
//employee contract type
	var conType = document.getElementById("r3").value;
	if(conType=="On Roll"){
		document.getElementById("employeeOption1on").checked=true;
	}if(conType=="Contract"){
		document.getElementById("employeeOption1con").checked=true;		
	}
...
url +="?EMP_NO=" +v;
//alert(url);
xmlHttp1.onreadystatechange = getInfo;  
...
<body onload="cleartext();cleartextBC();sendInfo(document.form.emp_code.value);getFormDetails(document.form.emp_code);getFormDetails(document.form.emp_code);hidefields();hidefieldsAjax();showSim();hideSim();showMob();hideMob();">
<form action="NEINFormUpdateBack.jsp" method="post" name="form">
...
Connection cnEmp = con.getConnection2();
Statement stEmp = cnEmp.createStatement();
ResultSet rsEmp = stEmp.executeQuery("select emplCode from neinapplicationformmain where emplCode='"+empGet+"' and (emplreqFor like '%Email ID%' and emplreqFor like '%Domain Account%' and emplreqFor like '%Biometric / Access Card%' and emplreqFor like '%Shared Folder%' and emplreqFor like '%Internet Access / FTP Access%' and emplreqFor like '%NEWINS%' and emplreqFor like '%NExAS%' and emplreqFor like '%GS-NET%' and emplreqFor like '%Internal Application%' and emplreqFor like '%USB Access%' and emplreqFor like '%VPN Access%' and emplreqFor like '%HardDisk / PenDrive%' and emplreqFor like '%Any Other Asset%')");
//if(!rsEmp.next()){
%>
<script>
//alert("Request for the Selected Employee is not Completed!!!");
//window.location.href="NEINFormUpdateFilter.jsp?msg=1";
</script>
<%
//}else{
...
conMul = con.getConnection2();
stMul=conMul.createStatement();
...
<td style="text-align:left;"><input type="text" name="emp_code" id="ecode" size="29" maxlength="14" value="<%=empGet%>" readonly onkeypress="return isNumber(event)" onkeyup="" onchange="sendInfo(this.value),getFormDetails(this);"/></td>
...
<td style="text-align:left;"><input type="text" name="branch" id="idbranch" size="29" maxlength="44" readonly></td>
<td style="text-align: right;width:23%;"><font color=red>*</font>Department :</td>
<td style="text-align:left;"><input type="text" name="depart" id="iddepart" size="29" maxlength="44" readonly></td>
</tr>
<tr>
<td style="text-align: right;"><font color=red>*</font>Designation :</td>
<td style="text-align:left;"><input type="text" name="designation" size="29" id="iddesignation" maxlength="44" readonly/></td>
...
<select name="scopeOfWork" id="sow" style="width:80%;">      
...
<td style="font-weight:bold;font-style:italic;width:23%;"><input type="hidden" id="employeeOption11">
...
<input type="text" id="employeeOption1on" name="employeeOption1" size="29" value="On Roll" readonly/>
</td>
</tr>
<tr>
...
<%-- <%
Connection cn0212 = null,cn0211=null;
Statement st0212 = null,st0211=null; 
ResultSet rs0212 = null,rs0211=null;
...
<td style="font-weight:bold;font-style:italic;width: 20%;">
<select name="opcGroup" id="opcGroup" style="width: 80%;">
<option value="">Select</option>
<%while(rs0211.next()){ %>
<option value="<%=rs0211.getString("groupName")%>"><%=rs0211.getString("groupName")%></option>
<%}%>
</select>
<!-- <input type="text" name="opcGroup" id="opcGroup" maxlength="44" size="20"/> -->
</td> --%>
...
<td style="font-size:1">&nbsp;&nbsp;<input style="size:1;font-size: 1.1em;" type="button"  value="BACK" onclick="window.location.href='NEINFormUpdateFilter.jsp?msg=1'"/></td>
</tr>
</table>
