...
if ((group.value==null)||(group.value=="")){
    ...
    group.style.bkColor = group.style.backgroundColor;
    group.style.backgroundColor = bkColor;
    group.style.backgroundColor = bkColor2;
    group.focus();
    return false;	
}
...
if((requestFor[0].checked==false && requestFor[0].disabled!=true) && (requestFor[1].checked==false && requestFor[1].disabled!=true) && (requestFor[2].checked==false && requestFor[2].disabled!=true) && (requestFor[3].checked==false && requestFor[3].disabled!=true) && (requestFor[4].checked==false && requestFor[4].disabled!=true) && (requestFor[5].checked==false && requestFor[5].disabled!=true) && (requestFor[6].checked==false && requestFor[6].disabled!=true) && (requestFor[7].checked==false && requestFor[7].disabled!=true) && (requestFor[8].checked==false && requestFor[8].disabled!=true) && (requestFor[9].checked==false && requestFor[9].disabled!=true) && (requestFor[10].checked==false && requestFor[10].disabled!=true) && (requestFor[11].checked==false && requestFor[11].disabled!=true) && (requestFor[12].checked==false && requestFor[12].disabled!=true) && (requestFor[13].checked==false && requestFor[13].disabled!=true)){
                          ...
                          if ((mobileOption[0].checked == false) && (mobileOption[1].checked == false)){
                           ...
                           if (((simNo.value==null)||(simNo.value=="")) && ((simOption.value=="Yes"))){
                               ...
                               simNo.style.bkColor = simNo.style.backgroundColor;
                               simNo.style.backgroundColor = bkColor;
                               simNo.style.backgroundColor = bkColor2;
                               simNo.focus();
                               return false;	
                           }
...
if(xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
{
	 ...
	 if(document.getElementById("r5").value!=""){	
 	 document.getElementById("reqB").disabled=true;
	 }
...
<body onload="cleartext();cleartextBC();getFormDetails(document.form.emp_code);hidefields();hidefieldsAjax();newCheck(document.form.changeNew.value);domCheck(document.form.passChan.value);bioCheck(document.form.changeBio.value);gsCheck(document.form.changeGS.value);callcostDetails(document.form.costCName.value);">
<form action="NEINApplicationFormBack.jsp" method="post" name="form">
...
<td style="text-align:left;"><input type="text" name="emp_code" id="ecode" size="29" maxlength="14" onkeypress="return isNumber(event)" onkeyup="sendInfo(this.value);" onchange="getFormDetails(this)"/></td>
...
<select name="group" id="sow" style="width:80%;">      
...
<input type="hidden" id="employeeOption12">
<input type="hidden" name="employeeOption1" value="On Roll"/>
</td>
</tr>
</table>
<br />
