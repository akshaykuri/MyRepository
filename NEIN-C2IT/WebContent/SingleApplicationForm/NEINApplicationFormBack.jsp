...
//String req_Branch = request.getParameter("req_Branch")==null?request.getParameter("reqB1"):request.getParameter("req_Branch");
//ends....
...
//out.println("requestFor====>"+requestFor);
//out.println("reqFor111====>"+reqFor111);
