...
$(document).ready(function(){
	$("#emplID").keyup(function(){
		$.ajax({
		type: "POST",
		url : "getContEmployee.jsp",
		data: 'EMP_NAME='+$(this).val(),
		beforeSend: function(){
			$("#emplID").css("background","#FFF url(LoaderIcon.gif) no-repeat 165px");
		},
		success: function(data){
			$("#suggesstion-box").show();
			$("#suggesstion-box").html(data);
			$("#emplID").css("background","#FFF");
		}
		});
	});
});
...
<br />
<br />
<form name="form" method="post" action="NEINApplicationLocalAllAdminEmp.jsp?msg=1">
<%
...
<table align="center">
<tr>
<th>ENTER CONTRACT EMPLOYEE NAME</th>
</tr>
</table>
<br>
<table align="center" width="350" border="0" cellpadding="3" cellspacing="1" bgcolor="lightgrey">
<tr>
<td bgcolor="#2f4377" colspan="2"><font size ="3" color="white"></font>
</td>
</tr>
<tr>
<td colspan="2">
<input type="text" name="emplID" id="emplID" autocomplete="off" size="45" maxlength="44" class="form-control"/>
