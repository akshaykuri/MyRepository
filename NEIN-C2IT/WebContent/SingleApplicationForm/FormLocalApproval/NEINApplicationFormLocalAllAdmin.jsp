...
<form name="form" method="post" action="NEINApplicationLocalAllAdmin.jsp?msg=1">
...
if(b_no.equals("20"))
    rs9 = st9.executeQuery("SELECT DISTINCT applicationNo,full_name FROM neinapplicationform WHERE  i_b_no in ('20','21') ORDER BY requested_branch,form_id DESC");
if(b_no.equals("30"))
    rs9 = st9.executeQuery("SELECT DISTINCT applicationNo,full_name FROM neinapplicationform WHERE  i_b_no in ('30','32','53','11') ORDER BY requested_branch,form_id DESC");
if(b_no.equals("90"))
    rs9 = st9.executeQuery("SELECT DISTINCT applicationNo,full_name FROM neinapplicationform  ORDER BY requested_branch,form_id DESC");
else
	rs9 = st9.executeQuery("SELECT DISTINCT applicationNo,full_name FROM neinapplicationform WHERE  i_b_no='"+b_no+"' ORDER BY requested_branch,form_id DESC");
...
<br>	 
  ...
  <tr>
   ...
   <tr>
<td colspan="2"><font size="2"><font color="red">*</font>SELECT FORM NUMBER</font> </td>
</tr>
