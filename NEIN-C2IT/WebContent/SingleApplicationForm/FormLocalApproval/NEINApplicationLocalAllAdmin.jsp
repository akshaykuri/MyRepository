...
<td colspan="3"> 
<input type ="text" name = "requestOption" size="31" readonly="readonly" value ="<%=requestOption%>" id=""/></td>
</tr>
<%}else{%>
<tr>
...
<tr>
<td align="right"  style="width:20%;" colspan="1"><font color="red">*</font>Remarks :</td>
<td align="left"  style="width:20%;" colspan="3"><textarea name="remarksDom" id="domainRem" rows="3" cols="26" maxlength="199" readonly value=""><%=emailRemarks%></textarea></td>
</tr>
</table>
<br />
</div>
...
<td colspan="3" style="font-weight:bold;font-style:italic;text-align:left;width: 60%;"><input size="31" type="text" value="<%=internetReqType%>" readonly></td>
</td>
</tr>
<tr>
