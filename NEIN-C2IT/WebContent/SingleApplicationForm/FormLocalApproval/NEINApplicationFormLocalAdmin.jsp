...
<br />
<br />
<form name="form" method="post" action="NEINApplicationLocalAdmin.jsp?msg=1">
<%
...
rs9 = st9.executeQuery("SELECT DISTINCT form2_no FROM neinapplicationform_item WHERE ((emp='"+AdminName+"' and desg='"+desg+"') OR (empid='"+emp_no+"')) and status='Pending' ORDER BY item_id desc");
