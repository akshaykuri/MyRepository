...
/* 	 try{ */
     ...
     if(document.getElementById("newUser").value=="33"){
...
document.form.action="NEINApplicationFormLocalAdminBack.jsp";
...
function hiddenTables(obj){
	...
	if(type[0].value=="Email ID" && newin!="33"){
	...
	if(type[1].value=="Domain Account" && newin!="33" && level!="1"){
	...
	if(type[2].value=="Biometric / Access Card" && newin!="33" && level!="1"){
	...
	if(type[3].value=="Shared Folder" && newin!="33" && level!="1"){
	...
	if(type[4].value=="Internet Access / FTP Access" && newin!="33" && level!="1"){
	...
	if(type[5].value=="NEWINS" && level!="1"){
		...
		if(chaNew=="Yes" && newin=="33" && chaNew!=""){
			oldPrograms();
		}
	}
	if(type[6].value=="NExAS" && level!="1"){
	...
	if(type[7].value=="GS-NET" && level!="1"){
	...
	if(type[8].value=="Internal Application" && newin!="33" && level!="1"){
	...
	if(type[9].value=="USB Access" && newin!="33" && level!="1"){
	...
	if(type[10].value=="VPN Access" && newin!="33" && level!="1"){
	...
	if(type[11].value=="HardDisk / PenDrive" && newin!="33" && level!="1"){
	...
	if(type[12].value=="Any Other Asset" && newin!="33" && level!="1"){
	...
	if(type[13].value=="NEx-GLOW" && level!="1"){
...
function hiddenTables1(obj){
	var type=obj;
	if((type[0].value=="Email ID") && (document.getElementById("requestForCheck_email").checked==true)){
		var email		= document.getElementById("requestForCheck_email");
	...
	if((type[1].value=="Domain Account") && (document.getElementById("requestForCheck_dom").checked==true)){
		var domain		= document.getElementById("requestForCheck_dom");
...
function hiddenTables2(obj){
	...
	if((type[1].value=="Domain Account") && (type[1].checked==true)){
		var domain		= document.getElementById("requestForCheck_dom");
		var dmdt11		= document.getElementById("dom_details1");
		if(domain.checked==true){
			dmdt11.style.display = "inline";
			dmdt11.style.visibility 	= "visible";
		}else{
			dmdt11.style.display = "none";
			dmdt11.style.visibility 	= "hidden";
		}
	}
	if((type[2].value=="Biometric / Access Card") && (type[2].checked==true)){
		var biometric 	= document.getElementById("requestForCheck_bio");
...
//NEINApplicationFormLocalAdminBack.jsp
</script>

</head>
<body onload="checkForm();hiddenTables(document.form.requestForCheck);intunedisplay(document.form.onintune);showTR1();showMob();showSim();showTROnload();dirApprove();">
<form name="form" method="post" action="NEINApplicationFormLocalAdminBack.jsp">
...
Connection cn1 = null,cn2=null,cn3=null,cn4=null,cn100=null,cnExtra=null;
...
Connection cn5 = null,cn11=null,cnB=null,cnH=null; 
Statement st5 = null,st11=null,st12=null,stB=null,stH=null; 
ResultSet rs5 = null,rs11=null,rs12=null,rsB=null,rsH=null; 
...
String nexasCCCode=null,nexasOPRange=null,nexasReqType=null,nexasOptionalMenu=null,nexasRemarks=null,gsnetBranchCode=null,gsnetDivName=null,gsnetPrimaryDiv=null,changesGSNet=null,prevBRCodesGSNet=null,prevDivGSNet=null,prevPDivGSNet=null,prevRoleGSNet=null,newinsLevel=null;
String gsnetUserRole=null,gsnetRemarks=null,internalApplication=null,internalRemarks=null,usbAccessFor=null,usbDetails=null,usbRemarks=null,vpnDomainID=null,level=null,passChan=null,chanReqBio=null,selBioBranches=null,changesNewins=null,previousBranchesNewins=null;
...
<td style="text-align:left;" bgcolor="grey" colspan="3"><input name="appName" value="<%=SessionName%>" size="31" readonly="readonly"/> </td>
</tr>	
<tr>
<td  style="text-align: right;width: 215px; " bgcolor="grey" >DESIGNATION :</td>
<td style="text-align:left;" bgcolor="grey" colspan="3"><input name="appDesg" value="<%=Sessiondesg%>" size="31" readonly="readonly"/> </td>
</tr>	
<tr>
<td  style="text-align: right;width: 215px; " bgcolor="grey" >FORM NO :</td>
<td style="text-align:left;" bgcolor="grey" colspan="3"><input name="appFormNo" value="<%=form2_no%>" size="31" readonly="readonly"/> </td>
</tr>	
<%
...
<td align="right" colspan="2" style="width: 20%;"><font color="red">*</font>Remarks :</td>
<td align="left" colspan="2" style="width: 60%;"><textarea name="sharedRemarks" rows="3" cols="30" id="shareRemarks" maxlength="199" readonly><%=folderRemarks%></textarea></td>
</tr>
</table>
<br />
</div>
...
<td style="font-weight:bold;font-style:italic;width:60%;background-color: <%=colorBG2%>;" colspan="11"><input type="text" name="newinsLevel" id="newlvel" value="<%=newinsLevel%>"></td>
</tr>
<%
...
<td colspan="5" id="hiderow"><input id="hiderow" type="button" name="delete" size="2" value="Delete" style="background-color:white;font-weight:bold;color:black;" onclick="deleteRecord2(<%=rsdel2new.getString(1)%>);" /></td></tr>
<%} %>
<tr>
<td bgcolor="white" style="text-align:left; width: 16%;" rowspan="4"><font color="black" size="2"><b>Program</b></font></td>
<% 
...
<td style="text-align: left;width: 60%;"><input name="nexasCompCode" type="text" value="<%=nexasCompCode%>" readonlu></td>
</tr>
<tr>
<td style="text-align: right;width: 20%;"><font color=red>*</font>Cost Center Name:</td>
<td style="text-align: left;width: 60%;"><input type="text" value="<%=nexasCCName%>" name="nexasCCName" readonly></td>
</tr>
<tr>
...
<td style="text-align: left;width: 60%;"><textarea rows="3" name="nexasOptionalMenu1" cols="65" readonly><%=nexasOptionalMenu1%></textarea>
<input type="hidden" name="nexasOptionalMenu" value="<%=nexasOptionalMenu%>" readonly></td>
</tr>
<tr>
...
<td style="text-align: right;width: 20%;"><font color="red">*</font>Internal Application :</td>
<td style="text-align: left;width: 60%;"><textarea rows="3" name="internalApplication" cols="65" readonly><%=internalApplication%></textarea>
</td>
</tr>
<tr>
<td style="text-align: right;width: 20%;"><font color="red">*</font>Remarks :</td>
...
<td style="text-align: left;width: 60%;"><textarea name="usbRem1" rows="3" cols="30" id="idUSBRem" maxlength="199" readonly><%=usbRemarks%></textarea></td>
</tr>
</table>
<br />
</div>
...
<input type="hidden" name="newinLev" value="<%=newinsLevel%>">
...
<br />
<table width="895" border="1" id="tableData" name="tableData" align="center" bgcolor="#F0F0F0" bordercolor="grey">
<tr>
...
<%
String mailD=null,form2_noD=null,colChange="red";
cn1 = con.getConnection2();
st1=cn1.createStatement();
String statusD=null,emp_no=null,levelno=null;
rs1 = st1.executeQuery("select form2_no,desg,emp,status,remarks,DATE_FORMAT(f_date,'%d/%m/%Y') as f_date,mail,empid,levelno from neinapplicationform_item WHERE form2_no='"+req+"' ORDER BY item_id ASC"); 
while(rs1.next())
{
...
if(statusD.equalsIgnoreCase("Initiator")){
	colChange = "#0066FF";
}else if(statusD.equalsIgnoreCase("Approved")){
...
<td bgcolor="white" width="100" style="background-color: <%=colChange%>"><font size="2" color="black"><%=statusD%></font></td>
...
<td style="display: none;" id="direct">
<table align="center" width="880" border="1" cellspacing="0" cellpadding="0" bgcolor="lightgrey">
...
<td class="it2" style="text-align:left;width:47%;" colspan="10"><input readonly type="text" value="<%=emailPass%>" name="passEmail" id="passEmail" maxlength="65" /></td>
</tr>
<tr>
...
<table width="880">
<tr><td style="text-align: center;background-color: <%=bgcolor2%>;" colspan="11" bgcolor="grey"><b>NEWINS</b></td></tr>
<tr>
...
<%}
System.out.println("progAll====>"+progAll);
if(!progAll.equals("")){	
...
if(i!=4)
{%>
<input type='checkbox' checked disabled id='gsBCode' name='gsBCode' value="<%=rsgs.getString(2)%>"/><%=rsgs.getString(2)%>
<%i++;}
else
{
%><br />
...
%>
<%while(rsdiv.next()){%>
<input type='checkbox' checked disabled id='gsDiv' name='gsDiv' value="<%=rsdiv.getString(2)%>"/><%=rsdiv.getString(2)%>
<%}%>
...
%>
<%while(rspri.next()){%>
<input type='checkbox' checked disabled id='gsPri' name='gsPri' value="<%=rspri.getString(2)%>"/><%=rspri.getString(2)%>
<%}%>
<%} catch (SQLException ex) {
ex.printStackTrace();
}	
...
<td class="it2"  style="text-align:left;width:47%;background-color: <%=colorBG3%>;" colspan="10">
<input type="hidden" name="gsUser1" id="gsUser1" value="<%=gsnetUserRole%>">
<%
...
<td class="it2" style="text-align:left;width:50%;" colspan="10"><input type="text" name="forti" id="forti" maxlength="65" /></td>
</tr>
</table>
</div>
<%}%>
...
<tr>
<td class="it2" style="text-align: right;width:20%;background-color: <%=colorBG%>;" colspan="1">Password :</td>
<td class="it2"  style="text-align:left;width:47%;background-color: <%=colorBG%>;" colspan="10"><input readonly type="text" name="ITpassword" value="nein*0001" id="pwd" maxlength="65" /></td>
</tr>
<tr>
<td class="it2" style="text-align: right;width:20%;background-color: <%=colorBG%>;" colspan="1"> Remarks :</td>
<td class="it2"  style="text-align:left;width:47%;background-color: <%=colorBG%>;" colspan="10"> <input type="text" name="ITremark" id="rem" size="60" maxlength="500" /></td>
...
System.out.println("here inside approved if");
...
<input type="hidden" name="ftype1" id="ftype1" value="<%=ftype%>">
 <table style="margin-left: auto;margin-right: auto;" ><tr>
  ...
  <td>&nbsp;&nbsp;<!-- <a href="HelpPageCS.jsp" onclick="return popitup('HelpPageCS.jsp')" id="hiderow"><font size=2>HELP</font></a> -->
   	...
   	<td style="font-size:1">&nbsp;&nbsp;<input type="button" value="Cancel" onclick="window.location.href='../../adminHR.jsp?msg=1'" /></td>
   	</tr>
