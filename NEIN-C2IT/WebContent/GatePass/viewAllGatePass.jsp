...
<head><title>VIEW GATE PASS FORM</title>
...
<tr align="center">
 <td bgcolor="#2f4377" class="blueLine"><strong><font size ="4" color="white">VIEW GATE PASS FORM</font></strong></td>
</tr>
...
<form name="form" method="post" action="viewGatePass.jsp?msg=1">
...
if(b_no.equals("90"))
{
	rs9 = st9.executeQuery("SELECT DISTINCT formno FROM gatepassform WHERE formno LIKE 'NEIN/GATEPASS%' ORDER BY id DESC");	
}
else
{
rs9 = st9.executeQuery("SELECT DISTINCT formno FROM gatepassform WHERE cityNo='"+b_no+"' AND formno LIKE 'NEIN/GATEPASS%' ORDER BY id DESC");
}
...
<table align="center">
<tr>
<th>SELECT GATE PASS FORM NUMBER</th>
</tr>
</table>
...
<br>	 
	...
	<table align="center" width="350" border="0" cellpadding="3" cellspacing="1" bgcolor=#D5F5E3>
  <tr>
