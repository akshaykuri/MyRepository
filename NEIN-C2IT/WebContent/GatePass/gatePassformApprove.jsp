...
<head><title>GATE PASS FORM</title>
...
<tr align="center">
 <td bgcolor="#2f4377" class="blueLine"><strong><font size ="4" color="white">PENDING GATE PASS  FORM</font></strong></td>
</tr>
...
rs9 = st9.executeQuery("SELECT DISTINCT formno FROM gatepassform WHERE ((ganame='"+AdminName+"' and gadesg='"+desg+"')|| gaempid='"+emp_no+"') and approvalStatus='Pending' AND formno LIKE 'NEIN/GATEPASS%' ORDER BY formno DESC");
