...
<script language="javascript" type="text/javascript">
  function validate()
      {
	  //alert("Here");
      var d1 = document.getElementById("idremremarks").value;
      //alert("Here:"+d1);
      if(d1=="")
	        {
	        alert("Enter Reminder updatator Remarks !");
	        idremremarks.focus();
	        return false;
	        }
         else
...
<form  name="form" method="post" onsubmit="return validate()" action="reminderUpdateBackBack.jsp" >
<%!
...
<center>
<table class="dynatable1" width="90%" border="2" style="height: 150;" cellspacing="0" cellpadding="0" bgcolor=#D5F5E3  >
          <tr>
          ...
          <br>
          <table class="dynatable1" width="90%" border="1" style="height: 150;" cellspacing="0" cellpadding="0" bgcolor=#D5F5E3  >
           <tr>
 ...
 --%>     		<td><font size="2" face="Swiss" id="hiderow">Name :<font color=red>*</font></font></td> 
     ...
     <table class="dynatable"  width="90%" border="1" style="height: 150;" cellspacing="0" cellpadding="0" bgcolor=#D5F5E3    >
	        <tr>
      ...
      <br>
      <table class="dynatable1" id="idapprovaRow" width="90%" border="1" style="height: 150;" cellspacing="0" cellpadding="0" bgcolor=#D5F5E3  >
               <tr>
               ...
               <tr>
        	         ...
        	         <td ><%= createdbydesg%> </td>
        	         <td>Initiator</td>
        	         <td ><textarea name="descOfItem" id="iddescOfItem" class="descOfItem" rows="4" cols="70" readonly><%=approvalremarks %> </textarea></td>
        	         <td><%=createdDate %> </td>
        	   </tr> 
        	   <tr>
        	         <td ><%=ganame %> </td>
        	         ...
        	         <td ><textarea name="descOfItem" id="iddescOfItem" class="descOfItem" rows="4" cols="70" readonly><%=gaApproverRemarks %></textarea> </td>
        	         <td><%=gaApprovedDate %> </td>
        	   </tr> 
        	 
        	 
        	<tr >
		           <td>Updater remarks :</td>
		           <td colspan="4"><textarea name="remremarks" id="idremremarks"  rows="4" cols="100" ></textarea></td>
