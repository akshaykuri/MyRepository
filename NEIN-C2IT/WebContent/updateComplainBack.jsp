...
int i=st.executeUpdate("update complain_master_item set cm_time2=CURRENT_TIMESTAMP(),cm_status='"+cm_status+"',cm_date2='"+result+"',admin_remarks='"+admin_remarks+"',status='append' where complain_id='"+complain_id+"'");                                                           
          ...
          // response.sendRedirect("updateComplaintPage.jsp?msg=" +msg);
...
%>
	...
	DbUtil.closeDBResources(rs5,st1,conn);
	DbUtil.closeDBResources(null,st,conn1);
	DbUtil.closeDBResources(null,st1,cn5);
...
<td><input type="button" value="OK" onclick="window.location.href='updateComplaintPage.jsp?msg=1'"/></td>
