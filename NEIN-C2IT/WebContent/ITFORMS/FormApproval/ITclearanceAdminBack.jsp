...
{   // if Approved and want to send directly to IT nonIT persons of HO and ONE copy to Initiator
	postMail.postMail(i_email_id,i_name,"pass1234",mail," Outstanding Dues & Handover Report :  " +form_no+ " ",i_name+  " "+  "request you to Approve - Outstanding Dues & Handover Report Form : " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
	postMail.postMail(i_email_id,i_name,"pass1234",allMails," Outstanding Dues & Handover Report :  " +form_no+ " ",initiatorNameIfNotApproved+  " "+  "your request for Outstanding Dues & Handover Report Form : "+form_no+" has been Approved by " +i_name+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>");
}
...
{   // if NOT Approved , so a copy to Initaior 
	postMail.postMail(i_email_id,i_name,"pass1234",mail," Outstanding Dues & Handover Report :  " +form_no+ " ",initiatorNameIfNotApproved+  " "+  "your request for Outstanding Dues & Handover Report Form : " +form_no+ " is not approved by "+i_name+" <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>");
}
message = null;
