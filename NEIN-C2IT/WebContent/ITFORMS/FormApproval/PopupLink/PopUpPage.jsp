...
<%
 ...
 %>
 <br /><center><label style="font: bold; size: 3">IT CLEARANCE FORM SAVED AND SENT SUCCESSFULLY</label></center> <br />
 <%
 try 
 ...
 ResourceBundle dbProperties = ResourceBundle.getBundle("csdb");
  ...
  String query2 = "SELECT form1_no FROM form1_it_clearance  WHERE SUBSTRING(form1_no,9,20)='"+second+"'";
  Statement st2 = conn.createStatement();
  ResultSet rs2 = st2.executeQuery(query2); 
  int k=0;
 
   if(rs2.next()){
	                      String msg = "IT__CLEARANCE__FORM__NO__:__<b>'"+no+"'</b>__SAVED__AND__SENT__SUCCESSFULLY";
...
<td width="1118" align="right"> 
    <center><p style="font-size:16px;color:black"> 
        <input type="button" value="OK" title="Click To Close Sub Menu" onclick="window.location.href='../../../adminPage.jsp?msg=1'" /></p></center>
</td> 
</tr> 
</table>
