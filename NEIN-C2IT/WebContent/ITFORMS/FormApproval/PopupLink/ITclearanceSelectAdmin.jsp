...
rs9 = st9.executeQuery("SELECT DISTINCT form1_no FROM form1_it_clearance WHERE Approval_emp='"+AdminName+"' and Approval_desg='"+desg+"' and Approval_sttatuss='Pending' AND form1_no LIKE 'NEIN/CS/IT%' ORDER BY form1_no ASC");
