...
<%! 
	              ...
	              PreparedStatement psmtApOp1=null,psmtApOp2=null,psmtApOp3=null,psmtNotApproved=null,psmt4i=null;
	              %>
...
String mmdradio = request.getParameter("mmdradio");//mmdradioHR
String CheckValues = request.getParameter("CheckValues");//HRremarks
//String mailingCheckSendingTOAC = request.getParameter("mailingCheckSendingTOAC");
//
	...
	System.out.println("Mail mailingCheckSendingHRfromAC value FOR IT CLEARANCE"+CheckValues);
...
psmt10 = cn2.prepareStatement("UPDATE form1_it_clearance SET Approval_status=?,Approval_sttatuss=?,Approval_remarks=?,Approval_f_date=?,Approval_emp=?,Approval_desg=?,Approval_empp=?,Approval_desgg=?,a_document_ac=?,r_document_ac=?,"
								+"a_model=?,a_data_card=?,a_email=?,a_newins=?,a_domain=?,a_mobile_model=?,a_mobile_no=?,a_access_card=?,a_drive=?,a_other_asset=?,a_remarks=?,r_model=?,r_data_card=?,r_email=?,r_newins=?,r_domain=?,r_mobile_model=?,r_mobile_no=?,r_access_card=?,r_drive=?,r_other_asset=?,a_model_info=?,r_model_info=? "
										+"WHERE form1_no=?");
...
psmt10.setString(9,a_document_ac);
psmt10.setString(10,r_document_ac);

psmt10.setString(11,a_model);
psmt10.setString(12,a_data_card);
psmt10.setString(13,a_email);
psmt10.setString(14,a_newins);
psmt10.setString(15,a_domain);
psmt10.setString(16,a_mobile_model);
psmt10.setString(17,a_mobile_no);
psmt10.setString(18,a_access_card);
psmt10.setString(19,a_drive);
psmt10.setString(20,a_other_asset);
psmt10.setString(21,a_remarks);
psmt10.setString(22,r_model);
psmt10.setString(23,r_data_card);
psmt10.setString(24,r_email);
psmt10.setString(25,r_newins);
psmt10.setString(26,r_domain);
psmt10.setString(27,r_mobile_model);
psmt10.setString(28,r_mobile_no);
psmt10.setString(29,r_access_card);
psmt10.setString(30,r_drive);
psmt10.setString(31,r_other_asset);

psmt10.setString(32,a_model_info);
psmt10.setString(33,r_model_info);

psmt10.setString(34,form_no);
int b = psmt10.executeUpdate(); 
		...
		if((mmdradio!=null && mmdradio.equals("Approved") || mmdradio.equals("APPROVED")))
		{
			if(mailHR!=null)
			{
