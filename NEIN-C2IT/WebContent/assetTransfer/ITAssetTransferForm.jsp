...
{ 
	...
	if (typeof XMLHttpRequest != "undefined")
 	...
 	if (xmlHttp==null)
	    ...
	    var url="featchassettransfer.jsp";  
	    url +="?asset_no=" +v;
...
<form  method="post" onsubmit="return validatefield()" action="itAssetTransferDB.jsp"  name="form1" id="form">
...
<div class="modal-header">
      <center> <h2> IT ASSET TRANSFER FORM </h2></center>
    </div>
	...
	<center>
		...
		<tr>
		<td colspan="4" align="center" >TRANSFER</td>
		</tr>
		<tr>
		<td colspan="2" align="center" >Asset Transfer to Branch </td>
		<td>Transfer Date</td>
		<td> Asset Transferred User/Office</td>
			
		</tr>
		<tr><td colspan="2" align="center" > <textarea rows="1" cols="30"  name="disposalReason" id="disposalReason"  ></textarea></td>
	
		<td> 
		
		<input type="text" name ="disposalDate" class="txtCalendar2" placeholder="Date" value="" id="disposalDate" >
		</td>
		<td> <textarea rows="1" cols="30"  name="disposalConsidaration" id="disposalConsidaration" ></textarea></td>
			</tr>
		<tr>
		<td colspan="2" align="center">Transfer Initiated By</td>
		<td colspan="2" align="center">Transfer Approved by</td>
		</tr>
		<tr>
