...
<form method="post" action="PrinterUpdate.jsp">
<br />
<br /><br />
...
ResultSet rs=null,rs2=null,rs02=null;
  ...
  
  {
	 ...
	 Class.forName(driver).newInstance();
      conn = DriverManager.getConnection(url+dbName,userName,password); 
       String query = "select * from printer_master where id='"+no+"'";
  ...
  <tr>
      ...
      <td bgcolor=""><input name="printer_name" style="background-color:white;width:100;color:black;" value="<%=rs.getString("printer_name")%>"></td>
      <td bgcolor=""><font color="white"><input name="printer_detail" style="background-color:white;width:80;color:black;" value="<%=rs.getString("printer_detail")%>"></font></td>
