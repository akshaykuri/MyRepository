...
<form method="post" action="NewDesigUpdate.jsp">
<br />
<br /><br />
...
String dbName = dbProperties.getString("csdb.dbName"); 
  ...
  
  {
      ...
      String query = "select * from desg where id='"+no+"'";
   st = conn.createStatement();
   rs = st.executeQuery(query);
  while(rs.next()){%>
  <tr>
     
      <td bgcolor=""><input name="DESIGNATION" style="background-color:white;width:100;color:black;" value="<%=rs.getString("DESIGNATION")%>"></td>
