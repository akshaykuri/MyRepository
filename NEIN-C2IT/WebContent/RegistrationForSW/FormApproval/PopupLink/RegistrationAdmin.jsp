...
<head>
   ...
   var ff=document.form.empid1;
    ...
    var finalap= document.form.finalap;
...
<form  name="form" method="post"  action="RegistrationAdminBack.jsp">
...
String i_name=null,i_desg=null,i_city=null,i_b_no=null,i_admin=null,i_email_id=null,desg=null,emp=null,mail=null,ITAssignedRights=null;
String req = request.getParameter("rss");

cn100 = con.getConnection2();
st100=cn100.createStatement();
rs100 = st100.executeQuery("select * from form10_registration WHERE form10_no='"+req+"'"); 
    while(rs100.next())
        {
...
<table width="907"  cellspacing="0" cellpadding="0" bgcolor="grey" align="center">
	 <tr>
		...
		<b><label>NEIN APPLICATION USER - REGISTRATION FORM</label>
		</b></font></center> 
...
<table width="895" border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
	  ...
	  rs1 = st1.executeQuery("select form10_no,desg,emp,status,remarks,f_date,mail,empid,levelno from form10_registration_item WHERE form10_no='"+req+"' ORDER BY id ASC"); 
	  while(rs1.next())
	      {
...
<%String flag = c2ITUtil1.getAuthorizedNameRegistration(form10_no,session.getAttribute("Nname").toString(),session.getAttribute("desg").toString(),EmpNo); %>
...
<table align="center" class="dynatable" width="100%" border="1" style="height: 150;" cellspacing="0" cellpadding="0" bgcolor="lightgrey">
   ...
   <tr style="visibility: hidden;display: none;" id="idApprovedd" >
    ...
    cn5 = DriverManager.getConnection(url+dbName,userName,password); 
     ...
     String maxlevel="";
      ...
      rs12= st12.executeQuery("SELECT max(levelno) FROM formapproval WHERE branch='"+i_b_no+"' and formtype='NEINUser'  ORDER BY levelno ASC");
     if(rs12.next())
         { 
    ...
    rs11 = st11.executeQuery("SELECT alloptions,directApprove FROM formapproval WHERE branch='"+i_b_no+"' and empid='"+emp_no+"' and formtype='NEINUser'");
     if(rs11.next())
         { 
     ...
     //System.out.println("Next  Level no :"+nextlevel);
      ...
      rsnext = stnext.executeQuery("SELECT * FROM formapproval WHERE branch='"+i_b_no+"' and levelno='"+nextlevel+"' and formtype='NEINUser' ORDER BY levelno ASC");
      if(rsnext.next())
           {
     ...
     if(allopt.equals("0")||allopt.equals(""))
           {
    	   System.out.println("Next  Level no 111:"+nextlevel);
    	   if(!levelno.equals(maxlevel))
    	         {System.out.println("send  approve section.............");
    	         rs5 = st5.executeQuery("SELECT * FROM formapproval WHERE branch='"+i_b_no+"' and levelno='"+nextlevel+"' and formtype='NEINUser' ORDER BY levelno ASC");
    	         if(rs5.next())
                     {
                  ...
                  <input type="hidden" name="finalap" id="idfinalap" value="0" readonly/>
              ...
              <%}}
               else
                  {
            	   ...
            	   %>
            	   <td>
            	   <input type="hidden" name="finalap" id="idfinalap" value="1" readonly/>
            	   <table>
            	      <tr>
            	     ...
            	     <tr>
            	          <td>Send to HO(IT) for Create UserID and Password</td>
                          <td><input align="left" type="radio" value="<%=napprovalsw%>" id="iddeptadminP1" onclick="sync(iddeptadminP.value);"/>
 ...
 <table style="margin-left: auto;margin-right: auto;" >
    <tr>
       <td> <div id="formsubmitbutton"> <input type="submit" style="background-color:#2f4377;font-weight:bold;color:white;" value="SUBMIT" name=button1 onclick="return (validate() && ButtonClicked());" />
            </div>
