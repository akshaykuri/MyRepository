...
if((mmdradio!=null && mmdradio.equals("Approved"))) 
	...
	if(!empid1.equals("Final"))
	        ...
	        psmt2 = cn2.prepareStatement("UPDATE form10_registration SET ITusername=?,ITpassword=?,ITAssignedRights=?,ITremark=? WHERE form10_no=?");
	        psmt2.setString(1,ITusername);
	        psmt2.setString(2,ITpassword);
	        psmt2.setString(3,ITcreated);
	        psmt2.setString(4,ITremark);
	        psmt2.setString(5,form_no);
