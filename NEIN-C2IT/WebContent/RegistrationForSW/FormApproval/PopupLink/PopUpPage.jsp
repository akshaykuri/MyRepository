...
String dbName = dbProperties.getString("csdb.dbName");
 ...
 %>
 <br /><center><label style="font: bold; size: 3">INTERNAL NEIN SOFTWARE -REGISTRATION FORM NO : <%=no%> IS SAVED AND SENT SUCCESSFULLY</label></center> <br />
 <%
 try 
 ...
 String query2 = "SELECT form10_no FROM form10_registration  WHERE SUBSTRING(form10_no,9,20)='"+second+"'";
  Statement st2 = conn.createStatement();
  ResultSet rs2 = st2.executeQuery(query2); 
  int k=0;
 
   if(rs2.next()){
	              String form10_no = rs2.getString("form10_no");
	              String Approval_emp = rs2.getString("Approval_emp");
	                     // String msg = "INTERNAL__NEIN__SOFTWARE__-__REGISTRATION__FORM__NO__:__'"+no+"'__SAVED__AND__SENT__SUCCESSFULLY";
	                        String msg = "INTERNAL__NEIN__SOFTWARE__USER__-__REGISTRATION__FORM__NO__:__'"+form10_no+"'__SAVED__AND__SENT__SUCCESSFULLY";
