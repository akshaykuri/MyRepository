...
<form name="form" method="post" action="RegistratorLocalAdmin.jsp?msg=1">
...
rs9 = st9.executeQuery("SELECT DISTINCT form10_no FROM form10_registration_item WHERE ((emp='"+AdminName+"' and desg='"+desg+"') or (empid='"+EmpNo+"')) and status='Pending' AND form10_no LIKE 'NEIN/CS/Registration%' ORDER BY form10_no ASC");
