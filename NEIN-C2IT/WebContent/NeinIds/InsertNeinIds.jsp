...
<body>
                ...
                for(int w=1; w <= count ; w++) {
			           ...
			           con3 = dbConn.getConnection2();
						...
						String query = "select max(id) from nein_ids";
						st = con1.createStatement();
 						rs = st.executeQuery(query);
 						
 						String query1 = "select month from nein_ids where month='"+month+"' and TypeOfNeinId='"+idtype+"' ";
 						...
 						if(!rs1.next())
 						     {
 							  ...
 							  for(int z=1; z <= count ; z++) {
 									       ...
 									       id++; 
 						                  prds = con3.prepareStatement(" INSERT INTO `nein_ids`(`id`,  `branchNo`, `initiator`, `month`, `total`,`TypeOfNeinId`)"+
 						                		                       " VALUES (?,?,?,?,?,?) ");   
 				                          ...
 				                          prds.setString(6,idtype);
 				                          
 				                          i= prds.executeUpdate();
 							       }      
 				                          msg = "Data__INSERTED__SUCCESSFULLY";
 				                          response.sendRedirect("CreateNeinIds.jsp?msg=" +msg);
