...
<script language="javascript" type="text/javascript">
	...
	for(i=1;i<=count;i++){
			 ...
			 if(no_ids == ''){		
	             alert("Enter the number of Lotus Email id's for branch :: "+i);
	            return false;
			  }  		
	     }
		  return true;
...
<form method="post" name="form1" action="InsertNeinIds.jsp">
...
<table  align="center" border="1" width="30%"> 
    ...
    <tr>
       <td><span style="color:red;">*</span>Select Id Type:</td>
       <td>
    ...
    <tr>
       ...
       <td><span style="color:red;">*</span>No.of Lotus ID's Used':</td>
    ...
    <%                       Connection con3 = null;
     ...
     <tr>
       <td><span style="color:red; "> ** Total count **</span>
       <input type="hidden" name="count" id="count" value="<%=number%>" readonly> </td>
       <td><input type="text" name="totalCount" id="totalCount" size="20" placeholder="click here" onclick="getTotalCount()" readonly></td>
     </tr>
    <tr>
       <th colspan="2"> <input type="submit" value="Submit" onclick="return (Validation());">&nbsp; &nbsp; &nbsp; &nbsp; <input type="reset" value="Reset"></th>
