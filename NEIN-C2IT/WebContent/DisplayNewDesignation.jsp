...
var f=document.form;    
f.method="post";    
f.action='NewDesigEdit.jsp?id='+id;    
f.submit();
}
function deleteRecord(id)
{    
	if(confirm('You are above to delete a Designation'))
	{
var f=document.form;    
f.method="post";    
f.action='NewDesigDelete.jsp?id='+id;    
f.submit();
}
	else{}
}
...
<center>
	...
	<table border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
		...
		<td height="20" bgcolor="white" width="120" align=center><font size="2" color="black"><b>NAME</b></font></td>
				<td height="20" bgcolor="white" width="5" align=center><font size="2" color="black" ><b>NO.</b></font></td>
						<td height="20" colspan="2" bgcolor="white" width="120" align=center><font size="2" color="black"><b>EDIT/DELETE</b></font></td>
...
<%if(session.getAttribute("admin")!=null && session.getAttribute("admin").equals("SuperAdmin"))
{%>
