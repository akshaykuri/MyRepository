...
<div class="bg"></div>
   ...
   <aside style="float: right;margin-right:10%;margin-top:-19%;">
							<div style="width: 45%;margin: auto;"> 
								<form method="get"  name="form1"  action="logtestadminHR.jsp">
								
						
								   <fieldset class="fieldset" style="width: 125%;margin: auto;background-color:#728FCE;opacity:0.7;">
									      <legend class="legend" style="color:black;background-color:#8ec300;border-radius:10px; width: 90%;margin-left:10px;opacity:0.7;"><b><center>Form User Login</center></b></legend>  
											 <table> 
												<tr>
