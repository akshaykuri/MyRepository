...
<jsp:useBean id = "postMail" class="CON2.PostMail" /> 
 ...
 {          
	 ...
	 rs = st2.executeQuery("SELECT id,form4_no FROM form4_accesscard WHERE id="+id+"");
	 if(rs.next()){
...
/* 	 int i=st.executeUpdate("delete from form4_accesscard where id="+id+"");    
	 int j=st3.executeUpdate("delete FROM form4_accesscard_item WHERE form4_no='"+FormNo+"'");  */
	 
	 int i=st.executeUpdate("UPDATE form4_accesscard SET deleted='yes' where id="+id+""); 
...
/* 	 deleteBy.trim();
	...
	// postMail.postMail(deleteMail,deleteBy,"pass1234",mail_id," IT CLEARANCE FORM :  " +FormNo+ " ",deleteBy+  " "+  "Deleted IT CLEARANCE FORM :     "+FormNo+"");              
	 ...
	 response.sendRedirect("accessCard.jsp?msg="+msg);
	 }
	 catch (Exception e) {
