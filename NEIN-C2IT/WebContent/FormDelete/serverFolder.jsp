...
<title>SHARED FOLDER REPORT</title>
...
var f=document.form;    
f.method="post";    
f.action='serverFolderEdit.jsp?id='+id;    
f.submit();
}
function deleteRecord(id)
{   

	if(confirm('You are above to delete a Shared Folder form'))
	{
var f=document.form;    
f.method="post";    
f.action='serverFolderDelete.jsp?id='+id;    
f.submit();
}
	else{}
}
...
if (VERSION > 3) {
	...
	<td colspan="7" align="center">SHARED FOLDER FORM</td>
	<td align="center" id="hiderow" colspan="2"><input align="middle" type="button" value="BACK"  onclick="window.location.href='../adminbom.jsp?msg=1'" /></td>
	</tr>
		<tr>
<td bgcolor="lightgrey"  align=center><font size="2" color="black"><b>SL </b></font></td>
		...
		<td bgcolor="lightgrey" width="60" align=center colspan="2"><font size="2" color="black"><b>EDIT</b></font></td>
		<td bgcolor="lightgrey" width="60" align=center colspan="2"><font size="2" color="black"><b>DELETE</b></font></td>
		</tr>
...
String query = "SELECT f.id,f.form5_no,f.i_name,f.full_name,f.i_city,f.branch,f.f_date,GROUP_CONCAT(g.emp ORDER BY g.id ASC SEPARATOR ', ') as emm FROM   form5_folder f INNER JOIN   form5_folder_item g ON(f.form5_no=g.form5_no) WHERE Approval_status='Pending' AND f.deleted='no' GROUP BY f.id ORDER BY f.id";
