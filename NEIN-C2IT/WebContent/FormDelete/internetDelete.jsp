...
<jsp:useBean id = "postMail" class="CON2.PostMail" /> 
 ...
 {          
	 ...
	 rs = st2.executeQuery("SELECT id,form6_no FROM  form6_internet WHERE id="+id+"");
	 if(rs.next()){
		 String id2 = rs.getString("id");
		 FormNo = rs.getString("form6_no");
...
/* 	 int i=st.executeUpdate("delete from   form6_internet where id="+id+"");    
	 int j=st3.executeUpdate("delete FROM   form6_internet_item WHERE form6_no='"+FormNo+"'");  */
	 
	 int i=st.executeUpdate("UPDATE form6_internet SET deleted='yes' where id="+id+"");
...
/* 	 deleteBy.trim();
	...
	// postMail.postMail(deleteMail,deleteBy,"pass1234",mail_id," IT CLEARANCE FORM :  " +FormNo+ " ",deleteBy+  " "+  "Deleted IT CLEARANCE FORM :     "+FormNo+"");              
	 ...
	 response.sendRedirect("internet.jsp?msg="+msg);
	 }
	 catch (Exception e) {
