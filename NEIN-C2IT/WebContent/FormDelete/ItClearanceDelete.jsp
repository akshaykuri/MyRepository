...
<jsp:useBean id = "postMail" class="CON2.PostMail" /> 
 ...
 System.out.println("IT CLEARANCE DELETE "+id);
 ...
 {          
	 ...
	 rs = st2.executeQuery("SELECT id,form1_no FROM form1_it_clearance WHERE id="+id+"");
	 if(rs.next()){
...
/* 	 int i=st.executeUpdate("delete from form1_it_clearance where id="+id+"");    
	 int j=st3.executeUpdate("delete FROM form1_it_clearance_item WHERE form1_no='"+FormNo+"'");  */
	 int i=st.executeUpdate("UPDATE form1_it_clearance SET deleted='Yes' where id="+id+"");    
	 //int j=st3.executeUpdate("delete FROM form1_it_clearance_item WHERE form1_no='"+FormNo+"'"); 
