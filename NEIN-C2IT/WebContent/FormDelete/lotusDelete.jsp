...
<jsp:useBean id = "postMail" class="CON2.PostMail" /> 
 ...
 System.out.println("LOTUS DELETE "+id);
 ...
 {          
	 ...
	 rs = st2.executeQuery("SELECT id,form3_no FROM form3_lotus WHERE id="+id+"");
	 if(rs.next()){
...
/* 	 int i=st.executeUpdate("delete from form3_lotus where id="+id+"");    
	 int j=st3.executeUpdate("delete FROM form3_lotus_item WHERE form3_no='"+FormNo+"'");  */
	 
	 int i=st.executeUpdate("UPDATE form3_lotus SET deleted='yes' where id="+id+"");
...
/* 	 deleteBy.trim();
	...
	// postMail.postMail(deleteMail,deleteBy,"pass1234",mail_id," IT CLEARANCE FORM :  " +FormNo+ " ",deleteBy+  " "+  "Deleted IT CLEARANCE FORM :     "+FormNo+"");              
	 ...
	 response.sendRedirect("lotus.jsp?msg="+msg);
	 }
	 catch (Exception e) {
