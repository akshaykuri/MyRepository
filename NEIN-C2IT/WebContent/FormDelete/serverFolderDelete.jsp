...
<jsp:useBean id = "postMail" class="CON2.PostMail" /> 
 ...
 {          
	 ...
	 rs = st2.executeQuery("SELECT id,form5_no FROM  form5_folder WHERE id="+id+"");
	 if(rs.next()){
...
/* 	 rs2 = st4.executeQuery("SELECT id,emp,form1_no,mail FROM form1_it_clearance_item WHERE form1_no="+FormNo+" ");
	...
	/*  int i=st.executeUpdate("delete from  form5_folder where id="+id+"");    
	 int j=st3.executeUpdate("delete FROM  form5_folder_item WHERE form5_no='"+FormNo+"'");  */
	 
	 int i=st.executeUpdate("UPDATE form5_folder SET deleted='yes' where id="+id+"");
