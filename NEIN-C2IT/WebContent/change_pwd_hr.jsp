...
<form name="f" method="post" action="changePasswordHRBack.jsp" >
<center>
...
<tr><td align="center" width="50%"><font size="2">System Admin</font> </td><td><font size="2"><%= session.getAttribute( "Nname" ) %></font></td></tr>   
<tr><td align="center" width="50%"><font size="2">Current Password</font></td><td><input size="20" type="password" id="idCurrent" name="current" maxlength="25"></td></tr>
