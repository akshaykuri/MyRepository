...
try
{
 ...
 conn = DriverManager.getConnection(url+dbName,userName,password); 
	...
	st.executeUpdate("update nentrydel set idd='"+idb+"',Nname='"+Nnameb+"',Npwd='"+Npwdb+"',Naddr='"+Naddrb+"',Ncontact='"+Ncontactb+"',Npost='"+Npostb+"',NpostingCo='"+NpostingCo+"',Nmail='"+Nmail+"' where id='"+num+"'");
	response.sendRedirect("DisplayDelDel.jsp");
