...
<title>BARCODE MASTER PAGE</title>
...
<% 
 ...
 <script language = "Javascript">
          ...
          function validate(){
              var w=document.form.barcode_name;
              var ab=document.form.barcode_detail;
              var bk = document.form.brLocation;
...
<tr align="center">
 <td bgcolor="#2f4377" class="blueLine"><strong><font size ="4" color="white">BARCODE PRINTER MASTER</font></strong></td>
</tr>
  ...
  <form name="form" method="post" onSubmit="return validate()" action="BarcodeMasterBack.jsp">
...
<table width="920" height="3" cellpadding="0" cellspacing="0" ID="Table1">
  ...
  <td width="25%" align="justify" valign="top"></td>
    <td width="14%" align="justify" valign="top">
      <p> <img src="images/barcode.jpg" height="150" width="370">
</td>
<td width="10%" align="justify" valign="top"></td>
<td width="5%" align="justify" valign="top"></td>
<td width="85%"><table width="100%" border="2" > 
  
    
<tr>
<td align=center width=60% colspan=2  background=".jpg">
<font color=darkblue size=3 > BARCODE PRINTER DETAILS</font>
</td>
</tr>

	<tr><td><font size="2"> BARCODE PRINTER NAME:</font><font color=red>*</font></td><td><input type="text" size="20" name="barcode_name" value=""></td></tr>

	<tr><td><font size="2"> BARCODE PRINTER DETAIL:</font><font color=red>*</font></td><td><input type="text" size="20" name="barcode_detail" value=""></td></tr>
<tr><td><font size="2">LOCATION:</font><font color=red>*</font></td><td>
    <select name="brLocation">
...
%>
	...
	<tr>
	<td>
    <a href="DisplayBarcode.jsp" onclick="return popitup('DisplayBarcode.jsp')">View Barcode printer</a> </td>
