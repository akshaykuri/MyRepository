...
<% 
 ...
 <script language = "Javascript">
          ...
          function validate(){
              var w=document.form.b_name;
              var ab=document.form.b_no;
              var bl=document.form.b_location;
...
<tr align="center">
 <td bgcolor="#2f4377" class="blueLine"><strong><font size ="4" color="white">SUB-BRANCH MASTER</font></strong></td>
</tr>
  ...
  <form name="form" method="post" onSubmit="return validate()" action="BranchMasterAdminBack.jsp">
...
<font color=darkblue size=3 >SUB-BRANCH DETAILS</font>
</td>
</tr>

	<tr><td><font size="2">BRANCH :</font><font color=red>*</font></td><td><input type="text" size="20" name="b_name" value=""></td></tr>

	<tr><td><font size="2">NO.:</font><font color=red>*</font></td><td><input type="text" size="20" name="b_no" value=""></td></tr>
	<tr><td><font size="2">LOCATION:</font><font color=red>*</font></td><td><input type="text" size="20" name="b_location" value=""></td></tr>
	</table>
	<table width="100%" align=center border=2 background=".jpg"  bordercolor=#aaaccc>
	
	<tr>
	<td>
    <a href="DisplayBranch.jsp" onclick="return popitup('DisplayBranch.jsp')">View Branch</a> </td>
