...
<form name="form" method="post" action="SharedFolderLocalAdmin.jsp?msg=1">
...
rs9 = st9.executeQuery("SELECT DISTINCT form5_no FROM form5_folder_item WHERE ((emp='"+AdminName+"' and desg='"+desg+"')OR(empid='"+(String) session.getAttribute("EmpNo")+"')) and status='Pending' AND form5_no LIKE 'NEIN/CS/Sfolder%' ORDER BY form5_no ASC");
