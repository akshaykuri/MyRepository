...
</tr>  <tr > <td bgcolor=""><font size ="2">NAME :<%=session.getAttribute("Nname")%> </font>&nbsp;&nbsp; 
...
<form name="form" method="post" action="SharedFolderAllLocalAdmin.jsp?msg=1">
...
if(b_no.equals("90"))
	rs9 = st9.executeQuery("SELECT DISTINCT form5_no,full_name FROM form5_folder WHERE form5_no LIKE 'NEIN/CS/Sfolder%' ORDER BY form5_no DESC");
else if(b_no.equals("30"))
	rs9 = st9.executeQuery("SELECT DISTINCT form5_no,full_name FROM form5_folder WHERE i_b_no in('30','32','11','53') and form5_no LIKE 'NEIN/CS/Sfolder%' ORDER BY form5_no DESC");

else
	rs9 = st9.executeQuery("SELECT DISTINCT form5_no,full_name FROM form5_folder WHERE i_b_no='"+b_no+"' AND form5_no LIKE 'NEIN/CS/Sfolder%' ORDER BY idextend DESC");
