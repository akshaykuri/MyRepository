...
document.form.action="SharedFolderLocalAdminBack.jsp";
document.form.method="post";
document.form.submit();
}
function ITManager()
{
document.form.action="SharedFolderLocalAdminITmanagerBack.jsp";
document.form.method="post";
document.form.submit();
}
</script>
...
<center>
<table width="912"  cellspacing="0" cellpadding="0" bgcolor="grey" align="center">
	<tr>
...
<table width="100%" border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
	  ...
	  rs1 = st1.executeQuery("select form5_no,desg,emp,status,remarks,DATE_FORMAT(f_date,'%d/%m/%Y'),mail from form5_folder_item WHERE form5_no='"+req+"'"); 
	  while(rs1.next())
	  {
		  String form5_noD= rs1.getString(1);
...
<table style="margin-left: auto;margin-right: auto;" ><tr>
     ...
     <td style="font-size:1" id="hiderow">&nbsp;&nbsp;<!-- <input style="size:1;font-size: 1.1em;" type="button"  value="BACK" onclick="window.location.href='SharedFolderSelectAdmin.jsp?msg=1'"/> -->
