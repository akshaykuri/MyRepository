  ...
  function getInfo()
             ...
             if(xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
                            { 
                             ...
                             document.getElementById("resultFromAjax2").innerHTML = str2;//fname,rofficer,designation,depart,branch
...
<body>
<form action="SharedFolderPageBack.jsp" method="post" name="form">
...
<table width="907"  cellspacing="0" cellpadding="0" bgcolor="grey" align="center">
	<tr>
		...
		<b><label>
		FOLDER ACCESS REQUEST FORM</label>
		</b></font></center> 
		</td>
		</tr>
...
rs3 = st3.executeQuery("SELECT max(idextend) FROM form5_folder WHERE form5_no IN(SELECT form5_no FROM form5_folder LEFT JOIN branch_master b ON(substr(form5_no,17,2)=b.b_no) WHERE '"+b_no+"'=b.b_no GROUP BY form5_no)");
...
<tr >
	...
	<input name="form5_no" readonly="readonly" value="<%=new_id%>" size="25" />
	</td>
	</tr>
	<tr>
...
<%-- <td style="text-align:left;width:33%;"><select name="branch"  id="hiderow" style="font-size : 8pt">
					...
					<%} %> </select></td>  --%>
<td style="text-align:left;"><input type="text" name="branch" size="29" id="branch" maxlength="44" /></td>
...
<%-- <td style="text-align:left;"><select name="depart"  id="hiderow" style="font-size : 8pt">
					...
					<%} %> </select></td> --%> 
<td style="text-align:left;"><input type="text" name="depart" size="29" id="depart" maxlength="44" /></td>
...
<%-- <td style="text-align:left;"><select name="designation"  id="hiderow" style="font-size : 8pt">
					...
					<%} %> </select></td> --%>
<td style="text-align:left;"><input type="text" name="designation" size="29" id="designation" maxlength="44" /></td>
...
<td style="text-align:left;"><input type="text" name="requestBy" size="29" id="req" size="40" value="<%=Name%> " maxlength="44"/></td>

</tr>
<!-- <tr>
<td style="text-align: right;">Requested E-Mail Id :</td>
<td style="text-align:left;"><input type="text" name="New_email" id="id" size="50"></td>
