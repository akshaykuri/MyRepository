...
rs100 = st100.executeQuery("select * from form5_folder WHERE form5_no='"+values[0]+"'"); 
while(rs100.next())
{
...
<table id="tableData" name="tableData" width="100%" border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
	  ...
	  rs1 = st1.executeQuery("select form5_no,desg,emp,status,remarks,f_date,mail from form5_folder_item WHERE form5_no='"+values[0]+"' AND desg <> 'none' ORDER BY id ASC"); 
	  while(rs1.next())
	  {
