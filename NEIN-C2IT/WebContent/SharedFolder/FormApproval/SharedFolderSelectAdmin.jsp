...
document.form.action="SharedFolderAdmin.jsp?msg=1";
...
document.form2.action="SharedFolderAllLocalAdmin.jsp?msg=1";
...
{  var p1=document.form.req;
 if ((p1.value==null)||(p1.value=="NULL"))
				{alert("Select Shared folder Number!"); p1.focus(); return false; }
...
<tr align="center">
 <td bgcolor="#2f4377" class="blueLine"><strong><font size ="4" color="white">SHARED FOLDER FORM</font></strong></td>
</tr>
...
<form name="form" method="post" action="SharedFolderAdmin.jsp?msg=1">
...
Connection cn9 = null;
Statement st9 = null; 
ResultSet rs9 = null;Connection cn99 = null;
Statement st99 = null; 
ResultSet rs99 = null;Connection cn10 = null;
Statement st10 = null; 
ResultSet rs10 = null;
try{
...
/* rs9 = st9.executeQuery("SELECT DISTINCT form5_no FROM form5_folder  ORDER BY form5_no"); */
//rs9 = st9.executeQuery("SELECT DISTINCT form5_no FROM form5_folder_item WHERE emp='"+AdminName+"' and desg='"+desg+"' and status='Pending' AND form5_no LIKE 'NEIN/CS/Sfolder%' ORDER BY form5_no ASC");
rs9 = st9.executeQuery("SELECT DISTINCT form5_no FROM form5_folder WHERE Approval_emp='"+AdminName+"' and Approval_desg='"+desg+"' and Approval_sttatuss='Pending' AND form5_no LIKE 'NEIN/CS/Sfolder%' ORDER BY form5_no ASC");
...
<table align="center">
<tr>
<th>SELECT SHARED FOLDER FORM NUMBER</th>
</tr>
</table>
...
<td align=center colspan="2">
	...
	<td width="40%">
	<form name="form2" method="post" action="SharedFolderAllLocalAdmin.jsp?msg=1">
<%-- %>	 <form action="POMonthWiseBack.jsp"> 
	<form action="POWiseBack.jsp">--%>
...
st99=cn9.createStatement();
//rs9 = st9.executeQuery("Select DISTINCT substr(pordernon,6,2) from po ORDER BY substr(pordernon,6,2) ASC");
/* rs9 = st9.executeQuery("SELECT DISTINCT form5_no FROM form5_folder  ORDER BY form5_no"); */
//rs99 = st99.executeQuery("SELECT DISTINCT form5_no FROM form5_folder WHERE i_b_no='"+b_no+"' AND form5_no LIKE 'NEIN/CS/Sfolder%' ORDER BY idextend DESC");
rs99 = st99.executeQuery("SELECT DISTINCT form5_no,full_name FROM form5_folder WHERE form5_no LIKE 'NEIN/CS/Sfolder%' ORDER BY id DESC");
