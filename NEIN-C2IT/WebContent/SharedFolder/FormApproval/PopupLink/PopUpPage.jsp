...
<%
 ...
 %>
 <br /><center><label style="font: bold; size: 3">SHARED FOLDER FORM NO : <%=no%> IS SAVED AND SENT SUCCESSFULLY</label></center> <br />
 <%
 try 
 ...
 ResourceBundle dbProperties = ResourceBundle.getBundle("csdb");
  ...
  String query2 = "SELECT form5_no FROM form5_folder  WHERE SUBSTRING(form5_no,9,20)='"+second+"'";
  Statement st2 = conn.createStatement();
  ResultSet rs2 = st2.executeQuery(query2); 
  int k=0;
 
   if(rs2.next()){
	                      String msg = "SHARED__FOLDER__USER__FORM__NO__:__'"+no+"'__SAVED__AND__SENT__SUCCESSFULLY";
