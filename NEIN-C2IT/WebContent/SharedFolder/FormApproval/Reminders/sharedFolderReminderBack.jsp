...
psmt11 = cn2.prepareStatement("UPDATE form5_folder SET reminder=?,f_date=? WHERE form5_no=?");
...
msg2 = "SHARED__FOLDER__REMINDER__FORM__NO__:__'"+form_no+"'__SAVED__SUCCESSFULLY";
System.out.println("result..date..........."+form_date);
response.sendRedirect("SharedFolderReminder.jsp?msg2="+msg2);
