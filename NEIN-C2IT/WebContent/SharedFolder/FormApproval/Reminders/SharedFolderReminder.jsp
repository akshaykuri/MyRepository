...
rs1 = st1.executeQuery("select * from form5_folder WHERE form5_no='"+no+"'"); 
if(!rs1.next())
{
...
rs100 = st100.executeQuery("select * from form5_folder WHERE form5_no='"+no+"'"); 
while(rs100.next())
{
...
<form name="form" action="sharedFolderReminderBack.jsp" method="post"  ><center>
<label> <font color="black"><u><b>SHARED FOLDER REQUEST-REMINDER</b></u></font> </label> 
<br/>
...
<input name="form_no" value="<%=form5_no%>" size="31" readonly="readonly"/> </td>
</tr>
<tr>
