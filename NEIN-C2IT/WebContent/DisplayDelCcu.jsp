...
<title>EMPLOYEE STATUS FORM (CCU)</title>
...
var f=document.form;    
f.method="post";    
f.action='CcuUserEdit.jsp?id='+id;    
f.submit();
}
...
var f=document.form;    
f.method="post";    
f.action='CcuUserDelete.jsp?id='+id;    
f.submit();
}
...
String query = "select * from nentryccu";
...
<%while(rs.next()){%>
		...
		<tr>
<td bgcolor="" width="100"><font color="black"><%=rs.getString(2)%></font></td>
<td bgcolor="" width="100"><font color="black"><%=rs.getString(3)%></font></td>
<td bgcolor="" width="100"><font color="black"><%=rs.getString(4)%></font></td>
<td bgcolor="" width="100"><font color="black"><%=rs.getString(5)%></font></td>
<td bgcolor="" width="120"><font color="black"><%=rs.getString(6)%></font></td>
<td bgcolor="" width="100"><font color="black"><%=rs.getString(7)%></font></td>
<td bgcolor="" width="120"><font color="black"><%=rs.getString(8)%></font></td>
<td bgcolor="" width="100"><font color="black"><%=rs.getString(9)%></font></td>
