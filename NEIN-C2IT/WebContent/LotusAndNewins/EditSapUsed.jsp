...
<script language="javascript" type="text/javascript">
	...
	{ 				
		...
		if(no_ids == ''){		
            alert("Enter the number of Sap / NExAS id's used for this month");
            return false;
		  }  		
...
<form method="post" name="form1" action="UpdateSapUsed.jsp">
...
<table width="1118" align="center" border="0" cellspacing="0" cellpadding="0">
    ...
    <td width="1000" align="left"><img src="../images/nippon.gif" height="35" width="220"> </td>
        <td width="115" align="right"><img src="../images/cs-soft.jpg" height="30" width="100" > </td>
         ...
         <tr align="center">
              <td bgcolor="#2f4377" colspan="2"><strong><font size ="4" color="white">SAP / NExAS ID's'</font></strong></td>
         </tr>
...
<table  align="center" border="1" width="30%"> 
					 ...
					 try 
					  {
					   ...
					   String query1 =  " SELECT DISTINCT mb.m_b_name,c.`branchNo`, "+
						                "  c.`initiator`, c.`month`,c.`total` FROM sap_used c "+  
    ...
    <tr>
       <td><span style="color:red;">*</span>No.of SAP ID's Used':</td>
