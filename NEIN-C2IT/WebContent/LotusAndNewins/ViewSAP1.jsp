...
<table width="95%" align="center" border="0" cellspacing="0" cellpadding="0">
    ...
    <td width="95%" align="left"><img src="../images/nippon.gif" height="35" width="220"> </td>
        <td width="95%" align="right"><img src="../images/cs-soft.jpg" height="30" width="100" > </td>
         ...
         <tr align="center">
              <td bgcolor="#2f4377" colspan="2"><strong><font size ="4" color="white">View SAP / NExAS Id's</font></strong></td>
         </tr>
...
<table class ="blue2" border="1" id="mytable">
			...
			<tr class="blueth1">
				...
				<th >Initiator</th>
				<th >Month</th>
				<th >No.of SAP / NExAS Id's used</th>
				<!-- <th>View/Edit</th> -->
			</tr>
			</thead>
			  <tbody >
             ...
             <%              
	              ...
	              %>
					<tr class="bluetd1">
						...
						<%-- <td ><a href="EditNewins.jsp?id=<%=rs1.getString("id")%>&fromdate=<%=fromdate1%>&todate=<%=todate1%>&branchId=<%=branchId%>">Edit/Update</a></td>	
						 --%>	  
				    </tr>
						 <%}%>
...
<input type="hidden" name="view" value="sap_used">
