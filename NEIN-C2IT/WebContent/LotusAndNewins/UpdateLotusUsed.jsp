...
<body>
                   <%
                     ...
                     try{
        			    ...
        			    i1=st.executeUpdate(" UPDATE `lotus_used` SET `branchNo`='"+branchNo+"',`month`='"+month+"',`total`='"+total+"' "+
        						             " WHERE `id`='"+ids+"' ");
        		       ...
        		       response.sendRedirect("ViewLotus.jsp?branch="+bNo+"&fromdate="+fromdate1+"&todate="+todate1+"&msg="+1);
