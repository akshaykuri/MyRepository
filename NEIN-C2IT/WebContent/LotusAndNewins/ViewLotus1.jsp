...
<table width="95%" align="center" border="0" cellspacing="0" cellpadding="0">
    ...
    <td width="95%" align="left"><img src="../images/nippon.gif" height="35" width="220"> </td>
        <td width="95%" align="right"><img src="../images/cs-soft.jpg" height="30" width="100" > </td>
         ...
         <tr align="center">
              <td bgcolor="#2f4377" colspan="2"><strong><font size ="4" color="white">View Lotus Email Id's</font></strong></td>
         </tr>
             ...
             <%              
	              ...
	              %>
					<tr class="bluetd1">
						...
						<%-- <td ><a href="EditLotus.jsp?id=<%=rs1.getString("id")%>&fromdate=<%=fromdate1%>&todate=<%=todate1%>&branchId=<%=branchId%>">Edit/Update</a></td>	
						 --%>	  
				    </tr>
						 <%}%>
...
<input type="hidden" name="view" value="Lotus_used">
