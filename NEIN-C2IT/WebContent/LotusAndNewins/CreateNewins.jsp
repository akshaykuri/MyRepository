...
<script language="javascript" type="text/javascript">
	...
	for(i=1;i<=count;i++){
			 ...
			 if(no_ids == ''){		
	             alert("Enter the number of Newin's id's for branch :: "+i);
	            return false;
			  }  		
	     }
		  return true;
...
<form method="post" name="form1" action="InsertNewinsUsed.jsp">
...
<table width="1118" align="center" border="0" cellspacing="0" cellpadding="0">
    ...
    <td width="1000" align="left"><img src="../images/nippon.gif" height="35" width="220"> </td>
        <td width="115" align="right"><img src="../images/cs-soft.jpg" height="30" width="100" > </td>
         ...
         <tr align="center">
              <td bgcolor="#2f4377" colspan="2"><strong><font size ="4" color="white">Newins Id's</font></strong></td>
         </tr>
...
<table  align="center" border="1" width="30%"> 
  <tr>
    ...
    <tr>
       ...
       <td><span style="color:red;">*</span>No.of Newin's' ID's Used:</td>
