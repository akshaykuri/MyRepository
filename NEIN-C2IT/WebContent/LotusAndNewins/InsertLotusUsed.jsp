...
<body>
                ...
                for(int w=1; w <= count ; w++) {
			           ...
			           con3 = dbConn.getConnection2();
						...
						String query = "select max(id) from lotus_used";
						st = con1.createStatement();
 						rs = st.executeQuery(query);
 						
 						String query1 = "select month from lotus_used where month='"+month+"' ";
 						...
 						if(!rs1.next())
 						     {
 							  ...
 							  for(int z=1; z <= count ; z++) {
 									       ...
 									       id++; 
 						                  prds = con3.prepareStatement(" INSERT INTO `lotus_used`(`id`,  `branchNo`, `initiator`, `month`, `total`)"+
 						                		                       " VALUES (?,?,?,?,?) ");   
 				                          ...
 				                          response.sendRedirect("CreateLotus.jsp?msg=" +msg);
