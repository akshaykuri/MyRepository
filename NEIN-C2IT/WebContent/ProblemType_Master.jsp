          ...
          function validate(){
           ...
           /*  if ((bk.value==null)||(bk.value=="")||(bk.value=="Null")){
                ...
                if ((dt.value==null)||(dt.value=="")||(dt.value=="Null")){
                    ...
                    if (checkAddress(dt.value)==false){
                    	dt.value="";
...
<table width="920" height="3" cellpadding="0" cellspacing="0" ID="Table1">
  ...
  <td width="25%" align="justify" valign="top"></td>
    <td width="21%" align="justify" valign="top">
      <p> <img src="images/17.jpg" height="180" width="340">
</td>
...
<font color=darkblue size=3 > CREATE PROBLEM TYPE DETAILS</font>
	...
	<tr><td><font size="2">PROBLEM TYPE:</font><font color=red>*</font></td><td><input type="text" size="20" name="p_type" value=""></td></tr>
	...
	<tr>
	<td>
    <a href="DisplayProb.jsp" onclick="return popitup('DisplayProb.jsp')">View Problem Type</a> </td>
