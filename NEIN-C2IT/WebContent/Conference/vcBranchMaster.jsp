...
function validate()
     {
	 //alert("hello");
     var nn=document.getElementById("branch");
...
<form name="form" method="post"  onsubmit="return validate()" action="vcBranchMasterBack.jsp">
   <div>
   </BR></BR>
 ...
 <td bgcolor="#2f4377" class="blueLine"><strong><font size ="4" color="white">CONFERENCE/MEETING ROOM BOOKING</font></strong></td>
   ...
   <div class="modal-content">
    <div class="modal-header">
              <center> <h2>BRANCH MASTER</h2></center>
    </div>
    ...
    <table border=1>
           ...
           <tr>
                <td><font color="red" size="4">*</font>BRANCH NAME :</td>
                <td><input type="text" name="branch" maxlength="20" id="branch" value="" size=20 placeholder="HEAD OFFICE"/></td>
                <td><font color="red" size="4">*</font>BRANCH ID :</td>
                <td><input type="text" name="bid" maxlength="20" id="bid" value="" size=20 placeholder="90"/></td>
           </tr>
    ...
    <table>
            <tr>
                ...
                <td><a href="DisplayvcBranchMaster.jsp" onclick="return popitup1('DisplayvcBranchMaster.jsp')">View VC Branches</a> </td>
