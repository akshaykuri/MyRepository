...
<form  name="form"  method="post"  onsubmit="return validateForm()" action="vcbrancheditaddback.jsp" >
<br><br>
...
con5= DriverManager.getConnection(url+dbName,userName,password);
						...
						String query2 = "select * from vc_branchmaster";
					    ...
					    <select name="vcbranch" class="amenc" id="vcbranch">
							...
							<%while(rs5.next()){%>
										...
										<option  value="<%=rs5.getString("branch_id")%>"><%=rs5.getString("branch_name")%></option>
    						<%}%>
							</select>
...
con5= DriverManager.getConnection(url+dbName,userName,password);
						...
						String query2 = "select * from vcbranch_add where Booking_no='"+booking_no+"'";
