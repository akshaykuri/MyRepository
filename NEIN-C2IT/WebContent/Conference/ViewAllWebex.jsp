...
<tr align="center">
 <td bgcolor="#2f4377" class="blueLine"><strong><font size ="4" color="white">WEBEX DETAILS</font></strong></td>
</tr>
...
<center>
 <br />
	...
	<table border="1"  align="center" bgcolor="#F0F0F0" bordercolor="#74c1b9">
	    ...
	    <td height="20" bgcolor="white" width="120" align=center style="background-color:#74c1b9"><font size="2" color="black"><b>Name</b></font></td>
		<td height="20" bgcolor="white" width="120" align=center style="background-color:#74c1b9"><font size="2" color="black"><b>Email</b></font></td>
		<td height="20" bgcolor="white" width="120" align=center style="background-color:#74c1b9"><font size="2" color="black"><b>Type</b></font></td>
...
PreparedStatement prds=null;
         ...
         if(branch.equals("all"))
        {
         ...
         {
        	 query = "SELECT a.*,c.`from_date`,c.`to_date`,c.`from_time`,c.`to_time` FROM `webex_meeting` a inner join conference_room_booking c on c.Booking_no=a.Booking_no WHERE c.booking_for_branch='"+branch+"' and c.status='Active' ";
         }
...
<td bgcolor="#d2f7f3" width="100"><font size="2" color="black"><%=rs.getString("name")%></font></td>
<td bgcolor="#d2f7f3" width="100"><font size="2" color="black"><%=rs.getString("email")%></font></td>
<td bgcolor="#d2f7f3" width="100"><font size="2" color="black"><%=rs.getString("type")%></font></td>
...
<input type="hidden" name="view" value="allwebex">
