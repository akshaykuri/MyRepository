...
<form method="post" action="MeetingtypeMasterUpdate.jsp">
<br />
<br /><br />
<table border="1"  align="center" bgcolor="#F0F0F0" bordercolor="#74c1b9">
	<tr>
	    <td></td>
		<td bgcolor="#74c1b9" width="120" align=center><font color="black">Meeting Type</font></td>
 ...
 Class.forName(driver).newInstance();
  ...
  //String query = "select assettype,configname from assetconfgfield where assettype='"+an+"' and configname ='"+co+"'";
   ...
   //rs = st.executeQuery(query);
    ...
    String query1 = "select Meeting_type from meeting_type_master";
   st2 = conn.createStatement();
   rs2 = st2.executeQuery(query1);  %>
    <tr>
          <td style="visibility: hidden;"><input type="hidden" name="mid" value="<%=mid%>"></td>
   	     <td bgcolor="#d2f7f3"><input name="mtype" style="background-color:white;width:100;color:black;" value="<%=mtype%>"></td>
