...
<form method="post" action="AmenitiesMasterUpdate.jsp">
<br />
<br /><br />
<table border="1"  align="center" bgcolor="#F0F0F0" bordercolor="#74c1b9">
	<tr>
	    <td></td>
		<td bgcolor="#74c1b9" width="120" align=center><font color="black">Amenities</font></td>
 ...
 try 
  ...
  //String query = "select assettype,configname from assetconfgfield where assettype='"+an+"' and configname ='"+co+"'";
   ...
   //rs = st.executeQuery(query);
    ...
    String query1 = "select Amenities_name from amenities_master";
   st2 = conn.createStatement();
   rs2 = st2.executeQuery(query1);  %>
    <tr>
          <td style="visibility: hidden;"><input type="hidden" name="aid" value="<%=aid%>"></td>
   	     <td bgcolor="#d2f7f3"><input name="atype" style="background-color:white;width:100;color:black;" value="<%=atype%>"></td>
