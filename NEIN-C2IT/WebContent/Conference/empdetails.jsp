           ...
           try
             ...
             conn= DriverManager.getConnection(url+dbName,userName,password);
              ...
              // System.out.println("fname----- :"+rs.getString("u.full_name"));
               ...
               while(rs.next())
                      { 
            	       buffer = buffer + "<input type='text' id='p1' value='"+rs.getString("u.full_name")+"'>" + "<input type='text' id='p2' value='"+rs.getString("u.email")+"'>" + "<input type='text' id='p3' value='"+rs.getString("b.branch_name")+"'>" + "<input type='text' id='p4' value='"+rs.getString("d.department_name")+"'>";
