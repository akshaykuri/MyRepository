...
function cleartext()
	...
	document.getElementById('meeting').value =null;
...
<form name="form" method="post"  onsubmit="return validate()" action="MeetingtypeMasterBack.jsp">
   <div>
   </BR></BR>
   <table width="1118" align="center" border="0" cellspacing="0" cellpadding="0">
    ...
    <td width="1000" align="left"><img src="../images/nippon.gif" height="35" width="220"> </td>
        <td width="115" align="right"><img src="../images/cs-soft.jpg" height="30" width="100" > </td>
         ...
         <tr align="center">
              <td bgcolor="#2f4377" colspan="2"><strong><font size ="4" color="white">CONFERENCE/MEETING ROOM BOOKING</font></strong></td>
         </tr>
   ...
   <div class="modal-content">
    <div class="modal-header">
              <center> <h2>MEETING TYPE</h2></center>
    </div>
    ...
    <table border=1>
           ...
           <tr>
                <td><font color="red" size="4">*</font>MEETING TYPE :</td>
                <td><input type="text" name="meeting" maxlength="20" id="meeting" value="" size=20 /></td>
           </tr>
    ...
    <table>
            <tr>
                ...
                <td><a href="MeetingtypeMasterDisplay.jsp" onclick="return popitup1('MeetingtypeMasterDisplay.jsp')">ViewAllMeetingType</a> </td>
