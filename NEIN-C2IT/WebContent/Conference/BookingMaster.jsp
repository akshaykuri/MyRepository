...
<title>Booking for Master</title>
...
function validate()
     {
	 //alert("hello");
     var nn=document.getElementById("booking");
     //var val=document.getElementById("idassetType").value;
     if ((nn.value==null)||(nn.value==""))
                {
                alert("Please Enter Booking For TYpe!");
                nn.focus();
                return false;
                }
     
     var mn=document.getElementById("branchid");
     //var val=document.getElementById("idassetType").value;
     if ((mn.value==null)||(mn.value==""))
                {
...
<form name="form" method="post"  onsubmit="return validate()" action="BookingMasterBack.jsp">
   <div>
   </BR></BR>
 ...
 <td bgcolor="#2f4377" class="blueLine"><strong><font size ="4" color="white">CONFERENCE/MEETING ROOM BOOKING</font></strong></td>
   ...
   <div class="modal-content">
    <div class="modal-header">
              <center> <h2>BOOKING FOR</h2></center>
    </div>
    ...
    <table border=1>
           ...
           <tr>
                <td><font color="red" size="4">*</font>Room Name :</td>
                <td><input type="text" name="booking" id="booking" maxlength="50"  value="" size=20 /></td>
                <td><font color="red" size="4">*</font>Branch ID :</td>
                <td><input type="text" name="branchid" id="branchid" maxlength="20"  value="" size=20 /></td>
           </tr>
    ...
    <table>
            <tr>
                ...
                <td><a href="DisplayBookingfor.jsp" onclick="return popitup1('DisplayBookingfor.jsp')">ViewAllBookingType</a> </td>
