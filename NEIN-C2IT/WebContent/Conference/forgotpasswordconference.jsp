...
var url="LookNameExistForForGotPasswordAjax.jsp";
url=url+"?name="+value;
...
<form name="f" method="post" action="forgotpasswordconferenceback.jsp" >
...
<label style="font: 3;font-size: large;"><font size="2">FORGOT PASSWORD</font></label>
  <table width="40%" align=center border=2 background=".jpg"  bordercolor=#aaaccc>
   ...
   <td align="center" width="20%"><font size="1"><input size="20" type="text"  name="name" id="name" value="" title="Enter Your Mail" placeholder="Enter User email-id"  maxlength="41"></font>
