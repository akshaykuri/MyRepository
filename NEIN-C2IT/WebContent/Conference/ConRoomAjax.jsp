...
<body>
<%
    System.out.println("here.....in ajax page  Chintu kumar....");
		...
		System.out.println("Room Type :"+room);
			   ...
			   while(rs1.next())
		           ...
		           if(  ((timeValue1.equals(timeValue2))&&(timeValue3.equals(timeValue4))   )||
				        ...
				        ((timeValue1.equals(timeValue2))&&(timeValue3.after(timeValue4))    )||
				        ((timeValue1.equals(timeValue2))&&(timeValue3.before(timeValue4))    )||
		             ...
		             if(room.equals(rs1.getString("booking_room_type")))
		            	 ...
		            	 if(branch.equals(rs1.getString("booking_for_branch")) || timeValue1.equals(timeValue3))
		            		   { 	  
		            		   System.out.println("Already exit ........From :"+date+" TO: "+date); 
		            	       msg = "Already_Booked on "+date+" with timing "+fromtime+" to "+totime+"";
