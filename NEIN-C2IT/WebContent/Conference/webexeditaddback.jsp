...
<%
	...
	PreparedStatement prs2 = null, psmt1 = null, psmt3 = null, psmt4=null,prs3=null,prs4=null,prbran = null;
	...
	try 
       ...
       for(int t=0; t< s; t++)
		{
			query1="insert into webex_meeting(Booking_no,name,email,type)value(?,?,?,?)";
		   ...
		   response.sendRedirect("Displaywebex.jsp?id="+booking_no); 
