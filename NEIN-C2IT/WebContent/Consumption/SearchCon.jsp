...
$(document).ready(function() {
			$("#fromdate").datepicker({ changeMonth: true, changeYear: true,  dateFormat: 'dd-mm-yy' }).val(); 
			$("#todate").datepicker({ changeMonth: true, changeYear: true,  dateFormat: 'dd-mm-yy' }).val(); 
       }); 
</script>
</head>

<body background="../images/u.jpg">
<form method="post" name="form1" action="ViewConsumption.jsp">
<!-- <input type="hidden" name="todate1" id="todate1" >
<input type="hidden" name="todate1" id="todate1" > -->
       ...
       Consumption Type:
             <%              Connection con2 = null;
		        ...
		        <option value="Select">Select</option>
	              <%while(rs2.next()){%>
			        <option value="<%=rs2.getString("type_name")%>"><%=rs2.getString("type_name")%></option>
    	            <%}%>
	           </select>
