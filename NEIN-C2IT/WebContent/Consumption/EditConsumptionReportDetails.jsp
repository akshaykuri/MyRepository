...
<body >
<br><br>
<form method="post" name="form1" action="UpdateConsumptionReportDetails.jsp" enctype="multipart/form-data">
...
<%
   ...
   <tr>
    ...
    <tr>
		...
		<td><input type="text" name="invoicenumber" id="invoicenumber" readonly value="<%=rs1.getString("invoiceno")%>" size="40" ></td>
		<td><span style="color:red;">*</span>Invoice Amount:</td>
		<td><input type="text" name="invoiceamt" id="invoiceamt" readonly value="<%=rs1.getString("invoiceamt")%>" onkeypress="return isNumberKey1(event)" size="40" > </td>			
		<td><span style="color:red;">*</span>Invoice Date:</td>
		<td><input type="text" name="invoicedate" id="invoicedate" readonly value="<%=rs1.getString("invoicedate")%>" size="40" readonly></td>		
