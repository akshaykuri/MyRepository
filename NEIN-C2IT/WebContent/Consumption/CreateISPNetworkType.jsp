...
<script language="javascript" type="text/javascript">
	function Validation()
	{ 		
		 var networktype = document.forms["form1"]["networktype"].value; 
		if(networktype == ''){		
...
<br><br>
<form method="post" name="form1" action="InsertISPNetworkType.jsp">
...
<table  align="center" border="1" width="35%"> 
   <tr>
		<td> <span style="color:red;">*</span>ISP NETWORK TYPE:</td>
		<td><input type="text" name="networktype" id="networktype"  size="60"></td>		
   </tr>
   <tr>
      <td colspan="2" align="center" >
         ...
         <a href="DisplayISPNetworkType.jsp" onclick="return popitup('DisplayISPNetworkType.jsp')">VIEW ALL</a> 
      </td>
   </tr>
 </table>
