...
<title>Display ISP Network Type Details</title>
...
function editRecord(id)
    ...
    var f=document.form;    
    f.method="post";    
    f.action='EditIspNetworkTypeMaster.jsp?id='+id;    
    f.submit();
    }
	...
	if(confirm('confirm to Delete'))
	      {
           var f=document.form;    
           f.method="post";    
           f.action='DeleteIspNetworkTypeMaster.jsp?id='+id;    
           f.submit();
          }
	else{}
   }
...
<center>
 <br />
	...
	<table border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey" width="60%">
		<tr>
		<td height="20" bgcolor="white" width="150" align=center style="background-color:grey"><font size="2" color="black"><b>ISP NETWORK TYPE:</b></font></td>
		...
		<%
				...
				String query = "select * from mobile_network";
