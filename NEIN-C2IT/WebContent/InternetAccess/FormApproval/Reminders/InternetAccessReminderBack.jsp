...
psmt11 = cn2.prepareStatement("UPDATE form6_internet SET reminder=?,f_date=? WHERE form6_no=?");
...
msg2 = "INTERNET__ACCESS__REMINDER__FORM__NO__:__'"+form_no+"'__SAVED__SUCCESSFULLY";
System.out.println("result..date..........."+form_date);
response.sendRedirect("InternetAccessReminder.jsp?msg2="+msg2);
