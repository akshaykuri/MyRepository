...
document.form.action="InternetAccessAdminBack.jsp";
document.form.method="post";
document.form.submit();
}
function ITManager()
{
document.form.action="InternetAccessAdminITmanagerHOBack.jsp";
document.form.method="post";
document.form.submit();
}
</script>
...
<table width="100%" border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
	  ...
	  rs1 = st1.executeQuery("select form6_no,desg,emp,status,remarks,f_date,mail from form6_internet_item WHERE form6_no='"+req+"' ORDER BY id ASC"); 
	  while(rs1.next())
	  {
	 ...
	 <td><input type="button"  style="size:1" value="RE-SEND MAIL" onclick="resendMail('<%=m%>','<%=form6_no%>','<%=empD%>','<%=SessionName%>');" /></td> 
...
<br />
		...
		cn11 = con.getConnection2();
		  ...
		  rs11 = st11.executeQuery("select form6_no,desg,emp,status,remarks,f_date,mail from form6_internet_item WHERE form6_no='"+req+"'"); 
		  while(rs11.next())
		  {
...
<%}
 ...
 <input type="hidden" value="<%= session.getAttribute("desg") %>" id="iddesg"/>
  <input type="hidden" value="<%= session.getAttribute("form6_no") %>" id="idmrId"/>
...
if((ITbno.equals(session.getAttribute("b_no")) && ITdesg.equals(session.getAttribute("desg"))))
 ...
 <%--    <td>  <input type="submit" style="background-color:#2f4377;font-weight:bold;color:white;" value=" IT SUBMIT" name=button1 onclick="return ITManager();" /></td>
    ...
    <td>  <input type="submit" style="background-color:#2f4377;font-weight:bold;color:white;" value="SUBMIT" name=button1 onclick="return OtherAdmin();" /></td>
    <%} %> --%>
