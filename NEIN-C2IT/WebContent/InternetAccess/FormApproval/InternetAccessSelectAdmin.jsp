...
{  var p1=document.form.req;
 if ((p1.value==null)||(p1.value=="NULL"))
				{alert("Select Internet Access Number!"); p1.focus(); return false; }
...
document.form.action="InternetAccessAdmin.jsp?msg=1";
...
document.form2.action="InternetAccessLocalAllAdmin.jsp?msg=1";
...
<tr align="center">
 <td bgcolor="#2f4377" class="blueLine"><strong><font size ="4" color="white">INTERNET ACCESS FORM</font></strong></td>
</tr>
...
<form name="form" method="post" action="InternetAccessAdmin.jsp?msg=1">
...
/* rs9 = st9.executeQuery("SELECT DISTINCT form6_no FROM form6_internet  ORDER BY form6_no"); */
//rs9 = st9.executeQuery("SELECT DISTINCT form6_no FROM form6_internet_item WHERE emp='"+AdminName+"' and desg='"+desg+"' and status='Pending' AND form6_no LIKE 'NEIN/CS/Internet%' ORDER BY form6_no ASC");
rs9 = st9.executeQuery("SELECT DISTINCT form6_no FROM form6_internet WHERE Approval_emp='"+AdminName+"' and Approval_desg='"+desg+"' and Approval_sttatuss='Pending' AND form6_no LIKE 'NEIN/CS/Internet%' ORDER BY form6_no ASC");
...
<table align="center">
<tr>
<th>SELECT INTERNET ACCESS FORM NUMBER</th>
</tr>
</table>
...
<form name="form2" method="post" action="InternetAccessLocalAllAdmin.jsp?msg=1">
<%-- %>	 <form action="POMonthWiseBack.jsp"> 
	<form action="POWiseBack.jsp">--%>
<%
	 String b_no=null;
...
//rs9 = st9.executeQuery("Select DISTINCT substr(pordernon,6,2) from po ORDER BY substr(pordernon,6,2) ASC");
/* rs9 = st9.executeQuery("SELECT DISTINCT form6_no FROM form6_internet  ORDER BY form6_no"); */
//rs99= st99.executeQuery("SELECT DISTINCT form6_no FROM form6_internet WHERE i_b_no='"+b_no+"' AND form6_no LIKE 'NEIN/CS/Internet%' ORDER BY idextend DESC");
rs99= st99.executeQuery("SELECT DISTINCT form6_no,full_name FROM form6_internet WHERE form6_no LIKE 'NEIN/CS/Internet%' ORDER BY id DESC");
