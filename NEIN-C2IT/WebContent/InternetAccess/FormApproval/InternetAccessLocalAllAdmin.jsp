...
rs100 = st100.executeQuery("select * from form6_internet WHERE form6_no='"+values[0]+"'"); 
while(rs100.next())
{
...
<table id="tableData" name="tableData" width="100%" border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
	  ...
	  rs1 = st1.executeQuery("select form6_no,desg,emp,status,remarks,f_date,mail from form6_internet_item WHERE form6_no='"+values[0]+"' AND desg <> 'none' ORDER BY id ASC"); 
	  while(rs1.next())
	  {
