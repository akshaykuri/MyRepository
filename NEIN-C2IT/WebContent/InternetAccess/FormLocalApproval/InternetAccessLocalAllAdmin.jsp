...
document.form.action="InternetAccessLocalAdminBack.jsp";
document.form.method="post";
document.form.submit();
}
function ITManager()
{
document.form.action="InternetAccessLocalAdminITmanagerHOBack.jsp";
document.form.method="post";
document.form.submit();
}
</script>
...
<td style="text-align:left;" bgcolor="grey" id="hiderow"><input size="31" name="branch" value="<%=Sessiondesg%>" size="31" readonly="readonly"/> </td>
</tr>	
<tr>
&nbsp;&nbsp;&nbsp; <td  style="text-align: right;width: 215px; " bgcolor="grey" >FORM NO :</td>
<td style="text-align:left;" bgcolor="grey"><input size="31" name="branch" value="<%=form6_no%>" size="31" readonly="readonly"/> </td>
</tr>	
<tr>
<td  style="text-align: right;">Employee Code :</td>
<td style="text-align:left;"><input type="text" size="31" name="emp_code" id="ecode" value="<%=emp_code%>" readonly="readonly"/></td>
<td  style="text-align: right;">Full Name :</td>
<td style="text-align:left;"><input type="text" size="31" name="full_name" id="fname" value="<%=full_name%>" readonly="readonly"/></td>
...
<input type="text" size="31"  name="ipAddress" value="<%=ipAddress%>" readonly="readonly"  readonly="readonly" />

</td>

<td  style="text-align: right;">Computer Name</td>
<td style="text-align:left;">
<input type="text"  size="31"  name="d_reliving"  value="<%=ComName%>" readonly="readonly" readonly="readonly" />
...
<table id="tableData" name="tableData" width="895" border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
	  ...
	  rs1 = st1.executeQuery("select form6_no,desg,emp,status,remarks,DATE_FORMAT(f_date,'%d/%m/%Y'),mail from form6_internet_item WHERE form6_no='"+req+"' order by id asc"); 
	  while(rs1.next())
	  {
		  String form6_noD= rs1.getString(1);
...
<table style="margin-left: auto;margin-right: auto;" ><tr>
     ...
     <td style="font-size:1" id="hiderow">&nbsp;&nbsp;<!-- <input style="size:1;font-size: 1.1em;" type="button"  value="BACK" onclick="window.location.href='InternetAccessSelectAdmin.jsp?msg=1'"/> -->
