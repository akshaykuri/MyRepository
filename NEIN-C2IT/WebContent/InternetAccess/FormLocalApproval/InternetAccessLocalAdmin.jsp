...
<form  name="form" method="post"  action="InternetAccessLocalAdminBack.jsp">
...
<table id="tableData" name="tableData" width="895" border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
	...
	<td bgcolor="white" width="100" class="fonter"><%=statusD%></td>
	 ...
	 <td><input type="button"  style="size:1" value="RE-SEND MAIL" onclick="resendMail('<%=email_id%>','<%=form6_no%>','<%=m%>','<%=SessionName%>');" /></td> 
