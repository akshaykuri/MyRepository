...
<form name="form" method="post" action="InternetAccessLocalAllAdmin.jsp?msg=1">
...
if(b_no.equals("90"))
	rs9 = st9.executeQuery("SELECT DISTINCT form6_no,full_name FROM form6_internet WHERE form6_no LIKE 'NEIN/CS/Internet%' ORDER BY form6_no DESC");
else
	rs9 = st9.executeQuery("SELECT DISTINCT form6_no,full_name FROM form6_internet WHERE i_b_no='"+b_no+"' AND form6_no LIKE 'NEIN/CS/Internet%' ORDER BY idextend DESC");
