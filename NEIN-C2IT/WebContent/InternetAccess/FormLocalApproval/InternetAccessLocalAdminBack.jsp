...
<%! 
	              ...
	              PreparedStatement psmt=null,psmt2=null,psmt3=null,psmt4=null,psmt10=null;
	              %>
...
if(senddirect.equals("sendonly"))
	 ...
	 if(higherAuthority.equals("direct"))
		 ...
		 postMail.postMail(i_email_id,i_name,"pass1234",ccmail,"INTERNET ACCESS FORM:  " +form_no+ " ",initiatorNameIfNotApproved+  " "+  "your request for - INTERNET ACCESS FORM "+form_no+"has been approved by " +i_name+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>");
