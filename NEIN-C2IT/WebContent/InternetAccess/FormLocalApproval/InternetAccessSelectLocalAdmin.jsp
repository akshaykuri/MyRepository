...
<form name="form" method="post" action="InternetAccessLocalAdmin.jsp?msg=1">
...
rs9 = st9.executeQuery("SELECT DISTINCT form6_no FROM form6_internet_item WHERE ((emp='"+AdminName+"' and desg='"+desg+"')OR(empid='"+(String) session.getAttribute("EmpNo")+"')) and status='Pending' AND form6_no LIKE 'NEIN/CS/Internet%' ORDER BY form6_no ASC");
