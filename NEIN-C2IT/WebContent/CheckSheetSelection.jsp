...
<table width="1118" align="center" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr align="center">
 <td bgcolor="#2f4377"><strong><font size ="4" color="white">SENT CHECK LIST DISPLAY</font></strong></td></tr>
</table>
<table align="center" cellspacing="0" cellpadding="0" border="0" width="1118"> 
<tr>
...
rs9 = st9.executeQuery("select DISTINCT cs_id from cs_master WHERE cs_id LIKE 'NEIN/CS/90%' ");
%>
<!-- <form name="form1" method="post" action="CheckListViewHO.jsp?msg=1" onsubmit="return ValidateForm();"> -->
<form name="form1" method="post" action="CheckListViewTextForm.jsp?msg=1" onsubmit="return ValidateForm();">
	
	 
<table align="center">
<tr>
<th>ENTER CHECK LIST NUMBER </th>
</tr>
</table>
