...
<%
 ...
 %>
 <br /><center><label style="font: bold; size: 3">COMPLAINT NO. : <%=no%> IS SAVED AND SENT SUCCESSFULLY</label></center> <br />
 <%
 ...
 String query2 = "SELECT form2_no FROM form2_domain  WHERE SUBSTRING(form2_no,9,20)='"+second+"'";
  ...
  int k=0;
   ...
   if(rs2.next()){
	                      String msg = "COMPLAINTS__NO__:__'"+no+"'__SAVED__AND__SENT__SUCCESSFULLY";
                          response.sendRedirect("complaintPending.jsp?msg="+msg);
                   }
