...
<!-- <body bgcolor="" leftmargin="80" rightmargin="80" topmargin="50" bottommargin="40" marginwidth="50" marginheight="100" onload="changeHashOnLoad(); ">
 -->
<body id="bodyleng" bgcolor="#FFFFFF" leftmargin="80" rightmargin="80"   marginwidth="70" marginheight="70" onload="checkForm() &&  changeHashOnLoad() " style="overflow-x: hidden; overflow-y: hidden;">
<form name="form">
...
<a href="http://neinsoft.nittsu.co.in:8185/NEIN/"><img src="images/nippon.gif" height="35" width="220" ></a> 
 </td>
<td align="right">
...
<a href="http://neinsoft.nittsu.co.in:8185/NEIN/" class="top"><img width="35" src="images/homeforAll.jpg"></a>
<a class="top" href="logout.jsp"><img width="35" src="images/icon_log.png"></a>
</td> 
</tr> 
</table>
...
<br />
 ...
 <center>
				...
				<tr><td colspan="5" align="center" bgcolor="lightgrey" class="tdColor"><font color="blue" >OFFICE ADMIN COMPLAINT STATUS</font></td></tr>
				<tr><td width="70" align="center"  height="21" bgcolor="grey" class="tdColor"><font size="2">ADMIN</font></td>
				
						<td width="70" align="center"  height="21" colspan="2" bgcolor="grey" class="tdColor"><font size="2">TODAYS CALLS</font></td>		
						<td width="70" align="center"  height="21" bgcolor="grey" class="tdColor"><font size="2">PREVIOUS CALLS</font></td>	
						<td width="70" align="center"  height="21" bgcolor="grey" rowspan="2" class="tdColor"><font size="2">AVAILABILITY</font></td>		
				</tr>
				<tr>
				<td  width="67" align="center"  height="21" bgcolor="lightgrey" class="fonter">NAME</td>
				<td  width="67" align="center"  height="21" bgcolor="lightgrey" class="fonter">RESOLVED</td>
				<td width="67" align="center"  height="21" bgcolor="lightgrey" class="fonter">PENDING</td>
				<td width="67" align="center"  height="21" bgcolor="lightgrey" class="fonter">PENDING</td>
				  ...
				  %>
					...
					AutoSendingMessageAdminAllCalls mailMessageAdminAllCalls = new AutoSendingMessageAdminAllCalls();
					 String message = null,messageT=null,messageallCalls=null;
						...
						/* DateFormat dateFormatr = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
						Date dater = new Date();
						...
						rs02 = st02.executeQuery("SELECT NEHo.Nname,SubQ.Nname,SubQ.Nmail,SubQ.count_comp,SubQ.count_comp2,SubQ.allPending,SubQ.avb from nentryho NEHo LEFT JOIN "+
										...
										"FROM nentryho n  WHERE n.DESG_NO ='2' ORDER BY n.Nname ASC) as SubQ On NEHo.Nname = SubQ.Nname WHERE NEHo.DESG_NO='2' AND NEHo.department='OFFICE ADMINISTRATION' AND SubQ.Nname is NOT null ORDER BY SubQ.Nname ASC");
						...
						%>
				    <tr><td width="420" align=center  ><input type="hidden" name="<%=k%>" value="<%=empp%>" />
				...
				<%}%>
					   	...
					   	<%                     
											...
											//System.out.println("Before Preparement Statement");
												psmtTime=conn.prepareStatement("SELECT id,SentDate,DATE_FORMAT(SentDate,'%e/%m/%Y') as datu FROM sendingautomail WHERE depart='OFFICE ADMINISTRATION' ORDER BY id DESC LIMIT 1");
														...
														// psmtOneMoreTime.setString(1,cs_date);
																	   ...
																	   //emppOneMoreTime = emppOneMoreTime.replaceAll("[\\s.]", "");
																		...
																		while(rsPsmt.next())
																		{
																			...
																			Timestamp time = rsPsmt.getTimestamp("cm_time");
																		     AutoEmp = rsPsmt.getString("emp");
																				...
																				postMail.postMail("neinsoft@nittsu.co.in","Pending Calls - Reminder","pass1234",AutoMail,"NEIN-C2IT Pending Calls - Reminder : To "+AutoEmp+"",  "<font color=red> Close respective pending calls :</font><br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  http://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HRadmin.jsp?msg=1  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><font color=blue>This is an auto generated e-mail, please do not reply to this e-mail. this will not be answered </font><br><br>"+message);
																				postMail.postMail("neinsoft@nittsu.co.in","Pending Calls - Reminder","pass1234",UserMail,"NEIN-C2IT Pending Calls - Reminder : Copy of Mail to User ",  "<font color=red>Your complaint status </font><br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  http://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HRadmin.jsp?msg=1  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><font color=blue>This is an auto generated e-mail, please do not reply to this e-mail. this will not be answered </font><br><br>"+message);
																		...
																		// System.out.println("AUTO MAIL : "+AutoMail);
																		 System.out.println("AUTO EMP : "+AutoEmp);
																		    ...
																		    psmmmt.setString(3,"OFFICE ADMINISTRATION");
														 ...
														 //postMail.postMail("prasanna.v@nittsu.co.in","Pending Calls - Reminder","pass1234","farooq.s@nittsu.co.in","NEIN-C2IT Pending Calls - Reminder : ",  "<font color=red>Close these pending calls and update us back.</font> <br><br><b><u> Open the following URL</u> </b><br> Local LAN (Within Office) -  http://10.206.10.3:8185/NEIN-C2IT/HOME.jsp  <br> Public Domain (Outside Office) - http://203.124.152.2:8185/NEIN-C2IT/HOME.jsp  <br><br><br><br>"+message);
														   ...
														   message = mailMessageAdmin.getMailAutoSendingMessageAdmin(AutoPending.trim());
														    ...
														    messageallCalls = mailMessageAdminAllCalls.getMailAutoSendingMessageAllCalls(cs_date.trim(),"OFFICE ADMINISTRATION");//sending mail to ITMANAGER of complaints which are resolved or not
														 ...
														 //  postMail.postMail("farooq.s@nittsu.co.in","All Calls - Reminder","pass1234","farooq.s@nittsu.co.in","NEIN-C2IT All Calls - Reminder : ",  "<font color=red>Close these pending calls and update us back.</font> <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  http://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+messageallCalls);
												              }
															 else{
																// System.out.println("\n TRUEEEEEE IN ELSE  :"+empp);
																 System.out.println("**************Auto Pending Complaints Mail Already Sent************");
															 }
...
<!-- <strong><a href="complainPage.jsp?msg=1"><font size=2><blink>COMPLAINS ? CLICK HERE</blink></font></a></strong> -->
	   ...
	   <center>
		<strong ><a href="SoftwareDeveloper.jsp?msg=1"><font size=2>SOFTWARE DEVELOPER</font></a></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<strong><a href="HOME.jsp?msg=1"><font size=2>SYSTEM ADMINISTRATION</font></a></strong>
	</center>
</td>
...
<%-- <table width="100%" height="100%" border="0" cellpadding="0"  cellspacing="0" ID="Table2">
	<tr> --%>
		...
		<img vspace="15" src="images/hr4.jpg" width="530" height="180" border="1">
		
	   <center>
		<strong ><a href="loginho.jsp?msg=1"><font size=2>OFFICE ADMINISTRATION PAGE</font></a></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<strong>
     <a href="assetManagement/loginAssetPage.jsp?msg=1"><font size=2>ASSET MGMT</font></a></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="complaintPage.jsp?msg=1" id="logC"><font size=2>LOG COMPLAINTS</font></a></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
