...
<title>Domain User Request Form</title>
...
<tr class="nameal"><td id="cs2">DOMAIN USER REQUEST FORM</td></tr>
...
<td class="it2"  style="text-align:left;width:25%;"> <input type="text" name="created" id="cud" maxlength="100"></td></tr>
<tr>
