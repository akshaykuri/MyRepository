...
<title>Issue Of Access Card</title>
...
<tr class="nameal"><td id="cs2">Issue Of Access Card</td></tr>
...
<td style="font-weight:bold;font-style:italic;width:17px;"> 
     <input style="" type ="radio" name = "requestStatus" value ="new" id=""/>New
     <input type ="radio" name = "requestStatus" value ="change  " />Delete
     <input type ="radio" name = "requestStatus" value ="change" />Change</td>
</tr>

<tr>
<td style="text-align: right;">Requested By :</td>
<td style="text-align:left;"><input type="text" name="requestBy" id="req" size="60"></td>
</tr>
</table>
...
<td class="it2"  style="text-align:left;width:25%;"> <input type="text" name="access" id="acn" maxlength="100"></td>
</tr>

<tr>
<td class="it2" style="text-align: right;width:23%;">Issued Date :</td>
<td class="it2"  style="text-align:left;width:25%;"> <input type="text" name="issued" id="datepicker" maxlength="100"></td></tr>
