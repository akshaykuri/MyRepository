...
<tr>
<td>SYS ADMIN:<textarea rows="1" cols="25" readonly="readonly" name="admin_name"><%=admin_name%></textarea></td>
<td>Location Name :<textarea rows="1" cols="15	" readonly="readonly" name="admin_city"><%=admin_city%></textarea></td>
<td>DATE:<textarea id="temp_date" name="Send_date" readonly="readonly" rows="1" cols="15"> <%= Send_date %> </textarea></td>
