...
<%!
	...
	%>
     ...
     req = request.getParameter("req1");
     req1 = request.getParameter("req2");
     req11 = request.getParameter("req3");
 ...
 String[] dateString2 = req3.split("-");
     ...
     System.out.println("req 1 Branch "+req);
     System.out.println("req 2 prob Type "+req1);
     System.out.println("req 3 IT SUPPORT "+req11);
     System.out.println("req complaintStatus "+complaintStatus);
     String msg=null;
   %>
...
<table id="invoicetable" width="1300" bgcolor="" cellpadding="4" cellspacing="6" align="center" border=1>
	<tr>
    ...
    <td   height="21" bgcolor="lightgrey" style="font-size: 1" width="10" align="center"><font size="2">STATUS:<b><%=complaintStatus%></b></font></td>
	...
	<table class="dynatable" width="1300" border="" style="height: 150;" cellspacing="0" cellpadding="0" bgcolor="lightgrey" align="center">
				...
				<tr style="background-color:gray;">
				  ...
				  <%if(hw_sw1.equals("")) 
						     ...
						     <tr>
									...
									<td id="hiderow" align="center"><input id="hiderow" type="button" size="2" name="delete" value="Delete" style="background-color:white;font-weight:bold;color:black;" onclick="deleteRecord(<%=rs2.getString("id")%>);" ></td>
							</tr>
