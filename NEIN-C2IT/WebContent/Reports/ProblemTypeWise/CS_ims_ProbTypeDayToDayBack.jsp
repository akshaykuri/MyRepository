...
<%!
	              ...
	              Statement st;
	              ResultSet rs;
	              String req,req2,req3,req4,req5;
	...
	%>
     ...
     req4 = request.getParameter("aabbcc");
     req5 = request.getParameter("aabbc2");
     req2 = request.getParameter("txtCalendar");
     req3 = request.getParameter("txtCalendar2");
    
    // System.out.println("req2   "+req2);
    // System.out.println("req3   "+req3);
     Date date1 = dateFormat.getFormatedDateforCalenderReport(req2);
     Date date2 = dateFormat.getFormatedDateforCalenderReport(req3);
...
%>
 <table id="invoicetable" width="1200" bgcolor="" cellpadding="4" cellspacing="6" align="center" border=1>
	<tr>
	<td bgcolor="lightgrey" style="font-size: 1" width="20" align="center">PROBLEM TYPE:</td>
	<td bgcolor="lightgrey" style="font-size: 1" width="10" align="center"><b><%=req4%></b></td>
	<td bgcolor="lightgrey" style="font-size: 1" width="100" align="center">LOCATION:</td>
	<td bgcolor="lightgrey" style="font-size: 1" width="100" align="center"><b><%=req5%></b></td>
	<td bgcolor="lightgrey" style="font-size: 1" align="center"><b>PROBLEM TYPE WISE REPORT</b></td>
	<td bgcolor="lightgrey" style="font-size: 1" width="10" align="center">FROM DATE:</td>
	<td bgcolor="lightgrey" style="font-size: 1" width="100" align="center"><b><%=req2%></b></td>
	<td bgcolor="lightgrey" style="font-size: 1" width="10" align="center">TO DATE:</td>
	<td bgcolor="lightgrey" style="font-size: 1" width="100" align="center"><b><%=req3%></b></td>
	</tr>
	</table> 
	...
	<table class="dynatable" width="1200" border="1" style="height: 150;" cellspacing="0" cellpadding="0" bgcolor="lightgrey" align="center">
				...
				<tr style="background-color:gray;">
					...
					<td width="67" align="center"  height="21" ><font size="2" ><b>System Admin</b></font> </td>
					...
					<!-- <td width="67" align="center"  height="21" ><b>Problem Date</b></td> -->
				    ...
				    <%int flag=0;
				           ...
				           rs2 = st2.executeQuery("select TIME(cm_time),TIME(cm_time2),TIMEDIFF(cm_time2,cm_time) as cm_time_diff,DATE(cm_time),DATE(cm_time2),complain_id,cm_name,transid,cm_location,cm_problem,cm_status,admin_remarks,emp,cm_date,cm_type,cm_time,cm_time2 from complain_master_item WHERE cm_type='"+req4+"' AND cm_location ='"+req5+"' AND cm_date >= '"+date1+"' and cm_date <= '"+date2+"' ORDER BY YEAR(cm_date),MONTH(cm_date),DATE(cm_date),complain_id");
				            ...
				            while(rs2.next()){
				            	flag=1;
                							    ...
                							    cm_location = rs2.getString("cm_location");
                	 						    ...
                	 						    String cm_date = rs2.getString("cm_date");
				    ...
				    <td width="100" align="center"><font size="2" ><b><%=emp%></b></font></td>
					<td width="100" align="center"><font size="2" ><%=complain_id%></font></td>
					<td width="100" align="center"><font size="2" ><%=cm_name %></font></td>
					<td width="100" align="center"><font size="2" ><%=cm_location %></font></td>
					...
					<%-- <td width="100" align="center"  height="21" ><%=cm_date%></td> --%>
				   ...
				   <td width="100" align="center"  height="21" ><font size="2" ><%=newDate2%></font></td>
					...
					<td width="100" align="center"><font size="2" ><%=cm_status %></font></td>
					<td width="100" align="center"><font size="2" ><%=admin_remarks %></font></td>
...
<tr> 
<td style="font-size: 1"><input style="size: 1;" type="button" title="Back To Selection Date Page" value="BACK" onclick="window.location.href='CS_ims_ProbTypeDayToDay.jsp?msg=1'" /></td>
