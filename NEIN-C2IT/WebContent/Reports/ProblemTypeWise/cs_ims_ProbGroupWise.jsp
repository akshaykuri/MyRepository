...
<script type="text/javascript">
 ...
 function link1() {
   			 //document.form.action="PoBranchDayExcel";
   			  document.form.action="cs_ims_ProbGroupWiseBackExcel.jsp";
   			 document.form.method="post";
   			 document.form.submit();
   			     }
 function OnButton1() {
   			 document.form.action="cs_ims_ProbGroupWiseBack.jsp?msg=1";
   			 document.form.method="post";
   			 document.form.submit();
   			     }
...
<form name="form" method="post" action="cs_ims_ProbGroupWiseBack.jsp">
...
<br>	 
  ...
  <tr>
   <td bgcolor="#2f4377" colspan="8">
     <font size ="3" color="white"><center>BRANCH WISE REPORT</center></font>
   </td>
  </tr>
   <tr><th>BRANCH:</th>
	<td>
