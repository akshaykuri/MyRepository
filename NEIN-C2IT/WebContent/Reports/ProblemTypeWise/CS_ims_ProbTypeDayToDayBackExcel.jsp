...
%>
 <table id="invoicetable" width="1200" bgcolor="" cellpadding="4" cellspacing="6" align="center" border=1>
	<tr>
	<td bgcolor="lightgrey"  width="20" align="center">PROBLEM TYPE:</td>
	<td bgcolor="lightgrey"  width="10" align="center"><b><%=req4%></b></td>
	<td bgcolor="lightgrey"  width="100" align="center">LOCATION:</td>
	<td bgcolor="lightgrey"  width="100" align="center"><b><%=req5%></b></td>
	<td bgcolor="lightgrey"  align="center"><b>PROBLEM TYPE WISE REPORT</b></td>
	<td bgcolor="lightgrey"  width="10" align="center">FROM DATE:</td>
	<td bgcolor="lightgrey"  width="100" align="center"><b><%=req2%></b></td>
	<td bgcolor="lightgrey"  width="10" align="center">TO DATE:</td>
	<td bgcolor="lightgrey"  width="100" align="center"><b><%=req3%></b></td>
	</tr>
	</table> 
