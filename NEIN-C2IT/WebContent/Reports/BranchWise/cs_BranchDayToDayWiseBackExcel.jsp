...
<table  width="1200" bgcolor=""  align="center" border=1>
	<tr>
	<td   height="21"   width="10" align="center">BRANCH NAME:</td>
	<td  width="40" height="21"  align="center" colspan="2"><b><%=req%></b></td>
	<td   height="21"   width="50%" align="center">BRANCH WISE REPORT</td>
	<td   height="21" width="10" align="center">DATE:</td>
	<td  width="10" height="21"   align="center"><b><%=req2%></b></td>
	</tr>
	</table> 
