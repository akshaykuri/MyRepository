...
<%!
	...
	%>
     ...
     req2 = request.getParameter("year1");
	...
	<table class="dynatable" width="1200" border="1" style="height: 150;" cellspacing="0" cellpadding="0" bgcolor="lightgrey" align="center">
				...
				<tr style="background-color:gray;">
				    ...
				    <%int flag=0;
				           ...
				           rs2 = st2.executeQuery("select TIME(cm_time),TIME(cm_time2),TIMEDIFF(cm_time2,cm_time) as cm_time_diff,DATE(cm_time),DATE(cm_time2),complain_id,cm_name,transid,cm_location,cm_problem,cm_status,admin_remarks,emp,cm_type,cm_time,cm_time2 from complain_master_item WHERE cm_location = '"+req+"' and YEAR(cm_date) = '"+req2+"' ORDER BY YEAR(cm_date),MONTH(cm_date),DATE(cm_date),complain_id");
