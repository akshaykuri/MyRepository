...
System.out.println("REQUESTT no : "+req2);
System.out.println("REQUESTT real : "+req);
...
<table id="tableData" name="tableData" width="100%" border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
	  ...
	  String statusD=null;
	  rs1 = st1.executeQuery("select form2_no,desg,emp,status,remarks,f_date,mail from form2_domain_item WHERE form2_no='"+req+"' AND desg <> 'none' ORDER BY id ASC"); 
	  while(rs1.next())
	  {
...
<td style="font-size:1" align="right" colspan="1">&nbsp;&nbsp;
 <!-- <a  href="javascript:history.back()">BACK</a> -->
<input style="background-color:white;font-weight:bold;color:black;" height="60" width="55" type="button"  value="BACK" onclick="javascript:history.back();"/>
     <!-- <a  href="javascript:history.back()">BACK</a> -->
      </td>
