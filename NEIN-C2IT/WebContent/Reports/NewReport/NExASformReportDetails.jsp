...
<table id="it" width="895" border=1>
                      ...
                      <table border=1>
                        ...
                        <%-- <tr>
                         ...
                         <tr>
                             ...
                             <td align="left">
                             (1)<input type="text" name="operationRangeOptional1" id="idoperationRangeOptional1" value="" size="10" maxlength="10"/><br>
                             ...
                             (5)<input type="text" name="operationRangeOptional5" id="idoperationRangeOptional5" value="" size="10" maxlength="10"/><br>
                             (6)<input type="text" name="operationRangeOptional6" id="idoperationRangeOptional6" value="" size="10" maxlength="10"/> <br>   
                             </td>
                         </tr>
                         <tr>
                        ...
                        <tr>
                           ...
                           <td align="left">
                              (1)<input type="text" name="dispRange1"	id="dispRange1" size="10" maxlength="44" /><br>
                              ...
                              (5) <input type="text" name="dispRange5"	id="dispRange5" size="10" maxlength="44" /><br>
                              (6)<input type="text" name="dispRange6"	id="dispRange6" size="10" maxlength="44" /><br>
  ...
  <%-- <tr>
    ...
    <tr>
       ...
       <td align="left" ><a href="../../NExAS/viewNExASExcelFile.jsp?f=<%=filepath%>"><%=fileName%></a></td>
  </tr> --%>
</table>
...
<INPUT type="button" style="background-color:#2f4377;font-weight:bold;color:white;" value="EXCEL" name=buttonNEE onclick="return (NXExcel(idformno1.value));">
</td>
   	</tr>
