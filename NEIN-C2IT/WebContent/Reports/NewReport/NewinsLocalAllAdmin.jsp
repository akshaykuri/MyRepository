...
System.out.println("REQ Newins : "+req);
...
<td style="text-align:left;"><input type="text" name="emp_code1" id="ecode1" value="<%=empid%>" readonly="readonly"/></td>
...
rs111 = st111.executeQuery("select ITdcode,ITdpassword,ITdlevel,ITdremark  from form7_newins WHERE form7_no='"+form7_no+"'");
