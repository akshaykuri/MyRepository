...
%>
 <table id="invoicetable" width="1200" bgcolor="" cellpadding="4" cellspacing="6" align="center" border=1>
	<tr>
	<td   height="21" bgcolor="lightgrey"  width="10" align="center" colspan="2">SYSTEM ADMIN NAME:</td>
	<td  width="40" height="21" bgcolor="lightgrey"  align="center" ><b><%=req%></b></td>
	<td   height="21" bgcolor="lightgrey"  width="50%" align="center" colspan="4">SYSTEM ADMIN WISE REPORT</td>
	<td   height="21" bgcolor="lightgrey"  width="10" align="center"  >MONTH:</td>
	<td  width="10" height="21" bgcolor="lightgrey"  align="center"  ><b><%=month%></b></td>
