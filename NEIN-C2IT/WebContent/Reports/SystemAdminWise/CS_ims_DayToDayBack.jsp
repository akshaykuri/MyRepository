...
%>
 <table id="invoicetable" width="1200" bgcolor="" cellpadding="4" cellspacing="6" align="center" border=1>
	...
	<td  width="40" height="21" bgcolor="lightgrey" style="font-size: 1" align="center" rowspan="2"><b><%=req2%></b></td>
	<td   height="21" bgcolor="lightgrey" style="font-size: 1" width="50%" align="center">FROM DATE-TO DATE WISE REPORT</td>
