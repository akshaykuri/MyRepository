...
<table id="invoicetable" width="1200" bgcolor="" cellpadding="4" cellspacing="6" align="center" border=1>
	<tr>
	<td   height="21" bgcolor="lightgrey" style="font-size: 1" width="10" align="center">SYSTEM ADMIN NAME:</td>
	<td  width="40" height="21" bgcolor="lightgrey" style="font-size: 1" align="center" rowspan="2"><b><%=req%></b></td>
	<td   height="21" bgcolor="lightgrey" style="font-size: 1" width="50%" align="center">SYSTEM ADMIN WISE (MONTH)REPORT</td>
	<%-- <td   height="21" bgcolor="lightgrey" style="font-size: 1" width="10" align="center">MONTH:</td>
	<td  width="10" height="21" bgcolor="lightgrey" style="font-size: 1" align="center"><b><%=tt%></b></td> --%>
	...
	<table class="dynatable" width="1200" border="1" style="height: 150;" cellspacing="0" cellpadding="0" bgcolor="lightgrey" align="center">
				...
				<tr style="background-color:gray;">
				    ...
				    <%int flag=0;
				           ...
				           rs2 = st2.executeQuery("select TIME(cm_time),TIME(cm_time2),TIMEDIFF(cm_time2,cm_time) as cm_time_diff,DATE(cm_time),DATE(cm_time2),complain_id,cm_name,transid,cm_location,cm_problem,cm_status,admin_remarks,emp,cm_type,cm_time,cm_time2 from complain_master_item WHERE  YEAR(cm_date)='"+req2+"' AND emp='"+req+"' ORDER BY YEAR(cm_date),MONTH(cm_date),DATE(cm_date),complain_id");
...
<tr> 
<td style="font-size: 1"><input style="size: 1;" type="button" title="Back To Selection Date Page" value="BACK" onclick="window.location.href='CS_ims_BranchMonthWise.jsp?msg=1'" /></td>
