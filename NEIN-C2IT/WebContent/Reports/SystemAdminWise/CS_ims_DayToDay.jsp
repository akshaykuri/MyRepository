...
<script type="text/javascript">
 ...
 function link1() {
   			...
   			document.form.action="CS_ims_DayToDayBackExcel.jsp";
   			 document.form.method="post";
   			 document.form.submit();
   			     }
 function OnButton1() {
   			 document.form.action="CS_ims_DayToDayBack.jsp";
   			 document.form.method="post";
   			 document.form.submit();
   			     }
...
<table width="1118" align="center" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr align="center">
 <td bgcolor="#2f4377"><strong><font size ="4" color="white">FROM DATE-TO DATE WISE REPORT</font></strong></td></tr>
</table>
...
<table align="center">
<tr>
<th>SELECT FROM DATE - TO DATE</th>
</tr>
</table>
...
<br>	 
  ...
  <tr>
   <td bgcolor="#2f4377" colspan="8">
     <font size ="3" color="white"><center>DATE TO DATE WISE REPORT</center></font>
   </td>
  </tr>
   <tr>
<td colspan="4"><font size="2">SELECT SYSTEM ADMIN AND DATE</font> </td>
</tr>
   <tr><td><font size="2">SYSTEM ADMIN NAME</font></td>
<td><select  name="admin"> 
 ...
 <td><font size="2"> FROM DAY:</font></td>
