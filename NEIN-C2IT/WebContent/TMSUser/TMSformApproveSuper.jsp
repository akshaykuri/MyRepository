...
<form name="form" method="post" action="TMSformApprove1super.jsp?msg=1">
<%
...
rs9 = st9.executeQuery("SELECT DISTINCT form_no FROM form16_tmsuser_item WHERE ((emp='"+AdminName+"' and desg='"+desg+"')|| empid='"+emp_no+"') and status='Pending' AND form_no LIKE 'NEIN/TMSUSER%' ORDER BY form_no ASC");
