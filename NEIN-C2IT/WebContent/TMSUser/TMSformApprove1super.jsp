...
<head>
 ...
 var usercode=document.form.usercode;
 var userpass=document.form.userpass;
 
 var f112 = document.form.higherAuthority;
...
if (document.getElementsByName("mmdradio")[0].checked)
	  {
	  //alert("heeeeeeeeeeeeeeeeeeeeeeeeee"+f112.value);
	  if (f112.value=="directApprove") 
	  		{  
...
<form  action="TMSformApproval1Back.jsp" method="post" name="form"  >
...
System.out.println("Form no1111 :"+req);
...
%>
  ...
  <table border=1 width="895">
   ...
   <tr>
        ...
        <td style="text-align:left;"><input type="text"  width=20 name="mailid" value="<%=mailid%>" readonly="readonly"/></td>
   ...
   <tr>
       ...
       <td style="text-align:left;"><input name="depart" size="31" value="<%=address%>" readonly="readonly"/></td> 
   </tr>
   <tr>
       <td  style="text-align: right;">EMail id :</td>
       <td style="text-align:left;"><input type="text"  width=20 name="mailid" value="<%=mailid%>" readonly="readonly"/></td>
  ...
  <tr>
      ...
      <td style="text-align:left;"><input type="text"  style="width: 15em"  name="d_reliving"  value="<%=requestBy%>" readonly="readonly" readonly="readonly" /></td> 	
	  <td align="right">Request  :</td>
      <td><input style="" type ="text" name = "requestOption" readonly="readonly" value ="<%=requestOption%>" id="requestOption"/></td>				        
  </tr>
  <tr>
...
<!-- /////////////////////////////////////////////////////////////// Change //////////////////////////////// -->
   ...
   <% 	ResourceBundle dbProperties = ResourceBundle.getBundle("csdb");
 	...
 	String dbName = dbProperties.getString("tmsdb.dbName"); // TMS DB
	String urltmsdb = dbProperties.getString("tmsdb.url");
 	
 	String csdbName = dbProperties.getString("csdb.dbName"); // C2IT DB
 	 cnm = con.getConnection2();
	    ...
	    if(rsm.next())
	       {
	    	mx=rsm.getString("maxlvel");
	    	if(!mx.equals("over"))
	    	    maxlevel1=Integer.parseInt(mx);
        }%>
 ...
 if(!requestOption.equals("Delete"))
	      ...
	      if(maxlevel1==2)
	    	    ...
	    	    <table id="it" width="100%">
                     <tr align="center" >
				         <td colspan=3 bgcolor="#7FB3D5">ASSIGN NEW APPLICATION RIGHTS FOR USER </td>
			         </tr>
			         <tr align="center" >
                     ...
                     try
                        {
                    	Class.forName(driver).newInstance();
						con1c = DriverManager.getConnection(urltmsdb+dbName,userName,password); 
						if(address==null)
...
<br />
<br /><input type="hidden" name="reqModule" size=20 id="idreqModule" readonly/>
	  ...
	  String statusD=null;
	  rs1 = st1.executeQuery("select form_no,desg,emp,status,remarks,DATE_FORMAT(form_date,'%d/%m/%Y'),mail,levelno,empid from form16_tmsuser_item WHERE form_no='"+req+"'"); 
	  while(rs1.next())
	  {
...
System.out.println("Seeempid"+sessempid);
  ...
  String flag = c2ITUtil1.getAuthorizedNameTMSUSER(form2_no,session.getAttribute("Nname").toString(),session.getAttribute("desg").toString(),session.getAttribute("emp_no").toString()); %>
...
<input type="hidden" id="idstatus" value="<%= flag %>" />
  ...
  <%  ResourceBundle dbProperties1 = ResourceBundle.getBundle("csdb");
	String userName1 = dbProperties.getString("csdb.username");
	String password1 = dbProperties.getString("csdb.password");
	String url1 = dbProperties.getString("csdb.url");
	String driver1 = dbProperties.getString("csdb.driverName");
	String dbName1 = dbProperties.getString("csdb.dbName"); 
 
  
  
  
	Class.forName(driver).newInstance();
    cn5= DriverManager.getConnection(url1+dbName1,userName1,password1); 
    ...
    // System.out.println("Max Level no :"+maxlevel);
     ...
     //rs5 = st5.executeQuery("Select * from desg");emp_no,levelno
     rsl1 = stl1.executeQuery("SELECT alloptions,directApprove FROM formapproval WHERE branch='"+req_Branch+"' and empid='"+sessempid+"' and formtype='TMSUSER'");
     if(rsl1.next())
         { 
     ...
     System.out.println("Current empno no :"+emp_no);
  ...
  <tr style="visibility: hidden;display: none;" id="idApproved" >
   <td>
       <%if(!levelno.equals(maxlevel) && !levelno.equals("over"))
        ...
        }else if(levelno.equals("over") || levelno.equals(maxlevel))
             {%>
    	      <input type="hidden" name="higherAuthority" value="directApproveClose" id="idmNon"></input>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input align="left" type="radio" name="higherAuthority" value="directApprove" id="idmNon" onclick="showHigherTR();"/>Form Close <br>
            
             <table id="it" width="895" border=1>
                  <table id="it" width="895">
                       <tr >
                           <td align="left">HO IT Use Only</td>
                       </tr>
                       <tr >
                         <td align="left"><font color=red>*</font>User Code:</td>
                         <td align="left"><input type="text" id="idusercode" name="usercode" value=""></input></td>
                      </tr>
                      <tr >
                         <td align="left"><font color=red>*</font>Password:	</td>
                         <td align="left"><input type="text" id="iduserpass" name="userpass" value=""></input></td>
                     </tr>
                 </table>
  ...
  <tr>
     <td style="size:1">
          <div id="formsubmitbutton">
                 <input type="submit"  value="SUBMIT" name="save1" id="save1" onclick="return (validate())" /></td>
          </div>  
