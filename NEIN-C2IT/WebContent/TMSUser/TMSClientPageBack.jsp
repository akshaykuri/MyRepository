...
//custCode,custname,address,conperson,empmailid,emp_mob,
...
int idextend = id;
psmt = cn2.prepareStatement("INSERT INTO form16_tmsuser(form_no,idextend,empid,full_name,address,conperson,empmail,emp_mob,requestBy,requestOption,req_Branch,ftype) VALUES(?,?,?,?,?,?,?,?,?,?,?,?)");
////custCode,custname,address,conperson,empmailid,emp_mob,
psmt.setString(1,new_id);
psmt.setInt(2,idextend);
psmt.setString(3,custCode);
psmt.setString(4,custname);
psmt.setString(5,addresss);
psmt.setString(6,conperson);
psmt.setString(7,empmail);
psmt.setString(8,emp_mob);
psmt.setString(9,requestBy);
psmt.setString(10,requestOption);
psmt.setString(11,req_Branch);
psmt.setString(12,deptType);
...
String msg = "TMS CUSTOMER USER__FORM__NO__:__'"+new_id+"'__SAVED__AND__SENT__SUCCESSFULLY";
