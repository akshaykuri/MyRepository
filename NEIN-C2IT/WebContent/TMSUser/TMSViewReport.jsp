...
<tr align="center">
 <td bgcolor="#2f4377" class="blueLine"><strong><font size ="4" color="white">TMS  FORM</font></strong></td>
</tr>
...
<form name="form" method="post" action="TMSViewReportBack.jsp?msg=1">
...
if(b_no.equals("90"))
	rs9 = st9.executeQuery("SELECT DISTINCT form_no,full_name FROM form16_tmsuser WHERE  form_no LIKE 'NEIN/TMSUSER%' ORDER BY idextend desc");
else
    rs9 = st9.executeQuery("SELECT DISTINCT form_no,full_name FROM form16_tmsuser WHERE req_Branch='"+b_no+"' AND form_no LIKE 'NEIN/TMSUSER%' ORDER BY idextend desc");
