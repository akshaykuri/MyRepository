...
<title>BARCODE PRINTER DETAILS</title>
...
var f=document.form;    
f.method="post";    
f.action='BarcodeEdit.jsp?id='+id;    
f.submit();
}
function deleteRecord(id)
{    
	if(confirm('You are above to delete a Barcode printer'))
	{
var f=document.form;    
f.method="post";    
f.action='BarcodeDelete.jsp?id='+id;    
f.submit();
}
	else{}
}
...
<center>
	...
	<table border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
		...
		<td height="20" bgcolor="white" width="120" align=center><font size="2" color="black"><b>BARCODE PRINTER</b></font></td>
...
String query = "select * from barcode_master ORDER BY brLocation";
