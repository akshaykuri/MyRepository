...
var f=document.form;    
f.method="post";    
f.action='MplsEdit.jsp?id='+id;    
f.submit();
}
function deleteRecord(id)
{    
	if(confirm('You are above to delete a ISP(MPLS)'))
	{
var f=document.form;    
f.method="post";    
f.action='MPLSDelete.jsp?id='+id;    
f.submit();
}
	else{}
}
...
//isp_name,mpls_branch,crt_id,brndwdt,lan_ip,wan_ip,network_ip 	 -->         
	<table border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
		...
		<td height="20" bgcolor="white" width="120" align=center><font size="2" color="black"><b>ISP(MPLS)</b></font></td>
		<td bgcolor="white" width="120" align=center><font size="2" color="black"><b>BRANCH</b></font></td>
		<td bgcolor="white" width="120" align=center><font size="2" color="black"><b>CIRCUIT ID</b></font></td>
		<td bgcolor="white" width="120" align=center><font size="2" color="black"><b>BANDWIDTH</b></font></td>
		<td bgcolor="white" width="120" align=center><font size="2" color="black"><b>LAN IP</b></font></td>
		<td bgcolor="white" width="120" align=center><font size="2" color="black"><b>WAN IP</b></font></td>
		<td bgcolor="white" width="120" align=center><font size="2" color="black"><b>NETWORK IP</b></font></td>
...
try
{
  ...
  String query = "select * from mpls_master ORDER BY bkLocation";
...
<td bgcolor="white" width="100"><font size="2" color="black"><%=rs.getString(8)%></font></td>
...
<input id="hiderow" type='submit' style="background-color:white;font-weight:bold;color:black;" value='CANCEL' onclick='btnClick();'></td>
