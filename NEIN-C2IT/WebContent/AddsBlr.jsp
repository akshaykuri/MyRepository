...
rs = st2.executeQuery("select idd from nentryblr where idd='"+idb+"'");
if(rs.next()){
...
int i=st.executeUpdate("insert into nentryblr(idd,Nname,Npwd,Naddr,Ncontact,Npost,NpostingCo,Nmail) values('"+idb+"','"+Nnameb+"','"+Npwdb+"','"+Naddrb+"','"+Ncontactnob+"','"+Npostb+"','"+Npostingcob+"','"+Nmail+"')");

//out.println("................................'"+Nnameb+"'   INFORMATION IS   INSERTED   SUCCESSFULLY.......................");

msg = "'"+Nnameb+"'__SAVED__SUCCESSFULLY";
}
response.sendRedirect("BlrUser.jsp?msg=" +msg);
%></b>
</font>
</center></form></div>
...
<a href="BlrUser.jsp"><img src="bakk.png" border="0" height="35" width="35"></a>
