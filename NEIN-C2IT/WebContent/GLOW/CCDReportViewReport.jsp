...
{	
	String msg2=null;
	msg2="Session Time Out Login Again";
...
<tr align="center">
 <td bgcolor="#2f4377" class="blueLine"><strong><font size ="4" color="white">CCD FORM</font></strong></td>
</tr>
...
<form name="form" method="post" action="CCDReportViewReportBack.jsp?msg=1">
...
if(b_no.equals("90"))
	rs9 = st9.executeQuery("SELECT DISTINCT form_no,full_name FROM form13_ccdreport WHERE  form_no LIKE 'NEIN/CCD%' ORDER BY idextend asc");
else
   rs9 = st9.executeQuery("SELECT DISTINCT form_no,full_name FROM form13_ccdreport WHERE req_Branch='"+b_no+"' AND form_no LIKE 'NEIN/CCD%' ORDER BY idextend asc");
...
<table align="center">
<tr>
<th>SELECT CCD Report FORM NUMBER</th>
</tr>
</table>
