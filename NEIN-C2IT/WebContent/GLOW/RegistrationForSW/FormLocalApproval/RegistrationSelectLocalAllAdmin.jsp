...
<tr align="center">
 <td bgcolor="#2f4377" class="blueLine"><strong><font size ="4" color="white">REGISTRATION FORM</font></strong></td>
</tr>
...
if(b_no.equals("90"))
    rs9 = st9.executeQuery("SELECT DISTINCT form10_no,full_name,Software FROM  form10_registration WHERE form10_no LIKE 'NEIN/CS/Regis%' ORDER BY form10_no DESC");
else if(b_no.equals("30"))
	rs9 = st9.executeQuery("SELECT DISTINCT form10_no,full_name,Software FROM  form10_registration WHERE i_b_no in('30','32','11','53') and  form10_no LIKE 'NEIN/CS/Regis%' ORDER BY form10_no DESC");

	
else
	rs9 = st9.executeQuery("SELECT DISTINCT form10_no,full_name,Software FROM  form10_registration WHERE i_b_no='"+b_no+"' AND form10_no LIKE 'NEIN/CS/Regis%' ORDER BY idextend DESC");
