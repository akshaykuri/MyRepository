...
<script language="javascript" type="text/javascript">
    function ValidateForm() {
        ...
        var tt = document.getElementById("com");
      //  alert("admin_remarks "+tt.value);
        if (tt.value != "N/A") {
            alert("Kindly Resolve the issue/Complaint from Dash Board \n \n To get a confirmation mail of complaint to Sender \n \n i.e Visit : View all Pending request Module.");
            tt.focus();
            isValidForm = false;
          } 
...
<%!
	           ...
	           // String idextend,mr_id,mr_name,mr_approved,mr_discuss,mr_date,e_name,e_designation,totalcon,desg,emp,theName,transid,mr_remarks,stauts,mail;
	            String cm_date,cm_time,idextend,complain_id,cm_name,cm_location,cm_type,cm_problem,desg,emp,transid,mail,admin_remarks,cm_status;
	%>
...
<%
 /* String num,req;
req = request.getParameter("complain_id"); */
...
/* if(!rs10.next()){
	...
	response.sendRedirect("complainPageStatus.jsp?msg="+msg1);
} */
%>
                ...
                //  req = request.getParameter("aabbcc");
                 ...
                 // out.println("Request payload: "+ req);
                  ...
                  // rs = st.executeQuery("select * from complain_master_item where complain_id='"+req+"'");
                   rs = st.executeQuery("select cm_location,cm_name,cm_date,cm_time,cm_time2,idextend,complain_id,cm_type,cm_problem,desg,emp,cm_status,admin_remarks,transid,mail from complain_master_item where complain_id='"+req+"'");
...
<form method="post" action="updateComplainBack.jsp" onsubmit="return ValidateForm();" name="form1">
...
<div id="leftfeature"><input type="button" value="BACK" onclick="window.location.href='ims_Branch_Back.jsp?msg=1'"/></div>
	<div id="page-wrap">
   ...
   <tr> 
	...
	<td style="size:1"><input style="font-size:1" type="submit" value="SAVE" name="save1" id="save1"/></td><!--
     ...
     <td style="size:1"><input style="font-size:1" type="submit" value="SAVE" name="save" id="save" onclick="this.disabled=true;return true;"/></td>
      ...
      <td style="font-size:1">&nbsp;&nbsp;<input style="size:1;font-size: 1.1em;" type="button"  value="BACK" onclick="window.location.href='ims_Branch_Back.jsp?msg=1'"/> </td>
