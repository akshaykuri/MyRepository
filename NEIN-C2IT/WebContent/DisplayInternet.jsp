...
var f=document.form;    
f.method="post";    
f.action='InternetEdit.jsp?id='+id;    
f.submit();
}
function deleteRecord(id)
{    
	if(confirm('You are above to delete a ISP Machine'))
	{
var f=document.form;    
f.method="post";    
...
<center>
	...
	<table border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
		...
		<td height="20" bgcolor="white" width="120" align=center><font size="2" color="black"><b>ISP MACHINE</b></font></td>
...
String query = "select * from internet_master";
