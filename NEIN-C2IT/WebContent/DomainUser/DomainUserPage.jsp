  ...
  function getInfo()
             ...
             if(xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
                            { 
                             ...
                             document.getElementById("resultFromAjax2").innerHTML = str2;//fname,idbranch,iddepart,iddesignation,rofficer
...
<body>
<form action="DomainUserPageBack.jsp" method="post" name="form">
...
<table width="907"  cellspacing="0" cellpadding="0" bgcolor="grey" align="center">
	<tr>
		...
		<b><label>
		DOMAIN USER REQUEST FORM</label>
		</b></font></center> 
		</td>
		</tr>
...
Statement st1= null,st2=null,st3=null,st4=null,st6=null; 
...
rs3 = st3.executeQuery("SELECT max(idextend) FROM form2_domain WHERE form2_no IN(SELECT form2_no FROM form2_domain LEFT JOIN branch_master b ON(substr(form2_no,16,2)=b.b_no) WHERE '"+b_no+"'=b.b_no GROUP BY form2_no)");
...
<table  width="895">
	...
	<input type="hidden" name="form2_no" readonly="readonly" value="<%=new_id%>" size="25" />

<tr>
  
<td  style="text-align: right;"><font color=red>*</font>Employee Code :</td>
<td style="text-align:left;"><input type="text" name="emp_code" id="ecode" size="29" maxlength="14" onkeypress="return isNumber(event)" onkeyup="sendInfo(this.value);"/></td>
...
<tr>
<td  style="text-align: right;width:23%;"><font color=red>*</font>Branch :<input type="hidden" name="idextend" value="<%=id%>" readonly/></td>
...
<tr>
 ...
 <td style="font-weight:bold;font-style:italic;width:23%;" > 
   ...
   <!--   <input type ="radio" name = "requestOption" value ="Change" />Change -->
     <input type ="radio" name = "requestOption" value ="Password Reset" />Password Reset
 </td>
