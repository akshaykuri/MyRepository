...
<head><title>IT CLEARANCE FORM</title>
...
<tr align="center">
 <td bgcolor="#2f4377" class="blueLine"><strong><font size ="4" color="white">DOMAIN USER FORM</font></strong></td>
</tr>
...
<form name="form" method="post" action="DomainUserLocalAllAdmin.jsp?msg=1">
...
if(b_no.equals("20"))
    rs9 = st9.executeQuery("SELECT DISTINCT form2_no,full_name FROM form2_domain WHERE  i_b_no in ('20','21') ORDER BY i_b_no DESC");

if(b_no.equals("30"))
    rs9 = st9.executeQuery("SELECT DISTINCT form2_no,full_name FROM form2_domain WHERE  i_b_no in ('30','32','53','11') ORDER BY i_b_no DESC");
if(b_no.equals("90"))
    rs9 = st9.executeQuery("SELECT DISTINCT form2_no,full_name FROM form2_domain  ORDER BY i_b_no DESC");
else
	rs9 = st9.executeQuery("SELECT DISTINCT form2_no,full_name FROM form2_domain WHERE  i_b_no='"+b_no+"' ORDER BY i_b_no DESC");
...
<table align="center">
<tr>
<th>SELECT DOMAIN USER FORM NUMBER</th>
</tr>
</table>
   ...
   <tr><!--<th>BRANCH:</th>
	--><td>
      ...
      <select  name="req"  id="hiderow">     <option value="NULL">SELECT</option> 
										        ...
										        while(rs9.next()){ 
										        /* 	form2_noD=rs9.getString("form2_no");
										        	 i_b_no1=form2_noD.substring(15,17);
										              if(i_b_no1.equals(b_no))
										                { */%> 
