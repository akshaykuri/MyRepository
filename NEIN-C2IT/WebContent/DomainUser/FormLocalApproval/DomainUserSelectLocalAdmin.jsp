...
<form name="form" method="post" action="DomainUserLocalAdmin.jsp?msg=1">
...
rs9 = st9.executeQuery("SELECT DISTINCT form2_no FROM form2_domain_item WHERE ((emp='"+AdminName+"' and desg='"+desg+"') OR (empid='"+emp_no+"')) and status='Pending' AND form2_no LIKE 'NEIN/CS/Domain%' ORDER BY id desc");
