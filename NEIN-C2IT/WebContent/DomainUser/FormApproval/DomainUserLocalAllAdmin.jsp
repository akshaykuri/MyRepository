...
rs100 = st100.executeQuery("select * from form2_domain WHERE form2_no='"+values[0]+"'"); 
while(rs100.next())
{
...
<td  > 
     <input style="" type ="text" name = "requestOption" size="31" readonly="readonly" value ="<%=group%>" id=""/></td>
...
<table id="tableData" name="tableData" width="100%" border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
	  ...
	  String statusD=null;
	  rs1 = st1.executeQuery("select form2_no,desg,emp,status,remarks,f_date,mail from form2_domain_item WHERE form2_no='"+values[0]+"' AND desg <> 'none' ORDER BY id ASC"); 
	  while(rs1.next())
	  {
