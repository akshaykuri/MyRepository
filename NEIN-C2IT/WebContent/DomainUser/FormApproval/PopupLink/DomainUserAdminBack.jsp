...
String ToMail="";
psmtt = cn2.prepareStatement("SELECT mail,emp FROM form2_domain_item WHERE form2_no=? AND status!='Initiator'");
...
//System.out.println("Send direct :"+senddirect);
 
  psmt = cn2.prepareStatement("UPDATE form2_domain_item SET status=?,remarks=?,presence=? WHERE form2_no=? and presence='now'");
 ...
 // System.out.println("mmradio 22:"+mmdradio);
...
if(senddirect.equals("sendonly"))
	...
	int b = psmt10.executeUpdate(); 
     psmt2 = cn2.prepareStatement("INSERT INTO form2_domain_item(form2_no,desg,emp,status,remarks,f_date,mail,presence,empid,levelno) VALUES(?,?,?,?,?,?,?,?,?,?)");
	 ...
	 if(higherAuthority.equals("direct"))
	       {
		   psmt2 = cn2.prepareStatement("UPDATE form2_domain SET ITusername=?,ITpassword=?,ITcreated=?,ITremark=?,Approval_sttatuss=?,Approval_f_date=? WHERE form2_no=?");
		   psmt2.setString(1,ITusername);
		   psmt2.setString(2,ITpassword);
		   psmt2.setString(3,ITcreated);
		   psmt2.setString(4,ITremark);
		   psmt2.setString(5,"Closed");
		   psmt2.setDate(6,form_date);
		   ...
		   if((SendExtraMails!="NULL")||(mmdradioBcc=="Yes"))
			  ...
			  postMail.sendMailCC(i_email_id,i_name,allMails,CCList," DOMAIN USER FORM :  " +form_no+ " ",initiatorNameIfNotApproved+  " "+  "your request for DOMAIN USER FORM "+form_no+" is been approved by " +i_name+ " <br><br><b><u> Open the following URL</u> </b><br>C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
		   }
	 ...
	 psmt2.setString(7,form_no);
	 int j = psmt2.executeUpdate();
	// System.out.println("Send direct 222:"+form_no);
	 message = mailMessage.getMailMessageDomain(form_no.trim());
	 //postMail.postMail(i_email_id,i_name,"pass1234",allMails," DOMAIN USER FORM :  " +form_no+ " ",initiatorNameIfNotApproved+  " "+  "your request for DOMAIN USER FORM "+form_no+" is been approved by " +i_name+ " <br><br><b><u> Open the following URL</u> </b><br>C2IT LINK -  http://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>");
...
msg = "DOMAIN__USER__SAVED__AND__SENT__SUCCESSFULLY";
