...
if(ApprovalOption.equals("ContinueStatus"))
{
	...
	//psmtApOp1 = cn2.prepareStatement("UPDATE form2_domain_item SET status=?,remarks=?,f_date=?,presence=? WHERE form2_no=? AND desg=? AND emp=? ");
	psmtApOp1 = cn2.prepareStatement("UPDATE form2_domain_item f,(SELECT max(id) as idf FROM form2_domain_item WHERE form2_no=? AND desg=? AND emp=?) as p SET f.status=?,f.remarks=?,f.f_date=?,f.presence=? WHERE f.form2_no=? AND f.desg=? AND f.emp=? AND f.id=p.idf");
	...
	psmtApOp2 = cn2.prepareStatement("UPDATE form2_domain SET Approval_status=?,Approval_sttatuss=?,Approval_remarks=?,Approval_f_date=?,Approval_emp=?,Approval_desg=?,Approval_empp=?,Approval_desgg=? WHERE form2_no=?");
	...
	psmtApOp3 = cn2.prepareStatement("INSERT INTO form2_domain_item(form2_no,desg,emp,status,remarks,f_date,mail,presence) VALUES(?,?,?,?,?,?,?,?)");
	...
	{  System.out.println("if Approved and sending again to Higher authority ");
		postMail.postMail(i_email_id,i_name,"pass1234",Mail1," DOMAIN USER FORM :  " +form_no+ " ",i_name+  " "+  "request you to Approve - DOMAIN USER FORM :"+form_no+ " <br><br><b><u> Open the following URL</u> </b><br>C2IT LINK -  https://ninsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
	}
...
/* 	if((mmdradio!=null && mmdradio.equals("Not Approved"))&&(higherAuthority!=null && higherAuthority.equals("directApprove")))
	...
	{	
	   System.out.println("IF NOT APPROVED THIS LOOP WILL RUN");
		...
		psmt4 = cn2.prepareStatement("SELECT mail,emp FROM form2_domain_item WHERE form2_no=?");
		psmt4.setString(1,form_no);
	   ...
	   // postMail.postMail(i_email_id,i_name,"pass1234",allMails1," DOMAIN USER FORM :  " +form_no+ " ",initiatorNameIfNotApproved+  " "+  "request Is NOT Approved for the Form No." +form_no+ " <br>Remarks : "+txtmail_msg+"<br><b><u> Open the following URL</u> </b><br>C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
		 postMail.postMail(i_email_id,i_name,"pass1234",allMails1," DOMAIN USER FORM :  " +form_no+ " ",initiatorNameIfNotApproved+  " "+  "your request for DOMAIN USER FORM "+form_no+" Is NOT Approved by" +i_name+ " <br>Remarks : "+txtmail_msg+"<br><b><u> Open the following URL</u> </b><br>C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
	   }
	}
...
psmt2 = cn2.prepareStatement("UPDATE form2_domain SET ITusername=?,ITpassword=?,ITcreated=?,ITremark=?,Approval_sttatuss=?,Approval_f_date=?,reminder=? WHERE form2_no=?");
...
int j = psmt2.executeUpdate();
		...
		//	postMail.postMail(i_email_id,i_name,"pass1234",mailingCheck[u]," DOMAIN USER FORM :  " +form_no+ " ","your request for DOMAIN USER FORM "+form_no+" is Approved by " +i_name+ " <br><br><b><u> Open the following URL</u> </b><br>C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
			postMail.postMailCC(i_email_id,i_name,"pass1234",mailingCheck[u],CCList," DOMAIN USER FORM :  " +form_no+ " ","your request for DOMAIN USER FORM "+form_no+" is Approved by " +i_name+ " <br><br><b><u> Open the following URL</u> </b><br>C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
		 	...
		 	postMail.sendMailCC(i_email_id,i_name,ToMail,CCList," DOMAIN USER FORM :  " +form_no+ " ","your request for DOMAIN USER FORM "+form_no+" is Approved by " +i_name+ " <br><br><b><u> Open the following URL</u> </b><br>C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
		}
		else
		{
			for(int u=0;u<mailingCheck.length;u++)
		...
		{ System.out.println("IF SendExtraMails in incident reported :"+SendExtraMails);
		   String valuesbcc[] = SendExtraMails.split(",");
			...
			// postMail.postMail(i_email_id,i_name,"pass1234",valuesbcc[u]," INCIDENT LOG FORM :  " +form_no+ " ",i_name+  " "+  " Approved request for the Form No.:" +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
			 postMail.postMail(i_email_id,i_name,"pass1234",valuesbcc[u]," DOMAIN USER FORM :  " +form_no+ " ","your request for DOMAIN USER FORM "+form_no+" is Approved by " +i_name+ " <br><br><b><u> Open the following URL</u> </b><br>C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
			}
		} */
