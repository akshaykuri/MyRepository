...
<table id="tableData" name="tableData" width="100%" border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
	  ...
	  <%
	  String mailD=null,emp_no=null,levelno=null,form2_noD=null;
	  cn1 = con.getConnection2();
	  st1=cn1.createStatement();
	  String statusD=null;
	  rs1 = st1.executeQuery("select id,form2_no,desg,emp,status,remarks,f_date,mail,empid,levelno from form2_domain_item WHERE form2_no='"+req+"' ORDER BY id ASC"); 
	  while(rs1.next())
	  {
	 ...
	 <td><input type="button"  style="size:1" value="RE-SEND MAIL" onclick="resendMail('<%=m%>','<%=form2_no%>','<%=email_id%>','<%=SessionName%>');" /></td> 
...
<%String flag =c2ITUtil1.getAuthorizedNameDomain(form2_no,session.getAttribute("Nname").toString(),session.getAttribute("desg").toString(), emp_no1); %>
