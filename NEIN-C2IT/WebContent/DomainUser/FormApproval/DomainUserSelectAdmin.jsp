...
document.form.action="DomainUserAdmin.jsp?msg=1";
...
<form name="form" method="post" action="DomainUserAdmin.jsp?msg=1">
...
rs9 = st9.executeQuery("SELECT DISTINCT form2_no,full_name FROM form2_domain WHERE Approval_emp='"+AdminName+"' and Approval_desg='"+desg+"' and Approval_sttatuss='Pending' AND form2_no LIKE 'NEIN/CS/Domain%' ORDER BY form2_no ASC");
...
<form name="form2" method="post" action="DomainUserLocalAllAdmin.jsp?msg=1">
<%-- %>	 <form action="POMonthWiseBack.jsp"> 
	<form action="POWiseBack.jsp">--%>
<%
	 String b_no=null;
...
rs99 = st99.executeQuery("SELECT DISTINCT form2_no,full_name FROM form2_domain WHERE form2_no LIKE 'NEIN/CS/Domain%' ORDER BY id DESC");
