...
System.out.println("DOMAIN REMINDER "+SessionName+"   -- FOR THE REQUEST : "+no);
cn1 = con.getConnection2();
st1 = cn1.createStatement();
rs1 = st1.executeQuery("select * from form2_domain WHERE form2_no='"+no+"'"); 
if(!rs1.next())
{
...
rs100 = st100.executeQuery("select * from form2_domain WHERE form2_no='"+no+"'"); 
while(rs100.next())
{
...
<form name="form" action="DomainReminderBack.jsp" method="post"  ><center>
<label> <font color="black"><u><b>DOMAIN USER REQUEST-REMINDER</b></u></font> </label> 
<br/>
...
<input name="form_no" value="<%=form2_no%>" size="31" readonly="readonly"/> </td>
</tr>
<tr>
...
<tr>
&nbsp;&nbsp;&nbsp; <td  style="text-align: right;width: 215px; " bgcolor="lightgrey" >Branch :</td>
<td style="text-align:left;"><input name="branch" value="<%=branch%>" size="31" readonly="readonly"/> </td>
<td  style="text-align: right;width: 175px;" bgcolor="lightgrey">Department :</td>
...
<td  style="text-align: right;" bgcolor="lightgrey">Requested By:</td>
<td style="text-align:left;">
...
<tr>
<td style="text-align: right;" bgcolor="grey">Request  :</td>
<td style="text-align:left;" bgcolor="grey"> 
