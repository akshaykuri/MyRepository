...
<% 
 ...
 <script language = "Javascript">
          ...
          function validate(){
              var w=document.form.printer_name;
              var ab=document.form.printer_detail;
...
<tr align="center">
 <td bgcolor="#2f4377" class="blueLine"><strong><font size ="4" color="white">DEPARTMENT MASTER </font></strong></td>
</tr>
 </table>


 
  <form name="form" method="post" onSubmit="return validate()" action="Department_MasterBack.jsp">
...
<table width="920" height="3" cellpadding="0" cellspacing="0" ID="Table1">
  ...
  <td width="25%" align="justify" valign="top"></td>
    <td width="21%" align="justify" valign="top">
      <p> <img src="images/dept.jpg" height="180" width="340">
</td>
...
<font color=darkblue size=3 > CREATE DEPARTMENT DETAILS</font>
</td>
</tr>

	<tr><td><font size="2">DEPARTMENT NAME:</font><font color=red>*</font></td><td><input type="text" size="20" name="dept_name" value=""></td></tr>

	<tr><td><font size="2"> DEPARTMENT DETAIL:</font><font color=red>*</font></td><td><input type="text" size="20" name="dept_detail" value=""></td></tr>
	...
	<tr>
	<td>
    <a href="DisplayDepartment.jsp" onclick="return popitup('DisplayDepartment.jsp')">View Department</a> </td>
