...
<img src="images/nippon.gif" height="35" width="220"> <img src="images/cs-soft.jpg" height="25" width="100" align="right">
 ...
 <form name="form" method="post" onSubmit="return validate()" action="AddsBlr.jsp">

<table width="1118" align="center" border="0" cellspacing="0" cellpadding="0">
  <tr align="center">
    <td bgcolor="#ec691f"><strong><font size ="4" color="white"><b>BANGLORE BRANCH</b><br />
...
<ul id="sidebarmenu1">
    ...
    <li><a href="MaaUser.jsp?msg=1?msg=1">MAA</a></li>
</ul>
</div>
</td>
...
<font color=darkblue size=3 > CREATE SPECIFIC USER</font>
	...
	<tr><td>
    <a href="DisplayDelBlr.jsp" onclick="return popitup('DisplayDelBlr.jsp')"><font size=3>View Detail</font></a> </td>
