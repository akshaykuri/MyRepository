...
<tr align="center">
 <td bgcolor="#2f4377" class="blueLine"><strong><font size ="4" color="white">PRINTER MASTER</font></strong></td>
</tr>
 </table>


 
  <form name="form" method="post" onSubmit="return validate()" action="Printer_MasterBack.jsp">
...
<table width="920" height="3" cellpadding="0" cellspacing="0" ID="Table1">
  ...
  <td width="25%" align="justify" valign="top"></td>
    <td width="21%" align="justify" valign="top">
      <p> <img src="images/print.jpg" height="180" width="340">
</td>
...
<font color=darkblue size=3 > CREATE PRINTER DETAILS</font>
</td>
</tr>

	<tr><td><font size="2">PRINTER NAME:</font><font color=red>*</font></td><td><input type="text" size="20" name="printer_name" value=""></td></tr>

	<tr><td><font size="2"> PRINTER DETAIL:</font><font color=red>*</font></td><td><input type="text" size="20" name="printer_detail" value=""></td></tr>
<tr><td><font size="2">LOCATION:</font><font color=red>*</font></td><td>
	...
	<tr>
	<td>
    <a href="DisplayPrinter.jsp" onclick="return popitup('DisplayPrinter.jsp')">View Printer</a> </td>
