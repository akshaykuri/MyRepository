...
<%@ page import="java.io.*" %>     
<%
   String name = request.getParameter( "tblr" );
...
String msg = null;
String n = request.getParameter("tblr");
String p = request.getParameter("t2");
String q = request.getParameter("nameee");
rs = st.executeQuery("select * from nentryblr where idd = '"+n+"' and Npwd = '"+p+"'");
...
<% 
   if(n.equals(sn) && p.equals(sn1))
	 {
	   ...
	   response.sendRedirect("BLRPage.jsp?msg=1");	
   ...
   else
   {
	   ...
	   response.sendRedirect("loginBLR.jsp?msg="+msg);	
...
<table width="1118" align="center" border="0" cellspacing="0" cellpadding="0">
  <tr align="center">
    <td bgcolor="#ec691f"><strong><font size ="5" color="white"><b>BANGALORE BRANCH</b><br />
...
<a href="loginBLR.jsp?msg=1"><img src="bakk.png" border="0" height="45" width="45"></a><address>BACK</address> 
</td> 
</tr> 
</table> 
