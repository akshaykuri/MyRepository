...
<tr align="center">
 ...
 <tr > <td bgcolor=""><font size ="2">NAME :<%=session.getAttribute("Nname")%> </font>&nbsp;&nbsp; 
       ...
       <td width="1118" align="right"><a href="logout.jsp"><font size=2>LOGOUT</font></a></td> 
 </tr>
</table>
...
%>
<form name="form1" method="post" action="IMSViewTextBranchForm.jsp?msg=1" onsubmit="return validate();">
...
<a href="imsSelectionBranch.jsp?msg=1"><img src="bakk.png" border="0" height="35" width="35"></a><address><font size="2">BACK</font></address> 
</td> 
</tr> 
</table> 
