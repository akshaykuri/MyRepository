...
<%
	...
	try 
		...
		String divNmae= request.getParameter("bcode");
		psmt3 = conn.prepareStatement("insert into gsnetprimarydivmaster(divName) values(?);");
	    psmt3.setString(1, divNmae);  
		...
		msg="inserted__successfully............";
		 ...
		 response.sendRedirect("primaryDivisionMaster.jsp?msg="+msg);
%>
</body>
</html>