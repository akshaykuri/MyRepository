...
f.method="post";    
f.action='gsnetBranchCodeMasterDel.jsp?id='+cname;    
f.submit();
}
	else{}
}
...
<center>
	...
	<table border="1" width='100' align="center" bgcolor="#F0F0F0" bordercolor="grey">
		<tr>
		  ...
		  <td height="20" bgcolor="white" width="120" align=center><font size="2" color="black"><b>GSNET BRANCH CODE</b></font></td>
...
String query = "select * from gsnetbranchcodemaster  ORDER BY branchcode";
