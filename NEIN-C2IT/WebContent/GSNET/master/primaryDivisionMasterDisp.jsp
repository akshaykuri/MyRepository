...
f.method="post";    
f.action='primaryDivisionMasterDel.jsp?id='+cname;    
f.submit();
}
	else{}
}
...
<center>
	...
	<table border="1" width='100' align="center" bgcolor="#F0F0F0" bordercolor="grey">
		<tr>
		  <td height="20" bgcolor="white" width="120" align=center><font size="2" color="black"><b>SR._NO.</b></font></td>
		  <td height="20" bgcolor="white" width="120" align=center><font size="2" color="black"><b>PRIMARY DIV NAME</b></font></td>
		  <td height="20" bgcolor="white" width="120" align=center><font size="2" color="black"><b>DELETE</b></font></td>
      	</tr>
...
String query = "select * from gsnetprimarydivmaster  ORDER BY divName";
...
%>
	 ...
	 <tr>
        ...
        <td id="hiderow"><input id="hiderow" type="button" size="2" name="delete" value="Delete" style="background-color:white;font-weight:bold;color:black;" onclick="deletePDiv('<%=rs.getString(2)%>');" ></td>
    </tr>
		<%}%>
