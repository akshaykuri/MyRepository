...
<script type="text/javascript">
  ...
  {  var p1=document.form.branch1; var y1=document.form.year1;
   if ((p1.value==null)||(p1.value=="NULL"))
 				{alert("Select GSNET Number!"); p1.focus(); return false; }
...
<tr align="center">
 <td bgcolor="#2f4377" class="blueLine"><strong><font size ="4" color="white">GSNET  FORM</font></strong></td>
</tr>
...
<form name="form" method="post" action="GSNETViewReportBack.jsp?msg=1">
...
if(b_no.equals("90"))
	rs9 = st9.executeQuery("SELECT DISTINCT form_no,full_name FROM form15_gsnet WHERE  form_no LIKE 'NEIN/GSNET%' ORDER BY idextend asc");
else if(b_no.equals("30"))
	rs9 = st9.executeQuery("SELECT DISTINCT form_no,full_name FROM form15_gsnet WHERE  req_Branch in('30','11','53','32') ORDER BY req_Branch asc");
else if(b_no.equals("54"))
	rs9 = st9.executeQuery("SELECT DISTINCT form_no,full_name FROM form15_gsnet WHERE  req_Branch in('54','44') ORDER BY req_Branch asc");

else
   rs9 = st9.executeQuery("SELECT DISTINCT form_no,full_name FROM form15_gsnet WHERE req_Branch='"+b_no+"' AND form_no LIKE 'NEIN/GSNET%' ORDER BY idextend asc");
...
<table align="center">
<tr>
<th>SELECT GSNET FORM NUMBER</th>
</tr>
</table>
