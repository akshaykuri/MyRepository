...
if(mmdradio.equals("Approved") && higherAuthority.equals("higherAuthority"))
        ...
        postMail.postMail(i_email_id,i_name,"pass1234",hoitmail,"NEIN-C2IT GSNET USER FORM :  " +form_no+ " ", "Dear Mr.KISHAN GOWDA, <br><br>GSNET USER FORM : "+form_no+",  Approved by " +i_name+ " ,<br>GSNET Form send for create User ID and Password. <br>Remarks : "+txtmail_msg+"<br><b><u> Open the following URL</u> </b><br> C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
       ...
       psmt2 = cn2.prepareStatement("UPDATE form15_gsnet set finalApproved='Final'  where form_no='"+form_no+"'");
       int j = psmt2.executeUpdate();
       ...
       while(rs1.next())
          ...
          postMail.postMail(i_email_id,i_name,"pass1234",allMails1,"NEIN-C2IT GSNET USER FORM :  " +form_no+ " "," "+  " GSNET USER FORM : "+form_no+" Is Approved by " +i_name+ " . <br>Remarks : "+txtmail_msg+"<br><b><u> Open the following URL</u> </b><br> C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
          }
        }
  else 
        {
