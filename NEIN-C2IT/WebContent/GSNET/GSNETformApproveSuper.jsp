...
<form name="form" method="post" action="GSNETformApprove1super.jsp?msg=1">
<%
...
rs9 = st9.executeQuery("SELECT DISTINCT form_no FROM form15_gsnet_item WHERE ((emp='"+AdminName+"' and desg='"+desg+"')|| empid='"+emp_no+"') and status='Pending' AND form_no LIKE 'NEIN/gsnet%' ORDER BY form_no ASC");
