...
try
{
	...
	st.executeUpdate("update nentryccu set idd='"+idb+"',Nname='"+Nnameb+"',Npwd='"+Npwdb+"',Naddr='"+Naddrb+"',Ncontact='"+Ncontactb+"',Npost='"+Npostb+"',NpostingCo='"+NpostingCo+"',Nmail='"+Nmail+"' where id='"+num+"'");
	response.sendRedirect("DisplayDelCcu.jsp");
}
catch(Exception e)
{
