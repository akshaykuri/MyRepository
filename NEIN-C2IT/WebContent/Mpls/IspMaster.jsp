...
<script language="javascript" type="text/javascript">
	function Validation()
	{ 		
		 var ispname = document.forms["form1"]["ispname"].value; 
		if(ispname == ''){		
...
<br><br>
<form method="post" name="form1" action="InsertIspMaster.jsp">
...
<table  align="center" border="1" width="30%"> 
   ...
   <tr>
		...
		<td><input type="text" name="ispname" id="ispname"  size="50"></td>		
   </tr>
   <tr>
      <td colspan="2" align="center" >
         ...
         <a href="DisplayIsp.jsp" onclick="return popitup('DisplayIsp.jsp')">VIEW ALL</a> 
      </td>
   </tr>
 </table>
