...
<%
   ...
   <tr><td><span style="color:red;">*</span>Circuit Id:</td><td>
    ...
    <tr>	
		...
		<td><input type="text" name="Location" id="Location" value="<%=rsx.getString("b_name")%>"  readonly size ="30">
		    ...
		    <input type="hidden" name="xvalue" id="xvalue"  value="1" readonly size ="30">
