...
<body>
                       <%
	                       ...
	                       String ImpactedMPLS=request.getParameter("ImpactedMPLSIds"); 
 							       ...
 							       try
 							          {
 								       ...
 								       if(id==0)
 						                  ...
 						                  prds = con.prepareStatement("INSERT INTO circuitidmaster_details(`id`, `circuit_Id`, `linktype_id`, `branch_id`,"+
					 						                		  "`lanpool`, `wanpool`, `Acc_relation_no`, `bandwidth`, `media`, `arc`, `otc`, `po_number`,"+
					 						                		  " `po_date`,`isp_name`,`nickName`,`ImpactedMPLS`) "+
					 						                		  "VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) ");   
 				                          prds.setInt(1,id);
				                          ...
				                          prds.setString(14,isp_name);
				                          prds.setString(15,nickName);
				                          prds.setString(16,ImpactedMPLS);
