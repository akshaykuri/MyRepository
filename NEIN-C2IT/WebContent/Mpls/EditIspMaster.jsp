...
<form method="post" action="UpdateIspMaster.jsp">
<br />
<br /><br />
<table border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey" width="50%">
	<tr>
		<td bgcolor="lightgrey" width="120" align="center" colspan="2"><font color="black">Isp Name</font></td>	    
		</tr>
<%
	  ...
	  try 
	    {  
		   ...
		   String query1 = "select * from isp_master where id="+id;
		   st = conn.createStatement();
		   rs = st.executeQuery(query1);  %>
         <tr>
              
	        <% while(rs.next()){ %>
	           <td width="120" align="center" colspan="2"><input name="ispname" size="60"  style="background-color:white;color:black;" value="<%=rs.getString(2)%>">	
