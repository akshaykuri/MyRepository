...
<script language="javascript" type="text/javascript">
	function Validation()
	{ 		
		 var branch = document.forms["form1"]["branchNo"].value; 
...
<input type="hidden" name="view" value="mplsreport1">
          ...
          Location:
           ...
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp;                   	
		        ...
		        <option value="Select">Select</option>
	              <%while(rs2.next()){%>
			         <option value="<%=rs2.getString("circuit_Id")%>"><%=rs2.getString("circuit_Id")%></option>
    	            <%}%>
	           </select>
