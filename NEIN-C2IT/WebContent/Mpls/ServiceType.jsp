...
<br><br>
<form method="post" name="form1" action="InsertServiceTypeMaster.jsp">
...
<table  align="center" border="1" width="40%"> 
   <tr>
		<td> <span style="color:red;">*</span>Service Type:</td>
		<td><input type="text" name="serviceType" id="serviceType"  size="50"></td>		
   </tr>
   <tr>
      <td colspan="2" align="center" >
         ...
         <a href="DisplayServiceType.jsp" onclick="return popitup('DisplayServiceType.jsp')">VIEW ALL</a> 
      </td>
   </tr>
 </table>
