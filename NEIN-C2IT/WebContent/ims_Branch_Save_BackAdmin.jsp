...
PreparedStatement psmt=null,psmtArray=null;
...
if(i>0){
  ...
  // postMail.postMail(mail,"pass1234",mail," IMS DAILY WORK LOG : For Date:  " +Send_date+ " ",  "<b> " +admin_name+  " "+  "</b>Sent You IMS DAILY WORK LOG <font color=blue>" +new_id+ "</font> <br><br><b><u> Open the following URL</u> </b><br> Local LAN (Within Office) -  http://10.206.10.18:8185/CheckSheet/HOME.jsp  <br> Public Domain (Outside Office) - http://203.124.152.5:8185/CheckSheet/HOME.jsp  <br><br><br><br>"+message);
   ...
   if(admail!=null)
   { postMail.postMailAttachedFileIMS(sysAdminMail,admin_name,"pass1234",admail," IMS DAILY WORK LOG : For Date:  " +Send_date+ " ",  "<b> " +admin_name+  " "+  "</b>Sent You IMS DAILY WORK LOG <font color=blue>" +new_id+ "</font> <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  http://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>",new_id);}
   System.out.println("admail");
   if(gmmail!=null)
   { postMail.postMailAttachedFileIMS(sysAdminMail,admin_name,"pass1234",gmmail," IMS DAILY WORK LOG : For Date:  " +Send_date+ " ",  "<b> " +admin_name+  " "+  "</b>Sent You IMS DAILY WORK LOG <font color=blue>" +new_id+ "</font> <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  http://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>",new_id);}
   System.out.println("gmmail");
   if(brmail!=null)
   { postMail.postMailAttachedFileIMS(sysAdminMail,admin_name,"pass1234",brmail," IMS DAILY WORK LOG : For Date:  " +Send_date+ " ",  "<b> " +admin_name+  " "+  "</b>Sent You IMS DAILY WORK LOG <font color=blue>" +new_id+ "</font> <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  http://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>",new_id);
   }
...
<!-- <a href="adminbom.jsp"><img src="bakk.png" border="0" height="35" width="35"></a> -->
<input type="button" src="bakk.png" onclick="history.go(-1)"/>
