...
String req=null;
	...
	%>
	 ...
	 calender =(String) session.getAttribute("CalCS");
...
<table width="1118" align="center" border="0" cellspacing="0" cellpadding="0">
  <tr align="center">
    <td bgcolor="#ec691f"><strong><font size ="4" color="white"><b></b><br />
    
 </font></strong></td></tr>
 <tr align="center">
 <td bgcolor="#2f4377"><strong><font size ="4" color="white">CHECK LIST REPORT</font></strong></td></tr>
</table>
...
//rs9=st9.executeQuery("SELECT DISTINCT c.cs_id FROM cs_master c INNER JOIN branch_master b ON((substr(c.cs_id,9,2))='"+city_no+"')  INNER JOIN assigned_master a  ON(a.delet=b_name) WHERE c.cs_date='"+dateF+"' GROUP BY c.cs_id");
// if not add this query :::::::::::::::::::::: rs9 = st9.executeQuery("SELECT DISTINCT c.cs_id FROM cs_master c INNER JOIN branch_master b ON((substr(c.cs_id,9,2))='"+city_no+"') WHERE c.cs_date='"+dateF+"'GROUP BY c.cs_id ");
                                                rs9=st9.executeQuery("SELECT DISTINCT c.cs_id  FROM  assigned_master a INNER JOIN branch_master b ON(a.delet=b.b_name) INNER JOIN cs_master c ON((substr(c.cs_id,9,2))=b.b_no) WHERE (substr(c.cs_id,9,2))='"+city_no+"' AND c.cs_date='"+dateF+"'");
/* while(!rs9.next())
{
...
%>
<form name="form1" method="post" action="CheckListViewTextFormBranchAdmin.jsp?msg=1" onsubmit="return validate();">

	
	 
<table align="center">
<tr>
<th>SELECT CHECK LIST NO.</th>
</tr>
</table>
...
<br>	 
  ...
  <table width="280" align="center" border="0" cellpadding="3" cellspacing="1" bgcolor="#ec691f">
   ...
   <tr><!--<th>BRANCH:</th>
	...
	<td align="center">
	<!-- <input style="background-color:#2f4377;font-weight:bold;color:white;" type="submit" align="middle" name="subpopup" value="DISPLAY"/> -->
...
<a href="CheckSheetSelectionAdminBranch.jsp?msg=1"><img src="bakk.png" border="0" height="35" width="35"></a><address><font size="2">BACK</font></address> 
</td> 
</tr> 
</table> 
