...
<tr align="center">
 <td bgcolor="#2f4377" class="blueLine"><strong><font size ="4" color="white">SENT CHECK LIST DISPLAY</font></strong></td>
</tr>
...
<form name="form1" method="post" action="ChecckViewSelectAdminBack.jsp?msg=1" onsubmit="return ValidateForm();">
