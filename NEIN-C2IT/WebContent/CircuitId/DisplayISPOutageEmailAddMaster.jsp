...
function edit(id)
    ...
    var f=document.form;    
    f.method="post";    
    f.action='EditOutageEmailAddMaster.jsp?id='+id;    
    f.submit();
    }
function deleter(id)
    {   	 
	if(confirm('confirm to Delete'))
	      {
           var f=document.form;    
           f.method="post";    
           f.action='DeleteIspOutageEmailAddMaster.jsp?group='+id;    
           f.submit();
          }
	else{}
   }
	     ...
	     <td bgcolor="white" width="30" align=center style="background-color:grey"><font size="2" color="black"><b>Delete</b></font></td>
			...
			//String query = "select * from ispoutageemailgroup_master ";
				...
				query = " select isp.id,b.m_b_name,i.groupName,b.id,isp.empName,isp.empEmail from ispoutageemailadd_master isp "+
		                ...
		                " where isp.branchId IN (select b1.id from branch_master_main b1 ) order by i.groupName ";
