...
<center>
 <br />
	...
	String query = "select *,b1.b_name from circuitidmaster_details c INNER JOIN branch_master b1 ON b1.id=c.branch_id ";
	...
	<td bgcolor="white" width="150"><font size="2" color="black"><%=rs.getString(7)%></font></td>
	<td bgcolor="white" width="150"><font size="2" color="black"><%=rs.getString(8)%></font></td>
	<td bgcolor="white" width="150"><font size="2" color="black"><%=rs.getString(9)%></font></td>
	<td bgcolor="white" width="150"><font size="2" color="black"><%=rs.getString(10)%></font></td>
	<td bgcolor="white" width="150"><font size="2" color="black"><%=rs.getString(11)%></font></td>
	<td bgcolor="white" width="150"><font size="2" color="black"><%=rs.getString(12)%></font></td>
	<td bgcolor="white" width="150"><font size="2" color="black"><%=rs.getString(13)%></font></td>
