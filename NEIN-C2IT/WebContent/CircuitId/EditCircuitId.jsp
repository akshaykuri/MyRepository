...
<form method="post" action="UpdateCircuitIdMaster.jsp">
<br />
<br /><br />
<table border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey" width="50%">
	<tr>
		<td bgcolor="lightgrey" width="120" align="center" colspan="2"><font color="black">Circuit ID</font></td>	    
		</tr>
<%
 ...
 try 
  {
   ...
   String query1 = "select c_id,circuit_Id from circuitidmaster where c_id="+id;
   st = conn.createStatement();
   rs = st.executeQuery(query1);  %>
    <tr>
              
	      <% while(rs.next()){ %>
	         <td width="120" align="center" colspan="2"><input name="circuitId" size="60"  style="background-color:white;color:black;" value="<%=rs.getString(2)%>">	
