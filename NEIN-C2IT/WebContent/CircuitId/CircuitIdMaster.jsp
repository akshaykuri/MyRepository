...
<br><br>
<form method="post" name="form1" action="InsertCircuitIdMaster.jsp">
...
<table  align="center" border="1" width="30%"> 
   ...
   <tr>
		<td> <span style="color:red;">*</span>Circuit Id:</td>
		<td><input type="text" name="CircuitId" id="CircuitId"  size="50"></td>		
   </tr>
   <tr>
      <td colspan="2" align="center" >
         ...
         <a href="DisplayCircuitid.jsp" onclick="return popitup('DisplayCircuitid.jsp')">VIEW ALL</a> 
      </td>
   </tr>
 </table>
