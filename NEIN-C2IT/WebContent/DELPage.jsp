...
<table width="1118" align="center" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr align="center">
 <td bgcolor="#2f4377"><strong><font size ="4" color="white">DELHI BRANCH</font></strong></td></tr>
</table>
...
<ul id="sidebarmenu1">
 ...
 <li><a href="MrHomePageDEL.jsp?msg=1">MATERIAL REQUISITION</a></li>

  <li><a href="ComparisionValidationDEL.jsp?msg=1">QUOTATION & COMPARISON</a>
 <!--  <ul>
...
-->
 <li><a href="DELvalidation.jsp?msg=1">PURCHASE ORDER</a></li>
 
 <li><a href="DELPage.jsp?msg=1">DELIVERY DETAILS</a>
  <ul>
  <li><a href="DeliveryPageDEL.jsp?msg=1">DELIVERY</a></li>
  <li><a href="ChequeDEL.jsp?msg=1">CHEQUE</a></li>
  <li><a href="PaymentCL_DEL.jsp?msg=1">PAYMENT COVERING LETTER</a></li>
 
  </ul>
  </li>
  <li><a href="warrantyDEL.jsp?msg=1">WARRANTY DETAILS</a>
  </li>
  <li><a href="DELPage.jsp?msg=1">REPORTS</a>
  <ul>

  <li><a href="PCL_PDF_DEL.jsp?msg=1">PRINT PAYMENT COVERING LETTER</a></li> 
  </ul>
  </li>
</ul>
...
<a href="loginDEL.jsp?msg = 1"><img src="bakk.png" border="0" height="35" width="35"></a><address><font size="2">BACK</font></address>
</td> 
</tr> 
</table> 
