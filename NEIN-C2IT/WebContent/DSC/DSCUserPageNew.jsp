...
<script language="javascript" type="text/javascript">  
function getItem(requestOption)
{
...
<script language = "Javascript">
          ...
          function validate(){
        	  var selectN = document.form.requestOption;
       ...
       if ((fn.value==null)||(fn.value=="")){
                ...
                alert("Please enter correct emp code and Emp shoulde must be in HRMS!");
                fn.focus()
                return false
                }
  ...
  function getInfo()
             ...
             if(xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
                            { 
                             ...
                             document.getElementById("resultFromAjax2").innerHTML = str2;//full_name,branch,department,Designation,idreporting_officer
                             ...
                             document.getElementById("Designation").value =  document.getElementById("p2").value;
                      		 ...
                      		 document.getElementById("department").value =  document.getElementById("p4").value;
...
try{
	...
	rsD = stD.executeQuery("select DISTINCT Nname from  formuser_master WHERE Npost <> 'IT SUPPORT' AND Npost <> 'SOFTWARE ENGINEER' AND Npost <> 'EXECUTIVE' ORDER BY Nname Asc");
...
<tr >
	...
	<input type="hidden" name = "requestOption" value ="New"/>
	</td>
	<td colspan="3" align="center"><b>NEW REQUEST</b></td>
	</tr>
	<tr>
<td align="right"><font color=red>*</font>Request  :</td>
<td style="font-weight:bold;font-style:italic;width:23%;" colspan="3"> 
     <input style="" name = "requestOption" value ="New"  type ="radio" id="New" checked="checked" />New
     <input type ="radio" name = "requestOption" value ="De-activate"  id="De-activate" onclick="javascript:yesnoCheck();"/>De-activate
     </td>
...
<td style="text-align:left;"><input type="text" name="emp_code"   id="emp_code" size="29" maxlength="14" onkeypress="return isNumber(event)" onkeyup="sendInfo(this.value);"/></td>
<td  style="text-align: right;"><font color=red>*</font>Full Name :</td>
<td style="text-align:left;"><input type="text" name="full_name"   id="full_name" size="29" value="" readonly/></td>
</tr>
<tr>
<td  style="text-align: right;width:23%;"><font color=red>*</font>Branch :<input type="hidden" name="cin_no" id="cin_no" value="New" /></td>
...
<select name="branch"  id="hiderow" style="font-size : 8pt">
					...
					<%} %> </select> </td>  --%>
<td style="text-align:left;"><input type="text" name="branch"   id="branch" size="29" value="" readonly/></td>
...
<select name="depart"  id="hiderow" style="font-size : 8pt">
					...
					<%} %> </select> </td>  --%>
<td style="text-align:left;"><input type="text" name="depart"   id="department" size="29" value="" readonly/></td>
</tr>
...
<td style="text-align:left;"><input type="text" name="designation"   id="Designation" size="29" value="" readonly/></td>
<td  style="text-align: right;"><font color=red>*</font>Reporting Officer  :</td>
<%-- <td style="text-align:left;"><!-- <input type="text"  readonly="readonly" name="reporting_officer" size="29" id="rofficer" maxlength="44"/> -->
<select name="reporting_officer"  id="hiderow" style="font-size : 8pt">
					<option value="" style="background: lightgrey;" > ---Select---</option>
					<%while(rsD.next()){ %>
					<option> <%=rsD.getString("Nname")%> </option> 
					<%} %> </select>
</td> --%>
<td style="text-align:left;"><input type="text" name="reporting_officer"   id="rofficer" readonlysize="29" value="" readonly/></td>
</tr>
<tr>
...
<td style="text-align:left;"><input type="text" name="requestBy" id="req" value="<%=Name%>" size="29" maxlength="44"/></td>
