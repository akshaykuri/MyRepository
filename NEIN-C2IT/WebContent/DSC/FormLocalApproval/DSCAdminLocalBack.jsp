...
String requestOptionType = request.getParameter("requestOptionType");
String requestOptionTypeDate = request.getParameter("requestOptionTypeDate");
...
System.out.println("I executed : "+i);
...
System.out.println("j executed : "+j);
PreparedStatement psmt10=null;
psmt10 = cn2.prepareStatement("UPDATE form11_dsc SET Approval_status=?,Approval_sttatuss=?,Approval_remarks=?,Approval_f_date=?,Approval_emp=?,Approval_desg=?,Approval_empp=?,Approval_desgg=?,requestOptionType=?,requestOptionTypeDate=? WHERE form11_no=?");
...
psmt10.setString(9,requestOptionType);
psmt10.setString(10,requestOptionTypeDate);
psmt10.setString(11,form_no);
int b = psmt10.executeUpdate(); 
System.out.println("b executed : "+b);
...
//postMail.postMail(i_email_id,"pass1234",mail," DSC USER FORM :  " +form_no+ " ",i_name+  " "+  "request your approval for the following DSC USER FORM. " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> Local LAN (Within Office) -  https://10.206.10.3:8185/NEIN-C2IT/HOME.jsp  <br> Public DSC (Outside Office) - https://203.124.152.5:8185/NEIN-C2IT/HOME.jsp  <br><br><br><br>"+message);

/* if(mmdradio!=null && mmdradio.equals("Approved"))
{
	postMail.postMail(i_email_id,"pass1234",mail," DSC USER FORM :  " +form_no+ " ",i_name+  " "+  "approved your request " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> Local LAN (Within Office) -  https://10.206.10.3:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
}
if(mmdradio!=null && mmdradio.equals("Not Approved"))
{
	postMail.postMail(i_email_id,"pass1234",mail," DSC USER FORM :  " +form_no+ " ",initiatorNameIfNotApproved+  " "+  "request Is NOT Approved " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> Local LAN (Within Office) -  https://10.206.10.3:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>");
}
 */
...
{   // if Approved and sending again to Higher authority 
	System.out.println("Sending to next higher authority ");
...
{   // if Approved and want to send directly to IT nonIT persons of HO and ONE copy to Initiator
	postMail.postMail(i_email_id,i_name,"pass1234",mail," DSC FORM :  " +form_no+ " ",i_name+  " "+  "request you to approve - DSC FORM : " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
	postMail.postMail(i_email_id,i_name,"pass1234",allMails," DSC FORM :  " +form_no+ " ",initiatorNameIfNotApproved+  " "+  "your request for DSC FORM "+form_no+" has been approved by " +i_name+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>");
}
...
{   // if NOT Approved , so a copy to Initaior 
	postMail.postMail(i_email_id,i_name,"pass1234",mail," DSC USER FORM :  " +form_no+ " ",initiatorNameIfNotApproved+  " "+  "request Is NOT Approved " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>");
} */
...
response.sendRedirect("DSCSelectLocalAdmin.jsp?msg=" +msg);
