         ...
         xmlHttp= new XMLHttpRequest();    
           ...
           alet("Creating html http object");    
             xmlHttp= new ActiveXObject("Microsoft.XMLHTTP");  
                    ...
                    alert("Browser does not support XMLHTTP Request");    
                      return;     
                       }       var url="../../ResendMailDSC?mail="+mail+","+form1_no+","+empD+"";  
...
//String a_model=null,a_data_card=null,a_email=null,a_newins=null,a_DSC=null,a_mobile_model=null,a_mobile_no=null,a_access_card=null,a_drive=null,a_other_asset=null,a_remarks=null;
//String r_model=null,r_data_card=null,r_email=null,r_newins=null,r_DSC=null,r_mobile_model=null,r_mobile_no=null,r_access_card=null,r_drive=null,r_other_asset=null,r_remarks=null;
...
<td style="text-align:left;" colspan="3"><input name="branch" value="<%=cin_no%>" size="31" readonly="readonly"/> </td>
...
<input type="text"   name="d_resignation" size="31" value="<%=scopeOfWork%>" readonly="readonly"  readonly="readonly" />
...
<table id="tableData" name="tableData" width="895" border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
	  ...
	  String statusD=null;
	  rs1 = st1.executeQuery("select form11_no,desg,emp,status,remarks,DATE_FORMAT(f_date,'%d/%m/%Y'),mail from form11_dsc_item WHERE form11_no='"+req+"'"); 
	  while(rs1.next())
	  {
		  String form11_noD= rs1.getString(1);
