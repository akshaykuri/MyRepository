...
<form name="form" method="post" action="DSCLocalAllAdmin.jsp?msg=1">
...
if(b_no.equals("90"))
rs9 = st9.executeQuery("SELECT DISTINCT form11_no,full_name FROM form11_dsc WHERE form11_no LIKE 'NEIN/CS/DSC%' ORDER BY form11_no DESC");
else
	rs9 = st9.executeQuery("SELECT DISTINCT form11_no,full_name FROM form11_dsc WHERE i_b_no='"+b_no+"' AND form11_no LIKE 'NEIN/CS/DSC%' ORDER BY idextend DESC");
