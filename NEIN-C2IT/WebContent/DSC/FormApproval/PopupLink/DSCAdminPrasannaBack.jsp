...
if(ApprovalOption.equals("ContinueStatus"))
{
	...
	//psmtApOp1 = cn2.prepareStatement("UPDATE form11_dsc_item SET status=?,remarks=?,f_date=?,presence=? WHERE form11_no=? AND desg=? AND emp=? ");
	psmtApOp1 = cn2.prepareStatement("UPDATE form11_dsc_item f,(SELECT max(id) as idf FROM form11_dsc_item WHERE form11_no=? AND desg=? AND emp=?) as p SET f.status=?,f.remarks=?,f.f_date=?,f.presence=? WHERE f.form11_no=? AND f.desg=? AND f.emp=? AND f.id=p.idf");
	...
	psmtApOp2 = cn2.prepareStatement("UPDATE form11_dsc SET Approval_status=?,Approval_sttatuss=?,Approval_remarks=?,Approval_f_date=?,Approval_emp=?,Approval_desg=?,Approval_empp=?,Approval_desgg=? WHERE form11_no=?");
	...
	psmtApOp3 = cn2.prepareStatement("INSERT INTO form11_dsc_item(form11_no,desg,emp,status,remarks,f_date,mail,presence) VALUES(?,?,?,?,?,?,?,?)");
	...
	{  System.out.println("if Approved and sending again to Higher authority ");
		postMail.postMail(i_email_id,i_name,"pass1234",Mail1," DSC  FORM :  " +form_no+ " ",i_name+  " "+  "request you to Approve - DSC  FORM :"+form_no+ " <br><br><b><u> Open the following URL</u> </b><br>C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
	}
	...
	{   System.out.println("if Approved and want to send directly to IT nonIT persons of HO and ONE copy to Initiator");
		postMail.postMail(i_email_id,i_name,"pass1234",Mail1," DSC  FORM:  " +form_no+ " ",i_name+  " "+  "request you to approve - DSC  FORM :" +form_no+ " <br><br><b><u> Open the following URL</u> </b><br>C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
		//postMail.postMail(i_email_id,i_name,"pass1234",allMails," DSC  FORM :  " +form_no+ " ",initiatorNameIfNotApproved+  " "+  "approved your request " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br>C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>");
		postMail.postMail(i_email_id,i_name,"pass1234",allMails," DSC  FORM :  " +form_no+ " ","your request for DSC  FORM : "+form_no+" has been approved by " +i_name+ " <br><br><b><u> Open the following URL</u> </b><br>C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>");
	}
/* 	if((mmdradio!=null && mmdradio.equals("Not Approved"))&&(higherAuthority!=null && higherAuthority.equals("directApprove")))
	...
	{
	postMail.postMail(i_email_id,i_name,"pass1234",mailingCheck[u]," DSC  FORM :  " +form_no+ " ",i_name+  " "+  "request is Approved " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br>C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> Public DSC (Outside Office) - https://203.124.152.5:8185/NEIN-C2IT/HOME.jsp  <br><br><br><br>"+message);
	} */
...
//psmt = cn2.prepareStatement("INSERT INTO form11_dsc_item(status,remarks,f_date,presence,form11_no,desg,emp) VALUES(?,?,?,?,?,?,?)");
...
// this one Approval_sttatuss for showing in status for admin.
psmt2 = cn2.prepareStatement("UPDATE form11_dsc SET ITusername=?,ITpassword=?,ITcreated=?,ITremark=?,Approval_sttatuss=?,Approval_f_date=?,reminder=? WHERE form11_no=?");
...
int j = psmt2.executeUpdate();
		...
		/* for(int u=0;u<mailingCheck.length;u++)
		{
		postMail.postMail(i_email_id,i_name,"pass1234",mailingCheck[u]," DSC  FORM :  " +form_no+ " ","your request for DSC  FORM "+form_no+" is Approved by " +i_name+ " <br><br><b><u> Open the following URL</u> </b><br>C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
		} */
		...
		if((SendExtraMails!="NULL")||(mmdradioBcc=="Yes"))
				...
				//	postMail.postMail(i_email_id,i_name,"pass1234",mailingCheck[u]," DOMAIN USER FORM :  " +form_no+ " ","your request for DOMAIN USER FORM "+form_no+" is Approved by " +i_name+ " <br><br><b><u> Open the following URL</u> </b><br>C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
					...
					postMail.postMailCC(i_email_id,i_name,"pass1234",mailingCheck[u],CCList," DSC  FORM :  " +form_no+ " ","your request for DSC  FORM "+form_no+" is Approved by " +i_name+ " <br><br><b><u> Open the following URL</u> </b><br>C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
					} */
				 	postMail.sendMailCC(i_email_id,i_name,ToMail,CCList," DSC  FORM :  " +form_no+ " ","your request for DSC  FORM "+form_no+" is Approved by " +i_name+ " <br><br><b><u> Open the following URL</u> </b><br>C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
				}
				else
				{
					for(int u=0;u<mailingCheck.length;u++)
...
msg = "DSC__FORM__NO__:__'"+form_no+"'__SAVED__AND__SENT__SUCCESSFULLY";
System.out.println("result..date..........."+form_date);
//response.sendRedirect("ITclearanceSelectAdmin.jsp?msg=" +msg);
//response.sendRedirect("DSCUserSelectAdmin.jsp?msg=" +msg);
