...
<form name="form" method="post" action="CCDReportformApprove1super.jsp?msg=1">
<%
...
rs9 = st9.executeQuery("SELECT DISTINCT form_no FROM form13_ccdreport_item WHERE ((emp='"+AdminName+"' and desg='"+desg+"')|| empid='"+emp_no+"') and status='Pending' AND form_no LIKE 'NEIN/CCD%' ORDER BY id desc");
