...
rs3 = st3.executeQuery("SELECT max(idextend) FROM form14_ccdregistration WHERE form10_no IN(SELECT form10_no FROM form14_ccdregistration LEFT JOIN branch_master b ON(substr(form10_no,13,2)=b.b_no) WHERE '"+b_no+"'=b.b_no GROUP BY form10_no)");
...
<b><font color=red>*</font>Send To RO/SRO:</b>
	<br />
