...
rs9 = st9.executeQuery("SELECT DISTINCT form10_no FROM form14_ccdregistration_item WHERE ((emp='"+AdminName+"' and desg='"+desg+"') or (empid='"+EmpNo+"')) and status='Pending' AND form10_no LIKE 'NEIN/CCDReg%' ORDER BY form10_no ASC");
