...
if((mmdradio!=null && mmdradio.equals("Approved"))) 
    ...
    psmt2 = cn2.prepareStatement("UPDATE form14_ccdregistration SET ITusername=?,ITpassword=? WHERE form10_no=?");
	...
	psmt4 = cn2.prepareStatement("SELECT mail,emp FROM form14_ccdregistration_item WHERE form10_no=?");
	psmt4.setString(1,form_no);
    ResultSet rs1 = psmt4.executeQuery();
	while(rs1.next())
	    {
	    allMails1 = rs1.getString(1); 
		postMail.postMail(i_email_id,i_name,"pass1234",allMails1,"NEIN-C2IT CCD SOFTWARE USER - REGISTRATION FORM :  " +form_no+ " ",i_name+  " "+  "Created User has per the " +form_no+ " request <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  http://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
        }
