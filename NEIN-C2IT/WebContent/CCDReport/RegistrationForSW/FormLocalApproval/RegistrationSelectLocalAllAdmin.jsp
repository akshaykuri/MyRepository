...
if(b_no.equals("90"))
    rs9 = st9.executeQuery("SELECT DISTINCT form10_no,full_name,Software FROM  form14_ccdregistration   ORDER BY form10_no DESC");
else if(b_no.equals("30"))
	rs9 = st9.executeQuery("SELECT DISTINCT form10_no,full_name,Software FROM  form14_ccdregistration WHERE i_b_no in('30','32','11','53') ORDER BY form10_no DESC");

	
else
	rs9 = st9.executeQuery("SELECT DISTINCT form10_no,full_name,Software FROM  form14_ccdregistration WHERE i_b_no='"+b_no+"'  ORDER BY idextend DESC");
