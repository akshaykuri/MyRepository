...
<table width="907"  cellspacing="0" cellpadding="0" bgcolor="grey" align="center">
	 <tr>
		...
		<b><label>CCD APPLICATION USER - REGISTRATION FORM</label>
		</b></font></center> 
...
<table width="895" border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
	  ...
	  rs1 = st1.executeQuery("select form10_no,desg,emp,status,remarks,f_date,mail,empid,levelno from form14_ccdregistration_item WHERE form10_no='"+req+"' ORDER BY id ASC"); 
	  while(rs1.next())
	      {
...
<%String flag = c2ITUtil1.getAuthorizedNameCCDRegistration(form10_no,session.getAttribute("Nname").toString(),session.getAttribute("desg").toString(),EmpNo); %>
...
<table align="center" class="dynatable" width="100%" border="1" style="height: 150;" cellspacing="0" cellpadding="0" bgcolor="lightgrey">
  ...
  /*    String url = "jdbc:mysql://localhost:3306/";
     ...
     String maxlevel="";
      ...
      rs12= st12.executeQuery("SELECT max(levelno) FROM formapproval WHERE branch='"+i_b_no+"' and formtype='CCDUser'  ORDER BY levelno ASC");
     if(rs12.next())
         { 
    ...
    rs11 = st11.executeQuery("SELECT alloptions,directApprove FROM formapproval WHERE branch='"+i_b_no+"' and empid='"+emp_no+"' and formtype='CCDUser'");
     if(rs11.next())
         { 
     ...
     //System.out.println("Next  Level no :"+nextlevel);
      ...
      rsnext = stnext.executeQuery("SELECT * FROM formapproval WHERE branch='"+i_b_no+"' and levelno='"+nextlevel+"' and formtype='CCDUser' ORDER BY levelno ASC");
      if(rsnext.next())
           {
     ...
     if(allopt.equals("0")||allopt.equals(""))
    	   ...
    	   if(!levelno.equals(maxlevel))
    	         ...
    	         rs5 = st5.executeQuery("SELECT * FROM formapproval WHERE branch='"+i_b_no+"' and levelno='"+nextlevel+"' and formtype='CCDUser' ORDER BY levelno ASC");
    	         if(rs5.next())
                     {
              ...
              <%}}
               else
                  {
            	   ...
            	   napprovalsw1="Final"+","+developer_name+","+"Manager"+","+developer_mail+","+"Creater";
