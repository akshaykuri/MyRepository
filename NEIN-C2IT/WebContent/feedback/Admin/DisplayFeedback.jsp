...
var f=document.form;    
f.method="post";    
f.action='FeedbackEdit.jsp?id='+id;    
f.submit();
}
...
<center>
	...
	<table border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
		...
		<td height="20" bgcolor="white" width="120" align=center><font size="2" color="black"><b>FEEDBACK NAME</b></font></td>
...
String query = "select * from about_master";
