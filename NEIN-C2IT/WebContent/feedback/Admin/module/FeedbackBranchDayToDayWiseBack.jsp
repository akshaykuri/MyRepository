...
<table id="invoicetable" width="1200" bgcolor="" cellpadding="4" cellspacing="6" align="center" border=1>
	...
	<table class="dynatable" width="1200" border="1" style="height: 150;" cellspacing="0" cellpadding="0" bgcolor="lightgrey" align="center">
				...
				<tr style="background-color:gray;">
					...
					<td width="" align="center"  height="21" ><b>Sl No</b></td>
							<td  width="67" align="center"  height="21" bgcolor="grey"><font size="2">NAME</font></td>
				<td  width="67" align="center"  height="21" bgcolor="grey"><font size="2">DATE</font></td>
					<td width="67" align="center"  height="21" bgcolor="grey"><font size="2">BRANCH</font></td>
					<td width="67" align="center"  height="21" bgcolor="grey"><font size="2">ABOUT</font></td>
					<td width="67" align="center"  height="21" bgcolor="grey"><font size="2">SYSTEM ADMIN</font></td>
					<td width="67" align="center"  height="21" bgcolor="grey"><font size="2">REMARKS/FEEDBACK</font></td>
				    ...
				    <%int flag=0;
				           ...
				           rs2 = st2.executeQuery("SELECT name,feedback,date,user_mail_id,gm_mail_id,Branch,About,systemAdmin FROM feedback WHERE Branch='"+req+"' and date >= '"+dateF+"' AND date <='"+dateFF+"' ORDER BY YEAR(date),MONTH(date),DATE(date)");
