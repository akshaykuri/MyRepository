...
<script type="text/javascript">
 ...
 function OnButton1() {
   			 document.form.action="FeedbackBranchDayToDayWiseBack.jsp?msg=1";
   			 document.form.method="post";
   			 document.form.submit();
   			     }
...
<tr align="center">
 <td bgcolor="#2f4377" colspan="2"><strong><font size ="4" color="white">FEEBACK - BRANCH WISE REPORT</font></strong></td></tr>
