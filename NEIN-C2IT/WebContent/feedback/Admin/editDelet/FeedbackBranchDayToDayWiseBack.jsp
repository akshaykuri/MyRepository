...
f.method="post";   
/* alert("ID : "+id); */
f.action='../module/feedbackReplyMail.jsp?id='+id;    
f.submit();
}
</script>
...
{    
	if(confirm('You are above to delete a Feedback'))
	{
var f=document.form;    
f.method="post";    
f.action='FeedbackDelete.jsp?id='+id;    
f.submit();
}
	else{}
}
...
<tr><td colspan="5" align="left" bgcolor="grey"><center><b><font size="3" style="font-size: medium;">FEEDBACK DATE TO DATE REPORT</font></b></center></td></tr>
</table>
...
<table id="invoicetable" width="80%" bgcolor="" cellpadding="4" cellspacing="6" align="center" border=1>
	...
	<table class="dynatable" width="80%" border="1" style="height: 150;" cellspacing="0" cellpadding="0" bgcolor="lightgrey" align="center">
				...
				<tr style="background-color:gray;">
					...
					<td width="15%" align="center"  height="21" bgcolor="grey"><font size="2">BRANCH</font></td>
					<td width="15%" align="center"  height="21" bgcolor="grey"><font size="2">ABOUT</font></td>
					<td width="15%" align="center"  height="21" bgcolor="grey"><font size="2">SYSTEM ADMIN</font></td>
					<td width="30%" align="center"  height="21" bgcolor="grey"><font size="2">REMARKS/FEEDBACK</font></td>
					<td id="hiderow" width="5%" align="center"  height="21" bgcolor="grey"><center><font size="2" >REPLY</font></center></td>
					<td id="hiderow" width="5%" align="center"  height="21" bgcolor="grey"><center><font size="2" >DELETE</font></center></td>
				    ...
				    String idno=null;
				           ...
				           rs2 = st2.executeQuery("SELECT id,name,feedback,date,user_mail_id,gm_mail_id,Branch,About,systemAdmin FROM feedback WHERE Branch='"+req+"' and date >= '"+dateF+"' AND date <='"+dateFF+"' ORDER BY YEAR(date),MONTH(date),DATE(date)");
				           ...
				           java.text.SimpleDateFormat sdf2 = new SimpleDateFormat("dd/mm/yyyy");
				            while(rs2.next()){
								...
								systemAdmin = rs2.getString("systemAdmin");
								feedback = rs2.getString("feedback");
								idno= rs2.getString("id");
				            	i++;       		    		 
				            %>
				            <script>id++; </script>
					...
					<tr>
					 ...
					 <td width="" align="center"  height="21" ><font size="2" ><%=branch%></font></td>
						<td width="" align="center"  height="21" ><font size="2" ><%=about%></font></td>
						<td width="" align="center"  height="21" ><font size="2" ><%=systemAdmin%></font></td>
...
<tr> 
<td style="font-size: 1"><input style="size: 1;" type="button" title="Back To Selection Date Page" value="BACK" onclick="window.location.href='FeedbackBranchDayToDayWise.jsp?msg=1'" /></td>
