...
{    
	if(confirm('You are above to delete a Home Page Message'))
	{
var f=document.form;    
f.method="post";    
f.action='homePageMessageDelete.jsp?id='+id;    
f.submit();
}
	else{}
}
...
<tr><td colspan="5" align="left" bgcolor="grey"><center><b><font size="3" style="font-size: medium;">HOME PAGE MESSAGE - DATE TO DATE REPORT</font></b></center></td></tr>
</table>
	...
	<table class="dynatable" width="80%" border="1" style="height: 150;" cellspacing="0" cellpadding="0" bgcolor="lightgrey" align="center">
				...
				<tr style="background-color:gray;">
				    ...
				    <%int flag=0;
				           ...
				           rs2 = st2.executeQuery("SELECT id,note,ndate,status,name FROM notemaster WHERE  ndate >= '"+dateF+"' AND ndate <='"+dateFF+"' ORDER BY id ASC");
				           ...
				           java.text.SimpleDateFormat sdf2 = new SimpleDateFormat("dd/mm/yyyy");
				            while(rs2.next()){
								...
								date2 = rs2.getString("ndate");
								
								
								
								feedback = rs2.getString("note");
				            	i++;       		    		 
				            %>
				            <script>id++; </script>
...
<tr> 
<td style="font-size: 1"><input style="size: 1;" type="button" title="Back To Selection Date Page" value="BACK" onclick="window.location.href='homePageMessage.jsp?msg=1'" /></td>
