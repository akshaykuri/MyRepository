...
<script type="text/javascript">
 ...
 function OnButton1() {
   			 document.form.action="ITsupportBack.jsp?msg=1";
   			 document.form.method="post";
   			 document.form.submit();
   			     }
 function datedatewise4()
 {
 document.form.action="ITsupportBack.jsp";
 document.form.method="post";
 document.form.submit();
 }
...
<tr align="center">
 <td bgcolor="#2f4377" colspan="2"><strong><font size ="4" color="white">MAIL SENT TO IT SUPPORT</font></strong></td></tr>
