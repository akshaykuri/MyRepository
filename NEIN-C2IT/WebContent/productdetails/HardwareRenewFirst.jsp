...
<form  name="form"  method="post"  action="HardwaredetailsRenew.jsp" >
<br><br>
...
<tr align="center">
 <td bgcolor="#2f4377" class="blueLine"><strong><font size ="4" color="white">HARDWARE RENEW</font></strong></td>
</tr>
...
<div class="modal-header">
      <center> <h2>HARDWARE RENEW</h2></center>
    </div>
...
<tr>
<td> Enter Asset Number to Renew</td>
<td><!-- <input type="text" name="assetno" id="assetno" /> -->
<% 
...
String dbName = dbProperties.getString("csdb.dbName");
                                                  ...
                                                  try
                                                     ...
                                                     String query = "SELECT DISTINCT `Asset_no` FROM `hardware_details` WHERE `branch`='"+bno+"' AND `status`='Active'";
                                       ...
                                       <option value="Select">Select</option>
	                                            <%while(rs.next()){ %>
			                                    <option value="<%=rs.getString("Asset_no")%>"><%=rs.getString("Asset_no")%></option>
    	                                        <%}%>
	                                  </select>
