...
<title>HardwareParts Master</title>
...
function cleartext()
	...
	document.getElementById('hardp').value =null;
...
function validate()
     ...
     if ((nn.value==null)||(nn.value==""))
                {
                alert("Please Enter Hardware Parts!");
                nn.focus();
                return false;
                }
...
<form name="form" method="post"  onsubmit="return validate()" action="HardwarePartsMasterBack.jsp">
   <div>
   </BR></BR>
 ...
 <td bgcolor="#2f4377" class="blueLine"><strong><font size ="4" color="white">PRODUCT DETAILS</font></strong></td>
   ...
   <div class="modal-content">
    <div class="modal-header">
              <center> <h2>Hardware Parts Master</h2></center>
    </div>
    ...
    <table border=1>
           ...
           <tr>
                <td><font color="red" size="4">*</font>HARDWARE PART :</td>
                <td><input type="text" name="hardp" maxlength="20" id="hardp" value="" size=20 /></td>
           </tr>
    ...
    <table>
            <tr>
                ...
                <td><a href="DisplayHardware.jsp" onclick="return popitup1('DisplayHardwareParts.jsp')">ViewAllHARDWAREPARTS</a> </td>
