...
<body>
<br><br>
<form  name="form"  method="post" enctype="multipart/form-data" onsubmit="return validateForm()" action="SoftwareDetailsRenewBack.jsp" >
...
String query4="SELECT * FROM `software_details` WHERE `sw_id`=( SELECT max(`sw_id`) FROM software_details WHERE `license_no`='"+licenseno+"' AND `status`='Active')";
...
<tr>
<td>Software Name</td>
<td> <input type="text" name="software" id="software" value="<%=rst.getString("software_name")%>" >	
     <input type="hidden" name="initiator" id="initiator" value="<%=rst.getString("initiator_empid")%>" >
 </td>
</tr>
<tr>
<td>License/Serial No</td>
<td><input type="text" name="sno" id="sno" value="<%=rst.getString("license_no")%>" ></td>
<td>IP Address</td>
<td><input type="text" name="ip" id="ip" value="<%=rst.getString("IP_address")%>"></td>
</tr>
<tr>
<td>PO Number</td>
<td><input type="text" name="ponum"  id="ponum" value="<%=rst.getString("po_number")%>" />                             			</td>
<td>Purchase Date</td>                              			
<td><input type="text" name="pdate" id="pdate" value="<%=rst.getString("purchase_date")%>">
</td>
</tr>
<tr>
<td>Vender</td>
<td><input type="text" id="vname" name="vname" value="<%=rst.getString("vender")%>" >
<td>Contact number</td>
<td><input type="text" name="vnum" id="vnum" value="<%=rst.getString("contact_no")%>"></td>
</tr>
<tr>
...
<tr>
<td>License Type</td>
<td><input type="text" name="licensetype" id="licensetype" value="<%=rst.getString("license_type")%>" >
<input type="hidden" name="nouser" id="nouser" value="<%=rst.getString("No_of_users")%>" >
<td>
