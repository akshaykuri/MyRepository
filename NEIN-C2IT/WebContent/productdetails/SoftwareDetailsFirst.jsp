...
<form  name="form"  method="post"  action="SoftwareDetailsDisplay.jsp" >
<br><br>
...
<div class="modal-header">
      <center> <h2>SOFTWARE DETAILS</h2></center>
    </div>
...
<tr>
<td> Enter License/Serial Number</td>
...
String dbName = dbProperties.getString("csdb.dbName");
                                                  ...
                                                  try
                                                     ...
                                                     String query = "SELECT DISTINCT `software_name`,license_no FROM `software_details` WHERE `branch`='"+bno+"' AND `status`='Active'";
                                       ...
                                       <option value="Select">Select</option>
	                                            <%while(rs.next()){ %>
			                                    <option value="<%=rs.getString("license_no")%>"><%=rs.getString("software_name")%></option>
    	                                        <%}%>
	                                  </select>
