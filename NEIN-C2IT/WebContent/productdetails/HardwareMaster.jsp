...
function cleartext()
	...
	document.getElementById('hard').value =null;
...
<form name="form" method="post"  onsubmit="return validate()" action="HardwaremasterBack.jsp">
   <div>
   </BR></BR>
...
<tr align="center">
 <td bgcolor="#2f4377" class="blueLine"><strong><font size ="4" color="white">ASSET MANAGEMENT</font></strong></td>
</tr>
   ...
   <div class="modal-content">
    <div class="modal-header">
              <center> <h2>Hardware Master</h2></center>
    </div>
    ...
    <table border=1>
           ...
           <tr>
                <td><font color="red" size="4">*</font>HARDWARE :</td>
                <td><input type="text" name="hard" maxlength="20" id="hard" value="" size=20 /></td>
           </tr>
    ...
    <table>
            <tr>
                ...
                <td><a href="DisplayHardware.jsp" onclick="return popitup1('DisplayHardware.jsp')">ViewAllHARDWARES</a> </td>
