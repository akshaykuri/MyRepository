...
<script language="javascript" type="text/javascript">     
   ...
   if (xmlHttp==null)
    ...
    var url="getAsset.jsp";  
	    url +="?AssetType="+m+"&Branch="+b;
...
<form  name="form"  method="post"  action="HardwareAlreadyExists.jsp" >
<br><br>
...
<tr>
<td>Select Asset Group</td>
<td>
<%

String b=null;
b =(String) session.getAttribute("b_no");
...
String query = "SELECT `item_name` FROM `asset_type`";
st = con.createStatement();
rs = st.executeQuery(query);
%>
<select name="item_name" required onchange="showEmp(this.value,<%=b%>)" style="font-size: 11px;width: 142px;overflow: auto;height: 20px " autofocus>      
...
<td>Select Asset Number</td>
<td><div id='assetno'>      
<select name="assetno" required style="font-size: 11px;width: 142px;overflow: auto;height: 20px ">   
