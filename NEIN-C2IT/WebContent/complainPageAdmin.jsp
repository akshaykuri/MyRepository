...
<form method="post" action="complainPageAdminBack.jsp" onsubmit="return ValidateForm();" name="form1">
...
<div id="leftfeature"><input type="button" value="BACK" onclick="window.location.href='complainPageStatus.jsp?msg=1'"/></div>
	<div id="page-wrap">
...
<table align=center bgcolor="lightgrey">
   ...
   <tr> 
      <td style="font-size:1">&nbsp;&nbsp;<input style="size:1;font-size: 1.1em;" type="button"  value="BACK" onclick="window.location.href='complainPageStatus.jsp?msg=1'"/> </td>
