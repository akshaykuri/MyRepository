...
<%!
	            ...
	            String total_val=null;
	              ...
	              Object logInName = null,desg=null,city=null,Initiator=null,locationNO=null;
	            // String transId = null;  
	...
	<table class="dynatable" width="1200" border="1" style="height: 150;" cellspacing="0" cellpadding="0" bgcolor="lightgrey" align="center">
				...
				<tr>
				    ...
				    <%
				         ...
				         //  rs2 = st2.executeQuery("select TIME(cm_time),TIME(cm_time2),TIMEDIFF(cm_time2,cm_time) as cm_time_diff,complain_id,cm_name,transid,cm_location,cm_problem,cm_status,admin_remarks,emp,cm_type from complain_master_item WHERE cm_date='"+cs_datett+"' AND emp='"+realname+"' UNION select TIME(cm_time),TIME(cm_time2),TIMEDIFF(cm_time2,cm_time) as cm_time_diff,complain_id,cm_name,transid,cm_location,cm_problem,cm_status,admin_remarks,emp,cm_type from complain_master_item WHERE cm_date2='"+cs_datett+"' AND emp='"+realname+"' ");
				           psmt = cna2.prepareStatement("select TIME(cm_time),TIME(cm_time2),TIMEDIFF(cm_time2,cm_time) as cm_time_diff,cm_time,cm_time2,complain_id,cm_name,transid,cm_location,cm_problem,cm_status,admin_remarks,emp,cm_type from complain_master_item WHERE cm_date=? AND emp=? UNION select TIME(cm_time),TIME(cm_time2),TIMEDIFF(cm_time2,cm_time) as cm_time_diff,cm_time,cm_time2,complain_id,cm_name,transid,cm_location,cm_problem,cm_status,admin_remarks,emp,cm_type from complain_master_item WHERE cm_date2=? AND emp=? ");
				           psmt.setString(1,cs_datett);
				           psmt.setString(2,realname);
				           psmt.setString(3,cs_datett);
				           psmt.setString(4,realname);
				          ...
				          // if(rs.next()){
				           ...
				           java.text.SimpleDateFormat sdf = new java.text.SimpleDateFormat("HH:mm:ss");
				            while(rs2.next()){
                							   ...
                							   // Timestamp diff = rs2.getTimestamp("cm_time_diff");
                							 //	System.out.println("NEW Timestamp ::::::::::::::::::::::::::::::: :"+diff);
                							 ...
                							 //String cm_time_diff2 = rs2.getString(3);
                							 	...
                							 	System.out.println("Cm time ff : "+t1);
                							 	System.out.println("Cm time2ff : "+t2);
                							 	...
                							 	System.out.println("diffTimediffTimed***********************************iffTime ::::::::::: :"+diffTime);
...
rsl3 = stl3.executeQuery("SELECT DISTINCT l.Nname,l.post,l.Nmail from login l INNER JOIN branch_master b ON((substr(l.city,1,4))=substr(b.b_name,1,4)) WHERE l.post='IT MANAGER' AND b.b_no='"+locationNO+"'");
while(rsl3.next()){ 
...
%>
  ...
  <label id="idMailLabel"></label>  
       ...
       <td><input type="checkbox" value="<%=itmail%>" name="itmail" id="iditmail"/>&nbsp;IT Manager : <%=itname %></td>
