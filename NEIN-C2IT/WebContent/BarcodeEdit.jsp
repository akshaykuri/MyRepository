...
<form method="post" action="BarcodeUpdate.jsp">
<br />
<br /><br />
<table border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
	<tr>
		...
		<td bgcolor="white" width="120" align=center><font color="black">DETAIL</font></td>
...
ResultSet rs =null,rs2=null;
  ...
  
  {
      ...
      String query = "select * from barcode_master where id='"+no+"'";
  ...
  <tr>
      ...
      <td bgcolor=""><input name="barcode_name" style="background-color:white;width:100;color:black;" value="<%=rs.getString("barcode_name")%>"></td>
      <td bgcolor=""><font color="white"><input name="barcode_detail" style="background-color:white;width:80;color:black;" value="<%=rs.getString("barcode_detail")%>"></font></td>
<td bgcolor=""><font color="white">
      <select name="bkLocation">
		<option value="<%=rs.getString("brLocation")%>"><%=rs.getString("brLocation")%></option> 
			<%while(rs2.next()){ %>
