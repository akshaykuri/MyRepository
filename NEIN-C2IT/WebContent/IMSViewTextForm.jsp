...
<%!
     ...
     <%req = request.getParameter("ims_idname");
                 ...
                 rs = st.executeQuery("select Send_date,admin_name,time_in,admin_city,time_out,ims_id,desg,emp,mail,idextend from ims_master WHERE ims_id='"+req+"' AND ims_id LIKE 'NEIN/CS/IMS/90%'");
                   while(rs.next()){
...
<table  width="900" border="1" style="height: 150;" cellspacing="0" cellpadding="0" bgcolor="lightgrey" align="center">
			...
			<td width="67" align="center"  height="21" ><input type="text" name="id[]\" value="<%=i%>" size=1 class="id" /></td>
					...
					<td width="67" align="center"  height="21" ><input type="text" name="cm_prob" size="34" id="UserDescripId" class="incUserDescrip" value="<%=cm_prob%>" /></td>
					<td width="67" align="center"  height="21" ><input type="text" name="cm_reported" size="4" id="TimeId" class="incTime" value="<%=cm_reported%>"  /></td>
				<td width="67" align="center"  height="21" ><input type="text" name="cm_completed" size="4" id="Time2Id" class="incTime2" value="<%=cm_completed %>" class="incRate" /></td>
				
					<td width="67" align="center"  height="21" ><input type="text" name="cm_time_diff" size="6" id="TimeDiffId" class="incTimeDiff" value="<%=cm_time_diff%>"  /></td>
...
<table width="" align=center bgcolor="lightgrey">
   ...
   <tr> 
	...
	<!--   <td> <input type="button" value="CANCEL" onclick="goBack();" /></td> -->
	  <td style="font-size: 1"><input style="size: 1; font-size: 1.1em;" type="button" value="BACK" onclick="window.location.href='imsSelection.jsp?msg=1'" /></td>
