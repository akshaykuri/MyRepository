...
<div id="leftfeature"><input type="button" value="BACK" onclick="window.location.href='CheckSheetSelection.jsp?msg=1'"/></div>
	<div id="page-wrap">
...
<tr>
	...
	<td width="390" >&nbsp;Cisco 2821/2811 Router Working(HO only)</td><td width="445">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<tr>
	...
	<td width="390" >&nbsp;Watchguard 550e Firewall working(HO only)</td><td width="445">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<table class="dynatable6" border="2" cellspacing="1" width="900" style="height: 150"  bgcolor="">
				...
				<%int n=0;try{
				            ...
				            rs6 = st6.executeQuery("select prt_name,prt from printer_item where prt_cs_id  = '"+req+"'");
				            while(rs6.next()){
...
<table class="dynatable7" border="2" cellspacing="1" width="900" style="height: 150"  bgcolor="">
				...
				<%int o=0;try{
				            ...
				            rs7 = st7.executeQuery("select fx_name,fx from fax_item where fx_cs_id  = '"+req+"'");
				            while(rs7.next()){
...
<table class="dynatable8" border="2" cellspacing="1" width="900" style="height: 150"  bgcolor="">
				...
				<%int p=0;try{
				            conn = con.getConnection2();
				            st7 = conn.createStatement();
				            rs7 = st7.executeQuery("select br_name,br from barcode_item where br_cs_id  = '"+req+"'");
				            while(rs7.next()){
...
rst5 = stt5.executeQuery("select desg,emp,mail from cs_master where cs_id  = '"+req+"'");
while(rst5.next()){
	
	        String desg = rst5.getString("desg");
	        String emp =rst5.getString("emp");
	        String mail = rst5.getString("mail");
	        
%>
       <tr>SENT TO:
       <td>
       <input type ="text" name = "quarter_r" value ="<%=desg%>"/>
...
<%}
			...
			DbUtil.closeDBResources(rst1,stt1,null);
			DbUtil.closeDBResources(rst2,stt2,null);
			DbUtil.closeDBResources(rst3,stt3,null);
			DbUtil.closeDBResources(rst4,stt4,null);
			DbUtil.closeDBResources(rst5,stt5,null);
...
<table align=center bgcolor="lightgrey">
   ...
   <tr> 
      <td style="font-size:1">&nbsp;&nbsp;<input style="size:1;font-size: 1.1em;" type="button"  value="BACK" onclick="window.location.href='CheckSheetSelection.jsp?msg=1'"/> </td>
