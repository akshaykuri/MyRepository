...
<form name="form" method="post" action="NExASformApprove1super.jsp?msg=1">
<%
...
rs9 = st9.executeQuery("SELECT DISTINCT form_no FROM form12_nexas_item WHERE ((emp='"+AdminName+"' and desg='"+desg+"')|| empid='"+emp_no+"') and status='Pending' AND form_no LIKE 'NEIN/NExAS%' ORDER BY form_no ASC");
