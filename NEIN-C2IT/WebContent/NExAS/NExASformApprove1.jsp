...
String mailid=null,mobno=null,i_name=null,i_desg=null,i_city=null,i_b_no=null,i_admin=null,i_email_id=null,desg=null,emp=null,mail=null,req_Branch="";
...
String dispUnit="",dispRange="",TVApp="",empType="",HRMenu="",date1="";
...
<%String sessempid=session.getAttribute("emp_no").toString();
...
<input type="hidden" id="idstatus" value="<%= flag %>" />
 ...
 --%>
  <tr  ><td colspan="6">REMARKS:
	    ...
	    <textarea  name="txtmail_msg"  rows="2" cols="80"></textarea></div></td>
  </tr>
