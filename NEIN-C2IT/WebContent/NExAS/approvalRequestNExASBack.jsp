...
psmt4 = cn2.prepareStatement("SELECT mail,emp FROM form12_nexas_item WHERE form_no=? AND status=?");
...
if(mmdradio.equals("Approved") && higherAuthority.equals("higherAuthority"))
        ...
        psmt = cn2.prepareStatement("UPDATE form12_nexas_item set status='"+mmdradio+"',remarks='"+txtmail_msg+"' where status='Pending' and form_no='"+form_no+"'");
        int i = psmt.executeUpdate();
        
		psmt2 = cn2.prepareStatement("INSERT INTO form12_nexas_item(form_no,desg,emp,status,remarks,mail,empid,levelno) VALUES(?,?,?,?,?,?,?,?)");
		...
		psmt2 = cn2.prepareStatement("INSERT INTO form12_nexas_item(form_no,desg,emp,status,remarks,mail,empid,levelno) VALUES(?,?,?,?,?,?,?,?)");
		psmt2.setString(1,form_no);
		psmt2.setString(2,"Manager");
		psmt2.setString(3,"KISHAN GOWDA");
		psmt2.setString(4,"Pending");
		psmt2.setString(5,"Pending");
		psmt2.setString(6,"kishan.gowda@nipponexpress.com");
		psmt2.setString(7,"1920");
		psmt2.setString(8,"over");
		int k = psmt2.executeUpdate();
		message = mailMessage.getMailMessageNExAS(form_no.trim());

        postMail.postMail(i_email_id,i_name,"pass1234",hoitmail,"NEIN-C2IT NExAS USER FORM :  " +form_no+ " ", "Dear Mr.SHARATH KUMARA Y, <br><br>Request you to upload the - NExAS USER FORM : "+form_no+",  Approved by " +i_name+ " ,<br>NExAS Form send for create User ID and Password. <br>Remarks : "+txtmail_msg+"<br><b><u> Open the following URL</u> </b><br> C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
       ...
       psmt2 = cn2.prepareStatement("UPDATE form12_nexas set finalApproved='Final'  where form_no='"+form_no+"'");
       int j = psmt2.executeUpdate();
 
       message = mailMessage.getMailMessageNExAS(form_no.trim());
       String allMails1=null;
       psmt4 = cn2.prepareStatement("SELECT mail,emp FROM form12_nexas_item WHERE form_no=?");
	   psmt4.setString(1,form_no);
       ResultSet rs1 = psmt4.executeQuery();
       while(rs1.next())
          {
          allMails1 = rs1.getString(1); 
          postMail.postMail(i_email_id,i_name,"pass1234",allMails1,"NEIN-C2IT NExAS USER FORM :  " +form_no+ " "," "+  " NExAS USER FORM : "+form_no+" Is Approved by " +i_name+ " . <br>Remarks : "+txtmail_msg+"<br><b><u> Open the following URL</u> </b><br> C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
          }
       String ccmail="nilkanth.pawar@nittsu.co.in";
       postMail.postMail(i_email_id,i_name,"pass1234",ccmail,"NEIN-C2IT NExAS USER FORM :  " +form_no+ " "," "+  " NExAS USER FORM : "+form_no+" approved by " +i_name+ " . <br>Remarks : "+txtmail_msg+"<br><b><u> Open the following URL</u> </b><br> C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
  ...
  else 
        {
    	 ...
    	 while(rs1.next())
    	   {
    	   allMails1 = rs1.getString(1); 
           postMail.postMail(i_email_id,i_name,"pass1234",allMails1,"NEIN-C2IT NExAS USER FORM :  " +form_no+ " ",initiatorNameIfNotApproved+  " "+  "your request for - NExAS USER FORM : "+form_no+" Is NOT Approved by " +i_name+ " <br>Remarks : "+txtmail_msg+"<br><b><u> Open the following URL</u> </b><br> C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>");
           }	
        }
...
msg = "NExAS__USER__FORM__SAVED__AND__SENT__SUCCESSFULLY";
