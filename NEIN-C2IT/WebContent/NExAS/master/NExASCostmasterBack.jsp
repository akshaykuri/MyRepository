...
<%
	...
	try 
		...
		String oprange[] = request.getParameterValues("oprange");
   	    l = cname.length;
		for (int k = 1; k < l; k++)
			   {
			   psmt3 = conn.prepareStatement("insert into nexascostmaster(costname,costcode,oprange) values(?,?,?);");
			   psmt3.setString(1, cname[k]);  
			   psmt3.setString(2, ccode[k]);
			   psmt3.setString(3, oprange[k]);
		 ...
		 response.sendRedirect("NExASCostmaster.jsp?msg="+msg);
%>
</body>
</html>