...
function deleteNExASCost(cname)
{  //alert("fgfg");  
...
f.method="post";    
f.action='NExASCostDel.jsp?id='+cname;    
f.submit();
}
	else{}
}
...
<center>
	...
	<table border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
		<tr>
		  ...
		  <td height="20" bgcolor="white" width="120" align=center><font size="2" color="black"><b>COST CENTER NAME</b></font></td>
		  <td bgcolor="white" width="120" align=center><font size="2" color="black"><b>COST CENTER NAME</b></font></td>
		  <td bgcolor="white" width="120" align=center><font size="2" color="black"><b>OPERATION RANGE</b></font></td>
      	</tr>
...
String query = "select * from nexascostmaster  ORDER BY costname";
...
%>
	 ...
	 <tr>
        ...
        <td id="hiderow"><input id="hiderow" type="button" size="2" name="delete" value="Delete" style="background-color:white;font-weight:bold;color:black;" onclick="deleteNExASCost('<%=rs.getString(2)%>');" ></td>
    </tr>
		<%}%>
