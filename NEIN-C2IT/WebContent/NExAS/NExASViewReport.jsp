...
<tr align="center">
 <td bgcolor="#2f4377" class="blueLine"><strong><font size ="4" color="white">NExAS  FORM</font></strong></td>
</tr>
...
<form name="form" method="post" action="NExASViewReportBack.jsp?msg=1">
...
if(b_no.equals("90"))
	rs9 = st9.executeQuery("SELECT DISTINCT form_no,full_name FROM form12_nexas WHERE  form_no LIKE 'NEIN/NExAS%' ORDER BY idextend asc");
if(b_no.equals("30"))
	rs9 = st9.executeQuery("SELECT DISTINCT form_no,full_name FROM form12_nexas WHERE  req_Branch in('30','11','53','32') ORDER BY idextend asc");

else
   rs9 = st9.executeQuery("SELECT DISTINCT form_no,full_name FROM form12_nexas WHERE req_Branch='"+b_no+"' AND form_no LIKE 'NEIN/NExAS%' ORDER BY idextend asc");
...
<table align="center">
<tr>
<th>SELECT NExAS FORM NUMBER</th>
</tr>
</table>
