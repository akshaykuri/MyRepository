...
<form  method="post" onsubmit="return validatefield()" action="mrApproverDisp.jsp?id=1"  name="form1" id="form">
...
<br><br>
 ...
 <tr align="center">
 <td bgcolor="#2f4377" colspan="2"><strong><font size ="4" color="white">ASSET MANAGEMENT APPROVER DISP</font></strong></td></tr>
...
<div class="modal-header">
      <center> <h2>ASSET MANAGEMENT APPROVER SEARCH FORM</h2></center>
    </div>
...
<a href="mrApprover.jsp?msg=1"><img src="bakk.png" border="0" height="35" width="35"></a><address><font size="2">BACK</font></address> 
</td> 
</tr> 
</table>                        
<table width="1118" align="center" border="0" cellspacing="0" cellpadding="0">
