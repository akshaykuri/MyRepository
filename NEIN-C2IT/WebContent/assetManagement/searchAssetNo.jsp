...
<%
System.out.println("--------------  IT Asset No Search --------------");
String ano=null;
...
<form name="form" id="myform" action="<%=request.getContextPath()%>/assetManagement/Report/ExcelReportOfByAssetNo.jsp">  
<center>
...
<%-- <table id="invoicetable" width="1000" bgcolor="" cellpadding="4" cellspacing="6" align="center" border=1>
	...
	<td   height="21" bgcolor="lightgrey" style="font-size: 1" width="10" align="center"><font size="2"> ADMIN DESG:<%=session.getAttribute("desg")%><b></b></font></td>
             ...
             <table class="dynatable"  border="1" style="height:100;" cellspacing="0" cellpadding="0" bgcolor="lightgrey" align="center">
			 
			    <%
			        
			        PreparedStatement psmt1=null,psmt2=null,psmt2s=null,psmt4=null,psmtPO=null;
				    Statement st=null;
			        ...
			        String s_no=null;
			        String query1=null,query2=null,query3=null,queryPO=null,query3s=null;
			        String assetno=null;
	                ...
	                //  query1 = "select * from asset_item where Asset_No='"+ano+"'"; 
	                      try
					         {
	                    	     queryPO = "select ai.PoNo,ai.InvNO,ai.VName,ai.mr_scan,ai.po_scan,ai.inv_scan,ai.other_scan from asset_inventory ai inner join asset_item ai1 on ai1.Inventory_No=ai.Inventory_No  where ai1.Asset_No='"+ano+"' limit 1";  
	                    	     ...
	                    	     if(rsPO.next())
				                	...
				                	if(rs1.next())
				                      ...
				                      <td  align="center"  height="21" ><font size="3" ><b>Sr.No</b></font></td>
				                      <td  align="center"  height="21" ><font size="3" ><b>Inventory no</b></font></td>
				                      <td  align="center"  height="21" ><font size="3" ><b>Asset Type</b></font></td>
				                      <td  align="center"  height="21" ><font size="3" ><b>Asset No</b></font></td>
				                      <td  align="center"  height="21" ><font size="3" ><b>Serial No</b></font></td>
				                      <td  align="center"  height="21" ><font size="3" ><b>Configuration</b></font></td>
				                      <td  align="center"  height="21" ><font size="3" ><b>From Branch</b></font></td>
				                      <td  align="center"  height="21" ><font size="3" ><b>From Emp</b></font></td>
				                      <td  align="center"  height="21" ><font size="3" ><b>To Branch</b></font></td>
				                      <td  align="center"  height="21" ><font size="3" ><b>To Emp</b></font></td>
				                	  
				                	  
				                	  
				                	  <td  align="center"  height="21" ><font size="3" ><b>PO No</b></font></td>
				                      <td  align="center"  height="21" ><font size="3" ><b>Invoice No.</b></font></td>
				                      <td  align="center"  height="21" ><font size="3" ><b>Vendor Name</b></font></td>
				                      <td  align="center"  height="21" ><font size="3" ><b>MR File</b></font></td>
				                      <td  align="center"  height="21" ><font size="3" ><b>PO File</b></font></td>
				                      <td  align="center"  height="21" ><font size="3" ><b>Invoice File</b></font></td>
				                      <td  align="center"  height="21" ><font size="3" ><b>Other File</b></font></td>
			                        ...
			                        --%> <!--  </tr> -->
				                      ...
				                      <td width="67" align="center"  height="21" ><font size="3" ><b>From Branch</b></font></td>
				                      <td width="67" align="center"  height="21" ><font size="3" ><b>From Emp</b></font></td>
				                      <td width="67" align="center"  height="21" ><font size="3" ><b>To Branch</b></font></td>
				                      <td width="67" align="center"  height="21" ><font size="3" ><b>To Emp</b></font></td>
				                     </tr> --> 
				                  <%while(rs1.next())
				                     {
				                	 flag=1;
				                   	 k++;
				                     String inv1 = rs1.getString("Inventory_No");
					    		     ...
					    		     String serialno= rs1.getString("serial_no");
					    	 	     %>
					    	 	    
			                         <tr style="background-color:PALEGREEN;">
		                             <td align=center><font color="black" size="3"><%=k%></font></td>
			                         <td align=center><font color="black" size="3"><%=inv1%></font></td>
				               ...
				               {	 
		    			  	      //Inventory_No,Asset_No,AssetType,Branch,SubBranch,WarExpDate,assignStatus,Scrap,Maintanance ,Assignedfor
		    				      query3 = "select * from asset_item where (Asset_No='"+ano+"' and AssetType not in('DESKTOP','CCTV_SETUP','UPS_SETUP')and assignStatus='0')";  
	 						      psmt2 = conn.prepareStatement(query3);
				                  rs2 = psmt2.executeQuery();
				                  query3s = "select * from asset_item where (Asset_No='"+ano+"' and AssetType not in('DESKTOP','CCTV_SETUP','UPS_SETUP')and assignStatus='0')";  
	 						      psmt2s = conn.prepareStatement(query3s);
				                  rs2s = psmt2s.executeQuery();
				                  if(rs2s.next())
	                           	  {%>
			                	  ...
			                	  <tr style="background-color:gray;">
			                          ...
			                          <td  align="center"  height="21" ><font size="3" ><b>Configuration</b></font></td>
			                          <td  align="center"  height="21" ><font size="3" ><b>Asset Type</b></font></td>
			                          <td  align="center"  height="21" ><font size="3" ><b>Branch Code</b></font></td>
			                         <td  align="center"  height="21" ><font size="3" ><b>Branch Name</b></font></td>
			                         <td  align="center"  height="21" ><font size="3" ><b>Assign Status</b></font></td>
			                         <td  align="center"  height="21" ><font size="3" ><b>User Name</b></font></td>
			                          <td  align="center"  height="21" ><font size="3" ><b>User Branch</b></font></td>
			                    	  <td  align="center"  height="21" ><font size="3" ><b>PO No</b></font></td>
				                      <td  align="center"  height="21" ><font size="3" ><b>Invoice No.</b></font></td>
				                      <td  align="center"  height="21" ><font size="3" ><b>Vendor Name</b></font></td>
				                      <td  align="center"  height="21" ><font size="3" ><b>MR File</b></font></td>
				               ...
				               <!--        <tr style="background-color:PALEGREEN;">
				                -->      
			                         ...
			                         <td width="67" align="center"  height="21" ><font size="3" ><b>Assign Status</b></font></td>
			                	...
			                	<% String invno = rs2.getString("Inventory_No");
				    		     ...
				    		     String serno  = rs2.getString("serial_no");
				    		     %>
		                        ...
		                        <tr style="background-color:PALEGREEN;">
		                         ...
		                         <td align=center><font color="black" size="3"><%=asno%></font></td>
		                          <td align=center><font color="black" size="3"><%=serno%></font></td>
		                         ...
		                         <td align=center><font color="black" size="3">Not Assigned</font></td>
				                	...
				                	<%if(asfor.equals("OFFICE"))
				                	     { 
				                	      ...
				                	      <tr style="background-color:gray;">
				                             ...
				                             <td  align="center"  height="21" ><font size="3" ><b>Configuration</b></font></td>
				                             <td  align="center"  height="21" ><font size="3" ><b>Branch Name</b></font></td>
				                             <td  align="center"  height="21" ><font size="3" ><b>Assigned Branch</b></font></td>
				                         </tr>
				                      	<%
			                	  ...
			                	  <%}else{
				                	...
				                	query4 = "SELECT * FROM `assignotherassetemp` WHERE (`ano`='"+ano+"' OR `mano`='"+ano+"' OR `hano`='"+ano+"')AND (`statusIT`='1' OR `statusMob`='1'OR`statusHD`='1')";
		 						    psmt4 = conn.prepareStatement(query4);
					                rs4 = psmt4.executeQuery();
					                if(rs4.next())
			                             {
...
<tr>
<td align="left" id="hiderow"><input type="button" size="2" style="background-color:lightgrey;font-weight:bold;color:black;" value='BACK' onclick='history.go(-1)'></td>
