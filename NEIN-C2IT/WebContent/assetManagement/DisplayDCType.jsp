...
<center>
 <br />
	...
	<table border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
		...
		<td height="20" bgcolor="white" width="120" align=center style="background-color:grey"><font size="2" color="black"><b>DataCardType Name</b></font></td>
...
String query = "select * from datacard_type";
...
<td style="background-color:grey"><input id="hiderow" type="button" size="2" name="edit" value="Edit" style="background-color:white;font-weight:bold;color:black;" onclick='editRecord("<%=rs.getString(1)%>,<%=rs.getString(2)%>");' ></td>
