...
function editRecord(id)
    ...
    var f=document.form;    
    f.method="post";    
    f.action='accessbioEdit.jsp?id='+id;    
    f.submit();
    }
	...
	if(confirm('You are above to delete a Problem Type'))
	      {
           var f=document.form;    
           f.method="post";    
           f.action='accessbioDel.jsp?id='+id;    
           f.submit();
          }
	else{}
   }
...
<center>
 <br />
	...
	<table border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
		...
		<td height="20" bgcolor="white" width="120" align=center style="background-color:grey"><font size="2" color="black"><b>Type Name</b></font></td>
...
String query = "select * from accessbiotype";
