...
{
	var ress=second.slice(-1);;
	var instr="idinvoiceDate"+ress;
	
	var podate1=document.getElementById('idInvDate').value;
	var start_date = document.getElementById(instr).value;;
	var res1;
	...
	// January is 0 so August (8th month) is 7
		...
		$(document).ready(function() {
			...
			$("table.dynatable button.add").click(function() {
			  ...
			  // Get a new row based on the prototype row
				...
				prot.find(".asinv").attr("id","idassetinvoice"+id);
				prot.find(".asinvamount").attr("id","idinvoiceAmount"+id);
				prot.find(".asinvdate").attr("id","idinvoiceDate"+id);
			...
			$("table.dynatable button.remove").live("click", function(){$(this).parents("tr").remove();	});});
	</script>
...
<form  method="post" onsubmit="return validatefield()" action="asmInvDBwithouthPO.jsp"  enctype="multipart/form-data" name="form1" id="form">
...
<div class="modal-header">
      <center> <h2>IT ASSET WITHOUTH PO INVENTORY FORM</h2></center>
    </div>
    <div class="modal-body">
<br>
<center>
   <table width="85%" border="1" style="height: 150;" cellspacing="0" cellpadding="0" bgcolor="lightgrey">
     	<tr>
		     <td colspan="2">
			...
			<td height="21" align="left" width="103">
								<table>
									...
									<tr>
										...
										<td><input type="text" name ="idPODate"  placeholder="Date" value="" id="idPODate">
										</td>
									</tr>
								</table></td>		
	        <td height="21" align="left" >
 	          <table>
	                <tr>
	                  <td ><font size="2" face="Swiss" id="hiderow"><font color="red" size="4">*</font>Invoice &nbsp;No. :</font> 
			           ...
			           <td width="10%"><font size="2" face="Swiss" id="hiderow">Invoice &nbsp;Date :</font> 
			            <td>
			            <input type="text" name ="idInvDate" class="txtCalendar2" placeholder="Date" value="" id="idInvDate" >
		          ...
		          <tr>
		               ...
		               <%
		               System.out.println("------------- AsmInventory With OUT PO  -----------------");
...
<table class="dynatable" width="85%" border="1" style="height: 150;" cellspacing="0" cellpadding="0" bgcolor="lightgrey">
        <tr>
          <td colspan="12"><center><font size="5" face="Swiss" id="hiderow">Enter Item Details</font></center> </td>
        </tr>
	    <tr>
		     <td width="35" align="center"  height="21" ><button class="add" type='button'>+</button></td>
		     ...
		     <td><font size="2" face="Swiss" id="hiderow">Invoice&nbsp;No.</font></td>
		     <td><font size="2" face="Swiss" id="hiderow">Invoice&nbsp;Amount.</font></td>
		     <td><font size="2" face="Swiss" id="hiderow">Invoice&nbsp;Date.</font></td>
	 	 ...
	 	 <tr class="prototype">
		           ...
		           <td><input type="text" name="assetName" maxlength="99" id="idasname" class="asname" value="" size=15 /></td>
		           <td><input type="hidden" id="testflag" name="testflag" class="testflag" value="0" size=1/>
		            <input type="text" name="assetNo" maxlength="99" id="idacasno" class="acasno" onkeyup="sendInfo1(this.value,this.id)" value="" size=15 /></td>
				     ...
				     <td colspan="1" ><input type="text" style="width: 6em" id="idassetInvoice" name="assetInvoice" class="asinv"/> </td>
				
				     <td colspan="1" ><input type="text" style="width: 6em" id="idinvoiceAmount" name="invoiceAmount" class="asinvamount"/> </td>
				 	
				     <td colspan="1" ><input type="text" style="width: 6em" id="idinvoiceDate" name="invoiceDate " class="asinvdate" onclick="showCalendarControl(this)" placeholder="dd-mm-yyyy" value="" /> </td>
                    ...
                    try
                       {
						...
						String query2 = "select * from asset_type where it_nonit='IT' ";
		          ...
		          <td><%Connection con = null;
                   ...
                   <td><select name="war" class="waranty" id="idWar" 
                   		 onclick="CalExp(this,'idWarExp'+id)">
      ...
      <!-- <tr class="prototype" >
	  <td colspan="1"> <button class="remove" type='button' ><font size="4">-</font></button></td>
     <td colspan="1" >Invoice No:</td>
     <td colspan="1" ><input type="text" style="width: 6em" id="idassetInvoice" name="assetInvoice" class="asinv"/> </td>
     <td colspan="1" >Invoice Amount:</td>
     <td colspan="1" ><input type="text" style="width: 6em" id="idinvoiceAmount" name="invoiceAmount" class="asinvamount"/> </td>
 	 <td colspan="1" >Invoice Date:</td>
     <td colspan="1" ><input type="text" style="width: 6em" id="idinvoiceDate" name="invoiceDate" class="asinvdate"  placeholder="dd-mm-yyyy" value="" /> </td>
