...
<%-- <%@ include file="getcon.jsp"%> --%>
 ...
 <%
	        ...
	        con3 = dbConn.getConnection2();
		     ...
		     String charged1=null,invoiceno1=null,invoiceAmt1=null,invoicedate1=null,path=null,status1=null,status2=null;
		     String agreementdate=null,agreementsdate=null,agreementedate=null;
  ...
  if (item.isFormField())
		...
		item.write(insertFile);
		 ...
		 { 
			...
			if(chequeNo.isEmpty() || chequeDate1.isEmpty()){
				status1="Pending";
			}
			else{
				status1="Completed";
              ...
              String query2="INSERT INTO `photocopier_details`(`brand`, `modelno`, `serialno`, `agreementno`, "+
                            ...
                            "`agreementedate`,`chequeAmt`)  VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";   
    	...
    	for(int j=0;j<x;j++)
    	   {			    
    		...
    		if(invoiceno.get(j).isEmpty() || invoicedate.get(j).isEmpty() || filenameList.get(j).isEmpty()){
    	   ...
    	   String query3="INSERT INTO `photocopy_summary`(`ph_id`, `serial_no`, `photo_type`, `closing_balance`,"+
           		         ...
           		         " `invoice_no`, `invoice_date`, `invoice_amt`,`filepath`,`status`,`createddate`) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";   
				        ...
				        prds3.setString(14,path+"/"+filenameList.get(j));
		 ...
		 out.println("Inserting error"+el.getMessage());
		    ...
		    msg = "Photo Copier data inserted successfully For serial No ::"+sno;
