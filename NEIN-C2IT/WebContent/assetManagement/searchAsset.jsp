...
<table width="75%" border="1" style="height: 150; border: 1px solid black; padding: 5px;" cellpadding="0" bgcolor="lightgrey">
		...
		<table width="75%" border="0" style="height: 150; border: 1px solid black; padding: 5px;" cellpadding="0" bgcolor="lightgrey">
		<!-- <tr>
		    <td><font size="2" face="Swiss" id="hiderow">Assign&nbsp;Type :</font></td>
		    <td><select name="asignType" id="idasgType">
	...
	<tr><center>Assigned Asset Details</center></tr>
	    <tr>
	         <td><font size="2" face="Swiss" id="hiderow"><font color="red" size="4">*</font>Office/User&nbsp; Use:</font></td>
		     <td>
		         <select name="assignFor" id="idasgFor" onclick="userofficefun()"style="font-size: 11px;width: 110px; overflow: auto; height: 20px">
		         <option selected="selected">Select</option>
		    ...
		    <td>
               ...
               try
                ...
                %>
                   <select name="branchName" id="idbranch" onclick="userofficefun()"style="font-size: 11px;width: 110px; overflow: auto; height: 20px">
		           <option selected="selected">Select</option>
	               <%while(rs.next()){%>
	    ...
	    <tr>
		     <td><font size="2" face="Swiss" id="hiderow">Asset&nbsp;Type :</td>
		     <td><%Connection con1 = null;
              ...
              try
                 ...
                 rs1 = st1.executeQuery(query1); %>
                       <select name="aType" id="idAtype" onclick="userofficefun()"style="font-size: 11px;width: 110px; overflow: auto; height: 20px">
		                  <option selected="selected">Select</option>
	                     <%while(rs1.next()){%>
		...
		<!-- <tr>
		  <td><font size="2" face="Swiss" id="hiderow">Sub Branch :</font>
		</td>
		<td>
		   <div id='Subcity'>      
           <select name="Subcity" id="idsub" onclick="selbranch()" style="font-size: 11px;width: 142px;overflow: auto;height: 20px ">  
           <option selected="selected">Select</option> 
		...
		<!-- <tr>
		<td><font size="2" face="Swiss" id="hiderow">Admin&nbsp; ID.:</font>
		</td>
		<td><input type="text" name="adminId" maxlength="99" id="idadminId" value="" size=20 /></td>
		 </tr> -->
		 <tr>
		    <td colspan="2"><font size="2" face="Swiss" id="hiderow"><!-- From Date: -->&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>
		      <input type="text"  style="width: 6em" hidden name="txtCalendar" value="" id="datepicker-13"  onclick="showCalendarControl(this),userofficefun()"></td>
		       <!-- <input type="text"  style="width: 6em"  name="txtCalendar" value="" id="idCalendar" onclick="showCalendarControl(this)" readonly="readonly">
		                 <img src="images/cal.gif" id="idForDay" style="float: right; margin: 0.5em 2em 0.5em 0.25em;" name="imgForDate" width="20" height="20"  onclick="showCalendarControl(document.getElementById('idCalendar'))">
	                         -->
	   	 	<td colspan="2"><!-- <font size="2" face="Swiss" id="hiderow">End Date:</font> -->
	  	      <input type="text"  style="width: 6em" hidden name="txtCalendar1" value="" id="datepicker-131"  onclick="return selfromdate(),showCalendarControl(this),userofficefun()"></td>
		                        <!-- <input type="text"  style="width: 6em"  name="txtCalendar1" value="" id="idCalendar1" onclick="showCalendarControl(this)" readonly="readonly">
		                                  <img src="images/cal.gif" id="idForDay" style="float: right; margin: 0.5em 2em 0.5em 0.25em;" name="imgForDate" width="20" height="20"  onclick="showCalendarControl(document.getElementById('idCalendar1'))">
	                                         -->
	     </tr>
	    <!--  <tr>
	        <td><font size="2" face="Swiss" id="hiderow">Asset&nbsp; No.:</font></td>
	        <td><input type="text" name="aNo1" maxlength="99" id="idaNo1" value="" size=20 onclick="userofficefun()" /></td>
	    </tr> -->
	    </table>
		 </table>
         <table width="75%" border="1" align="center" bgcolor="lightgrey">
               	<td style="size: 1">
	            <center>
			    <!-- <input type="button" name="searchBtn" onclick="" value="SEARCH" /> -->
