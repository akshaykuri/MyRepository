...
<body>
<%
		System.out.println("----------------------------- Asset TransferDB ----------------------");
        ...
        try
        {
        	 prs1 = conn.prepareStatement("select b_no from branch_master where b_name='"+nbran+"'");
        	  rs = prs1.executeQuery();
        	  if (rs.next())
        	      {
        		  rde2 = rs.getString("b_no");
        	...
        	prs5 = conn.prepareStatement("select ConfigField , serial_no from asset_item where Asset_No='"+asno+"'");
        ...
        prs51 = conn.prepareStatement("select * from asset_trans where New_Asset_No='"+asno+"' && curAID='1'");
        ...
        if (rs41.next())
	            ...
	            j11=st111.executeUpdate("update asset_trans set curAID='0' where New_Asset_No='"+asno+"' && curAID='1'");
   	 ...
   	 j=st1.executeUpdate("update asset_item set Branch='"+rde2+"',BranchName='"+nbran+"',EmpId='NULL',assignStatus='0',Assignedfor='NULL',assignedbraemp='NULL' where Asset_No='"+asno+"'");
