	...
	if (typeof XMLHttpRequest != "undefined"){    
      xmlHttp= new XMLHttpRequest();    
          ...
          xmlHttp= new ActiveXObject("Microsoft.XMLHTTP");  
                         ...
                         var url="branchFieldFeatchNONIT.jsp";  
                         url +="?b_name=" +str;   
	 	...
	 	if (typeof XMLHttpRequest != "undefined"){    
	       xmlHttp= new XMLHttpRequest();    
	           ...
	           xmlHttp= new ActiveXObject("Microsoft.XMLHTTP");  
	                  ...
	                  alert("Browser does not support XMLHTTP Request");   
	                    return;     
	                     }       var url="subBranchFeatchNONIT.jsp"; 
	                     //alert (str);
	                             url +="?bno=" +str12;   
	                             //alert(url);
	...
	if (typeof XMLHttpRequest != "undefined"){    
      xmlHttp= new XMLHttpRequest();    
          ...
          xmlHttp= new ActiveXObject("Microsoft.XMLHTTP");  
                 ...
                 alert("Browser does not support XMLHTTP Request");   
                   return;     
                    }       var url="assetavailableNONIT3.jsp"; 
                    //alert (str);
                            url +="?AssetType=" +str;   
                            //alert(url);
	...
	if (typeof XMLHttpRequest != "undefined"){    
      xmlHttp= new XMLHttpRequest();    
          ...
          xmlHttp= new ActiveXObject("Microsoft.XMLHTTP");  
                 ...
                 alert("Browser does not support XMLHTTP Request");   
                   return;     
                    }       var url="assignAssetBackNONIT1.jsp"; 
                    //alert (str);
                            url +="?it_nonit=" +str;   
                            //alert(url);
...
<form  name="form"  method="post"  onsubmit="return validate()" action="assignAssetDBNONIT.jsp" >
<br><br>
         ...
         <tr>
		     ...
		     <td><%Connection con1 = null;
                   ...
                   try
                     ...
                     String query1 = "select * from asset_type where it_nonit='NON IT' and item_name!='Laptop'";
              ...
              <tr>
		             ...
		             <td><input type="text" name ="date1" id="datepicker" placeholder="Date" value=""></td>
                     <td><font size="2" face="Swiss" id="hiderow">REMARKS:</font></td>
		             <td><input type="text" name="remarks1" maxlength="99" id="idremarks1" value="" size=40 /></td>
		             <input type="hidden" name="bname" maxlength="99" id="idbname" value="" size=40 />
              ...
              <td><font size="2" face="Swiss" id="hiderow"><font color="red" size="4">*</font>ASSIGN TO SUB&nbsp;BRANCH:</font></td>
                  <td><div id='subbranch'>      
                       <select name="subbranch" id="idsubbranch" style="font-size: 11px;width: 110px; overflow: auto; height: 20px ">  
                          <option selected="selected">Select</option> 
                          <option value='-1'></option>  
                       </select>     
                        </div>
