...
String query = "select ac.id,at.item_name,ac.configname,ac.configdisc from asset_type at, assetconfgfield ac where at.item_name=ac.assettype order by item_name";
