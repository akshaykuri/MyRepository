	    ...
	    // alert(ano1);
	     if(ano1=="")
	    	...
	    	{	
	         var f=document.form;    
		     f.method="post";    
		     f.action='assetConfigUpdateformNONIT.jsp?ano='+ano1;    
		     f.submit();
		     } 
         }
</script>
...
<% 
	System.out.println("-------------  NON IT Asset Config Update -----------------");
...
<br>
	    <table width="75%" border="1" style="height: 150; border: 1px solid black; padding: 5px;" cellpadding="0" bgcolor="lightgrey">
	        ...
	        <tr>
	         <td colspan=2>
                 <a href="assetAllView.jsp" onclick="return popitup2('assetAllViewNONIT.jsp')">ViewAllAsset</a> 		      
