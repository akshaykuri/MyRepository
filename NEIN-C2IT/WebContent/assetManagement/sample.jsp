											...
											<table>
												<tr>
													...
													<td><input type="text" name="abc8" maxlength="99"
														id="idabc8" value="<%=vendor_Address%>" size=20 />
													</td>
												</tr>
												<tr>
													...
													<td><input type="text" name="abc7" maxlength="99"
														id="idabc7" value="<%=vendor_Mobile_Number%>" size=20 />
													</td>
													<td><font size="2" face="Swiss" id="hiderow">Vendor
															&nbsp;Address :</font>
													<td><input type="text" name="abc6" maxlength="99"
														id="idabc6" value="<%=vendor_Name%>" size=20 />
													</td>
												</tr>
											</table></td>
									</tr>
										...
										while (ii < qty) 
										{
											...
											%>
										 	 <tr>
													...
													<td><input type="text" id="assetName<%=sr%>" name="assetName" value="<%=rs21.getString(1)%>">
											</td>
