...
<% 
	System.out.println("-------------  Add Asset New Config -----------------");
...
<body>
<form name="form" method="post"  onsubmit="return validate()" action="AddnewConfigBack.jsp">
<br><br>
    ...
    <table border=1>
           ...
           <tr>
              ...
              try
                 ...
                 String query1 = "select * from asset_type where it_nonit='IT'";
