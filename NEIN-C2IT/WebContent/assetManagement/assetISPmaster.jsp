...
function cleartext()
	...
	document.getElementById('idisp').value =null;
...
<form name="form" method="post"  onsubmit="return validate()" action="assetISPmasterBack.jsp">
   <div>
   </BR></BR>
   ...
   <div class="modal-content">
    <div class="modal-header">
              <center> <h2>ISP Master</h2></center>
    </div>
    ...
    <table border=1>
           ...
           <tr>
                <td><font color="red" size="4">*</font>ISP :</td>
                <td><input type="text" name="isp" maxlength="20" id="idisp" value="" size=20 /></td>
           </tr>
    ...
    <table>
            <tr>
                ...
                <td><a href="DisplayISP.jsp" onclick="return popitup1('DisplayISP.jsp')">ViewAllISP</a> </td>
