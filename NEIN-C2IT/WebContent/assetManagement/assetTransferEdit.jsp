...
<%
	System.out.println("------------------ Asset Transfer Edit -------------");
        ...
        <td>
             <%
                ...
                try 
                   ...
                   //String query1 = "select * from branch_master where b_no!='"+bcod+"' ORDER BY b_name";
                   String query1 = "select * from branch_master  ORDER BY b_name";
...
<a href='assettransferback.jsp?assetno=<%=asno%>'><img src="../bakk.png" border="0" height="35" width="35"></a><address><font size="2">BACK</font></address> 
</td> 
</tr> 
</table>                              
<table width="1118" align="center" border="0" cellspacing="0" cellpadding="0">
