	...
	function func(atype) 
      {
	      ...
	      //  alert(atype);
	      f.method="post";   
		  f.action='assetConfigAdd.jsp?atype='+atype;
		  f.submit();
	 }
</script>  
...
<% 
	...
	System.out.println("------------- Add Asset Config Field  -----------------");
...
<div class="modal-header">
      <center> <h2>ADD ASSET CONFIGURATION FORM</h2></center>
    </div>
...
<br>
	 ...
	 <table width="100%" border="1" style="height: 150; border: 1px solid black; padding: 5px;" cellpadding="0" bgcolor="lightgrey">
	   	     <tr><td colspan="7" align="center" bgcolor="grey">ADD ASSET CONFIGURATION FORM</td></tr>
	   	     <tr>
