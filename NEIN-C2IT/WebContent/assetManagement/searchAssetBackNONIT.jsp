...
<%
System.out.println("------------- Search Asset Back  -----------------");
String uid=request.getParameter("m_b_no");  
String buffer="<select name='Subcity' id='idsub' onclick='selbranch()' style=\"font-size: 11px;width: 142px;overflow: auto;height: 20px \"><option selected='selected'>Select</option>";
//String buffer="";
//System.out.println();
String name=null;
