    	    ...
    	    var url="getEmployee11.jsp";  
             ...
             if(xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
                      { 
		                ...
		                document.getElementById("idmobAType").value =  document.getElementById("matype").value;
		                if(document.getElementById("idmobAType").value=="")
                   		 document.getElementById("idmobAType").value="Select";
		                
		                
						document.getElementById("idmobAssetNo").value =  document.getElementById("mano").value;
						document.getElementById("idmano1").value =  document.getElementById("mano").value;
                       	
                       	if(document.getElementById("idmobAssetNo").value =="-1")
    	               	  {
        	                  document.getElementById("idmobAssetNo").value="";
                    	  }
		                
		                ///////////
		                
		                document.getElementById("idharddiscAType").value =  document.getElementById("hatype").value;
		                if(document.getElementById("idharddiscAType").value=="")
                   		 document.getElementById("idharddiscAType").value="Select";
		                
		                
						document.getElementById("idHardDiscAssetNo").value =  document.getElementById("mano").value;
						document.getElementById("idhano1").value =  document.getElementById("hano").value;
                       	
                       	if(document.getElementById("idHardDiscAssetNo").value =="-1")
    	               	  {
        	                  document.getElementById("idHardDiscAssetNo").value="";
                    	  }
...
function cleartext1()
    ...
    document.getElementById("idmano1").value="";
    ...
    document.getElementById("idmobAType").value = "Select";
    document.getElementById("idmobAssetNo").value = "Select";
    document.getElementById("idharddiscAType").value = "Select";
    document.getElementById("idHardDiscAssetNo").value = "Select";
    
    document.getElementById("idhano1").value="";
...
function validate() 
    ...
    ////////////////////////////////
	   ...
	   var mxx=document.getElementById("idmobAType").value;
	   var mxx1=document.getElementById("idmobAssetNo").value ;
	   
	   var hxx=document.getElementById("idharddiscAType").value;
	   var hxx1=document.getElementById("idHardDiscAssetNo").value ;
...
<script type="text/javascript">
function fetchMobileDetails(str,bn){  
	document.getElementById("idmobMod").value = "";
	document.getElementById("idmobSer").value = "";
    document.getElementById("idmobNum").value = "";
    document.getElementById("idmobSIM").value = ""; 
	...
	if (typeof XMLHttpRequest != "undefined"){    
      xmlHttp= new XMLHttpRequest();    
          ...
          xmlHttp= new ActiveXObject("Microsoft.XMLHTTP");  
                 ...
                 alert("Browser does not support XMLHTTP Request");   
                   return;     
                    }       var url="assetavailable6.jsp"; 
                            url +="?AssetType=" +str + "&bname="+ bn ;   
                           xmlHttp.onreadystatechange = assetavailable6;  
                           xmlHttp.open("GET", url, true);   
                           xmlHttp.send(null);    
         }     
                     function assetavailable6(){     
                            	if(xmlHttp.readyState==4 || xmlHttp.readyState=="complete"){   
                                    document.getElementById("mobAssetNo").innerHTML=xmlHttp.responseText;    
...
<script type="text/javascript">
function mobileAssetConfigFetch(str){  
	document.getElementById("idmobMod").value = "";
	document.getElementById("idmobSer").value = "";
    document.getElementById("idmobNum").value = "";
    document.getElementById("idmobSIM").value = ""; 
	...
	if (typeof XMLHttpRequest != "undefined"){    
      xmlHttp= new XMLHttpRequest();    
          ...
          xmlHttp= new ActiveXObject("Microsoft.XMLHTTP");  
                 ...
                 alert("Browser does not support XMLHTTP Request");   
                   return;     
                    }       var url="assetavailable7.jsp"; 
                            url +="?AssetNo=" +str;   
                           xmlHttp.onreadystatechange = assetavailable7;  
                           xmlHttp.open("GET", url, true);   
                           xmlHttp.send(null);    
         }     
                     function assetavailable7(){     
                            	if(xmlHttp.readyState==4 || xmlHttp.readyState=="complete"){   
                                 
                            		//   alert(xmlHttp.responseText);

                            		document.getElementById("resultFromAjax2").innerHTML=xmlHttp.responseText;
                                    document.getElementById("idmobMod").value=document.getElementById("mobileSerial").value;
                                    document.getElementById("idmobSer").value=document.getElementById("mobileModel").value;
                                    document.getElementById("idmano1").value=document.getElementById("mobileano").value;
                                    document.getElementById("idmobAType").value=document.getElementById("mobileatype").value;
...
<script type="text/javascript">
function fetchHardDiscDetails(str,bn){  
	 document.getElementById("idhardMod").value = "";
	document.getElementById("idhardSer").value = "";
    document.getElementById("iddoiHard").value = "";
    document.getElementById("idhardType").value = "Select"; 
	 ...
	 if (typeof XMLHttpRequest != "undefined"){    
      xmlHttp= new XMLHttpRequest();    
          ...
          xmlHttp= new ActiveXObject("Microsoft.XMLHTTP");  
                 ...
                 alert("Browser does not support XMLHTTP Request");   
                   return;     
                    }       var url="assetavailable8.jsp"; 
                            url +="?AssetType=" +str + "&bname="+ bn ;   
                           xmlHttp.onreadystatechange = assetavailable8;  
                           xmlHttp.open("GET", url, true);   
                           xmlHttp.send(null);    
         }     
                     function assetavailable8(){     
                            	if(xmlHttp.readyState==4 || xmlHttp.readyState=="complete"){   
                                    document.getElementById("hardDiscAssetNo").innerHTML=xmlHttp.responseText;    
                                  }
...
<script type="text/javascript">
function hardDiscAssetConfigFetch(str){  
	document.getElementById("idhardMod").value = "";
	document.getElementById("idhardSer").value = "";
    document.getElementById("iddoiHard").value = "";
    document.getElementById("idhardType").value = "Select"; 
	 ...
	 if (typeof XMLHttpRequest != "undefined"){    
      xmlHttp= new XMLHttpRequest();    
          ...
          xmlHttp= new ActiveXObject("Microsoft.XMLHTTP");  
                 ...
                 alert("Browser does not support XMLHTTP Request");   
                   return;     
                    }       var url="assetavailable9.jsp"; 
                            url +="?AssetNo=" +str; 
                           // alert(url);
                           xmlHttp.onreadystatechange = assetavailable10;  
                           xmlHttp.open("GET", url, true);   
                           xmlHttp.send(null);    
         }     	
                     function assetavailable10(){     
                            	if(xmlHttp.readyState==4 || xmlHttp.readyState=="complete"){   
                //                    alert(xmlHttp.responseText);
                            		document.getElementById("resultFromAjax2").innerHTML=xmlHttp.responseText;
                                    document.getElementById("idhardMod").value=document.getElementById("HarddiscModel").value;
                                    document.getElementById("idhardSer").value=document.getElementById("HarddiscSerial").value;
								
                                    document.getElementById("idharddiscAType").value=document.getElementById("hdatype").value;
                                    document.getElementById("idhano1").value=document.getElementById("hdano").value;
                                    }
                           } 
</script>
...
<form  name="form"  method="post"  onsubmit="return validate()" action="assignOtherAssetDB.jsp" >
<br><br>
...
<div class="modal-header">
       ...
       <table border="1" style="height: 100; border: 1px solid black; padding: 5px;" cellpadding="0" bgcolor="lightgrey">
		    ...
		    <tr> 
		       ...
		       <td><input type="text" name="empBranch" maxlength="99" id="idempBranch" value="" size=20 readonly/></td>
		        <td><font size="2" face="Swiss" id="hiderow">EMP&nbsp;SUB BRANCH :</font></td>
		        ...
		        <td><input type="text" name="empMobNo" maxlength="99" id="idempMobNo" value="" size=20 readonly/></td>
		    </tr>
		    <tr>   
		       <td><font size="2" face="Swiss" id="hiderow">EMAIL ID :</font></td>
		       <td><input type="text" name="empEID" maxlength="99" id="idempEmailID" value="" size=30 readonly/>
		...
		<table border="1" style="height: 100; border: 1px solid black; padding: 5px;" cellpadding="0" bgcolor="lightgrey">
            <tr>
               <td><font size="2" face="Swiss" >Laptop&nbsp;/Desktop:</font></td>
               <td><table>
                      <tr>
                      ...
                      <td><font size="2" face="Swiss" id="hiderow">Asset No :&nbsp;&nbsp;&nbsp;</font></td>
                       <td><div id='assetno'>      
                   	   ...
                   	   <td colspan="2"><input type="text" name="ano1" maxlength="99" id="idano1" value="" size=20 readonly/></td>
                       </tr>
		               <tr>  
		              ...
		              <td><input type="text" name="remarksasset" maxlength="99" id="idremarksasset" value="" size=30 /></td>
		              <td><font size="2" face="Swiss" id="hiderow">Date Of Issue :</font></td>
		              <td><input type="text" name="doiasset" maxlength="99" id="iddoiasset" size=15 onclick="showCalendarControl(this)"/></td>
		              </tr>
                   </table>
              </td>                        
            </tr>   
            <tr>
               <td><font size="2" face="Swiss" >Email&nbsp;ID:</font></td>
               <td>
                   <table>
                      <tr>
                      <td><font size="2" face="Swiss" id="hiderow">Email ID&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;</font></td>
                      <td><input type="text" name="emailid" maxlength="99" id="idemailid1" value="" size=25 /></td>
		              ...
		              <td><input type="text" name="idfile" maxlength="99" id="ididfile" value="" size=20 /></td>   
		               <td><font size="2" face="Swiss" id="hiderow">Remarks :</font></td>
		              <td><input type="text" name="remarks2" maxlength="99" id="idremarks2" value="" size=30 /></td>
            ...
            <tr>
               <td><font size="2" face="Swiss" >Newins&nbsp;ID:</font></td>
               <td>
                   <table>
                      <tr>
            ...
            <tr>
               <td><font size="2" face="Swiss" >DSC:</font></td>
               <td>
                   <table>
                      <tr>
            ...
            <tr>   
               <td><font size="2" face="Swiss" >Domain&nbsp;User:</font></td>
               <td>
                   <table>
                      <tr>
            ...
            <tr>
               <td><font size="2" face="Swiss" >Data&nbsp;Card:</font></td>
               <td> <table >
                      <tr>
              ...
              %>
                       <select name="isp" id="idisp" style="font-size: 11px;width: 110px; overflow: auto; height: 20px">
		               <option selected="Select">Select</option>
	                   <%while(rs1.next()){%>
             ...
             <%} catch (SQLException ex)
		              ...
		              <td><font size="2" face="Swiss" id="hiderow">Data Card Type :</font></td>
		              <td><%
              try
                 {
	             Class.forName(driver1).newInstance();
                 ...
                 rs1 = st1.executeQuery(query1);
              %>
                       <select name="dctype" id="iddctype" style="font-size: 11px;width: 110px; overflow: auto; height: 20px">
		               <option selected="Select">Select</option>
	                   <%while(rs1.next()){%>
			           <option value="<%=rs1.getString(2)%>"><%=rs1.getString(2)%></option>
    	                      <%}%>
             ...
             <%} catch (SQLException ex)
		               ...
		               <td><font size="2" face="Swiss" id="hiderow">Remarks :</font></td>
		              <td><input type="text" name="remarks1" maxlength="99" id="idremarks1" value="" size=30/></td>    
		               </tr>
                   </table>
              </td>
            </tr> 
             <tr>
               <td><font size="2" face="Swiss" >Access&nbsp;Card/ Biometric:</font></td>
               <td>
                   <table>
                      <tr>
              ...
              try
                 ...
                 rs1 = st1.executeQuery(query1);
              %>
                       <select name="type" id="idtype" style="font-size: 11px;width: 110px; overflow: auto; height: 20px">
		               <option selected="Select">Select</option>
	                   <%while(rs1.next()){%>
			           <option value="<%=rs1.getString(2)%>"><%=rs1.getString(2)%></option>
    	                      <%}%>
             ...
             <%} catch (SQLException ex)
				    ...
				    <td><font size="2" face="Swiss" id="hiderow">Date Of Issue:</font></td>
	                <td><input type="text" name="doi6" maxlength="99" id="iddoi6" value="" size=20 onclick="showCalendarControl(this)"/></td>
   ...
   <!--  -----------------------Mobile Hand Set Details--------------  -->
            <tr>
               <td><font size="2" face="Swiss" >Mobile&nbsp;Handset</font></td>
               <td>
                   <table>
                      <tr>
                  	  <td><font size="2" face="Swiss" id="hiderow">Asset Type &nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp; </font></td>
                      <td><select name="mobAType" id="idmobAType"  onchange="fetchMobileDetails(this.value,idempBranch.value)">
		                  	 	<option selected value="Select">Select</option>
	                       		<option value="MOBILE PHONE">Mobile Handset</option>
	                      </select>
                      </td>
                      <td><font size="2" face="Swiss" id="hiderow">Asset No &nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp; </font></td>
                      <td>
                      		<div id='mobAssetNo'>      
                           <select name="mobAssetNo" id="idmobAssetNo" onchange="mobileAssetConfigFetch(this.value)" style="font-size: 11px;width: 110px; overflow: auto; height: 20px">  
                               <option selected ="Select">Select</option>
                           </select>     
                         </div>
                        </td>
                      <td colspan="2"><input type="text" name="mano1" maxlength="99" id="idmano1" value="" size=20 readonly/></td>
		              </tr>
		              <tr>
                      ...
                      <td><input type="text" name="mobSer" maxlength="99" id="idmobSer" value="" size=20 /></td>  
                 	    <td><font size="2" face="Swiss" id="hiderow">Date Of Issue:</font></td>
                      <td><input type="text" name="doiMob" maxlength="99" id="iddoiMob" value="" size=20 onclick="showCalendarControl(this)"/></td>
                     ...
                     <td><input type="text" name="mobileNo" maxlength="99" id="idmobNum" value="" size=20 /></td>
		              ...
		              <td>
		                 ...
		                 <select name="mobileNumComp" id="idmobileNoCom" style="font-size: 11px;width: 110px; overflow: auto; height: 20px">
		                   <option selected="Select">Select</option>
     ...
     <!-- ---------------------- Lotus Traveler -------------------- -->
              ...
              <tr>
               <td><font size="2" face="Swiss" >Lotus Note Traveler &nbsp;</font></td>
                <td>
               <table>
                <tr>
                <td><font size="2" face="Swiss" id="hiderow">Device Model &nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp; </font></td>
                      ...
                      <td>
                   		   <select name="lotusOwner" id="idlotusOwner" style="font-size: 11px;width: 110px; overflow: auto; height: 20px">
			                   <option selected="Select">Select</option>
            ...
            <!-- ---------------------- Internet / FTP --------------------- -->
            <tr>
               <td><font size="2" face="Swiss" >Internet &nbsp;/FTP:</font></td>
               <td>
                   <table>
                      <tr>
                      ...
                      <td><font size="2" face="Swiss" id="hiderow">Remarks :</font></td>
		              <td><input type="text" name="remarksFtp" maxlength="99" id="idremarksFtp" value="" size=30 /></td>
                      <td><font size="2" face="Swiss" id="hiderow">Date Of Issue:</font></td>
                      <td><input type="text" name="doiFtp" maxlength="99" id="iddoiFtp" value="" size=20 onclick="showCalendarControl(this)"/></td>
                      </tr>
          ...
          <tr>
               <td><font size="2" face="Swiss" >Hard Disk&nbsp;/Pen Drive:</font></td>
               <td>
               
                   <table>
                    <tr>
                  	  <td><font size="2" face="Swiss" id="hiderow">Asset Type &nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp; </font></td>
                      <td><select name="harddiscAType" id="idharddiscAType"  onchange="fetchHardDiscDetails(this.value,idempBranch.value)"style="font-size: 11px;width: 110px; overflow: auto; height: 20px">
		                  	 	<option selected value="Select">Select</option>
	                       		<option value="STORAGE (USER)">Hard Disc</option>
	                       		<option value="PEN DRIVE">Pendrive</option>
	                      </select>
                      </td>
                      <td><font size="2" face="Swiss" id="hiderow">Asset No &nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp; </font></td>
                      <td>
                      		<div id="hardDiscAssetNo">      
                           <select name="hardDiscAssetNo" id="idHardDiscAssetNo" onchange="hardDiscAssetConfigFetch(this.value)" style="font-size: 11px;width: 110px; overflow: auto; height: 20px">  
                               <option selected="Select">Select</option>
                           </select>     
                         </div>
                       </td>
                       <td colspan="2"><input type="text" name="hano1" maxlength="99" id="idhano1" value="" size=20 readonly/></td>
		              ...
		              <td>
		                 <select name="hardCap" id="idhardCap" style="font-size: 11px;width: 110px; overflow: auto; height: 20px">
		                   <option selected="Select">Select</option>
		                 ...
		                 <select name="hardType" id="idhardType" style="font-size: 11px;width: 110px; overflow: auto; height: 20px">
		                   <option selected="Select">Select</option>
		              ...
		              <td><font size="2" face="Swiss" id="hiderow">Remarks :</font></td>
		              <td><input type="text" name="remarks8" maxlength="99" id="idremarks8" value="" size=30 /></td>
		              </tr>
		           </table>
              </td>
            </tr>
            ...
            <!--  ---------------- Shared Folders -------------- -->
            <tr>
               <td><font size="2" face="Swiss" >Shared Folder:</font></td>
               <td>
                   <table>
                      <tr>
                      <td><font size="2" face="Swiss" id="hiderow">Path</td>
                      <td><input type="text" name="shaFO" maxlength="99" id="idshaFO" value="" size=30 /></td>
                      <td><font size="2" face="Swiss" id="hiderow">Remarks :</font></td>
		              <td><input type="text" name="remarksshaFO" maxlength="99" id="idremarksshaFO" value="" size=30 /></td>
            ...
            <tr>
               ...
               <td>
                   <table>
                      ...
                      <td><font size="2" face="Swiss" id="hiderow">Remarks :</font></td>
		              <td><input type="text" name="remarksappCre"  maxlength="99" id="idremarksappCre" value="" size=30 /></td>
         ...
         <tr>
               <td><font size="2" face="Swiss" >Other Asset:</font></td>
               <td>
                   <table>
                      <tr>
                      <td><font size="2" face="Swiss" id="hiderow">Asset Desicription</td>
                      <td><input type="text" name="otherAsset" maxlength="99" id="idotherAsset" value="" size=30 /></td>
                      <td><font size="2" face="Swiss" id="hiderow">Remarks :</font></td>
		              <td><input type="text" name="remarks9" maxlength="99" id="idremarks9" value="" size=30 /></td>
                      <td><font size="2" face="Swiss" id="hiderow">Date Of Issue:</font></td>
