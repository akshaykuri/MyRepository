...
<body bgcolor="#FFFFFF" leftmargin="80" rightmargin="80"   marginwidth="70" marginheight="70">
   <form name="form"  action="uploadAssetInventoryNONOIT1.jsp" method="post" enctype="multipart/form-data" >
</br>
 ...
 <%String FileFullPath="D://neinSoft//files//C2IT//assetFile//UploadAssetInventory.csv";%>
