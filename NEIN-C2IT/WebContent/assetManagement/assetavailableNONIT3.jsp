...
System.out.println("------------- NONIT  Asset Available 3 -----------------");
...
String atype=null;
    try{ 
        ...
        rs1 = stmt1.executeQuery("select * from asset_item where (AssetType='" + uid + "' and assignStatus=0 and Scrap=0 and Maintanance=0); ");
