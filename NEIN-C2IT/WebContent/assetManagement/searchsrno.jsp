...
<%
System.out.println("------------- Search Serno  -----------------");
String ano=null;
ano = request.getParameter("srno");//asset no    
...
<form name="form" id="myform" action="<%=request.getContextPath()%>/assetManagement/Report/reportBySrNo.jsp">  
<center>
