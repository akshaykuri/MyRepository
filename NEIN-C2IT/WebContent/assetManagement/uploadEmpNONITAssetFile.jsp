...
<body bgcolor="#FFFFFF" leftmargin="80" rightmargin="80"   marginwidth="70" marginheight="70">
   <form name="form"  action="uploadeEmpNONITAssetFile1.jsp" method="post" enctype="multipart/form-data" >
</br>
 ...
 <%String FileFullPath="E://neinSoft//files//C2IT//assetFile//UploadITAsset.csv";
 System.out.println("------------- Upload Emp IT Asset File  -----------------");
