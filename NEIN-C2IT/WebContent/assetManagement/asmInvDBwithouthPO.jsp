...
<body>
<%
	System.out.println("-------------  Asm Inv With Out Po -----------------");
					...
					if (rs.next())
				    {
						...
						else
					   {
						...
						for (k=1;k<count1;k++)
						 ...
						 AssetType=AssetTypes.get(k);
					 	 ...
					 	 AssetName=AssetNames.get(k);
					 	  ...
					 	  AssetInvoice1=AssetInvoice.get(k);
						  AssetAmount1=AssetAmount.get(k);
						  AssetDate1=AssetDate.get(k);
							
						 System.out.println(" Asset Invoice "+AssetInvoice1+"AssetAmount"+AssetAmount1+"Asset Date"+AssetDate1);
						...
						System.out.println("branch name : " + rde11);
					     	...
					     	System.out.println("Error inside the  branch  asmInvDBWithoutPo:"+e);
					    	e.printStackTrace();
				        }    
				...
				if (i!=0 && j == 0)
				   {
				    ...
				    response.sendRedirect("AsmInventoryWithouthPO.jsp?msg=" +msg1);}
		/* multiple invoice 		   } */
			 }
		    msg = "Invetory-data-inserted-successfully::";
	      //  response.sendRedirect("AsmInventoryWithouthPO.jsp?msg="+msg);
		 }//// first try block
		 catch (Exception e){
			 System.out.println(" Error inside the InventoryForm "+e);
			 e.printStackTrace();
