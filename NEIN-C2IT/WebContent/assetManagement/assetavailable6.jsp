...
<%
		System.out.println("-------------  asset Available 6 -----------------");
		...
		String buffer="<select name='mobAssetNo' id='idmobAssetNo' onchange='mobileAssetConfigFetch(this.value)' style=\"font-size: 11px;width: 110px; overflow: auto; height: 20px \"><option selected='Select' >Select</option>";  
        String name=null;
