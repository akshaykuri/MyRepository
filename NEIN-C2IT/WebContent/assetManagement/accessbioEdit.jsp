...
<form method="post" action="accessbioUpdate.jsp">
<br>
<br>
<br>
<table border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
	<tr>
	    <td></td>
		<td bgcolor="lightgrey" width="120" align=center><font color="black">Type Name</font></td>
	    <td bgcolor="lightgrey" width="120" align=center colspan="3"><font color="black">Update/Cancel</font></td>
		</tr>
	<%
		System.out.println("------------- Access Bio Edit  -----------------");
