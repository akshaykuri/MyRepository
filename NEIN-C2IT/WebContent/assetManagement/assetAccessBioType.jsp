...
<title>AssetAccessBioTypeMaster</title>
...
function cleartext()
	...
	document.getElementById('idaccessbiotype').value =null;
...
<% 
	System.out.println("------------- access BIoType  -----------------");
...
<form name="form" method="post"  onsubmit="return validate()" action="assetAccessBioTypeBack.jsp">
   <div>
   <BR><BR>
   ...
   <div class="modal-content">
    <div class="modal-header">
              <center> <h2>Access/Biometric Master</h2></center>
    </div>
    ...
    <table border=1>
           ...
           <tr>
                <td><font color="red" size="4">*</font>Type :</td>
                <td><input type="text" name="accessbiotype" maxlength="20" id="idaccessbiotype" value="" size=20 /></td>
           </tr>
    ...
    <table>
            <tr>
                ...
                <td><a href="DisplayAccesBioType.jsp" onclick="return popitup1('DisplayAccesBioType.jsp')">ViewAllType</a> </td>
