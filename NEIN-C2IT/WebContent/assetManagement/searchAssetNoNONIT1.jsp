	                      ...
	                      try
					         {
				               ...
				               {	 
	    			  	      //Inventory_No,Asset_No,AssetType,Branch,SubBranch,WarExpDate,assignStatus,Scrap,Maintanance ,Assignedfor
	    				      query3 = "select * from asset_item where (Asset_No='"+ano+"' and AssetType not in('DESKTOP','CCVTV','UPS_SETUP')and assignStatus='0')";  
 						      psmt2 = conn.prepareStatement(query3);
			                  rs2 = psmt2.executeQuery();
			                  query3s = "select * from asset_item where (Asset_No='"+ano+"' and AssetType not in('DESKTOP','CCVTV','UPS_SETUP')and assignStatus='0')";  
