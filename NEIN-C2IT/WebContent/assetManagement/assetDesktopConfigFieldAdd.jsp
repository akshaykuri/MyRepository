...
<body onload="myFunction()">
	<form method="post" action="asmInvDesktopDB.jsp" 
		name="form1" id="form"  >
		<input type="hidden" id="idflag" name="idflag" value="0" />
		<%
		System.out.println("------------- Asset Desktop Config Field Add -----------------");
								...
								{																						
											...
											%>
										 	 <tr>
													...
													<td><input type="text" id="assetName" name="assetName" value="CPU" readonly ></td>
													...
													<td> <input type="text" name="cpuasset" id="cpuasset" value="CPU"/></td>
													<td> <input type="text" name="cpuserial" id="cpuserial" value=""></td>
													<td> <input type="text" name="cpumodel" id="cpumodel" value=""></td>
													<td> <input type="text" name="cpubrand" id="cpubrand" value=""></td>
										    		<td>
										    		<tr>
										    	<tr>
										    		<td><font size="2" face="Swiss" id="hiderow">2</font>	</td>
													<td><input type="text" id="assetName1" name="assetName1" value="MONITER" readonly ></td>
													...
													<td> <input type="text" name="moniterasset" id="moniterasset" value="MONITER"></td>
													<td> <input type="text" name="moniterserila" id="moniterserila" value=""></td>
													<td> <input type="text" name="monitermodel" id="monitermodel" value=""></td>
													<td> <input type="text" name="moniterbrand" id="moniterbrand" value=""></td>
										    		<td>
