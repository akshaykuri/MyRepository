...
<table border="1" cellspacing="1" width="800" align="center" >
                 ...
                 queryemp = "select EmpId,EmpName,empdesg,empbranch,dept,atype,ano,asdoi,aconf from  assignotherassetemp "+
          		 ...
          		 <%try
   				     ...
   				     // System.out.println(queryemp);  				     
   				      ...
   				      psmt2.setString(3,at);
				      psmt2.setString(4,at);
				      
				      psmt2.setString(5,at);
   				      psmt2.setString(6,at);
   				      
   				      psmt2.setString(7,branch);
   				      psmt2.setString(8,branch);
   				      psmt2.setString(9,df);
   				      psmt2.setString(10,df);
   				      psmt2.setString(11,dt);
   				      psmt2.setString(12,dt);
...
<!--        		       <td width="67" align="center"  height="21" ><font size="2" ><b>SubBranch</b></font></td> -->
          				  ...
          				  -->  </tr> 
				             ...
				             // at,ano,branch,,sbranch,eid,aid,asgtype,asgfor,scm,df,dt
				             if(branch.equals("Select")&& (!at.equals("Select")))
				             {
				            	 System.out.println(" Condition 1::: asset Type selected ");
				             ...
				             if((!branch.equals("Select")) && at.equals("Select"))
				             {
				            	 System.out.println(" Condition 2 ::: branch selected ");
				            	 query2 = "select BranchCode,BranchName,BranchPHNo,AssetType,AssetName,AssetNo,DateOfAssigned,AssignedByName,ConfigField from  assignassetoffice "+
	                              "WHERE (BranchName = ? )";
				            	 psmt1 = conn.prepareStatement(query2);
					    	     psmt1.setString(1,branch);
					    	     
				             }
				             
				             if((branch.equals("Select")) && (at.equals("Select")))
				             {
				            	 System.out.println(" Condition 3::: with out selection all asset");
				            	 query2 = "select BranchCode,BranchName,BranchPHNo,AssetType,AssetName,AssetNo,DateOfAssigned,AssignedByName,ConfigField from  assignassetoffice ";
				            	 psmt1 = conn.prepareStatement(query2);
	                         }
...
<tr> 
<td style="font-size: 1"><input style="font-weight:bold;color:black; height='60' width='55'" type="button" title="Back To Selection Date Page" value="BACK" onclick="window.location.href='searchAsset.jsp?msg=1'" /></td>
<td align="right" >
