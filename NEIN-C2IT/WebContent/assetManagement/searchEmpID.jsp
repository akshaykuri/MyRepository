...
<form name="form" id="myform" action="<%=request.getContextPath()%>/assetManagement/Report/reportsearchEmpid.jsp">  
<center>
...
<tr><td colspan="5" align="left"><center><b><font size="3" style="font-size: medium;">DISPLAY RECORD </font></b></center></td></tr>
    <input type="hidden" value="<%=ano%>" id="ideid" name="eid"></input>
</table>
<br />
<%-- <table id="invoicetable" width="1000" bgcolor="" cellpadding="4" cellspacing="6" align="center" border=1>
	...
	<td   height="21" bgcolor="lightgrey" style="font-size: 1" width="10" align="center"><font size="2"> ADMIN DESG:<%=session.getAttribute("desg")%><b></b></font></td>
                 ...
                 <table class="dynatable" width="1000" border="" style="height: 150;" cellspacing="0" cellpadding="0"  align="center">
    			  ...
    			  <%try
			    	  ...
			    	  String edoi=null,ndoi=null,dscdoi=null,dscpass=null,dodoi=null,dcarddoi=null,demie=null,disp=null,dcardtype=null;	 
			     	   ...
			     	   String matype=null,mano=null,hatype=null,hano=null;
				      if(rs1.next())
				             {
				    	     ...
				    	     matype=rs1.getString(93);
				    	     mano=rs1.getString(94);
				    	     hatype=rs1.getString(95);
				    	     hano=rs1.getString(96);
    				...
    				<tr>   <!-- dscpin,dsccin,dscpass,dscdoi -->
    					...
    					<tr >
    					<td style="background-color:PaleGreen;" width="67" align="center" colspan="2" height="21" ><font size="2" ><b>MOBILE ASSET NO : </b></font></td>
    					<%if(mobmodno.equals("")){mano="Not Assigned";%>
    					   
    					    <td align=center ><font color="red" size="3"><%=mano%></font></td>
					         <%}else{ %>
					         <td align=center ><font color="black" size="3"><%=mano%></font></td>
					        	 <%}%>
    					</tr>
    					<tr>
    					...
    					<tr >
    					<td style="background-color:PaleGreen;" width="67" align="center" colspan="2" height="21" ><font size="2" ><b>HARD DISC ASSET NO : </b></font></td>
    					<%if(hardmodno.equals("")){hano="Not Assigned";%>
    					   
    					    <td align=center ><font color="red" size="3"><%=hano%></font></td>
					         <%}else{ %>
					         <td align=center ><font color="black" size="3"><%=hano%></font></td>
					        	 <%}%>
    					</tr>
				        <tr style="background-color:PaleGreen;">
