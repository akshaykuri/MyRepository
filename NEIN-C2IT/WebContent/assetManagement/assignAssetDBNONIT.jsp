...
<%
    ...
    //String brcode=assetno.substring(9,11);
    System.out.println("asset no :  " + assetno);
    //String branchname=empbranch+" -"+brcode; 
    //System.out.println("branch code1:" + brcode);
	...
	String brcode=null;
    	...
    	///////////////////////////////
		       ...
		       //branchcode = request.getParameter("branchCode");
		    	...
		    	//String s="hello"+branchcode+"hello";
		    	//System.out.println("value of S:"+ s);
		    	//if(branchcode==brcode)
	    	    /* if(branchcode.equals(brcode)) 
		    	{ */
		     	String branchname = request.getParameter("bname");
		    	//String subbranch = request.getParameter("Subcity");
		    	...
		    	prs3 = conn.prepareStatement("insert into assignassetoffice(BranchCode,BranchName,BranchPHNo,BranchAddress,AssetType,AssetName,AssetNo,DateOfAssigned,AssignedByName,AssignFor,Remarks,ConfigField,assignToBranch) values(?,?,?,?,?,?,?,'"+str+"','"+asgby+"',?,?,?,?)");
		...
		if ( j!=0)
		   { 
            ...
            response.sendRedirect("assignAssetNONIT.jsp?msg=" +msg);
		   }
