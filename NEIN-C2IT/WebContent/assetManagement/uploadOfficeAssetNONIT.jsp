...
<body bgcolor="#FFFFFF" leftmargin="80" rightmargin="80"   marginwidth="70" marginheight="70">
   <form name="form"  action="uploadOfficeAssetNONIT1.jsp" method="post" enctype="multipart/form-data" >
</br>
 ...
 <%String FileFullPath="E://neinSoft//files//C2IT//assetFile//UploadOfficeAsset.csv";
 System.out.println("------------- NONIT Uppload Office Asset    -----------------");
 %>
