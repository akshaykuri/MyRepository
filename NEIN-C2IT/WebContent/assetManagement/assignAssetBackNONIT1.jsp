...
String buffer1="<select name='assetName' id='idaType' onchange='assetnofetch(this.value)' style=\"font-size: 11px;width: 142px;overflow: auto;height: 20px \"><option value='-1'>Select</option>";
//String buffer="";
System.out.println("------- NONIT Assign Asset Back 1 --------");
