...
<center>
 <br />
	...
	<table border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
        ...
        <td bgcolor="white" width="120" align=center style="background-color:grey"><font size="2" color="black"><b>ConfigField</b></font></td>
        <td bgcolor="white" width="120" align=center style="background-color:grey"><font size="2" color="black"><b>ConfigDisc</b></font></td>
...
String query = "select ac.id,at.item_name,ac.configname,ac.configdisc from asset_type at, assetconfgfield ac where at.item_name = ac.assettype and at.it_nonit='NON IT' order By item_name";
