...
<img src="images/nippon.gif" height="35" width="220"> <img src="images/cs-soft.jpg" height="25" width="100" align="right">
 ...
 <form name="form" method="post" onSubmit="return validate()" action="AddsCcu.jsp">

<table width="1118" align="center" border="0" cellspacing="0" cellpadding="0">
  <tr align="center">
    <td bgcolor="#ec691f"><strong><font size ="4" color="white"><b>KOLKATA BRANCH</b><br />
...
<font color=darkblue size=3 > CREATE SPECIFIC USER</font>
	...
	<tr><td>
    <a href="DisplayDelCcu.jsp" onclick="return popitup('DisplayDelCcu.jsp')">View Detail</a> </td>
