...
<tr align="center">
 <td bgcolor="#2f4377" class="blueLine"><strong><font size ="4" color="white">COMPLAINT DETAILS</font></strong></td>
</tr>
  </table>
<table align="center" cellspacing="0" cellpadding="0" border="0" width="1118"> 
<tr>
...
<form name="form1" method="post" action="complainPageStatusBranchAdmin.jsp?msg=1" onsubmit="return ValidateForm();">
