...
<form method="post" action="InternetUpdate.jsp">
<br />
<br /><br />
...
String dbName = dbProperties.getString("csdb.dbName");
  ...
  String query = "select * from internet_master where id='"+no+"'";
  ...
  <tr>
      ...
      <td bgcolor=""><input name="internet_name" style="background-color:white;width:100;color:black;" value="<%=rs.getString("internet_name")%>"></td>
      <td bgcolor=""><font color="white"><input name="internet_add" style="background-color:white;width:80;color:black;" value="<%=rs.getString("internet_add")%>"></font></td>
