...
<table width="1118" align="center" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr align="center">
 <td bgcolor="#2f4377" colspan="2"><strong><font size ="4" color="white">ASSET  DETAILS</font></strong></td></tr>
 ...
 try 
  ...
  //String query = "select assettype,configname from assetconfgfield where assettype='"+an+"' and configname ='"+co+"'";
   ...
   //rs = st.executeQuery(query);
    ...
    String query1 = "select hwp_id,Asset_type,serial_no,brand,model,configuration from hardware_nonit_multiple where Asset_no='"+no+"'";
