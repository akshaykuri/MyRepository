...
<div id="leftfeature"><input type="button" value="BACK" onclick="history.go(-1)"/></div>
	<div id="page-wrap">
...
rst5 = stt5.executeQuery("select desg,emp,mail,gmmail,brmail,itmail,admail from cs_master where cs_id  = '"+req+"'");
while(rst5.next()){
	
	        String desg = rst5.getString("desg");
	        String emp =rst5.getString("emp");
	        String mail = rst5.getString("mail");
	        String gmmail = rst5.getString("gmmail");
	        String brmail = rst5.getString("brmail");
	        String itmail = rst5.getString("itmail");
	        String admail = rst5.getString("admail");
	        
%>
       <tr>SENT TO:
       <td>
       <input type ="text" name = "quarter_r" value ="<%=gmmail%>"/>
       </td><td>
       <input type ="text" name = "quarter_r" value ="<%=brmail%>"/>
       </td>
       <td>
       <input type ="text" name = "quarter_r" value ="<%=itmail%>"/>
       </td>
       <td>
       <input type ="text" name = "quarter_r" value ="<%=admail%>"/>
       </td>
       </tr>
       <%--   <tr>
         <td>
...
<table align=center bgcolor="lightgrey">
   ...
   <tr> 
      <td style="font-size:1">&nbsp;&nbsp;<input style="size:1;font-size: 1.1em;" type="button"  value="BACK" onclick="window.location.href='SelectCheckListAdmin.jsp?msg=1'"/> </td>
