...
<tr><td colspan="5" align="left"><center><b><font size="3" style="font-size: medium;">CCTV SURVEILLANCE & SECURITY SYSTEMS</font></b></center></td></tr>
</table>
...
<%-- 	<tr style="background: lightgrey">
	...
	<tr>
		...
		<!-- <td height="20" bgcolor="lightgrey"  align=center><font color="black" size="2"><b>CCTV footage reviewed by IT Dept.</b></font></td>
		<td height="20" bgcolor="lightgrey"  align=center><font color="black" size="2"><b>CCTV footage reviewed by HR & Admin.</b></font></td>
	 -->	
		...
		<td height="20" bgcolor="lightgrey"  align=center><font color="black" size="2"><b>TO DATE</b></font></td>
				    ...
				    String form9_no,SessionName,Created_date,from_date,to_date,Approval_status,Approval_remarks,branchI=null,ITReview=null,HRReview=null;
				         ...
				         // String query3 = "select form9_no,SessionName,LEFT(SessionCity,LOCATE('-',SessionCity) - 1) as SessionCity,DATE_FORMAT(Created_date,'%d %b %Y') as Created_date "+
				          // ",DATE_FORMAT(from_date,'%d %b %Y') as from_date "+
				           //",DATE_FORMAT(to_date,'%d %b %Y') as to_date "+
				          // ",Approval_status,Approval_remarks from  form9_incident_log "+
							//	           "WHERE "+
				        ...
				        //   rs2 = st2.executeQuery("CALL search_Company_Service_Status(?,?,?)");
				           while(rs2.next()){
				            	flag=1;
				        						...
				        						//form9_no,SessionName,Created_date,from_date,to_date,Approval_status,Approval_remarks
					...
					<input type="hidden" name="<%=k%>" value="<%=s_no%>" />
	         		<td  align=center  ><font color="white" size="2" ><a href="#" onclick="link(<%=k%>);"  title="click for more details"><%=s_no%></a></font> </td>
					...
					<%-- <td align=center><font color="black" size="2"><%=ITReview %></font></td>
					<td align=center><font color="black" size="2"><%=HRReview%></font></td> --%>
