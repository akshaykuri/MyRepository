...
<form name="form" method="post" action="IncidentLogLocalAdmin.jsp?msg=1">
...
rs9 = st9.executeQuery("SELECT DISTINCT form9_no FROM  form9_incident_log WHERE Approval_emp='"+AdminName+"' and Approval_desg='"+desg+"' and status='Pending' AND form9_no LIKE 'NEIN/CS/IL%' ORDER BY id DESC");
