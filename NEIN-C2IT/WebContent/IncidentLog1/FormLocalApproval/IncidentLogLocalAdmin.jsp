...
<table id="tableData" name="tableData" width="100%" border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
	  ...
	  rs1f = st1f.executeQuery("select form9_no,I_date,I_time,I_viewedBy,Incident_Reported,I_Remarks,Created_Date,viewedByIT,id from form9_incident_item WHERE form9_no='"+req+"' ORDER BY id ASC"); 
	  while(rs1f.next())
	  { k++;
	   ...
	   <tr>
		...
		<td bgcolor="white" width="20" align="center"><font size="2" color="black"><%=I_date%></font></td>
		<td bgcolor="white" width="20" align="center"><font size="2" color="black"><%=I_time%></font></td>

		<td bgcolor="white" width="120" align="center"><font size="2" color="black"><%=I_viewedBy%></font></td>
		<td bgcolor="white" width="120" align="center"><font size="2" color="black"><%=Incident_Reported%></font></td>
