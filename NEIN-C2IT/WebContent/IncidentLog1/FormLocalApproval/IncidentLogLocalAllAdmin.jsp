...
<table id="tableData" name="tableData" width="100%" border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
	  ...
	  rs1 = st1.executeQuery("select form9_no,I_date,I_time,I_viewedBy,Incident_Reported,I_Remarks,Created_Date,viewedByIT,id,viewedByGA from  form9_incident_item WHERE form9_no='"+values[0]+"'  ORDER BY id ASC"); 
	  while(rs1.next())
	  {
