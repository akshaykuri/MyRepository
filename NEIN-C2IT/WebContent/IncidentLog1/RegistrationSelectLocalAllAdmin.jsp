...
<tr align="center">
 <td bgcolor="#2f4377" colspan="2"><strong><font size ="4" color="white">REGISTRATION FORM</font></strong></td></tr>
...
if(b_no.equals("90"))
	rs9 = st9.executeQuery("SELECT DISTINCT form10_no,full_name,Software FROM  form14_ccdregistration WHERE form10_no LIKE 'NEIN/CCDReg%' ORDER BY idextend DESC");
else
	rs9 = st9.executeQuery("SELECT DISTINCT form10_no,full_name,Software FROM  form14_ccdregistration WHERE i_b_no='"+b_no+"' AND form10_no LIKE 'NEIN/CCDReg%' ORDER BY idextend DESC");
