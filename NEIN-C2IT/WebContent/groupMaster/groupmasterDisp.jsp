...
var f=document.form;    
f.method="post";    
f.action='groupmasterEdit.jsp?id='+id;    
f.submit();
}
...
var f=document.form;    
f.method="post";    
f.action='groupmasterDel.jsp?id='+id;    
f.submit();
}
	else{}
}
...
<center>
     <br />
		...
		<tr>
		 	<td height="20" bgcolor="white" width="120" align=center><font size="2" color="black"><b>GROUP NAME</b></font></td>
...
ResultSet rs=null; 
  try
    ...
    String query = "select * from groupmaster";
