...
<br><br>
<form method="post" name="form1" action="UpdateCat.jsp" enctype="multipart/form-data">
...
<table  align="center" border="1" width="75%" style="margin-left:110px;"> 
	...
	<tr> 
			...
			<%                      
				...
				<td><input type="text" name="poNumber" id="poNumber" size="15" value="<%=rs1.getString("po_number")%>" readonly="readonly" onkeyup="sendInfo(this.value)"></td>
				<td><b style="color:red">*</b>Purchase Date</td>
				<td><input type="text" name="monthOfPayment" id="monthOfPayment" size="10" readonly="readonly" value="<%=rs1.getString("month_of_payment")%>" ></td>
	    ...
	    <tr>
				...
				<td><input	type="text" name="quantity" id="quantity<%=x%>" readonly="readonly" class="number-only" value="<%=rsx.getString("quantity")%>" size="6" onkeypress="return isNumberKey1(event,<%=x%>)"></td>
				<td><input	type="text" name="amount" id="amount<%=x%>"  readonly="readonly" value="<%=rsx.getString("amount")%>" size="15"></td>	
				<td><input type="text" name="invoiceno" id="invoiceno<%=x%>"  readonly="readonly" value="<%=rsx.getString("invoiceno")%>" size="20"></td>
			    <td><input type="text" name="invoiceAmt" id="invoiceAmt<%=x%>" readonly="readonly" class="number-only" value="<%=rsx.getString("invoice_amt")%>" size="13" onkeypress="return isNumberKey(event)" maxlength="10" ></td>				
			    <td><input type="text" name="invoiceDate" id="invoiceDate<%=x%>"  readonly="readonly" value="<%=rsx.getString("invoice_date")%>"  readonly class="date1"></td>
...
<tr>
	<td colspan="12"> Total Amount &nbsp &nbsp &nbsp &nbsp 
	   <input type="text" name="totalAmt" id="totalAmt"  value="<%=total%>" readonly="readonly" size="30" readonly onclick="return totalamount();"></td>
	</tr>
<tr>
