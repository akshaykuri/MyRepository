             ...
             <%              
                           ...
                           try
   						 ...
   						 query = " SELECT DISTINCT c.catridge_model,s.b_name,mb.m_b_name,c.printer_name,"+
   										...
   										" Round(SUM( CASE WHEN MONTH( c.month_of_payment ) =2 THEN c.amount ELSE 0 END ),2 ) Amt_Feb,"+
   										" Round(SUM( CASE WHEN MONTH( c.month_of_payment ) =3 THEN c.amount ELSE 0 END ),2 ) Amt_Mar,"+
   										" Round(SUM( CASE WHEN MONTH( c.month_of_payment ) =4 THEN c.amount ELSE 0 END ),2 ) Amt_Apr,"+
   										" Round(SUM( CASE WHEN MONTH( c.month_of_payment ) =5 THEN c.amount ELSE 0 END ),2 ) Amt_May,"+
   										" Round(SUM( CASE WHEN MONTH( c.month_of_payment ) =6 THEN c.amount ELSE 0 END ),2 ) Amt_June,"+
   										" Round(SUM( CASE WHEN MONTH( c.month_of_payment ) =7 THEN c.amount ELSE 0 END ),2 ) Amt_July, "+
   										" Round(SUM( CASE WHEN MONTH( c.month_of_payment ) =8 THEN c.amount ELSE 0 END ),2 ) Amt_Aug,"+
   								        " Round(SUM( CASE WHEN MONTH( c.month_of_payment ) =9 THEN c.amount ELSE 0 END ),2 ) Amt_Sep,"+
   										" Round(SUM( CASE WHEN MONTH( c.month_of_payment ) =10 THEN c.amount ELSE 0 END ),2 ) Amt_Oct,"+
   										" Round(SUM( CASE WHEN MONTH( c.month_of_payment ) =11 THEN c.amount ELSE 0 END ),2 ) Amt_Nov,"+
   										" Round(SUM( CASE WHEN MONTH( c.month_of_payment ) =12 THEN c.amount ELSE 0 END ),2 ) Amt_dec"+
	              ...
	              %>
					 <tr class="bluetd1">
						...
						<td ><%=rs1.getString("printer_name")%></td>
						<td ><%=rs1.getString("catridge_model")%></td>
...
<input type="hidden" name="view" value="catridge">
...
<form action="../callForReport" method="get" style="margin-left:110px;">
	<input type="hidden" name="view" value="catridge2">
	<input type="hidden" name="branch" value="<%=branchId%>">
    <input type="hidden" name="fromdate" value="<%=fromdate1%>">
    <input type="hidden" name="todate" value="<%=todate1%>">
