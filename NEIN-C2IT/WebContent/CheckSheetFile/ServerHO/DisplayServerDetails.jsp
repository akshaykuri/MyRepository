...
<title>SERVER HDD DETAILS</title>
...
var f=document.form;    
f.method="post";    
f.action='ServerDetailsEdit.jsp?id='+id;    
f.submit();
}
function deleteRecord(id)
{    
	if(confirm('You are above to delete a HO Server Details'))
	{
var f=document.form;    
f.method="post";    
f.action='ServerDetailsDelete.jsp?id='+id;    
f.submit();
}
	else{}
}
...
<center>
	...
	<table border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
		...
		<td bgcolor="white" width="120" align=center><font size="2" color="black"><b>DRIVE</b></font></td>
		<td bgcolor="white" width="120" align=center><font size="2" color="black"><b>HDD SPACE</b></font></td>
		<td bgcolor="white" width="120" align=center><font size="2" color="black"><b>IF DRIVE IN TB</b></font></td>
		<td bgcolor="white" width="120" align=center><font size="2" color="black"><b>EDIT</b></font></td>
...
String query = "select * from  server_details_master";
...
<td bgcolor="white" width="100"><font size="2" color="black"><%=rs.getString(3)%>&nbsp;&nbsp; <%=rs.getString(5)%></font></td>
