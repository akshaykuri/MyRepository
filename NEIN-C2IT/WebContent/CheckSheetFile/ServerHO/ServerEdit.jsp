...
<form method="post" action="ServerUpdate.jsp">
<br />
<br /><br />
...
String dbName = dbProperties.getString("csdb.dbName");
  ...
  String query = "select * from servername where id='"+no+"'";
  ...
  <tr>
      ...
      <td bgcolor=""><input name="backup_name" style="background-color:white;width:100;color:black;" value="<%=rs.getString("sname")%>"></td>
      <td bgcolor=""><font color="white"><input name="backup_detail" style="background-color:white;width:80;color:black;" value="<%=rs.getString("sdetail")%>"></font></td>
      ...
      <td style="visibility: hidden;"><input type="hidden" name="id" value="<%=rs.getString(1)%>"><input type="hidden" name="sname" value="<%=rs.getString(2)%>"></td>
