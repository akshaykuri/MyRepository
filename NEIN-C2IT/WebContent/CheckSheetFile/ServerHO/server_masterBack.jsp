...
rs = st2.executeQuery("select sname from servername where sname='"+backup_name+"'");
if(rs.next()){
	...
	psmt1 = cn.prepareStatement("insert into servername(sname,sdetail,bkLocation) values(?,?,?)");
...
response.sendRedirect("server_master.jsp?msg=" +msg);
}
catch (Exception e) {
