...
var f=document.form;  
	f.method="post";   
	f.action='CheckListViewTextForm.jsp?s_no='+s_no;
...
<tr><td colspan="5" align="left"><center><b><font size="3" style="font-size: medium;">CHECK LIST REPORT</font></b></center></td></tr>
</table>
