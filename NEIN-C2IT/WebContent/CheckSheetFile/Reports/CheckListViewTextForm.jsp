...
<tr>
<td>CheckSheet No.:<textarea id="idcs_id" name="cs_id" rows="1" readonly="readonly"><%= req %></textarea></td>
<td align="right">Location:<textarea id="idcity" name="city" rows="1" readonly="readonly"><%=city%></textarea></td>
</tr>
<tr >
<td >Creation Date (dd/mm/yyyy):  <textarea id="idcs_date" name="cs_date" rows="1" readonly="readonly"><%= cs_date %></textarea></td>
<td align="right">Creation Time:   <textarea id="idcs_time" name="cs_time" rows="1" readonly="readonly"><%= cs_time %></textarea></td>
</tr>
...
<tr>
	...
	<td colspan="2">&nbsp;RAW Power Working</td><td >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type ="text" name = "ps_raw" value ="<%=ps_raw %>" readonly="readonly"/></td>
</tr>
<tr>
...
<tr>
	<td colspan="2">&nbsp;UPS Backup Time(To be checked weekly once)</td><td >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type ="text" name = ps_upsbackup value ="<%=ps_upsbackup %>"  readonly="readonly"/>hours</td>
</tr> 
			 ...
			 <%int i=0;
				...
				<tr class="prototype">
				   <td width="36"  height="21" ></td>
					...
					<td width="10" align="center"  height="21" ><input readonly="readonly" type="text" name="id[]" value="<%=i%>" size=1 class="id" /></td>		
					<td width="217" align="center"  height="21" ><input readonly="readonly" type="text" name="si_harddisk" size="10" value="<%=si_harddisk %>" id="idsi_harddisk" style="background:lightgrey;" />	 
					</td>
                      <td width="217" align="center"  height="21" ><input readonly="readonly" type="text" name="si_drive" size="10" value="<%=si_drive %>" id="idsi_harddisk" style="background:lightgrey;" />	 
					</td>
					<td width="218" align="center"  height="21" ><input readonly="readonly" type="text" name="si_usedspace" size="10" value="<%=si_usedspace%>" class="incRate" style="background:lightgrey;" /></td> 
					<td width="218" align="center"  height="21" ><input readonly="readonly" type="text" name="si_freespace" size="10" value="<%=si_freespace%>" class="incRate" style="background:lightgrey;" /></td>      
				</tr>
...
<tr>
	...
	<td width="40">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type ="text" name = isp_router value ="<%=isp_router %>" readonly="readonly" /></td>
</tr>
<%} 
}
catch (Exception e) {
...
<table class="dynatable3" border="2" cellspacing="1" width="900" style="height: 150"  bgcolor="">
			...
			<tr class="prototype3">
					...
					<td width="60" align="center"  height="21" ><input readonly="readonly" type="text" name="id3[]" value="<%=k%>" size=1 class="id3" /></td>					
					<td width="320" align="center"  height="21" ><input readonly="readonly" type="text" class="incinternet" id="idint_name" value="<%=int_name%>"/></td>
                      <td width="100" align="center"  height="21" ><input readonly="readonly" type="text" class="incinternet"  value="<%=internet%>"/></td>
...
<table class="dynatable4" border="2" cellspacing="1" width="900" style="height: 150"  bgcolor="">
			...
			<%int l=0; try{
				...
				<tr class="prototype4">
					...
					<td width="60" align="center"  height="21" ><input readonly="readonly" type="text" name="id4[]" value="<%=l%>" size=1 class="id4" /></td>					
					<td width="320" align="center"  height="21" ><%=bkup_name %></td>
                      <td width="100" align="center"  height="21" ><input readonly="readonly" type="text" class="incbkup" value="<%=bkup%>"/></td>
...
<tr>
	<td width="65" align="center" height="5" colspan="2"><center>7</center></td>
	<td width="390" >&nbsp;Cisco Router Working(HO only)</td><td width="445">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<tr>
	...
	<td width="390" >&nbsp;FortiGate 500D Firewall working(HO only)</td><td width="445">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<tr>
	...
	<td width="390" >&nbsp;Server Room AC (Working) <br /> Temperature Maintained</td><td width="445">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type ="text" name = sr_ac value ="<%=sr_ac %>" readonly="readonly" onclick="popup();"/><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type ="text" size="30" name = "tm" value ="<%=tm %>"  readonly="readonly"/>
        </td>
</tr>
<%} 
...
<table class="dynatable6" border="2" cellspacing="1" width="900" style="height: 150"  bgcolor="">
				...
				<tr class="prototype6">
					...
					<td width="320" align="center"  height="21" ><input type="text" readonly="readonly" class="incprt" value="<%=prt_name%>"/></td>
                      <td width="100" align="center"  height="21" ><input type="text" readonly="readonly" class="incprt" value="<%=prt%>"/></td>
...
<table class="dynatable7" border="2" cellspacing="1" width="900" style="height: 150"  bgcolor="">
				...
				<tr class="prototype7">
					...
					<td width="60" align="center"  height="21" ><input type="text" readonly="readonly" name="id7[]" value="<%=o%>" size=1 class="id7" /></td>					
					<td width="320" align="center"  height="21" ><input type="text" readonly="readonly" value="<%=fx_name %>" class="incfx"/></td>
					
                      <td width="100" align="center"  height="21" ><input type="text" readonly="readonly" value="<%=fx %>" class="incfx"/></td>
					  <td width="245" align="center"  height="21" ></td>      
				</tr>
...
<table class="dynatable8" border="2" cellspacing="1" width="900" style="height: 150"  bgcolor="">
				...
				<tr class="prototype8">
					...
					<td width="60" align="center"  height="21" ><input type="text" readonly="readonly" name="id8[]" value="<%=p%>" size=1 class="id8" /></td>					
					<td width="320" align="center"  height="21" ><input type="text" readonly="readonly" class="incbr" value="<%=br_name%>"/></td>
					<td width="100" align="center"  height="21" ><input type="text" readonly="readonly" class="incbr" value="<%=br%>"/></td>
...
<td width="408">&nbsp;Intrusion Deduction System (IDS) (working)</td><td width="460" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type ="text" name = "ids_w" value ="<%=ids_w %>" readonly="readonly"/></td></tr>
<tr>
	<td width="32" align="center" rowspan="1"><center></center></td>
	<td colspan="2" width="408">&nbsp;When was last checked</td><td width="460" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<td width="408">&nbsp;Any IT hardware under Repair(Pls. specify)</td><td width="460">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type ="text" name = "ithardware_r" readonly="readonly" value ="<%=ithardware_r %>" /></td></tr>
<tr>
	<td width="32" align="center" rowspan="1"><center></center></td>
	<td colspan="2" width="408">&nbsp;Status or by it will be rectified and put into use</td><td  width="460">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type ="text" name = "ithardware_n" readonly="readonly" value ="<%=ithardware_n %>"  /></td>
</tr>
...
<tr>
	...
	<td colspan="2" width="408">&nbsp;To be done every quater without fail <br />&nbsp; If No, provide reason</td><td width="460">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type ="text" readonly="readonly" name = "quarter_r" value ="<%=quarter_r%>"/></td>
</tr>

</table>
 <label>Remarks (If any):</label><br />
<textarea rows="3" cols="175" readonly="readonly" name="main_remarks" style="background: lightgrey;"><%=main_remarks %></textarea> 
