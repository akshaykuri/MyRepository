...
st=con.createStatement();
 ...
 rs1=st.executeQuery("select * from nentryho where Npwd='"+currentPassword+"' AND Nname='"+newName+"'");
if(rs1.next())
{
id=rs1.getInt(1);
...
int i=st1.executeUpdate("update nentryho set Npwd='"+Newpass+"',EMP_NO='"+emp_no+"',Naddr='"+address+"',Ncontact='"+contact+"' where id='"+id+"'");
%>
<center>
<% 
...
response.sendRedirect("change_pwdHO.jsp?msg=" +msg);
}
