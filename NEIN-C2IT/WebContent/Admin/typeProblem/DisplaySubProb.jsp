...
var f=document.form;    
f.method="post";    
f.action='SubProbEdit.jsp?id='+id;    
f.submit();
}
function deleteRecord(id)
{    
	if(confirm('You are above to delete a Sub Title from Type Master'))
	{
var f=document.form;    
f.method="post";    
f.action='SubProbDelete.jsp?id='+id;    
f.submit();
}
	else{}
}
...
<center>
	...
	<table border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
		...
		<td height="20" bgcolor="white" width="120" align=center><font size="2" color="black"><b>TYPE</b></font></td>
		<td bgcolor="white" width="120" align=center><font size="2" color="black"><b>CATEGORIES.</b></font></td>
		<td bgcolor="white" width="120" align=center><font size="2" color="black"><b>DESCRIPTION</b></font></td>
		<td bgcolor="white" width="120" align=center><font size="2" color="black"><b>SW/HW</b></font></td>
		</tr>
...
String query = "select * from prob_type_master_sub ORDER BY name ASC";
