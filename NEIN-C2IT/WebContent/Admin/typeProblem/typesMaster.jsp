...
<font color=darkblue size=3 > CREATE NEW TYPE</font>
</td>
</tr>
...
<%
                    ...
                    rs_id = st_id.executeQuery("SELECT max(no) from prob_type_master_main");
                    while ( rs_id.next() )
                    {    
	...
	<tr>
	<td>
    <a href="DisplayTypes.jsp" onclick="return popitup('DisplayTypes.jsp')">View Detail</a> </td>
