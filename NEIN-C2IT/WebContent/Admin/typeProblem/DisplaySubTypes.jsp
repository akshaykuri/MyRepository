...
var f=document.form;    
f.method="post";    
f.action='NewSubTypeEdit.jsp?id='+id;    
f.submit();
}
function deleteRecord(id)
{    
	if(confirm('You are above to delete a Category'))
	{
var f=document.form;    
f.method="post";    
f.action='NewSubTypeDelete.jsp?id='+id;    
f.submit();
}
	else{}
}
...
String query = "select * from prob_master ORDER BY p_type ASC";
