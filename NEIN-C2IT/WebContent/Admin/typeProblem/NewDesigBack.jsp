...
String msg = null;
rs = st2.executeQuery("select NAME from prob_type_master_main where NAME='"+NAME+"'");
if(rs.next()){
...
int i=st.executeUpdate("insert into prob_type_master_main(NAME,no) values('"+NAME+"','"+no+"')");
...
<br />
 ...
 <button onclick="window.location.href='typesMaster.jsp?msg=1'">OK</button>
</b>
</font>
</center>
</div>
