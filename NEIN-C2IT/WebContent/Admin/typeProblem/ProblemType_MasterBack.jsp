...
String pt_fullDescription = request.getParameter("pt_fullDescription");
String swhw = request.getParameter("sw_hw");
String msg = null;
PreparedStatement psmt1=null;
rs = st2.executeQuery("select name from  prob_type_master_sub where name='"+p_type+"'");
if(rs.next()){
...
psmt1 = cn.prepareStatement("insert into prob_type_master_sub(name,pt_descriptions,pt_fullDescription,sw_hw) values(?,?,?,?)");
//int i=st.executeUpdate("insert into prob_master(p_type,bkLocation) values('"+p_type+"','"+bkLocation+"')");

psmt1.setString(1,bkLocation);
psmt1.setString(2,p_type);
psmt1.setString(3,pt_fullDescription);
psmt1.setString(4,swhw);
...
msg = "'"+p_type+"'__SAVED__SUCCESSFULLY";
