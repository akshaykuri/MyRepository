...
<div id="wrapper"> 
  <form name="form" method="post" onSubmit="return validate()" action="SubNewTypeBack.jsp">
...
<font color=darkblue size=3 > CREATE NEW CATEGORY</font>
</td>
</tr>
...
<%
                    ...
                    rs_id = st_id.executeQuery("SELECT max(id) from prob_master");
                    while ( rs_id.next() )
                    {    
	...
	<tr>
	<td>
    <a href="DisplayTypes2.jsp" onclick="return popitup('DisplaySubTypes.jsp')">View Detail</a> </td>
