...
<title>INTERNET MASTER PAGE</title>
...
<% 
 ...
 <script language = "Javascript">
          ...
          function validate(){
              var w=document.form.internet_name;
              var ab=document.form.internet_add;
...
<tr align="center">
 <td bgcolor="#2f4377" class="blueLine"><strong><font size ="4" color="white">ISP MASTER</font></strong></td>
</tr>
 </table>


 
  <form name="form" method="post" onSubmit="return validate()" action="Internet_MasterBack.jsp">
...
<table width="920" height="3" cellpadding="0" cellspacing="0" ID="Table1">
  ...
  <td width="25%" align="justify" valign="top"></td>
    <td width="21%" align="justify" valign="top">
      <p> <img src="images/internet.png" height="150" width="340">
</td>
...
<font color=darkblue size=3 > ISP DETAILS</font>
</td>
</tr>

	<tr><td><font size="2">ISP NAME:</font><font color=red>*</font></td><td><input type="text" size="20" name="internet_name" value=""></td></tr>

	<tr><td><font size="2"> ISP DETAIL:</font><font color=red>*</font></td><td><input type="text" size="20" name="internet_add" value=""></td></tr>
<tr><td><font size="2">LOCATION:</font><font color=red>*</font></td><td>
	...
	<tr>
	<td>
    <a href="DisplayInternet.jsp" onclick="return popitup('DisplayInternet.jsp')">View ISP </a> </td>
