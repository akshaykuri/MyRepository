...
<%
 ...
 Statement st=null,st2=null,st3=null,st4=null,st5=null,st6=null,st7=null,st8=null,st9=null,st10=null,st11=null,st12=null,st13=null,st14=null;
 ...
 String[] parts1 = req.split("/");
 System.out.println("FIRST : "+parts1[1]);
 String first = "";
 String second ="";
 if(!parts1[1].equals("USB")&& !parts1[1].equals("VPN"))
	 {
 ...
 String query3 = "SELECT form3_no FROM form3_lotus  WHERE SUBSTRING(form3_no,9,20)='"+second+"'";
  ...
  String query6 = "SELECT form6_no,SUBSTRING(form6_no,9,20) FROM form6_internet  WHERE SUBSTRING(form6_no,9,20)='"+second+"'";
  ...
  String query7 = "SELECT form7_no FROM form7_newins  WHERE SUBSTRING(form7_no,9,20)='"+second+"'";
   ...
   String query9 = "SELECT form9_no,SUBSTRING(form9_no,9,20) FROM  form9_incident_log  WHERE SUBSTRING(form9_no,9,20)='"+second+"'";
   st9 = conn.createStatement();
   rs9 = st9.executeQuery(query9);
   String query10 = "SELECT form10_no FROM form10_registration  WHERE SUBSTRING(form10_no,9,20)='"+second+"'";
   ...
   String query12 = "SELECT form10_no FROM form17_usb_access_item  WHERE SUBSTRING(form10_no,6,3)='USB' and form10_no='"+req+"'";
  ...
  if(rs.next()){
	  String rss = rs.getString(1);
	              ...
	              response.sendRedirect("ITFORMS/FormApproval/PopupLink/ITclearanceAdmin.jsp?rss="+rss);
               }
  else if(rs2.next()){
	  String rss = rs2.getString(1);
                          ...
                          //response.sendRedirect("DomainUser/FormApproval/DomainUserAdmin.jsp?msg=1");
                          response.sendRedirect("DomainUser/FormApproval/PopupLink/DomainUserAdmin.jsp?rss="+rss);
                   }
  else if(rs3.next()) {
	  String rss = rs3.getString(1);
	                      ...
	                      response.sendRedirect("LOTUS/FormApproval/PopupLink/LotusAdmin.jsp?rss="+rss);
                      }
  else if(rs4.next()) {
	  String rss = rs4.getString(1);
	                      ...
	                      //response.sendRedirect("AccessCard/FormApproval/AccessCardSelectAdmin.jsp?rss="+rss);
	                      response.sendRedirect("AccessCard/FormApproval/PopupLink/AccessCardAdmin.jsp?rss="+rss);
                      }
  else if(rs5.next()) {
	  String rss = rs5.getString(1);
	                      ...
	                      response.sendRedirect("SharedFolder/FormApproval/PopupLink/SharedFolderAdmin.jsp?rss="+rss);
                      }
  else if(rs6.next()) {
	  String rss = rs6.getString(1);
	                      System.out.println("INTERNET ACCESS : is .....................correct : "+rss);
	                      response.sendRedirect("InternetAccess/FormApproval/PopupLink/InternetAccessAdmin.jsp?rss="+rss);
                      }
  else if(rs7.next()) {
	  String rss = rs7.getString(1);
	                      System.out.println("NEWINS: is .....................correct : "+rss);
	                      response.sendRedirect("Newins/FormApproval/PopupLink/NewinsAdmin.jsp?rss="+rss);
                      }
  else if(rs8.next()) {
	  String rss = rs8.getString(1);
	                      System.out.println("NEWINS: is .....................correct : "+rss);
	                      response.sendRedirect("LotusTraveler/FormApproval/PopupLink/LotusAdmin.jsp?rss="+rss);
                      }
  else if(rs9.next()) {
	  String rss = rs9.getString(1);
	                      System.out.println("Incident log : is .....................correct : "+rss);
	                      response.sendRedirect("IncidentLog/FormApproval/PopupLink/IncidentLogsAdmin.jsp?rss="+rss);
                      
                      }
  else if(rs10.next()) {
	  String rss = rs10.getString(1);
	                      System.out.println("Registration Form : is .....................correct : "+rss);
	                      response.sendRedirect("RegistrationForSW/FormApproval/PopupLink/RegistrationAdmin.jsp?rss="+rss);
                      
                      }
  else if(rs11.next()) {
	  String rss = rs11.getString(1);
	                      System.out.println("DSC Form : is .....................correct : "+rss);
	                      response.sendRedirect("DSC/FormApproval/PopupLink/DSCAdmin.jsp?rss="+rss);
                      
                      }
  else if(rs12.next()) {
	  String rss1 = rs12.getString(1);
	                      System.out.println("USB Access : is .....................correct : "+rss1);
	                      response.sendRedirect("USB/RegistrationForSW/FormApproval/PopupLink/RegistrationAdmin.jsp?rss="+rss1);
