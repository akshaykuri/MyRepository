...
<title>EMPLOYEE STATUS FORM (BLR)</title>
...
var f=document.form;    
f.method="post";    
f.action='BlrUserEdit.jsp?id='+id;    
f.submit();
}
...
var f=document.form;    
f.method="post";    
f.action='BlrUserDelete.jsp?id='+id;    
f.submit();
}
...
String query = "select * from nentryblr";
...
<td bgcolor="white" width="120"><font size="2" color="black"><%=rs.getString(6)%></font></td>
<td bgcolor="white" width="100"><font size="2" color="black"><%=rs.getString(7)%></font></td>
<td bgcolor="white" width="120"><font size="2" color="black"><%=rs.getString(8)%></font></td>
