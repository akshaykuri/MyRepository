...
<head><title>LOTUS TRAVELER FORM</title>
...
document.form.action="LotusAdmin.jsp?msg=1";
...
document.form2.action="LotusLocalAllAdmin.jsp?msg=1";
...
{  var p1=document.form.req;
 if ((p1.value==null)||(p1.value=="NULL"))
				{alert("Select LOTUS TRAVELER Number!"); p1.focus(); return false; }
...
<tr align="center">
 <td bgcolor="#2f4377" colspan="2"><strong><font size ="4" color="white">LOTUS TRAVELER FORM</font></strong></td></tr>
...
<form name="form" method="post" action="LotusAdmin.jsp?msg=1">
...
/* rs9 = st9.executeQuery("SELECT DISTINCT form8_no FROM form8_lotus_traveler  ORDER BY form8_no"); */
//rs9 = st9.executeQuery("SELECT DISTINCT form8_no FROM form8_lotus_traveler_item WHERE emp='"+AdminName+"' and desg='"+desg+"' and status='Pending' AND form8_no LIKE 'NEIN/CS/Lotus%' ORDER BY form8_no ASC");
rs9 = st9.executeQuery("SELECT DISTINCT form8_no FROM form8_lotus_traveler WHERE Approval_emp='"+AdminName+"' and Approval_desg='"+desg+"' and Approval_sttatuss='Pending' AND form8_no LIKE 'NEIN/CS/Lotus%' ORDER BY form8_no ASC");
...
<table align="center">
<tr>
<th>SELECT LOTUS USER FORM NUMBER</th>
</tr>
</table>
...
<td align=center colspan="2">
	...
	<td width="40%">
	<form name="form2" method="post" action="LotusLocalAllAdmin.jsp?msg=1">
<%-- %>	 <form action="POMonthWiseBack.jsp"> 
	<form action="POWiseBack.jsp">--%>
...
//rs9 = st9.executeQuery("Select DISTINCT substr(pordernon,6,2) from po ORDER BY substr(pordernon,6,2) ASC");
/* rs9 = st9.executeQuery("SELECT DISTINCT form8_no FROM form8_lotus_traveler  ORDER BY form8_no"); */
//rs99 = st99.executeQuery("SELECT DISTINCT form8_no FROM form8_lotus_traveler WHERE i_b_no='"+b_no+"' AND form8_no LIKE 'NEIN/CS/Lotus%' ORDER BY idextend DESC");
rs99 = st99.executeQuery("SELECT DISTINCT form8_no,full_name FROM form8_lotus_traveler WHERE form8_no LIKE 'NEIN/CS/LotusTraveler%' ORDER BY id DESC");
...
<table align="center">
<tr>
<th>SELECT LOTUS TRAVELER FORM NUMBER</th>
</tr>
</table>
