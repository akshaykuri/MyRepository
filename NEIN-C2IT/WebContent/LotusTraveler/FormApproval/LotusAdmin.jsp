...
<tr>
<td  style="text-align: right;">New Mail ID :</td>
<td style="text-align:left;">

<input type="text"  style="width: 6em"  name="d_resignation" value="<%=New_email%>" readonly="readonly"  readonly="readonly" />

</td>

<td  style="text-align: right;">Password:</td>
<td style="text-align:left;">
<input type="text"  style="width: 6em"  name="d_reliving"  value="<%=password%>" readonly="readonly" readonly="readonly" />
...
<table id="tableData" name="tableData" width="100%" border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
	  ...
	  rs1 = st1.executeQuery("select form3_no,desg,emp,status,remarks,f_date,mail from form3_lotus_item WHERE form3_no='"+req+"' ORDER BY id ASC"); 
	  while(rs1.next())
	  {
		  String form3_noD= rs1.getString("form3_no");
	 ...
	 <td><input type="button"  style="size:1" value="RE-SEND MAIL" onclick="resendMail('<%=m%>','<%=form3_no%>','<%=empD%>','<%=SessionName%>');" /></td> 
...
<br />
		...
		cn11 = con.getConnection2();
		  ...
		  rs11 = st11.executeQuery("select form3_no,desg,emp,status,remarks,f_date,mail from form3_lotus_item WHERE form3_no='"+req+"' ORDER BY id ASC"); 
		  while(rs11.next())
		  {
