...
rs100 = st100.executeQuery("select * from form8_lotus_traveler WHERE form8_no='"+values[0]+"'"); 
while(rs100.next())
{
...
<table id="tableData" name="tableData" width="100%" border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
	  ...
	  rs1 = st1.executeQuery("select form8_no,desg,emp,status,remarks,f_date,mail from form8_lotus_traveler_item WHERE form8_no='"+values[0]+"' ORDER BY id ASC"); 
	  while(rs1.next())
	  {
