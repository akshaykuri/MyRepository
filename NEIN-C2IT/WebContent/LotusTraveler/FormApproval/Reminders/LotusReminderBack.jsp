...
psmt11 = cn2.prepareStatement("UPDATE form8_lotus_traveler SET reminder=?,f_date=? WHERE form8_no=?");
...
msg2 = "LOTUS__TRAVELER__REMINDER__FORM__NO__:__'"+form_no+"'__SAVED__SUCCESSFULLY";
System.out.println("result..date..........."+form_date);
response.sendRedirect("LotusReminder.jsp?msg2="+msg2);
