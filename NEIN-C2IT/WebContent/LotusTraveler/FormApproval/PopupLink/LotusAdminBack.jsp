...
if(senddirect.equals("sendonly"))
	 ...
	 if(higherAuthority.equals("direct"))
	     ...
	     //postMail.postMail(i_email_id,i_name,"pass1234",mail,"LOTUS TRAVELER FORM :  " +form8_no+ " ",i_name+  " "+  "approved your request " +form8_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  http://ninsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
...
response.sendRedirect("PopUpPage.jsp?form_no=" +form8_no);
}
