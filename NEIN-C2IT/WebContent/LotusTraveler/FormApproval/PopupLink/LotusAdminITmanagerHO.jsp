...
//	psmtApOp1 = cn2.prepareStatement("UPDATE form8_lotus_traveler_item SET status=?,remarks=?,f_date=?,presence=? WHERE form8_no=? AND desg=? AND emp=? ");
	psmtApOp1 = cn2.prepareStatement("UPDATE form8_lotus_traveler_item f,(SELECT max(id) as idf FROM form8_lotus_traveler_item WHERE form8_no=? AND desg=? AND emp=?) as p SET f.status=?,f.remarks=?,f.f_date=?,f.presence=? WHERE f.form8_no=? AND f.desg=? AND f.emp=? AND f.id=p.idf ");
	...
	psmtApOp2 = cn2.prepareStatement("UPDATE form8_lotus_traveler SET Approval_status=?,Approval_sttatuss=?,Approval_remarks=?,Approval_f_date=?,Approval_emp=?,Approval_desg=?,Approval_empp=?,Approval_desgg=? WHERE form8_no=?");
	...
	psmtApOp3 = cn2.prepareStatement("INSERT INTO form8_lotus_traveler_item(form8_no,desg,emp,status,remarks,f_date,mail,presence) VALUES(?,?,?,?,?,?,?,?)");
	...
	message = mailMessage.getMailMessageLotusTraveler(form_no.trim());

//postMail.postMail(i_email_id,i_name,"pass1234",mailingCheck[u]," LOTUS TRAVELER FORM :  " +form_no+ " ",i_name+  " "+  "request is Approved " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  http://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
	...
	{  System.out.println("if Approved and sending again to Higher authority ");
		postMail.postMail(i_email_id,i_name,"pass1234",Mail1," LOTUS TRAVELER FORM:  " +form_no+ " ",i_name+  " "+  "request you to Approved " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  http://ninsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
	}
	...
	{  System.out.println("if Approved and want to send directly to IT nonIT persons of HO and ONE copy to Initiator");
		postMail.postMail(i_email_id,i_name,"pass1234",Mail1," LOTUS TRAVELER FORM:  " +form_no+ " ",i_name+  " "+  "approved your request " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  http://ninsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
		postMail.postMail(i_email_id,i_name,"pass1234",allMails," LOTUS TRAVELER FORM :  " +form_no+ " ",initiatorNameIfNotApproved+  " "+  "approved your request " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  http://ninsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>");
	}
	...
	{  System.out.println("if NOT Approved , so a copy to Initaior ");
		postMail.postMail(i_email_id,i_name,"pass1234",Mail1," LOTUS TRAVELER FORM :  " +form_no+ " ",initiatorNameIfNotApproved+  " "+  "request Is NOT Approved " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  http://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>");
		postMail.postMail(i_email_id,i_name,"pass1234",allMails," LOTUS TRAVELER FORM :  " +form_no+ " ",initiatorNameIfNotApproved+  " "+  "request Is NOT Approved " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  http://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>");
	} */
	...
	{	
	   System.out.println("IF NOT APPROVED THIS LOOP WILL RUN");
		...
		psmt4 = cn2.prepareStatement("SELECT mail,emp FROM form8_lotus_traveler_item WHERE form8_no=?");
		psmt4.setString(1,form_no);
	    ...
	    postMail.postMail(i_email_id,i_name,"pass1234",allMails1," LOTUS TRAVELER FORM :  " +form_no+ " ",initiatorNameIfNotApproved+  " "+  "request Is NOT Approved for the Form No." +form_no+ " <br>Remarks : "+txtmail_msg+"<br><b><u> Open the following URL</u> </b><br> C2IT LINK -  http://ninsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
	   }
	}
...
psmt = cn2.prepareStatement("UPDATE form8_lotus_traveler_item SET status=?,remarks=?,f_date=?,presence=? WHERE form8_no=? AND desg=? AND emp=? ");
...
if((SendExtraMails!="NULL")||(mmdradioBcc=="Yes"))
		...
		//	postMail.postMail(i_email_id,i_name,"pass1234",mailingCheck[u]," DOMAIN USER FORM :  " +form_no+ " ","your request for DOMAIN USER FORM "+form_no+" is Approved by " +i_name+ " <br><br><b><u> Open the following URL</u> </b><br>C2IT LINK -  http://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
			//postMail.postMailCC(i_email_id,i_name,"pass1234",mailingCheck[u],CCList," DOMAIN USER FORM :  " +form_no+ " ","your request for DOMAIN USER FORM "+form_no+" is Approved by " +i_name+ " <br><br><b><u> Open the following URL</u> </b><br>C2IT LINK -  http://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
				postMail.postMailCC(i_email_id,i_name,"pass1234",mailingCheck[u],CCList," LOTUS TRAVELER FORM :  " +form_no+ " ",i_name+  " "+  "request is Approved " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  http://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
			} */
			
			postMail.sendMailCC(i_email_id,i_name,ToMail,CCList," LOTUS TRAVELER FORM :  " +form_no+ " ",i_name+  " "+  "request is Approved " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  http://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
		}
		else
		{
			for(int u=0;u<mailingCheck.length;u++)
...
msg = "LOTUS__TRAVELER__FORM__NO__:__'"+form_no+"'__SAVED__AND__SENT__SUCCESSFULLY";
