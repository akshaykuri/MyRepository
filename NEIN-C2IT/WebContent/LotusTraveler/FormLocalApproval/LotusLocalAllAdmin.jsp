...
//form2_domain
String form8_no=null,f_date=null,idextend=null,branch=null,depart=null,full_name=null,designation=null,scopeOfWork=null,emp_code=null,reporting_officer=null,requestOption=null,requestBy=null,remarks=null;
...
<table width="907"  cellspacing="0" cellpadding="0" bgcolor="grey" align="center">
	<tr>
		...
		<b><label>
		LOTUS TRAVELER APPLICATION </label>
		</b></font></center> 
...
<td style="text-align:left;" colspan="3" bgcolor="white"><%=owner%>
...
<td style="text-align:left;" colspan="3" bgcolor="white"><%=lotusAddress%>
...
<table width="895" border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
	  ...
	  rs1 = st1.executeQuery("select form8_no,desg,emp,status,remarks,DATE_FORMAT(f_date,'%d/%m/%Y'),mail from form8_lotus_traveler_item WHERE form8_no='"+req+"'"); 
	  while(rs1.next())
	  {
		  String form8_noD= rs1.getString(1);
    							        ...
    							        <tr>
					    						...
					    						<p align="justify"><b>4.NEIN IT is NOT responsible for</b>
					    							...
					    							<p align="justify"><b>5.Inactive User</b>
					    							  ...
					    							  <b>(b)</b>Request for reactivation may required.</p></font></td>
					    			</tr></table>                                                            
   </td>
