...
<form name="form" method="post" action="LotusLocalAdmin.jsp?msg=1">
...
rs9 = st9.executeQuery("SELECT DISTINCT form8_no FROM  form8_lotus_traveler_item WHERE ((emp='"+AdminName+"' and desg='"+desg+"')OR(empid='"+(String) session.getAttribute("EmpNo")+"')) and status='Pending' AND form8_no LIKE 'NEIN/CS/LotusTraveler%' ORDER BY form8_no ASC");
