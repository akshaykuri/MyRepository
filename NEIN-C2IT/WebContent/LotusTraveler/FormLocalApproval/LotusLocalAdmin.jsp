 ...
 */
  ...
  <script language="javascript" type="text/javascript"> 
  function resendMail(email_id,form8_no,mail,name)
  		 {
	 if (typeof XMLHttpRequest != "undefined"){    
         xmlHttp= new XMLHttpRequest();    
           }      else if (window.ActiveXObject){
           alet("Creating html http object");    
             xmlHttp= new ActiveXObject("Microsoft.XMLHTTP");  
                    ...
                    alert("Browser does not support XMLHTTP Request");    
                      return;     
                       }       var url="../../ResendMailLotusNotes?mail="+email_id+","+form8_no+","+mail+","+name+"";  
...
//form2_domain
String form8_no=null,f_date=null,idextend=null,branch=null,depart=null,full_name=null,designation=null,remarks=null;
//scopeOfWork=null,emp_code=null,reporting_officer=null,requestOption=null,requestBy=null,,String New_email=null,password=null;
String i_name=null,i_desg=null,i_city=null,i_b_no=null,i_admin=null,i_email_id=null,desg=null,emp=null,mail=null;
String emp_email=null,emp_contact=null,d_model=null,d_phone_no=null,owner=null,lotusAddress=null,empid=null,ro=null;
String co_name=null;
...
rs100 = st100.executeQuery("select * from form8_lotus_traveler WHERE form8_no='"+req+"'"); 
while(rs100.next())
{
...
<table width="907"  cellspacing="0" cellpadding="0" bgcolor="grey" align="center">
	<tr>
		...
		<input type="hidden" name="form1_no" value="<%=form8_no%>" />
...
<tr>
&nbsp;&nbsp;&nbsp; <td  style="text-align: right;width: 200px; " bgcolor="grey" >NAME:</td>
<td style="text-align:left;width: 248px;" bgcolor="grey"><input name="branch" value="<%=SessionName%>" size="31" readonly="readonly"/> </td>
</tr>	
<tr>
...
<td style="text-align:left;" bgcolor="grey"><input name="form8_no" value="<%=form8_no%>" size="31" readonly="readonly"/> </td>
</tr>	
...
<tr>
<td  style="text-align: right;">Emp Id :</td>
<td style="text-align:left;" bgcolor="white"><%=empid%></td>
...
<td style="text-align:left;" bgcolor="white"><%=ro%></td>
</tr>
...
<td style="text-align:left;" bgcolor="white" colspan="3"><%=lotusAddress%>
...
<table width="895" border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
	  ...
	  rs1 = st1.executeQuery("select form8_no,desg,emp,status,remarks,f_date,mail,empid,levelno from form8_lotus_traveler_item WHERE form8_no='"+req+"' ORDER BY id ASC"); 
	  while(rs1.next())
	  {
		  String form8_noD= rs1.getString("form8_no");
	 ...
	 <td><input type="button"  style="size:1" value="RE-SEND MAIL" onclick="resendMail('<%=email_id%>','<%=form8_no%>','<%=m%>','<%=SessionName%>');" /></td> 
...
String flag =c2ITUtil1.getAuthorizedNameLotusTraveler(form8_no,session.getAttribute("Nname").toString(),session.getAttribute("desg").toString(),session.getAttribute("EmpNo").toString()); %>
<%
   ...
   <tr style="display: none;" id="idApproved" >
    ...
    cn5 = DriverManager.getConnection(url+dbName,userName,password); 
     ...
     String maxlevel="";
	  ...
	  String i_b_no1=form8_no.substring(22,24);
	  
	  
	  
      rs12= st12.executeQuery("SELECT max(levelno) FROM formapproval WHERE branch='"+i_b_no1+"' and formtype='LOTUS_TRAVELER'  ORDER BY levelno ASC");
     if(rs12.next())
         { 
    ...
    rs11 = st11.executeQuery("SELECT alloptions,directApprove FROM formapproval WHERE branch='"+i_b_no1+"' and empid='"+emp_no+"' and formtype='LOTUS_TRAVELER'");
     if(rs11.next())
         { 
    ...
    //System.out.println("dirappro  :"+dirappro);
     ...
     /* ////////////////////////// Skeeping level code  ////////////////////////////////// */
      ...
      rsnext = stnext.executeQuery("SELECT * FROM formapproval WHERE branch='"+i_b_no1+"' and levelno='"+nextlevel+"' and formtype='LOTUS_TRAVELER' ORDER BY levelno ASC");
      if(rsnext.next())
           {
     ...
     if(allopt.equals("0") || allopt.equals(""))
    	  ...
    	  if(!levelno.equals(maxlevel) && !dirappro.equals("1"))
    	     ...
    	     rs5 = st5.executeQuery("SELECT * FROM formapproval WHERE branch='"+i_b_no1+"' and levelno='"+nextlevel+"' and formtype='LOTUS_TRAVELER' ORDER BY levelno ASC");
    	     if(rs5.next())
                {
               ...
               %><input type="hidden" name="senddirect" id="senddirect" value="sendonly" readonly/>
               ...
               else
                  {
            	   ...
            	   napprovalsw1="1920"+","+developer_name+","+"Dy. Manager"+","+developer_mail+","+"Creater";
            	   ...
            	   if(!levelno.equals(maxlevel) && dirappro.equals("1"))
            	         ...
            	         <td style="display: none;" id="send">Send to HO(IT) for Create<br>
                           ...
                           <td style="display: none;" id="direct">Create LOTUS_TRAVELER<br>
