...
if(b_no.equals("90")) 
     rs9 = st9.executeQuery("SELECT DISTINCT form8_no,full_name FROM form8_lotus_traveler WHERE form8_no LIKE 'NEIN/CS/Lotus%' ORDER BY form8_no DESC");
else
	 rs9 = st9.executeQuery("SELECT DISTINCT form8_no,full_name FROM form8_lotus_traveler WHERE i_b_no='"+b_no+"' AND form8_no LIKE 'NEIN/CS/Lotus%' ORDER BY idextend DESC");
