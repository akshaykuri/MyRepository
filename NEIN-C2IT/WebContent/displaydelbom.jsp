...
<title>EMPLOYEE STATUS FORM (BOM)</title>
...
var f=document.form;    
f.method="post";    
f.action='bomuseredit.jsp?id='+id;    
f.submit();
}
...
var f=document.form;    
f.method="post";    
f.action='bomuserdelete.jsp?id='+id;    
f.submit();
}
...
<center>
	...
	<table border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
		...
		<td height="20" bgcolor="white" width="100" align=center><font size="2" color="black">E-NAME</font></td>
		<td bgcolor="white" width="100" align=center><font size="2" color="black">E-ID</font></td>
		<td bgcolor="white" width="100" align=center><font size="2" color="black">E-PWD</font></td>
		<td bgcolor="white" width="100" align=center><font size="2" color="black">E-ADDRESS</font></td>
		<td bgcolor="white" width="120" align=center><font size="2" color="black">E-CONTACT</font></td>
		<td bgcolor="white" width="100" align=center><font size="2" color="black">E-POST</font></td>
		<td bgcolor="white" width="120" align=center><font size="2" color="black">E-POSTING</font></td>
		<td bgcolor="white" width="100" align=center><font size="2" color="black">E-MAILID</font></td>
...
String query = "select * from nentrybom";
...
<td align="center" id="hiderow"><input id="hiderow"type='submit' style="background-color:white;font-weight:bold;color:black;" value='CANCEL' onclick='btnClick();'></td>
<td align="center" id="hiderow">
<SCRIPT Language="Javascript">  
