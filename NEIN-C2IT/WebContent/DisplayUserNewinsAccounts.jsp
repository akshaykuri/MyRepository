...
<title>NEWINS USER MASTER</title>
...
{    
	if(confirm('You are above to delete a Newins Approver'))
	{
var f=document.form;    
f.method="post";    
f.action='NEWINSAccountDelete.jsp?id='+id;    
f.submit();
}
	else{}
}
...
//isp_name,mpls_branch,crt_id,brndwdt,lan_ip,wan_ip,network_ip 	 -->         
	<table border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
		...
		<td bgcolor="white" width="120" align=center><font size="2" color="black"><b>DESIGNATION</b></font></td>
		<td bgcolor="white" width="120" align=center><font size="2" color="black"><b>MAIL ID</b></font></td>
		<td bgcolor="white" width="60" align=center><font size="2" color="black"><b>EMP ID</b></font></td>
		<td bgcolor="white" width="60" align=center ><font size="2" color="black"><b>DELETE</b></font></td>
		</tr>
...
String query = "select id,Name,Designation,Mail_id,emp_id from ho_finance_account_master";
