...
<%
 ...
 %>
 <br /><center><label style="font: bold; size: 3">Incident Log FORM NO : <%=no%> IS SAVED AND SENT SUCCESSFULLY</label></center> <br />
 <%
 ...
 Connection conn = DriverManager.getConnection(url+dbName,userName,password); 
  String query2 = "SELECT form9_no FROM form9_incident_log  WHERE SUBSTRING(form9_no,9,20)='"+second+"'";
  Statement st2 = conn.createStatement();
  ResultSet rs2 = st2.executeQuery(query2); 
  int k=0;
 
   if(rs2.next()){
	                      String msg = "INCIDENT__LOG__FORM__NO__:__<b>'"+no+"'</b>__SAVED__AND__SENT__SUCCESSFULLY";
