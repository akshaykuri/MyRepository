...
<td style="text-align:left;width: 75%;" colspan="3" bgcolor="grey"><input name="branch" value="<%=SessionName%>" size="31" readonly="readonly"/> </td>
...
<td style="text-align:left;width: 75%;" colspan="3" bgcolor="grey"><input name="branch" value="<%=Sessiondesg%>" size="31" readonly="readonly"/> </td>
</tr>	
<tr>
&nbsp;&nbsp;&nbsp; <td  style="text-align: right;width: 25%;" bgcolor="grey" ><b>FORM NO :</b></td>
<td style="text-align:left;width: 75%;" colspan="3" bgcolor="grey"><input name="branch" value="<%=form9_no%>" size="31" readonly="readonly"/> </td>
</tr>	
<tr>
&nbsp;&nbsp;&nbsp; <td  style="text-align: right;width: 25%;" bgcolor="grey"><b>Branch :</b></td>
<td style="text-align:left;width: 25%;" bgcolor="grey"><input name="branch" value="<%=Sessionb_no%>" size="31" readonly="readonly"/> </td>
...
<td  style="text-align: right;background-color: white; width: 50%">FROM DATE :<font color="black"><b><%=from_date%></b></font> TO  :<font color="black"><b><%=to_date%></b></font></td>
</tr>
...
<table id="tableData" name="tableData" width="895" border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
       <tr>
	    ...
	    <td bgcolor="grey" width="120" align=center><font size="2" color="black"><b>Location Name</b></font></td>
	  ...
	  rs2 = st2.executeQuery("select form9_no,I_date,I_time,I_Location,I_viewedBy,I_Remarks,Created_Date,Incident_Reported,viewedByIT,id,viewedByGA,CONCAT(form9_no,'/',incidentlogFile) as incidentlogFile from form9_incident_item WHERE form9_no='"+req+"' ORDER BY id ASC");
	  while(rs2.next())
	  {
		  k++;
		  ...
		  String I_Location= rs2.getString("I_Location");
		  ...
		  String incFile = "E:/neinSoft/C2IT/IncidentLog/"+rs2.getString("incidentlogFile");
	   ...
	   <tr>
		...
		<td bgcolor="white" width="130px"><font size="2" color="black"><%=I_date%></font></td>
		<td bgcolor="white" width="100px"><font size="2" color="black"><%=I_time%></font></td>
	    <td bgcolor="white" width="200px"><font size="2" color="black"><%=I_Location%></font></td>
		

		<td bgcolor="white" width="120"><font size="2" color="black"><%=I_viewedBy%></font></td>
		
		
	    <td bgcolor="white" width="200px"><font size="2" color="black"><%=Incident_Reported%></font></td>
	    
	    <td bgcolor="white" width="100"><font size="2" color="black"><a href="../../../download6.jsp?f=<%=incFile%>">View File</a></font></td>	    
...
<table >
 <tr><td id="ita" colspan="4" bgcolor="grey"><b>IT DEPARTMENT USE ONLY</b></td></tr>
	...
	<tr >
	    <td class="it2" style="text-align: right;width:23%;">Observation/Incident:</td>
	    <td class="it2" style="text-align: left;width:23%;">
...
<tr id="idrem" style="display: none;">
...
<tr>
<td colspan="2">
   <b>Note :</b> For operational purpose and in accordance with the CCTV Policy, Procedure & Monitoring Policy(*Refer IT Policy), only designated IT & GA Department staff shall have the primary
                access to CCTV Recording. Regular monitoring i.e daily and weekly once (Which is mandatory as per AEO compliance) need to be done by IT & GA Department i.e randomly select any office/warehouse
...
<td align="left" width="" colspan="2">
		...
		cn11 = con.getConnection2();
		  ...
		  rs11 = st11.executeQuery("select DISTINCT emp,form9_no,desg,status,remarks,f_date,mail from form9_incident_log_item WHERE form9_no='"+req+"' group by mail ORDER BY id ASC"); 
		  while(rs11.next())
		  {
		...
		<%} %>
		  ...
		  <tr>
    <td align="left" colspan="2"><b>Send BCC</b>
