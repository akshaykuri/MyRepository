...
<table id="tableData" name="tableData" width="100%" border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
	  ...
	  st1=cn1.createStatement();
	   String I_date,I_time,I_Location,I_viewedBy,Incident_Reported,I_Remarks,Created_Date,incFile,revbyIT=null,revbyGA=null;
	  rs1 = st1.executeQuery("select form9_no,I_date,I_time,I_Location,I_viewedBy,Incident_Reported,I_Remarks,Created_Date,viewedByIT,viewedByGA, CONCAT(form9_no,'/',incidentlogFile) as incidentlogFile from  form9_incident_item WHERE form9_no='"+req2+"'  ORDER BY id ASC"); 
	  while(rs1.next())
	  {
		  I_date = rs1.getString("I_date");
		  I_time = rs1.getString("I_time");
		  I_Location=rs1.getString("I_Location");
		  System.out.println("I_Location  is "  +I_Location);
