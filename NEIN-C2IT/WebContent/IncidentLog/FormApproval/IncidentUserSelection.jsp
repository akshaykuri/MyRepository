...
// -->
   ...
   {
   document.form.action="IncidentExcelReport.jsp?msg=1";
   document.form.method="post";
   document.form.submit();
   }
</script>
...
<tr align="center">
 <td bgcolor="#2f4377" class="blueLine"><strong><font size ="4" color="white">CCTV SURVEILLANCE & SECURITY SYSTEMS</font></strong></td>
</tr>
 </table>
<table align="center" cellspacing="0" cellpadding="0" border="0" width="1118"> 
<tr>
