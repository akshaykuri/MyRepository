...
<td >Form No. :</td>
<td ><font size="2" color="black"><%=values[0]%></font></td>
</tr>
...
<table id="tableData" name="tableData" width="100%" border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
       <tr>
	    ...
	    <td bgcolor="grey" width="20" align=center><font size="2" color="black"><b>Branch</b></font></td>
		...
		<td  bgcolor="grey" width="100" align="center"><font size="2" color="black">CCTV footage reviewed by IT Dept.</font></td>
		<td bgcolor="grey" width="100" align="center"><font size="2" color="black">CCTV footage reviewed by GA Dept.:</font></td>
	  </tr>
	  <%
	  
	  cn1 = con.getConnection2();
	  st1=cn1.createStatement();
	   String I_date,I_time,I_viewedBy,I_Location,Incident_Reported,I_Remarks,Created_Date,incFile,revbyIT=null,revbyGA=null;
	  rs1 = st1.executeQuery("select form9_no,I_date,I_time,I_Location,I_viewedBy,Incident_Reported,I_Remarks,Created_Date,viewedByIT,viewedByGA,CONCAT(form9_no,'/',incidentlogFile) as incidentlogFile from  form9_incident_item WHERE form9_no='"+values[0]+"'  ORDER BY id ASC"); 
	  while(rs1.next())
	  {
		  I_date = rs1.getString("I_date");
		  I_time = rs1.getString("I_time");
		  I_Location= rs1.getString("I_Location");
		  ...
		  incFile = "E:/neinSoft/C2IT/IncidentLog/"+rs1.getString("incidentlogFile");
	   ...
	   <tr>
		...
		<td bgcolor="white" width="100" align="center"><font size="2" color="black"><%=I_time%></font></td>
			    <td bgcolor="white" width="20" align="center"><font size="2" color="black"><%=I_Location%></font></td>
		...
		<td bgcolor="white" width="100" align="center"><font size="2" color="black"><%=revbyGA%></font></td>
	  </tr>
...
<table id="tableData" name="tableData" width="100%" border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
	  ...
	  rs2 = st2.executeQuery("select * FROM form9_incident_log_item WHERE form9_no='"+values[0]+"' ORDER BY id ASC"); 
	  while(rs2.next())
	  {
