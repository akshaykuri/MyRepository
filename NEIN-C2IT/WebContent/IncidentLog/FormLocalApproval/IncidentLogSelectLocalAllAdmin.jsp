...
<tr align="center">
 <td bgcolor="#2f4377" class="blueLine"><strong><font size ="4" color="white">INCIDENT LOG FORM</font></strong></td>
</tr>
...
<form name="form" method="post" action="IncidentLogLocalAllAdmin.jsp?msg=1">
...
if(b_no.equals("90"))
rs9 = st9.executeQuery("SELECT DISTINCT form9_no,DATE_FORMAT(Created_date,'%d-%M-%Y') as cDate FROM  form9_incident_log WHERE form9_no LIKE 'NEIN/CS/IL%' ORDER BY form9_no DESC");
else
	rs9 = st9.executeQuery("SELECT DISTINCT form9_no,DATE_FORMAT(Created_date,'%d-%M-%Y') as cDate FROM  form9_incident_log WHERE SessionCityNo='"+b_no+"' AND form9_no LIKE 'NEIN/CS/IL%' ORDER BY idextend DESC");
...
<table align="center">
<tr>
<th>SELECT INCIDENT LOG FORM NUMBER</th>
</tr>
</table>
