...
String SystemAdminName=null,Location=null,CreatedDate=null,FromDate=null,ToDate=null,form_no9=null;
...
<table id="tableData" name="tableData" width="100%" border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
	   ...
	   <td bgcolor="grey" width="120" align=center><font size="2" color="black"><b>Branch</b></font></td>
	  ...
	  st1=cn1.createStatement();
	   String I_date,I_time,I_viewedBy,Incident_Reported,I_Remarks,Created_Date,viewedByIT=null,viewedByGA=null;
	  rs1 = st1.executeQuery("select form9_no,I_date,I_time,I_Location,I_viewedBy,Incident_Reported,I_Remarks,Created_Date,viewedByIT,id,viewedByGA,CONCAT(form9_no,'/',incidentlogFile) as incidentlogFile from form9_incident_item WHERE form9_no='"+values[0]+"'  ORDER BY id ASC"); 
	  while(rs1.next())
	  {
		  I_date = rs1.getString("I_date");
		  I_time = rs1.getString("I_time");
		  String I_Location= rs1.getString("I_Location");
		  ...
		  viewedByIT = rs1.getString("viewedByIT");
		  viewedByGA = rs1.getString("viewedByGA");
		  String incFile = "E:/neinSoft/C2IT/IncidentLog/"+rs1.getString("incidentlogFile");
	   ...
	   <tr>
	    ...
	    <td bgcolor="white" width="100" align="center"><font size="2" color="black"><%=I_Location%></font></td>
		...
		<td bgcolor="white" width="100" align="center"><font size="2" color="black"><%=I_Remarks%></font></td>
