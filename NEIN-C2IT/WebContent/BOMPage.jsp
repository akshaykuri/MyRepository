...
<table width="1118" align="center" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr align="center">
 <td bgcolor="#2f4377"><strong><font size ="4" color="white">MUMBAI BRANCH</font></strong></td></tr>
</table>
...
<ul id="sidebarmenu1">
 ...
 <li><a href="MrHomePageBOM.jsp?msg=1">MATERIAL REQUISITION</a></li>

  <li><a href="ComparisionValidationBOM.jsp?msg=1">QUOTATION & COMPARISON</a>
 <!--  <ul>
...
-->
 <li><a href="BOMvalidation.jsp?msg=1">PURCHASE ORDER</a></li>
 
 <li><a href="BOMPage.jsp?msg=1">DELIVERY DETAILS</a>
  <ul>
  <li><a href="DeliveryPageBOM.jsp?msg=1">DELIVERY</a></li>
  <li><a href="ChequeBOM.jsp?msg=1">CHEQUE</a></li>
  <li><a href="PaymentCL_BOM.jsp?msg=1">PAYMENT COVERING LETTER</a></li>
 
  </ul>
  </li>
  <li><a href="warrantyBOM.jsp?msg=1">WARRANTY DETAILS</a>
  </li>
  <li><a href="BOMPage.jsp?msg=1">REPORTS</a>
  <ul>

  <li><a href="PCL_PDF_BOM.jsp?msg=1">PRINT PAYMENT COVERING LETTER</a></li> 
  </ul>
  </li>
</ul>
...
<a href="loginBOM.jsp?msg = 1"><img src="bakk.png" border="0" height="35" width="35"></a><address><font size="2">BACK</font></address>
</td> 
</tr> 
</table> 
