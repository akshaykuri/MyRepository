...
<tr align="center">
 <td bgcolor="#2f4377" class="blueLine"><strong><font size ="4" color="white">BACKUP SERVER/NAS BOX MASTER</font></strong></td>
</tr>
  ...
  <form name="form" method="post" onSubmit="return validate()" action="Backup_MasterBack.jsp">
...
<font color=darkblue size=3 >CREATE BACKUP SERVER/NAS BOX DETAILS</font>
</td>
</tr>

	<tr><td><font size="2">BACKUP SERVER/NAS BOX NAME:</font><font color=red>*</font></td><td><input type="text" size="20" name="backup_name" value=""></td></tr>

	<tr><td><font size="2">BACKUP SERVER/NAS BOX DETAIL:</font><font color=red>*</font></td><td><input type="text" size="20" name="backup_detail" value=""></td></tr>
...
%>
	...
	<tr>
	<td>
    <a href="DisplayBackup.jsp" onclick="return popitup('DisplayBackup.jsp')">View Backup server/NAS Box</a> </td>
