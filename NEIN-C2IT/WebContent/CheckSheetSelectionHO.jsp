...
var url="CheckSheetAjaxValidity.jsp";
...
<tr align="center">
 <td bgcolor="#2f4377" colspan="2"><strong><font size ="4" color="white">CHECK LIST DISPLAY</font></strong></td></tr>
...
//rs9 = st9.executeQuery("select DISTINCT cs_id from cs_master WHERE 'HO(BLR)'=branch_master.b_name GROUP BY cs_id ");
rs9 = st9.executeQuery("select DISTINCT cs_id from cs_master Left Join branch_master On(substr(cs_id,9,2)=branch_master.b_no) WHERE '"+city+"'=branch_master.b_name GROUP BY cs_id");
--%>
<!-- <form name="form1" method="post" action="CheckListViewHO.jsp?msg=1" onsubmit="return ValidateForm();"> -->


<!-- <form name="form1" method="post" action="CheckListViewTextFormBranch.jsp?msg=1" onsubmit="return ValidateForm();"> -->
	<form name="form1" method="post" action="ChecckViewSelectHOBack.jsp?msg=1" onsubmit="return ValidateForm();">
	 
<table align="center">
<tr>
<th>SELECT CHECK LIST DATE </th>
</tr>
</table>
   ...
   <tr><!--<th>BRANCH:</th>
	--><%-- <td>
      ...
      <select  name="aabbcc"  id="hiderow">     <option value="NULL">SELECT</option> 
										        ...
										        <%while(rs9.next()){ %> 
										        <% tot_val = rs9.getString("cs_id");%>
										        
										        
										       <option><%=rs9.getString("cs_id")%> </option>
										        <%} %> 
										        </select>
      </td> --%>
