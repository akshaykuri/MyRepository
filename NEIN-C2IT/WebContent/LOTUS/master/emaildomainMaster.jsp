...
<body>
<form  method="post" onsubmit="return validatefield()" action="emaildomainMasterBack.jsp"  name="form1" id="form">
...
<tr align="center">
 <td bgcolor="#2f4377" class="blueLine"><strong><font size ="4" color="white">EMAIL DOMAIN MASTER</font></strong></td>
</tr>
...
<div class="modal-header">
      <center> <h4>EMAIL DOMAIN ENTERY FORM</h4></center>
    </div>
...
<table class="dynatable" width="75%" border="1" style="height: 150;" cellspacing="0" cellpadding="0" bgcolor="lightgrey">
        <tr>
          <center><td colspan="9"><font size="5" face="Swiss" id="hiderow">Enter Email Domain Details</font></td></center> 
        </tr>
         <tr>
             <td><font size="2" face="Swiss" id="hiderow">EMAIL DOMAIN :<font color=red>*</font></font></td>
             <td><input type="text" name="bcode" maxlength="99" id="idbcode"  value="" size=30 /></td>
	                          	 ...
	                          	 <br>
	                          	 <center>
	                          	  <a href="costCodeDisp.jsp" onclick="return popitup('emaildomainMasterDisp.jsp')">View </a>
