...
rs1 = st1.executeQuery("select * from form3_lotus WHERE form3_no='"+no+"'"); 
if(!rs1.next())
{
...
rs100 = st100.executeQuery("select * from form3_lotus WHERE form3_no='"+no+"'"); 
while(rs100.next())
{
...
<input name="form_no" value="<%=form3_no%>" size="31" readonly="readonly"/> </td>
</tr>
<tr>
