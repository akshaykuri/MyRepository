...
psmt11 = cn2.prepareStatement("UPDATE form3_lotus SET reminder=?,f_date=? WHERE form3_no=?");
...
msg2 = "LOTUS__NOTES__REMINDER__FORM__NO__:__'"+form_no+"'__SAVED__SUCCESSFULLY";
