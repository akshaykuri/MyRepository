...
<%! 
	              ...
	              PreparedStatement psmt=null,psmt2=null,psmt3=null,psmt4=null;PreparedStatement psmtApOp1=null,psmtApOp2=null,psmtApOp3=null;
	              %>
...
String ITnotesid = request.getParameter("notesid");
String ITgroup = request.getParameter("gname");
...
//	psmtApOp1 = cn2.prepareStatement("UPDATE form3_lotus_item SET status=?,remarks=?,f_date=?,presence=? WHERE form3_no=? AND desg=? AND emp=? ");
	psmtApOp1 = cn2.prepareStatement("UPDATE form3_lotus_item f,(SELECT max(id) as idf FROM form3_lotus_item WHERE form3_no=? AND desg=? AND emp=?) as p SET f.status=?,f.remarks=?,f.f_date=?,f.presence=? WHERE f.form3_no=? AND f.desg=? AND f.emp=? AND f.id=p.idf ");
	...
	psmtApOp2 = cn2.prepareStatement("UPDATE form3_lotus SET Approval_status=?,Approval_sttatuss=?,Approval_remarks=?,Approval_f_date=?,Approval_emp=?,Approval_desg=?,Approval_empp=?,Approval_desgg=? WHERE form3_no=?");
	...
	psmtApOp3 = cn2.prepareStatement("INSERT INTO form3_lotus_item(form3_no,desg,emp,status,remarks,f_date,mail,presence) VALUES(?,?,?,?,?,?,?,?)");
	...
	message = mailMessage.getMailMessageLotus(form_no.trim());

//postMail.postMail(i_email_id,i_name,"pass1234",mailingCheck[u]," LOTUS NOTES USER FORM :  " +form_no+ " ",i_name+  " "+  "request is Approved " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  http://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
	...
	{  System.out.println("if Approved and sending again to Higher authority ");
		postMail.postMail(i_email_id,i_name,"pass1234",Mail1," LOTUS NOTES USER FORM:  " +form_no+ " ",i_name+  " "+  "request you to Approved " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  http://ninsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
	}
	...
	{  System.out.println("if Approved and want to send directly to IT nonIT persons of HO and ONE copy to Initiator");
		postMail.postMail(i_email_id,i_name,"pass1234",Mail1," LOTUS NOTES USER FORM:  " +form_no+ " ",i_name+  " "+  "approved your request " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  http://ninsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
		postMail.postMail(i_email_id,i_name,"pass1234",allMails," LOTUS NOTES USER FORM :  " +form_no+ " ",initiatorNameIfNotApproved+  " "+  "approved your request " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  http://ninsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>");
	}
	...
	{  System.out.println("if NOT Approved , so a copy to Initaior ");
		postMail.postMail(i_email_id,i_name,"pass1234",Mail1," LOTUS NOTES USER FORM :  " +form_no+ " ",initiatorNameIfNotApproved+  " "+  "request Is NOT Approved " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  http://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>");
		postMail.postMail(i_email_id,i_name,"pass1234",allMails," LOTUS NOTES USER FORM :  " +form_no+ " ",initiatorNameIfNotApproved+  " "+  "request Is NOT Approved " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  http://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>");
	} */
	...
	{	
	   System.out.println("IF NOT APPROVED THIS LOOP WILL RUN");
	    ...
	    postMail.postMail(i_email_id,i_name,"pass1234",allMails1," LOTUS NOTES USER FORM :  " +form_no+ " ",initiatorNameIfNotApproved+  " "+  "request Is NOT Approved for the Form No." +form_no+ " <br>Remarks : "+txtmail_msg+"<br><b><u> Open the following URL</u> </b><br> C2IT LINK -  http://ninsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
	   }
	}
	...
	{
	postMail.postMail(i_email_id,i_name,"pass1234",mailingCheck[u]," DOMAIN USER FORM :  " +form_no+ " ",i_name+  " "+  "request is Approved " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  http://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
	} */
...
System.out.println("Group :"+ITgroup);
psmt2 = cn2.prepareStatement("UPDATE form3_lotus SET ITusername=?,ITpassword=?,ITcreated=?,ITremark=?,Approval_sttatuss=?,Approval_f_date=?,reminder=?,notesid=?,groupName=? WHERE form3_no=?");
...
psmt2.setString(8,ITnotesid);
psmt2.setString(9,ITgroup);
psmt2.setString(10,form_no);
...
if((SendExtraMails!="NULL")||(mmdradioBcc=="Yes"))
		{ System.out.println("IF SendExtraMails in incident reported after attachment with CC :"+SendExtraMails);
		   String valuesbcc[] = SendExtraMails.split(",");
		 	for(int v=0;v<valuesbcc.length;v++)
			{
		 	...
		 	String NoOfFiles = request.getParameter("NoOfFiles");
		 	System.out.println("NoOfFiles -------------------------->>>>>"+NoOfFiles);
		 	
		 /* 	//System.out.println("IF After For loop :"+allValues);
			for(int u=0;u<mailingCheck.length;u++)
			{
				System.out.println("INSIDE FOR LOOP LOTUS OF mailingCheck[u] main "+mailingCheck[u]);
		...
		//	postMail.postMailCC(i_email_id,i_name,"pass1234",mailingCheck[u],CCList," DOMAIN USER FORM :  " +form_no+ " ","your request for DOMAIN USER FORM "+form_no+" is Approved by " +i_name+ " <br><br><b><u> Open the following URL</u> </b><br>C2IT LINK -  http://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
			postMail.postMailCC(i_email_id,i_name,"pass1234",mailingCheck[u],CCList," LOTUS NOTES USER FORM :  " +form_no+ " ",i_name+  " "+  "request is Approved " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  http://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
			} */
			
			//postMail.sendMailCC(i_email_id,i_name,ToMail,CCList," LOTUS NOTES USER FORM :  " +form_no+ " ",i_name+  " "+  "request is Approved " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  http://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
		 	  postMail.sendMailCCWithAttachment(i_email_id,i_name,ToMail,CCList," LOTUS NOTES USER FORM :  " +form_no+ " ",i_name+  " "+  "Approved your request " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  http://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message,form_no);
		}
		else
		{
			for(int u=0;u<mailingCheck.length;u++)
			...
			postMail.sendMailWithAttachment(i_email_id,i_name,mailingCheck[u]," LOTUS NOTES USER FORM :  " +form_no+ " ",i_name+  " "+  "Approved your request " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  http://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message,form_no);
			}
		}
...
msg = "LOTUS__NOTES__FORM__NO__:__'"+form_no+"'__SAVED__AND__SENT__SUCCESSFULLY";
System.out.println("Resulted date of lotus note form no ..........."+form_date);
