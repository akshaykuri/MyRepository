...
<%
 ...
 %>
 <br /><center><label style="font: bold; size: 3">EMAIL FORM NO : <%=no%> IS SAVED AND SENT SUCCESSFULLY</label></center> <br />
 <%
 try 
 ...
 ResourceBundle dbProperties = ResourceBundle.getBundle("csdb");
  ...
  String query2 = "SELECT form3_no FROM form3_lotus  WHERE SUBSTRING(form3_no,9,20)='"+second+"'";
  Statement st2 = conn.createStatement();
  ResultSet rs2 = st2.executeQuery(query2); 
  int k=0;
 
   if(rs2.next()){
	                      String msg = "LOTUS__FORM__NO__:__'"+no+"'__SAVED__AND__SENT__SUCCESSFULLY";
