 ...
 if(sendopt.value=="senddirect")
     ...
     if (document.getElementsByName("mmdradio")[0].checked)
       ...
       if (document.getElementsByName("mmdradio")[0].checked && document.getElementsByName("higherAuthority")[1].checked )
           {
    	   //notesid,gname,ITcreated,
    	   var notesid = document.form.notesid;
    	   ...
    	   var mmdradioBcc = document.form.mmdradioBcc;
    	   var SendBCCmail = document.form.SendBCCmail;
    	   //alert(mmdradioBcc.value);
    	   if(notesid.value==""||notesid.value==null)
		         {
		         alert("Please Enter Notes ID. ");
		         notesid.focus();
		         return false;
		         }
    	  ...
    	  if(mmdradioBcc.value=="Yes" && SendBCCmail.value=="")
			    {
			    alert("Please Enter Send BCC email id..");
			    SendBCCmail.focus();
			    return false;
			    }
...
<form  name="form" method="post"  action="LotusAdminBack.jsp">
...
Statement st1= null,st2=null,st3=null,st4=null,st100=null,st12=null,stnext=null; 
ResultSet rs1 = null,rs2=null,rs3=null,rs4=null,rs100=null,rs12=null,rsnext=null;
...
//form2_domain
String form3_no=null,f_date=null,idextend=null,branch=null,depart=null,full_name=null,designation=null,scopeOfWork=null,emp_code=null,reporting_officer=null,requestOption=null,requestBy=null,remarks=null;
String New_email=null,password=null;
String i_name=null,i_desg=null,i_city=null,i_b_no=null,i_admin=null,i_email_id=null,desg=null,emp=null,mail=null,emailDomain="",employeeType="",intune="";
String req = request.getParameter("rss");
cn100 = con.getConnection2();
st100=cn100.createStatement();
rs100 = st100.executeQuery("select * from form3_lotus WHERE form3_no='"+req+"'"); 
while(rs100.next())
{
	    form3_no = rs100.getString("form3_no");
	    ...
	    emailDomain = rs100.getString("emailDomain");
	    employeeType = rs100.getString("employeeType");
	    intune = rs100.getString("intune");
...
<table width="101%"  cellspacing="0" cellpadding="0" bgcolor="grey" align="center">
	<tr>
		...
		<input type="hidden" name="form1_no" value="<%=form3_no%>" />
...
session.setAttribute("form_no",form3_no);
%>
...
<td style="text-align:left;" bgcolor="grey"><input name="form3_no" value="<%=form3_no%>" size="31" readonly="readonly"/> </td>
</tr>	
<tr>
...
<input type="text"  size="20"  name="d_resignation" value="<%=scopeOfWork%>" readonly="readonly"  readonly="readonly" />

</td>

<td  style="text-align: right;">Requested By:</td>
<td style="text-align:left;">
<input type="text"  size="20"  name="d_reliving"  value="<%=requestBy%>" readonly="readonly" readonly="readonly" />
...
<tr>
	<td align="right">Email Domain :</td>
	<td style="font-weight:bold;font-style:italic;width:23%;" > 
	     <input type="text"  size="20"  name="emaildomain"  value="<%=emailDomain%>" readonly="readonly" readonly="readonly" />
	 </td>
	 <td style="text-align: right;">Employee Type :</td>
	 <td style="text-align:left;">
	        <input type="text"  size="20"  name="emplyee type"  value="<%=employeeType%>" readonly="readonly" readonly="readonly" />
	 </td>  
</tr>
...
<tr>
<td  style="text-align: right;">Requested Mail ID :</td>
<td style="text-align:left;">

<input type="text"  size="20"  name="d_resignation" value="<%=New_email%>" readonly="readonly"  readonly="readonly" />

</td>

<td  style="text-align: right;">Mobile Access (Intune):</td>
<td style="text-align:left;">
<input type="text"  size="20"  name="d_reliving"  value="<%=intune%>" readonly="readonly" readonly="readonly" />
...
<table id="tableData" name="tableData" width="100%" border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
	  ...
	  String levelno="",emp_no="",form3_noD="";
	  rs1 = st1.executeQuery("select form3_no,desg,emp,status,remarks,f_date,mail,empid,levelno from form3_lotus_item WHERE form3_no='"+req+"' ORDER BY id ASC"); 
	  while(rs1.next())
	  {
		   form3_noD= rs1.getString("form3_no");
	 ...
	 <td><input type="button"  style="size:1" value="RE-SEND MAIL" onclick="resendMail('<%=m%>','<%=form3_no%>','<%=email_id%>','<%=SessionName%>');" /></td> 
...
String flag =c2ITUtil1.getAuthorizedNameLotus(form3_no,session.getAttribute("Nname").toString(),session.getAttribute("desg").toString(),session.getAttribute("EmpNo").toString()); %>
...
<input type="hidden" id="idstatus" value="<%= flag %>" />
  ...
  <tr>
   ...
   <tr style="display: none;" id="idApproved" >
 	...
 	String pass = dbProperties.getString("csdb.password");
 	String url = dbProperties.getString("csdb.url");
 	String driver = dbProperties.getString("csdb.driverName");
 	String dbName = dbProperties.getString("csdb.dbName");
     
 	Class.forName(driver).newInstance();
    cn5 = DriverManager.getConnection(url+dbName,userName,pass); 
     ...
     String maxlevel="";
	  ...
	  String i_b_no1=form3_noD.substring(14,16);
	  
	  
	  
      rs12= st12.executeQuery("SELECT max(levelno) FROM formapproval WHERE branch='"+i_b_no1+"' and formtype='LOTUS_NOTES'  ORDER BY levelno ASC");
     if(rs12.next())
         { 
     ...
     rs11 = st11.executeQuery("SELECT alloptions,directApprove FROM formapproval WHERE branch='"+i_b_no1+"' and empid='"+emp_no+"' and formtype='LOTUS_NOTES'");
     if(rs11.next())
         { 
     ...
     System.out.println("The sseecccoonndd mr_master emp_no :"+emp_no);
	 System.out.println("The sseecccoonndd mr_master levelno :"+levelno);
     if(!levelno.equals("Creater"))
            {
            //nextlevel=Integer.parseInt(levelno)+1;
             if(emp_no.equals("77") && employeeType.equals("Indian"))
	    	    {
    	    	nextlevel=Integer.parseInt(levelno)+2;
	    	    }
    	    else
	    	    {
    	    	nextlevel=Integer.parseInt(levelno)+1;
     ...
     /* ////////////////////////// Skeeping level code  ////////////////////////////////// */
      ...
      rsnext = stnext.executeQuery("SELECT * FROM formapproval WHERE branch='"+i_b_no1+"' and levelno='"+nextlevel+"' and formtype='LOTUS_NOTES' ORDER BY levelno ASC");
      if(rsnext.next())
           {
     ...
     if(allopt.equals("0") || allopt.equals(""))
    	  ...
    	  if(!levelno.equals(maxlevel) && !dirappro.equals("1"))
    	     ...
    	     rs5 = st5.executeQuery("SELECT * FROM formapproval WHERE branch='"+i_b_no1+"' and levelno='"+nextlevel+"' and formtype='LOTUS_NOTES' ORDER BY levelno ASC");
    	     if(rs5.next())
                {
               ...
               %><input type="hidden" name="senddirect" id="senddirect" value="sendonly" readonly/>
               ...
               else
                  {
            	   ...
            	   if(!levelno.equals(maxlevel) && dirappro.equals("1"))
            	         ...
            	         <td style="display: none;" id="send">Send to HO(IT) for Create<br>
                           ...
                           <td style="display: none;" id="direct">Create EMAIL ID<br>
...
<tr>
<td class="it2" style="text-align: right;width:23%;"> E-mail Address :</td>
<td class="it2"  style="text-align:left;width:50%;"> <input type="hidden" name="notesid" id="idnotesid" maxlength="65" value="NA"/>
<input type="text" name="ITusername" id="uname" maxlength="65" size="40"/></td>
</tr>
...
<td class="it2"  style="text-align:left;width:25%;"> <input type="text" name="ITremark" id="rem" size="60" maxlength="500"></td>
  ...
  <tr>
    ...
    <td>
        <input style="size:1;font-size: 1.1em;" type="button"  value="Upload/View Supporting file" onclick="window.location.href='SupportingFile.jsp?msg=1'"/> &nbsp;&nbsp;
    </td>
 </tr>
 <tr style="visibility: hidden;display: none;" id="idBcc">
   <td align="left">
  	   <b>Enter Mail ID's with comma:</b></td><td> <input type="text" name="SendBCCmail" size="50" value="" placeholder="abcd.nittsu.co.in,xyz.nittsulogistics.co.in"/>  
            	         ...
            	         <td>Create EMAIL ID<br>
            	           <table id="idFinal" align="center" width="100%" border="1" style="height: 150;" cellspacing="0" cellpadding="0" bgcolor="lightgrey" >
                             <tr>
<td class="it2" style="text-align: right;width:23%;"> Notes Id :</td>
<td class="it2"  style="text-align:left;width:25%;"> <input type="text" name="notesid" id="idnotesid" maxlength="65" /></td>
</tr>

<tr>
<td class="it2" style="text-align: right;width:23%;"> E-mail Address :</td>
<td class="it2"  style="text-align:left;width:50%;"> <input type="text" name="ITusername" id="uname" maxlength="65" size="40"/></td>
</tr>
...
<tr>
    ...
    <td>
        <input style="size:1;font-size: 1.1em;" type="button"  value="Upload Supporting file" onclick="window.location.href='SupportingFile.jsp?msg=1'"/> &nbsp;&nbsp;
    </td>
 </tr>
 <tr style="visibility: hidden;display: none;" id="idBcc">
   <td align="left">
    	 ...
    	 int next=0;
    	  while(curlev<=Integer.parseInt(maxlevel))
    	     {
    		  next=curlev+1;
    	     rs5 = st5.executeQuery("SELECT * FROM formapproval WHERE branch='"+i_b_no1+"' and levelno='"+next+"' and formtype='LOTUS_NOTES' ORDER BY levelno ASC");
         	 if(rs5.next())
                 {
		         ResultSet nrs = nstmt.executeQuery("SELECT DISTINCT u.user_name,rr.role_code,b.branch_name, d.department_name, m3.user_name AS manager_name,u.email,u.mobile_number FROM user u Inner Join user_role ur on ur.user_id=u.user_id INNER JOIN reporting_officers m1 ON m1.user_id = u.user_id INNER JOIN role rr ON ur.role_id =rr.role_id INNER JOIN branchmaster b ON b.branch_id = u.branch_id INNER JOIN department d ON d.department_id = u.department_id INNER JOIN user m3 ON m3.user_id = m1.manager_id INNER JOIN user m4 ON m4.user_id = m1.manager2_id WHERE ( m1.emp_id ='" + rs5.getString(5) + "' ) AND u.employee_status = 'yes' ");
		         if(nrs.next())
 ...
 <table style="margin-left: auto;margin-right: auto;" ><tr>
    <td> <div id="formsubmitbutton"> <input type="submit" style="background-color:#2f4377;font-weight:bold;color:white;" value="SUBMIT" name=button1 onclick="return (validate());" />
    </div>
...
if(SessionSuperAdmin!=null && SessionSuperAdmin.equals("5") && Sessiondesg!=null && Sessiondesg.equals("ASST. GENERAL MANAGER"))
{
  ...
  <tr style="visibility: hidden;display: none;" id="idApproved" >
   <td>
       ...
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input align="left" type="radio" name="higherAuthority" value="directApprove" id="idmNon" onclick="showHigherTR();"/>Direct Approve
        ...
        <span id='directMail' style="color: red"></span>
...
<td class="it2"  style="text-align:left;width:15%;"> <font color="white">
...
<br />
		...
		cn11 = con.getConnection2();
		  ...
		  rs11 = st11.executeQuery("select DISTINCT emp,form3_no,desg,emp,status,f_date,mail from form3_lotus_item WHERE form3_no='"+req+"' ORDER BY id ASC"); 
		  while(rs11.next())
		  {
    ...
    <td>       <input style="size:1;font-size: 1.1em;" type="button"  value="Upload/View Supporting file" onclick="window.location.href='SupportingFile.jsp?msg=1'"/> &nbsp;&nbsp;
  ...
  <tr style="visibility: hidden;display: none;" id="idBcc">
   ...
   <!-- <tr class="r"><td colspan="3" align="center" style="border-color:silver;background-color:#5CD6D6;border-radius:5px;padding: 5px;"><span class="mandetory">*</span>File Attachments</td></tr> -->

<!-- <tr style="visibility: hidden;display: none;" id="idBcc2">
  <td align="left">

		<b>File Attachments:</b></td>
<td>
...
<input type="hidden" name="NoOfFiles" id="NoOfFiles" value="0">
<a href="javascript:addFileInput();" style="width: auto;text-decoration: none;"><img title="Attach Files" src="../../../images/addAttach.jpg" width="30" height="30"> <span style="font-size: 15px;font-family: Chiller;color:#cc3300;">Attach File</span></a>

<span class="error" id="fileE"></span>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
<a  id="remove" style="width: auto;" onclick="return removeAttachment()"><img title="Remove Attachment" src="../../../images/removeAttach.jpg" width="30" height="30"><span style="font-size: 15px;font-family: Chiller;color:#cc3300;">Remove Last Attached File</span></a>

 <h5 style="color:lightgrey;font-style: italic;">  -----------------------------------------------------------------------------------------------------------------------------------------------------------</h5>
 </div>
<div></div> 
</td>
...
<%}
 ...
 <input type="hidden" value="<%= session.getAttribute("Nname") %>" id="idsession"/>
 <input type="hidden" value="<%= session.getAttribute("desg") %>" id="iddesg"/>
  <input type="hidden" value="<%= session.getAttribute("form3_no") %>" id="idmrId"/>
<input type="hidden" id="idstatus" value="<%= flag %>" />
...
<!--  <table style="margin-left: auto;margin-right: auto;" ><tr>
     ...
     <td style="font-size:1">&nbsp;&nbsp;<input style="size:1;font-size: 1.1em;" type="button"  value="BACK" onclick="window.location.href='LotusSelectAdmin.jsp?msg=1'"/> </td>
...
//if((ITbno.equals(session.getAttribute("b_no")) && ITdesg.equals(session.getAttribute("desg"))))
	...
	//if(SessionSuperAdmin!=null && SessionSuperAdmin.equals("5")){
	if(SessionSuperAdmin!=null && SessionSuperAdmin.equals("5") && Sessiondesg!=null && Sessiondesg.equals("ASST. GENERAL MANAGER"))
	{
	%>
 ...
 <td> <div id="formsubmitbutton"> <input type="submit" style="background-color:#2f4377;font-weight:bold;color:white;" value="SUBMIT" name=button1 onclick="return (validate() && ButtonClicked() && OtherAdmin());" />
	...
	<td>&nbsp;&nbsp;<!-- <a href="HelpPageCS.jsp" onclick="return popitup('HelpPageCS.jsp')" id="hiderow"><font size=2>HELP</font></a> -->
   	...
   	<td style="font-size:1">&nbsp;&nbsp;<!-- <input style="size:1;font-size: 1.1em;" type="button"  value="BACK" onclick="window.location.href='LotusSelectAdmin.jsp?msg=1'"/>  -->
