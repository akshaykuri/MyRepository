...
<head><title>EMAIL ID FORM</title>
...
{  var p1=document.form.req;
 if ((p1.value==null)||(p1.value=="NULL"))
				{alert("Select EMAIL ID FORM Number!"); p1.focus(); return false; }
...
<tr align="center">
 <td bgcolor="#2f4377" class="blueLine"><strong><font size ="4" color="white">EMAIL ID USER FORM</font></strong></td>
</tr>
...
/* rs9 = st9.executeQuery("SELECT DISTINCT form3_no FROM form3_lotus  ORDER BY form3_no"); */
//rs9 = st9.executeQuery("SELECT DISTINCT form3_no FROM form3_lotus_item WHERE emp='"+AdminName+"' and desg='"+desg+"' and status='Pending' AND form3_no LIKE 'NEIN/CS/Lotus%' ORDER BY form3_no ASC");
rs9 = st9.executeQuery("SELECT DISTINCT form3_no FROM form3_lotus WHERE Approval_emp='"+AdminName+"' and Approval_desg='"+desg+"' and Approval_sttatuss='Pending' AND (form3_no LIKE 'NEIN/CS/Lotus%' OR form3_no LIKE 'NEIN/CS/Email%') ORDER BY form3_no ASC");
...
<table align="center">
<tr>
<th>SELECT EMAIL ID FORM NUMBER</th>
</tr>
</table>
...
//rs9 = st9.executeQuery("Select DISTINCT substr(pordernon,6,2) from po ORDER BY substr(pordernon,6,2) ASC");
/* rs9 = st9.executeQuery("SELECT DISTINCT form3_no FROM form3_lotus  ORDER BY form3_no"); */
//rs99 = st99.executeQuery("SELECT DISTINCT form3_no FROM form3_lotus WHERE i_b_no='"+b_no+"' AND form3_no LIKE 'NEIN/CS/Lotus%' ORDER BY idextend DESC");
rs99 = st99.executeQuery("SELECT DISTINCT form3_no,full_name FROM form3_lotus WHERE (form3_no LIKE 'NEIN/CS/Lotus%' OR form3_no LIKE 'NEIN/CS/Email%') ORDER BY id DESC");
