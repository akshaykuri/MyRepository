...
<script type="text/javascript">
  ...
  {  var p1=document.form.branch1; var y1=document.form.year1;
   if ((p1.value==null)||(p1.value=="NULL"))
 				{alert("Select Form Number!"); p1.focus(); return false; }
...
<tr align="center">
 <td bgcolor="#2f4377" class="blueLine"><strong><font size ="4" color="white">EMAIL ID  FORM</font></strong></td>
</tr>
...
<form name="form" method="post" action="LotusLocalAllAdmin.jsp?msg=1">
...
if(b_no.equals("20"))
   {
    rs9 = st9.executeQuery("SELECT DISTINCT form3_no,full_name FROM form3_lotus WHERE i_b_no in ('20','21') AND (form3_no LIKE 'NEIN/CS/Lotus%' or form3_no LIKE 'NEIN/CS/Email%') ORDER BY idextend DESC");
   }
else if(b_no.equals("30"))
{
 rs9 = st9.executeQuery("SELECT DISTINCT form3_no,full_name FROM form3_lotus WHERE i_b_no in ('30','32','53','11') AND (form3_no LIKE 'NEIN/CS/Lotus%' or form3_no LIKE 'NEIN/CS/Email%') ORDER BY idextend DESC");
}
else if(b_no.equals("90"))
   {
  rs9 = st9.executeQuery("SELECT DISTINCT form3_no,full_name FROM form3_lotus WHERE (form3_no LIKE 'NEIN/CS/Lotus%' or form3_no LIKE 'NEIN/CS/Email%') ORDER BY form3_no DESC");
   }
else
   { 
   rs9 = st9.executeQuery("SELECT DISTINCT form3_no,full_name FROM form3_lotus WHERE i_b_no='"+b_no+"' AND (form3_no LIKE 'NEIN/CS/Lotus%' or form3_no LIKE 'NEIN/CS/Email%') ORDER BY idextend DESC");
   }
