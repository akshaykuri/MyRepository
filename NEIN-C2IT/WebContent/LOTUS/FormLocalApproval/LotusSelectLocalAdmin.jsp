...
rs9 = st9.executeQuery("SELECT DISTINCT form3_no FROM form3_lotus_item WHERE ((emp='"+AdminName+"' and desg='"+desg+"') or(empid='"+empno+"')) and status='Pending' AND (form3_no LIKE 'NEIN/CS/Lotus%' OR form3_no LIKE 'NEIN/CS/Email%')  ORDER BY form3_no ASC");
