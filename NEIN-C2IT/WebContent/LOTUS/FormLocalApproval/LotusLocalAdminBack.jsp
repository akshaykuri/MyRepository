...
<%! 
	              ...
	              PreparedStatement psmt=null,psmt2=null,psmt3=null,psmt4=null,psmtt=null,psmtf=null;
	              %>
...
/* psmtf = cn2.prepareStatement("UPDATE form3_lotus_item  SET status=?,remarks=?,f_date=?,presence=? WHERE form3_no=? and presence='now' ");
psmtf.setString(1,mmdradio);
psmtf.setString(2,txtmail_msg);
psmtf.setDate(3,form_date);
psmtf.setString(4,"over");
psmtf.setString(5,form3_no);
int if1 = psmtf.executeUpdate(); */
