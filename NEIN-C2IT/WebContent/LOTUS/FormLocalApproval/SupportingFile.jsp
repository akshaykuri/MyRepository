...
<%
try{
	String SessionName = (String) session.getAttribute("idsession");//there Name
	String req = (String) session.getAttribute("form3_no");//there Name
...
<form name="form"  action="../../lotusSupportingFileFormUser" method="post" enctype="multipart/form-data">
...
<tr class="r"><td colspan="3" align="center" style="border-color:silver;background-color:grey;border-radius:5px;padding: 5px;">UPLOAD SUPPORTING DOCUMENTS</td></tr>
	<tr >
	<td align="left">Lotus No. <u><input type="text" name="form_no" size="15" style="color: navy;"  value="<%=req%>" readonly="readonly"/></u>
	</td></tr>
<tr>
