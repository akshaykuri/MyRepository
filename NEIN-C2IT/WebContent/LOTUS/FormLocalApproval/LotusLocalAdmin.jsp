 ...
 */
  ...
  <script language="javascript" type="text/javascript"> 
  function resendMail(email_id,form3_no,mail,name)
  		 {
	 if (typeof XMLHttpRequest != "undefined"){    
         xmlHttp= new XMLHttpRequest();    
           }      else if (window.ActiveXObject){
           alet("Creating html http object");    
             xmlHttp= new ActiveXObject("Microsoft.XMLHTTP");  
                    ...
                    alert("Browser does not support XMLHTTP Request");    
                      return;     
                       }       var url="../../ResendMailLotusNotes?mail="+email_id+","+form3_no+","+mail+","+name+"";  
...
<form  name="form" method="post"  action="LotusLocalAdminBack.jsp">
...
String intune="",i_name=null,i_desg=null,i_city=null,i_b_no=null,i_admin=null,i_email_id=null,desg=null,emp=null,mail=null,emailDomain="",employeeType="";
...
}session.setAttribute("form3_no",form3_no);
%>
...
<table width="895" border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
	  ...
	  String form3_noD=null,emp_no="",levelno="";
	 ...
	 <td><input type="button"  style="size:1" value="RE-SEND MAIL" onclick="resendMail('<%=email_id%>','<%=form3_no%>','<%=m%>','<%=SessionName%>');" /></td> 
...
<table align="center" class="dynatable" width="100%" border="1" style="height: 150;" cellspacing="0" cellpadding="0" bgcolor="lightgrey">
 ...
 <input type="hidden" value="<%= session.getAttribute("desg") %>" id="iddesg"/>
  <input type="hidden" value="<%= form3_noD %>" id="idmrId"/>
               ...
               else
                  {
            	   ...
            	   if(!levelno.equals(maxlevel) && dirappro.equals("1"))
            	         ...
            	         <td style="display: none;" id="send">Send to HO(IT) for Create<br>
                           ...
                           <td style="display: none;" id="direct">Create EMAIL ID1<br>
...
<td class="it2"  style="text-align:left;width:25%;"> <input type="text" name="ITcreated" id="cud" maxlength="65"></td>
</tr>-->
...
<br />
		...
		cn11 = con.getConnection2();
		  ...
		  rs11 = st11.executeQuery("select form3_no,desg,emp,status,remarks,f_date,mail from form3_lotus_item WHERE form3_no='"+req+"'"); 
		  while(rs11.next())
		  {
