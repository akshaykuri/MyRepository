...
document.form.action="LotusAdminBack.jsp";
document.form.method="post";
document.form.submit();
}
function ITManager()
{
document.form.action="LotusAdminITmanagerHO.jsp";
document.form.method="post";
document.form.submit();
}
</script>
...
String New_email=null,password=null,notesid=null,group=null;
...
while(rs100.next())
{
	 ...
	 notesid = rs100.getString("notesid");
	 group = rs100.getString("groupName");
...
<tr>
	...
	<td style="font-weight:bold;font-style:italic;width:23%;" > 
	     <input type="text"  size="31"  name="emaildomain"  value="<%=emailDomain%>" readonly="readonly" readonly="readonly" />
	 </td>
	 <td style="text-align: right;">Employee Type :</td>
	 <td style="text-align:left;">
	        <input type="text"  size="31"  name="emplyee type"  value="<%=employeeType%>" readonly="readonly" readonly="readonly" />
	 </td>  
</tr>
...
<input type="text"  size="31"  name="d_resignation" value="<%=New_email%>" readonly="readonly"  readonly="readonly" />

</td>

<td  style="text-align: right;">Mobile Access (Intune):</td>
<td style="text-align:left;">
<input type="text"  size="31"  name="d_reliving"  value="<%=intune%>" readonly="readonly" readonly="readonly" />
	
		</td> 					        
</tr>
<tr>
<%-- <td  style="text-align: right;">Notes ID :</td>
<td style="text-align:left;">

<input type="text"  size="31"  name="d_resignation" value="<%=notesid%>" readonly="readonly"  readonly="readonly" />

</td> --%>

<td align="right">Type Of Request  :</td>
<td  > 
     <input style="" size="31" type ="text" name = "requestOption" readonly="readonly" value ="<%=requestOption%>" id=""/></td>
   


<td  style="text-align: right;">Group:</td>
<td style="text-align:left;">
<input type="text"  size="31"  name="d_reliving"  value="<%=group%>" readonly="readonly" readonly="readonly" />
...
<table width="895" border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
	  ...
	  rs1 = st1.executeQuery("select form3_no,desg,emp,status,remarks,DATE_FORMAT(f_date,'%d/%m/%Y'),mail from form3_lotus_item WHERE form3_no='"+req+"'"); 
	  while(rs1.next())
	  {
		  String form3_noD= rs1.getString(1);
 ...
 <table style="margin-left: auto;margin-right: auto;" ><tr>
     ...
     <td style="font-size:1" id="hiderow">&nbsp;&nbsp;<!-- <input style="size:1;font-size: 1.1em;" type="button"  value="BACK" onclick="window.location.href='LotusSelectAdmin.jsp?msg=1'"/> -->
