...
<%-- <%@ include file="getcon.jsp"%> --%>
 ...
 <%
	        ...
	        con3 = dbConn.getConnection2();
			 ...
			 String b_id=null,b_no=null,machinetype=null,vendortype=null,brand=null,modelno=null,sno=null,agreementno=null,chequeNo="",vendorname=null;
		     ...
		     String fromdate=null,todate=null,filename=null;
  ...
  if (item.isFormField())
		 ...
		 out.println("Inserting__error"+el.getMessage());
		   ...
		   // msg = "Photo Copier data Updated successfully For serial No ::"+sno;
	        ...
	        response.sendRedirect("../callForReport?branch="+branchno+"&fromdate="+fromdate+"&todate="+todate+"&view=photoCopier&Edit=1"); 
