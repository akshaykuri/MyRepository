...
$(document).ready(function () {
	...
	$("#agreementdate").datepicker({ changeMonth: true, changeYear: true,  dateFormat: 'yy-mm-dd' }).val();  
	
	$("#agreementsdate").datepicker({ changeMonth: true, changeYear: true,  dateFormat: 'yy-mm-dd' }).val(); 
	
	$("#agreementedate").datepicker({ changeMonth: true, changeYear: true,  dateFormat: 'yy-mm-dd' }).val();
	
	$("#installed").datepicker({ changeMonth: true, changeYear: true,  dateFormat: 'yy-mm-dd' }).val();
...
function popitup(url)
        {
		newwindow=window.open(url,'name','height=700,width=950,location=1,status=1,scrollbars=1,resizable=yes,channelmode=yes');
...
<body background="../images/u.jpg" onload="onLoadOfPage()">

<form method="post" name="form1" action="InsertBrandMaster.jsp">
...
<table  align="center" border="1" width="35%" style="margin-left:110px;"> 
<tr>
  ...
  <tr>
       ...
       <td><input type="text" name="brand" id="brand" size="35"></td>
   </tr>
   
    <tr>
       <td><span style="color:red;">*</span>Model No:</td>
       <td><input type="text" name="modelno" id="modelno" size="35"></td>
   </tr>
   
    <tr>
       <td><span style="color:red;">*</span>Serial No:</td>
       <td><input type="text" name="sno" id="sno" size="35"></td>
   </tr>
   
    <tr>
       <td><span style="color:red;">*</span>Agreement No:</td>
       <td><input type="text" name="agreementno" id="agreementno" size="35"></td>
   </tr>
   
    <tr>
       <td><span style="color:red;">*</span>Agreement Date:</td>
      <td><input type="text" name="agreementdate" id="agreementdate" readonly size="35"></td>
   </tr>
   <tr>
       <td><span style="color:red;">*</span>Agreement Start Date:</td>
      <td><input type="text" name="agreementsdate" id="agreementsdate" readonly size="35"></td>
   </tr>
    <tr>
       <td><span style="color:red;">*</span>Agreement End Date:</td>
       <td><input type="text" name="agreementedate" id="agreementedate" readonly size="35"></td>
   </tr>
    <tr>
       <td><span style="color:red;">*</span>Installed Date:</td>
       <td><input type="text" name="installed" id="installed" readonly size="35"></td>
   </tr>
    ...
    <tr>
       ...
       <td><input type="text" name="fcblack" id="fcblack" size="35" onkeypress="return isNumberKey1(event)" maxlength="10"></td>
   </tr>
   <tr>
       <td><span style="color:red;">*</span>charge of BA4:</td>
       <td><input type="text" name="chargefcblack" id="chargefcblack" size="35" onkeypress="return isNumberKey(event)" maxlength="10"></td>
   </tr>
   <tr>
       <td><span style="color:red;">*</span>Free Copies BA3:</td>
       <td><input type="text" name="fca3" id="fca3" size="35" onkeypress="return isNumberKey1(event)" maxlength="10"></td>
   </tr>
   <tr>
       <td><span style="color:red;">*</span>charge of BA3:</td>
       <td><input type="text" name="chargea3" id="chargea3" size="35" onkeypress="return isNumberKey(event)" maxlength="10"></td>
   </tr>
   <tr id="colortype1">
       <td><span style="color:red;">*</span>Free Copies of CA3:</td>
      <td><input type="text" name="fccolor" id="fccolor" size="35" onkeypress="return isNumberKey1(event)" maxlength="10"></td>
   </tr>
   <tr id="chargecolortype1">
       <td><span style="color:red;">*</span>charge of CA3:</td>
      <td><input type="text" name="chargefccolor" id="chargefccolor" size="35" onkeypress="return isNumberKey(event)" maxlength="10"></td>
   </tr>
   <tr id="colortype2">
       <td><span style="color:red;">*</span>Free Copies of CA4:</td> 
      <td><input type="text" name="fccolorprint" id="fccolorprint" size="35" onkeypress="return isNumberKey1(event)" maxlength="10"></td>  
   </tr>
  <tr id="chargecolortype2">
       <td><span style="color:red;">*</span>charge of CA4:</td> 
      <td><input type="text" name="chargefccolorprint" id="chargefccolorprint" size="35" onkeypress="return isNumberKey(event)" maxlength="10"></td>  
   </tr>
    <tr>
       <td><span style="color:red;">*</span>Rent Amount:</td>
      <td><input type="text" name="rentamt" id="rentamt" size="35" onkeypress="return isNumberKey(event)" maxlength="10"></td>
   </tr>
  <!--  <tr>
       <td><span style="color:red;">*</span>Tax Amount:</td>
      <td><input type="text" name="txtamt" id="txtamt" size="35" onkeypress="return isNumberKey(event)" maxlength="10"></td>
   </tr> -->
<tr>
       <th colspan="2"> <input type="submit" value="Submit" onclick="return (Validation());">&nbsp &nbsp &nbsp &nbsp 
       <input type="reset" value="Reset">
       <a href="DisplayModelMaster.jsp" onclick="return popitup('DisplayModelMaster.jsp')">VIEW ALL</a> 
       </th>
   </tr>
   </table><br><br>
  <!--  <div align="center">
