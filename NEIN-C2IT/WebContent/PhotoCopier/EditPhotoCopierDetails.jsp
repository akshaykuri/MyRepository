...
<script language="javascript" type="text/javascript">
 ...
 $(document).ready(function () { 
	...
	//	$("#monthOfPayment").datepicker(  { changeMonth: true, changeYear: true,  dateFormat: 'yy-mm-dd' }).val();  
		...
		$("#closingdate1").datepicker(  { changeMonth: true, changeYear: true,  dateFormat: 'yy-mm-dd' }).val(); 
		var closingdate = document.forms["form1"]["closingdate"].value;	
		 
		$("#openingdate1").datepicker(  { changeMonth: true, changeYear: true,  dateFormat: 'yy-mm-dd',maxDate: closingdate}).val(); 
		//$("#openingdate").datepicker(  { changeMonth: true, changeYear: true,  dateFormat: 'yy-mm-dd' }).val(); 
...
<form method="post" name="form1" action="UpdatePhotoCopyDetails.jsp" enctype="multipart/form-data">
...
<tr>
       <td><span style="color:red;">*</span>Location/Branch:</td>
		   ...
		   <td>
		       ...
		       <input type="hidden" name="fromdate" id="from" readonly size="35" value="<%=from%>">
		       <input type="hidden" name="todate" id="to" readonly size="35" value="<%=to%>">
   ...
   <tr>
    ...
    <tr>  
        <td><span style="color:red;">*</span>Closing Meter Date:</td><td><input type="text" name="closingdate" id="closingdate1" size="35" value="<%=rs3.getString("closingdate")%>" readonly></td>
        <td><span style="color:red;">*</span>Opening Meter Date:</td><td><input type="text" name="openingdate" id="openingdate1" size="35" value="<%=rs3.getString("openingdate")%>" readonly></td>
    <td colspan="2">
       <span style="color:red;">*</span>Rent CGST : % <input type="text" name="rcgst_per" id="cgst_per0" size="3" value="<%=rs3.getString("rcgst_per")%>" onkeypress="return isNumberKey2(event)">
       &nbsp<input type="text" name="rcgst_Amt" id="cgst_Amt0" placeholder="click here"  value="<%=rs3.getString("rcgst_amt")%>"  size="10" readonly>
       &nbsp &nbsp
      <span style="color:red;">*</span> Rent SGST : % <input type="text" name="rsgst_per" id="sgst_per0" size="3" value="<%=rs3.getString("rsgst_per")%>" onkeypress="return isNumberKey3(event)" > 
    ...
    <tr> 
	     ...
	     <input type="text" name="installdate" id="installdate" value="<%=rs3.getString("installeddate")%>" size="15" >
               <span style="color:red;">*</span> Rent Invoice No: &nbsp <input type="text" name="rinvoiceno" id="rinvoiceno"  size="15" value="<%=rs3.getString("rinvoice_no")%>" >&nbsp &nbsp &nbsp &nbsp
               <span style="color:red;">*</span> Rent Invoice Date: &nbsp <input type="text" name="rinvoicedate" id="rinvoicedate" size="15" value="<%=rs3.getString("rinvoice_date")%>"  >    &nbsp &nbsp &nbsp &nbsp
	           <span style="color:red;">*</span> Rent Invoice Amt: &nbsp <input type="text" name="rinvoiceAmt" id="rinvoiceAmt"  size="20"   onclick="return aa()" >&nbsp &nbsp &nbsp &nbsp 
	           <span style="color:red;">*</span> Rent Invoice File:&nbsp 
   ...
   if(rs5.getString("photo_type").equals("BA4")){  %>             
     ...
     <tr>
	   ...
	   <td><input type="text" name="closingbalance" id="closingbalance1"  value="<%=rs5.getString("closing_balance")%>" size="10" ></td>
	   <td><input type="text" name="openingbalance" id="openingbalance1"  value="<%=rs5.getString("opening_balance")%>" size="10" ></td>
	   ...
	   <td><input type="text" name="invoiceno" id="invoiceno1"  value="<%=rs5.getString("invoice_no")%>" size="15"></td>
	   <td><input type="text" name="invoicedate" id="invoicedate1" value="<%=rs5.getString("invoice_date")%>" size="10" readonly></td>
	   <td><input type="text" name="invoiceAmt" id="invoiceAmt1"   size="8"  onclick="return xx()" ></td>	   
       <td>
  ...
  <% } 
   ...
   <tr>
     <td><input type="text" name="phototype" id="phototype4"  value="<%=rs5.getString("photo_type")%>" readonly size="15"></td>    
	   <td><input type="text" name="closingbalance" id="closingbalance4"  value="<%=rs5.getString("closing_balance")%>" size="10" ></td>
	   <td><input type="text" name="openingbalance" id="openingbalance4"  value="<%=rs5.getString("opening_balance")%>" size="10" ></td>
	   ...
	   <td><input type="text" name="cgst_per" id="cgst_per4" size="7" value="<%=rs5.getString("cgst_per")%>" onkeypress="return isNumberKeya13(event)"></td>
	   <td><input type="text" name="cgst_Amt" id="cgst_Amt4" value="<%=rs5.getString("cgst_amt")%>" readonly size="15" ></td>
	   <td><input type="text" name="sgst_per" id="sgst_per4" size="7" value="<%=rs5.getString("sgst_per")%>" onkeypress="return isNumberKeya23(event)"></td>
	   <td><input type="text" name="sgst_Amt" id="sgst_Amt4" value="<%=rs5.getString("sgst_amt")%>"  size="15" readonly></td>	   
	   
	   <td><input type="text" name="invoiceno" id="invoiceno4"  value="<%=rs5.getString("invoice_no")%>" size="15"></td>
	   <td><input type="text" name="invoicedate" id="invoicedate4" value="<%=rs5.getString("invoice_date")%>" size="10" readonly></td>
	   <td><input type="text" name="invoiceAmt" id="invoiceAmt4"   size="8"  onclick="return a3()" ></td>	   
     <td>
...
<% }
   if(rs5.getString("photo_type").equals("CA3")){  %>    
      <tr>
       <td><input type="text" name="phototype" id="phototype2" value="CA3" value="<%=rs5.getString("photo_type")%>"readonly size="15"></td>    
	   <td><input type="text" name="closingbalance" id="closingbalance2"  size="10" value="<%=rs5.getString("closing_balance")%>" ></td>
	   <td><input type="text" name="openingbalance" id="openingbalance2"  size="10" value="<%=rs5.getString("opening_balance")%>" ></td>
	   ...
	   <td><input type="text" name="invoiceno" id="invoiceno2"  value="<%=rs5.getString("invoice_no")%>" size="15"></td>
	   <td><input type="text" name="invoicedate" id="invoicedate2" size="10" value="<%=rs5.getString("invoice_date")%>" readonly></td>
	   <td><input type="text" name="invoiceAmt" id="invoiceAmt2"  size="8"  onclick="return yy()"></td>	   
       <td>
          <input type="file" name="invoicefile" id="invoicefile3">
          <input type="hidden" name="filepath" id="file" value="<%=rs5.getString("filepath")%>">
          <a href="DownloadFile.jsp?f=<%=rs5.getString("filepath")%>" ><%=filename%></a>
    ...
    <% } if(rs5.getString("photo_type").equals("CA4")){  %>   
     <tr>
       <td><input type="text" name="phototype" id="phototype3" value="CA4" value="<%=rs5.getString("photo_type")%>" readonly size="15"></td>    
	   <td><input type="text" name="closingbalance" id="closingbalance3"   value="<%=rs5.getString("closing_balance")%>" size="10" ></td>
	   <td><input type="text" name="openingbalance" id="openingbalance3"  value="<%=rs5.getString("opening_balance")%>" size="10" ></td>
	   ...
	   <td><input type="text" name="invoiceno" id="invoiceno3"  value="<%=rs5.getString("invoice_no")%>" size="15"></td>
	   <td><input type="text" name="invoicedate" id="invoicedate3" size="10" value="<%=rs5.getString("invoice_date")%>" readonly></td>
	   <td><input type="text" name="invoiceAmt" id="invoiceAmt3"  size="8"  onclick="return zz()"></td>	   
       <td>
          <input type="file" name="invoicefile" id="invoicefile3">
          <input type="hidden" name="filepath" id="file" value="<%=rs5.getString("filepath")%>">
          <a href="DownloadFile.jsp?f=<%=rs5.getString("filepath")%>" ><%=filename%></a>
    ...
    <tr>
		...
		<td><input type="text" name="chequeDate" id="chequeDate" value="<%=rs3.getString("cheque_date")%>" size="35" ></td>
		
	</tr>
    <tr>
        <td><span style="color:red;">*</span>Month Of Payment:</td>
	    <td><input type="text" name="monthOfPayment" id="monthOfPayment" value="<%=rs3.getString("month_of_payment")%>" size="35" ></td>
