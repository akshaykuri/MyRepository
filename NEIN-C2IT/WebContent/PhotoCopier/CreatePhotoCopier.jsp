...
<script language="javascript" type="text/javascript">
	...
	{ 		
		...
		// var txtamt = document.forms["form1"]["txtamt"].value;
		 ...
		 if(installdate == '' || installdate == 'null'){	
			 alert("Please update Installed Date on master");
		        return false;     
			    } 
		 ...
		 if(phototype1 == "BA4"){
			 ...
			 var invoicefile1 = document.forms["form1"]["invoicefile1"].value;  
			...
			/* if(invoicefile1 == ''){		
			    alert("Enter White/Black invoice file");
			    return false;
			}  */
  ...
  if(machinetype == "Colour"){		 
		 ...
		 if(phototype2 == "CA3"){
			 ...
			 var invoicefile2 = document.forms["form1"]["invoicefile2"].value;
			...
			/* if(invoicefile2 == ''){		
			    alert("Enter Colour Copy invoice file");
			    return false;
			}  */
		...
		if(phototype3 == "CA4"){
			 ...
			 var invoicefile3 = document.forms["form1"]["invoicefile3"].value;
 ...
 $(document).ready(function () { 
	...
	//	$("#monthOfPayment").datepicker(  { changeMonth: true, changeYear: true,  dateFormat: 'yy-mm-dd' }).val();  
		...
		$("#closingdate").datepicker(  { changeMonth: true, changeYear: true,  dateFormat: 'yy-mm-dd' }).val(); 
		
		 var closingdate = document.forms["form1"]["closingdate"].value;	
		 
		$("#openingdate").datepicker(  { changeMonth: true, changeYear: true,  dateFormat: 'yy-mm-dd',maxDate: closingdate}).val(); 
		
		//$("#installdate").datepicker( { changeMonth: true, changeYear: true,  dateFormat: 'yy-mm-dd' }).val(); 
...
function isNumberKeya23(evt)
{
 ...
 function totalprint1(){
         ...
         if(numberofcopies1 != ''){
				 ...
				 var atotalcharged1=+percopy1 * +extracopies11;
				 var totalcharged1 = parseFloat(atotalcharged1).toFixed( 2 );
...
if(numberofcopies4 != ''){
	 ...
	 var atotalcharged4=+percopy4 * +extracopies4;
	 var totalcharged4 = parseFloat(atotalcharged4).toFixed( 2 );
 ...
 function totalprint2(){
		...
		if(numberofcopies2 != ''){		 
			 ...
			 var atotalcharged2=+percopy2 * +extracopies12;
			 var totalcharged2 = parseFloat(atotalcharged2).toFixed( 2 );
 ...
 function totalprint3(){
			...
			if(numberofcopies3 != ''){		 
				 ...
				 var atotalcharged3=+percopy3 * +extracopies13;
				 var totalcharged3 = parseFloat(atotalcharged3).toFixed( 2 );
 ...
 function totalamount(){
			...
			if(machinetype == "Colour"){
			    ...
			    if(invoiceAmt3 == ''){
				  ...
				  var atotalamount=+rinvoiceAmt + +invoiceAmt1 + +invoiceAmt2 + +invoiceAmt3 + +invoiceAmt4;
				  var totalamount = parseFloat(atotalamount).toFixed( 2 );
				  document.getElementById("totalamt").value =totalamount;
			}
			else{
				 var atotalamount=+rinvoiceAmt + +invoiceAmt1 + +invoiceAmt4;
				 var totalamount = parseFloat(atotalamount).toFixed( 2 );
				 document.getElementById("totalamt").value =totalamount;
			}	 
...
function xx(){
    ...
    if(charged1 == ''){
		 alert("Please Enter BA4 charged Amount");
		 return false;
	 }
...
function yy(){
    ...
    if(charged2 == ''){
		 alert("Please Enter CA3 charged Amount");
		 return false;
	 }
...
<form method="post" name="form1" action="InsertPhotoCopyDetails.jsp"  enctype="multipart/form-data">
...
<tr>
       <td><span style="color:red;">*</span>Location/Branch:</td>
                    <% 
                             response.setContentType("text/html;charset=UTF-8");
   		                     ...
   		                     String branch_id1=request.getParameter("branch_id");
   		                     int branch_id=Integer.parseInt(branch_id1);
   		                     String installeddate=null;
   		                     
   		                     String  freecopyblack=null;String freecopycolor=null;String freecopycolorprint=null,freea3=null;
   		                     String  chargeblackcopy=null;String chargecolorcopy=null;String chargecolorprint=null,chargea3=null;
   		                     String ba4openbal="0",ba3openbal="0",ca4openbal="0",ca3openbal="0",opendate="";
                           ...
                           try
                              {
                               ...
                               String query = "SELECT p.`branch_id`, `brand`, `modelno`, `serialno`, `agreementno`, `agreementdate`,"+
                               " `agreementsdate`, `agreementedate`, `vendortype`,`machinetype`, `freecopyblack`, `freecopycolor`, "+
                               "`freecopycolorprint`, `chargeblackcopy`, `chargecolorcopy`, `chargecolorprint`,`rentamt`,`vendorname`, "+
                               "`taxamt`,b.b_name,mb.m_b_no,`freea3`,`chargea3`,`installed_date` FROM `photocopier_model_master` p"+
                               " INNER JOIN branch_master b ON p.branch_id = b.id "+
                               " INNER JOIN branch_master_main mb ON b.b_no = mb.m_b_no"+
                               " WHERE `branch_id`='"+branch_id+"' AND `serialno`='"+sno+"'";
	              ...
	              <%while(rs3.next()){
	            	    freecopyblack=rs3.getString("freecopyblack");  
                        chargeblackcopy=rs3.getString("chargeblackcopy"); 
                        freea3=rs3.getString("freea3");  
                        chargea3=rs3.getString("chargea3"); 
                        freecopycolor=rs3.getString("freecopycolor");  
                        chargecolorcopy=rs3.getString("chargecolorcopy"); 
                        freecopycolorprint=rs3.getString("freecopycolorprint");  
                        chargecolorprint=rs3.getString("chargecolorprint"); 
                        machinetype=rs3.getString("machinetype");  
                        amount =rs3.getString("rentamt");                        
                        installeddate=rs3.getString("installed_date");
                        //System.out.println("aaaaaaaaaa"+rs3.getString("installed_date"));
	              %>
   ...
   <tr>
     ...
     <tr>
        ...
        try
           {
            ...
            String query = " SELECT `photo_type`,`closing_balance`,`opening_balance`,`month_of_payment`,"+
                           " p2.`closingdate`,p2.`openingdate` FROM `photocopy_summary` p1 "+
                           " INNER JOIN `photocopier_details` p2 ON p1.`ph_id` = p2.`ph_id` "+
                           " WHERE p1.`ph_id` in (SELECT max(p3.`ph_id`) "+
                           " FROM `photocopier_details` p3 WHERE p3.`branch_id`='"+branch_id+"' AND p3.`serialno`='"+sno+"') ";
                            
              stx = conx.createStatement();
              rsx = stx.executeQuery(query);   
            
             while(rsx.next()){ 
            	 
            	 String typ=rsx.getString("photo_type"); 
            	 opendate=rsx.getString("closingdate"); 
            	 if(typ.equals("BA4")){
            		 ba4openbal=rsx.getString("closing_balance"); 
            	 }
            	 if(typ.equals("BA3")){
            		 ba3openbal=rsx.getString("closing_balance"); 
            	 }
            	 if(typ.equals("CA4")){
            		 ca4openbal=rsx.getString("closing_balance"); 
            	 }
            	 if(typ.equals("CA3")){
            		ca3openbal=rsx.getString("closing_balance"); 
            	 } 
             ...
             System.out.println("ba4openbal "+ba4openbal);
             System.out.println("ba3openbal "+ba3openbal);
             System.out.println("ca3openbal "+ca3openbal);
             System.out.println("ca4openbal "+ca4openbal);
       ...
       <%-- <td >      <%Connection con4 = null;
        ...
        <td><span style="color:red;">*</span>Rent Amount:</td>
        <td><input type="text" name="rentamt" id="rentamt" size="35" readonly value="<%=amount%>"></td>
       </tr> 
    <tr>
    <td><span style="color:red;">*</span>Closing Meter Date:</td>
    <td><input type="text" name="closingdate" id="closingdate" size="35" readonly></td>
    <td><span style="color:red;">*</span>Opening Meter Date:</td>
    <td><input type="text" name="openingdate" id="openingdate" value="<%=opendate%>" size="35" readonly></td>  
    <td colspan="2">
     <span style="color:red;">*</span>  Rent CGST : % <input type="text" name="rcgst_per" id="cgst_per0" size="3" onkeypress="return isNumberKey2(event)">
       &nbsp<input type="text" name="rcgst_Amt" id="cgst_Amt0"  readonly  size="10" readonly>
       &nbsp &nbsp
     <span style="color:red;">*</span>  Rent SGST : % <input type="text" name="rsgst_per" id="sgst_per0" size="3" onkeypress="return isNumberKey3(event)"> 
       &nbsp<input type="text" name="rsgst_Amt" id="sgst_Amt0"   size="10" readonly>
    </td>
    </tr> 
    
    <tr > 
          <td colspan="6">
              <span style="color:red;">*</span>Installed Date:
	          <input type="text" name="installdate" id="installdate"  size="15" value="<%=installeddate%>" readonly>
              <span style="color:red;">*</span> Rent Invoice No: &nbsp <input type="text" name="rinvoiceno" id="rinvoiceno"  size="15">&nbsp 
              <span style="color:red;">*</span> Rent Invoice Date: &nbsp <input type="text" name="rinvoicedate" id="rinvoicedate" size="15" readonly >&nbsp 
	          <span style="color:red;">*</span> Rent Toal Invoice Amt: &nbsp <input type="text" name="rinvoiceAmt" id="rinvoiceAmt"  size="20" readonly onclick="return aa()" placeholder="click here">&nbsp &nbsp &nbsp &nbsp 
	           Rent Invoice File:&nbsp <input type="file" name="rinvoicefile" id="rinvoicefile">
         </td>    
    </tr>
    <tr> 
    <td colspan="6">
    ...
    <tr>            
     ...
     <tr>
       <td><input type="text" name="phototype" id="phototype1" value="BA4" readonly size="15"></td>    
	   <td><input type="text" name="closingbalance" id="closingbalance1"  size="10" onkeypress="return isNumberKey(event)" ></td>
	   <td><input type="text" name="openingbalance" id="openingbalance1" value="<%=ba4openbal%>" size="10" onkeypress="return isNumberKey(event)" ></td>
	   <td><input type="text" name="numberofcopies" id="numberofcopies1"  size="8"  readonly onclick="return totalprint1()" placeholder="click here"></td>
	   <td><input type="text" name="freecopies" id="freecopies1"  size="6" value="<%=freecopyblack%>" readonly></td>
	   <td><input type="text" name="extracopies" id="extracopies1"  size="6" readonly></td>
	   <td><input type="text" name="percopy" id="percopy1"  size="7" value="<%=chargeblackcopy%>" readonly></td>
	   <td><input type="text" name="charged" id="charged1" size="7" readonly></td>
	  
	   <td><input type="text" name="cgst_per" id="cgst_per1" size="7" onkeypress="return isNumberKey4(event)"></td>
	   <td><input type="text" name="cgst_Amt" id="cgst_Amt1" placeholder="click here" readonly  size="15" readonly></td>
	   <td><input type="text" name="sgst_per" id="sgst_per1" size="7" onkeypress="return isNumberKey5(event)"></td>
	   <td><input type="text" name="sgst_Amt" id="sgst_Amt1" placeholder="click here"  size="15" readonly></td>
	   
       <td><input type="text" name="invoiceno" id="invoiceno1"  size="15"></td>
	   <td><input type="text" name="invoicedate" id="invoicedate1" size="10" readonly></td>
	   <td><input type="text" name="invoiceAmt" id="invoiceAmt1"  size="8" readonly onclick="return xx()" placeholder="click here"></td>	 
	   <td><input type="file" name="invoicefile" id="invoicefile1"></td>  
      </tr> 
      <tr>
       <td><input type="text" name="phototype" id="phototype4" value="BA3" readonly size="15"></td>    
	   <td><input type="text" name="closingbalance" id="closingbalance4"  size="10" onkeypress="return isNumberKey(event)" ></td>
	   <td><input type="text" name="openingbalance" id="openingbalance4"  value="<%=ba3openbal%>" size="10" onkeypress="return isNumberKey(event)" ></td>
	   <td><input type="text" name="numberofcopies" id="numberofcopies4"  size="8"  readonly onclick="return totalprinta3()" placeholder="click here"></td>
	   <td><input type="text" name="freecopies" id="freecopies4"  size="6" value="<%=freea3%>" readonly></td>
	   <td><input type="text" name="extracopies" id="extracopies4"  size="6" readonly></td>
	   <td><input type="text" name="percopy" id="percopy4"  size="7" value="<%=chargea3%>" readonly></td>
	   <td><input type="text" name="charged" id="charged4" size="7" readonly></td>
	  
	   <td><input type="text" name="cgst_per" id="cgst_per4" size="7" onkeypress="return isNumberKeya13(event)"></td>
	   <td><input type="text" name="cgst_Amt" id="cgst_Amt4" placeholder="click here" readonly  size="15" readonly></td>
	   <td><input type="text" name="sgst_per" id="sgst_per4" size="7" onkeypress="return isNumberKeya23(event)"></td>
	   <td><input type="text" name="sgst_Amt" id="sgst_Amt4" placeholder="click here"  size="15" readonly></td>
	   
       <td><input type="text" name="invoiceno" id="invoiceno4"  size="15"></td>
	   <td><input type="text" name="invoicedate" id="invoicedate4" size="10" readonly></td>
	   <td><input type="text" name="invoiceAmt" id="invoiceAmt4"  size="8" readonly onclick="return a3()" placeholder="click here"></td>	 
	   <td><input type="file" name="invoicefile" id="invoicefile4"></td>  
     </tr> 
  <% if (machinetype.equals("Colour")){%>    
     <tr> 
       <td><input type="text" name="phototype" id="phototype2" value="CA3" readonly size="15"></td>    
	   <td><input type="text" name="closingbalance" id="closingbalance2"  size="10" onkeypress="return isNumberKey(event)" ></td>
	   <td><input type="text" name="openingbalance" id="openingbalance2"  value="<%=ca3openbal%>" size="10" onkeypress="return isNumberKey(event)" ></td>
	   <td><input type="text" name="numberofcopies" id="numberofcopies2"  size="8"  readonly onclick="return totalprint2()" placeholder="click here"></td>
	   <td><input type="text" name="freecopies" id="freecopies2"  size="6" value="<%=freecopycolor%>" readonly></td>
	   <td><input type="text" name="extracopies" id="extracopies2"  size="6" readonly></td>
	   <td><input type="text" name="percopy" id="percopy2"  size="7" value="<%=chargecolorcopy%>" readonly></td>
	   <td><input type="text" name="charged" id="charged2" size="7" readonly></td>
	  
	   <td><input type="text" name="cgst_per" id="cgst_per2" size="7" onkeypress="return isNumberKey6(event)"></td>
	   <td><input type="text" name="cgst_Amt" id="cgst_Amt2" placeholder="click here"  size="15" readonly></td>
	   <td><input type="text" name="sgst_per" id="sgst_per2" size="7" onkeypress="return isNumberKey7(event)"></td>
	   <td><input type="text" name="sgst_Amt" id="sgst_Amt2" placeholder="click here"  size="15" readonly></td>

	   <td><input type="text" name="invoiceno" id="invoiceno2"  size="15"></td>
	   <td><input type="text" name="invoicedate" id="invoicedate2" size="10" readonly></td>
	   <td><input type="text" name="invoiceAmt" id="invoiceAmt2"  size="8" readonly onclick="return yy()" placeholder="click here" ></td>	   
	   <td><input type="file" name="invoicefile" id="invoicefile2"></td> 
     </tr>
     <tr>
       <td><input type="text" name="phototype" id="phototype3" value="CA4" readonly size="15"></td>    
	   <td><input type="text" name="closingbalance" id="closingbalance3"  size="10" onkeypress="return isNumberKey(event)" ></td>
	   <td><input type="text" name="openingbalance" id="openingbalance3"  value="<%=ca4openbal%>" size="10" onkeypress="return isNumberKey(event)" ></td>
	   <td><input type="text" name="numberofcopies" id="numberofcopies3"  size="8"  readonly onclick="return totalprint3()" placeholder="click here"></td>
	   <td><input type="text" name="freecopies" id="freecopies3"  size="6" value="<%=freecopycolorprint%>" readonly></td>
	   <td><input type="text" name="extracopies" id="extracopies3"  size="6" readonly></td>
	   <td><input type="text" name="percopy" id="percopy3"  size="7" value="<%=chargecolorprint%>" readonly></td>
	   <td><input type="text" name="charged" id="charged3" size="7" readonly></td>
	  
       <td><input type="text" name="cgst_per" id="cgst_per3" size="7" onkeypress="return isNumberKey8(event)"></td>
	   <td><input type="text" name="cgst_Amt" id="cgst_Amt3" placeholder="click here"  size="15" readonly></td>
	   <td><input type="text" name="sgst_per" id="sgst_per3" size="7" onkeypress="return isNumberKey9(event)"></td>
	   <td><input type="text" name="sgst_Amt" id="sgst_Amt3" placeholder="click here"  size="15" readonly></td>

	   <td><input type="text" name="invoiceno" id="invoiceno3"  size="15"></td>
	   <td><input type="text" name="invoicedate" id="invoicedate3" size="10" readonly></td>
	   <td><input type="text" name="invoiceAmt" id="invoiceAmt3"  size="8" readonly onclick="return zz()" placeholder="click here"></td>	
	   <td><input type="file" name="invoicefile" id="invoicefile3"></td>    
    </tr>
  <%}%> 
    </table>  
     ...
     <tr> <td><span style="color:red;">*</span>Month Of Payment:</td>
	     <td><input type="text" name="monthOfPayment" id="monthOfPayment" size="35" readonly></td>
	     
		 <td><span style="color:red;">*</span>Total Amount:</td>
		 <td><input type="text" name="totalamt" id="totalamt"  size="35" readonly onclick="return totalamount()" placeholder="click here for total"></td>		
    </tr>
    <tr>
       
	    <td><!-- <span style="color:red;">*</span> -->Cheque No:</td>
		<td ><input type="text" name="chequeNo" id="chequeNo" class="number-only" size="35"></td>
		<td><b style="color:red"></b>Cheque Amount :  </td>
		<td><input type="text" name="chequeamt" id="chequeamt"   value="" size="30" onkeypress="return isNumberKey(event)" placeholder="enter cheque amount">   </td>
		<td><!-- <span style="color:red;">*</span> -->Cheque Date:</td>
		<td><input type="text" name="chequeDate" id="chequeDate" size="35" readonly></td>
  ...
  <!--  <div align="center">
   ...
   <table align="center" cellspacing="0" cellpadding="0" border="0" width="1118"> 
	...
	<a href="javascript:history.go(-1)"><img src="../bakk.png" border="0" height="35" width="35"></a><address><font size="2">BACK</font></address> 
	</td> 
	</tr> 
</table> 
 <table width="1118" align="center" border="0" cellspacing="0" cellpadding="0">
