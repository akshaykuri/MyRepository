...
<form method="post" action="PhotocopierUpdate.jsp">
<br />
<br /><br />
...
ResultSet rs=null,rs2=null;
  ...
  
  {
      ...
      conn = DriverManager.getConnection(url+dbName,userName,password); 
        String query = "select * from photocopier_master where id='"+no+"'";
  ...
  <tr>
      ...
      <td bgcolor=""><input name="photocopier_name" style="background-color:white;width:100;color:black;" value="<%=rs.getString("photocopier_name")%>"></td>
      <td bgcolor=""><font color="white"><input name="photocopier_detail" style="background-color:white;width:80;color:black;" value="<%=rs.getString("photocopier_detail")%>"></font></td>
