...
<center>
	...
	<table border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
		<tr>
				<td height="20" bgcolor="white" width="120" align=center><font size="2" color="black"><b>ID</b></font></td>
		<td height="20" bgcolor="white" width="120" align=center><font size="2" color="black"><b>DATE</b></font></td>
<td bgcolor="white" width="120" align=center><font size="2" color="black"><b>TIME</b></font></td>
...
String query = "SELECT id,SentDate,DATE_FORMAT(SentDate,'%e/%m/%Y') as datu FROM sendingautomail ORDER BY id DESC LIMIT 1";
