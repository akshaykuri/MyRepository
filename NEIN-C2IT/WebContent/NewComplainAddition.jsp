...
<%!
	...
	%>
     ...
     department = (String) session.getAttribute("department");//there Name
     		 ...
     		 System.out.println("Initiator NAME "+Initiator);
     		 System.out.println("Initiator department "+department);
     %>
<body >
...
rs2 = st2.executeQuery("select p_type from prob_master WHERE department='"+department+"' ORDER BY p_type Asc");
%>
   <%
...
<tr><td style="visibility: hidden; display: none"><input
			type="hidden" name="idextend" value="<%=id%>" />
			
			</td>
			
<td width="25" align="center" height="5" colspan="2"><center>2</center></td>

<td >&nbsp;USER NAME </td><td width="443"><input type ="text" name = "cm_name"  id = "cm_name" value ="" size="40" />
...
<table align=center bgcolor="lightgrey">
 ...
 <a href="ims_Branch_Back.jsp?msg=1"><img src="bakk.png" border="0" height="35" width="35" title="BACK" /></a><address><font size="2">BACK</font></address></td> -->
<!--  <td style="font-size: 1"><input style="size: 1;" type="button" title="Back To Selection Date Page" value="BACK" onclick="window.location.href='ims_Branch_Back.jsp?msg=1'" /></td>
<td style="size:1"><input style="font-size:1" type="button" value="CANCEL" onclick="window.location.href='ims_Branch_Back.jsp?msg=1'" /></td>
 -->

<!--  <td style="size:1"><input style="font-size:1" type="button" value="BACK" onclick="goBack()" /></td> -->
	...
	<td style="size:1"><input style="font-size:1 ;color: blue;"  type="submit" value="SAVE" name="save1" id="save1" onclick="return ValidateForm();"/></td><!--
     ...
     <td>&nbsp;&nbsp;<a href="csHelpPage.jsp" onclick="return popitup('csHelpPage.jsp')" id="hiderow"><font size=2>HELP</font></a></td>
       ...
       <td style="size:1"><input style="font-size:1" type="button" value="BACK" onclick="window.location.href=' ims_Branch_Back.jsp?msg=1'" /></td>
 </tr>
