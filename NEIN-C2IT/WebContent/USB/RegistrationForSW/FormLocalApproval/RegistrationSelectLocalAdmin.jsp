...
rs9 = st9.executeQuery("SELECT DISTINCT form10_no FROM form17_usb_access_item WHERE ((emp='"+AdminName+"' and desg='"+desg+"') or (empid='"+EmpNo+"')) and status='Pending' AND form10_no LIKE 'NEIN/USB%' ORDER BY form10_no ASC");
