...
String i_name=null,i_desg=null,i_city=null,i_b_no=null,i_admin=null,i_email_id=null,desg=null,emp=null,mail=null,dongleNo="",accessFor="";
...
<table id="tableData" name="tableData" width="895" border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
	  ...
	  String statusD=null;
	  rs1 = st1.executeQuery("select form10_no,desg,emp,status,remarks,DATE_FORMAT(f_date,'%d/%m/%Y'),mail from  form17_usb_access_item WHERE form10_no='"+req+"'"); 
	  while(rs1.next())
	  {
