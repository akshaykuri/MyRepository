...
rs = st2.executeQuery("select sname from backuptypemaster where sname='"+sname+"'");
if(rs.next()){
...
psmt1 = cn.prepareStatement("insert into backuptypemaster(sname) values(?)");
...
response.sendRedirect("backupTypeMaster.jsp?msg=" +msg);
%>
