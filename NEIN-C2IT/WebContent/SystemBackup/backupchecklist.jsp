             ...
             if(xmlHttp.readyState==4 || xmlHttp.readyState=="complete")//iddesg,iddept,idbranch,idcono
                            { 
                             ...
                             document.getElementById("iddesg").value =  document.getElementById("p2").value;
                     		 ...
                     		 document.getElementById("idres").value =  document.getElementById("p8").value;
                     		 var val=document.getElementById("p8").value;
                     		 //alert(val);
                     		 matches =val.match(/##/g);
                       	     ...
                       	     for (var i=1; i<=matches.length-1; i++)
                     	          ...
                     	          for (var j=0; j<6; j++)
                     	                ...
                     	                if(j==0)
                     	        	         ...
                     	        	         td.appendChild(document.body.appendChild(ed));
                     	        	         de.appendChild(detext);
                    	        	         td.appendChild(document.body.appendChild(de));
                     	        	         }
                     	                 else
                     	        	         {
    		                 ...
    		                 document.getElementById("idsysno").value = "";
                     	     ...
                     	     var i=document.getElementById("idres").value;
                     	     matches =i.match(/##/g);
                     		//alert(matches.length); 
...
<!-- <script type="text/javascript">  
 function sendInfo1(v)  
	       ...
	       alert(v.length);
           if(v.length==4)
           window.location.replace("backupchecklist.jsp?empid="+v); 
           }
 </script> -->
           ...
           %>
                 <center>
                    ...
                    <div id="myDynamicTable">
                	  <table id="myTable" width="80%" border="1" style="border-collapse: collapse;" bgcolor="gray">
                           <tr>
                               <td align=center width=60%  colspan=8  background=".jpg">
                                   <font color=darkblue size=3 >SCHEDULED LIST</font>
                                </td>
                          </tr>
                          <input type="hidden"  value="0" size=30 id="idres" name="res" readonly>
                          <tr>
	                          ...
	                          <td align="center" colspan=3><font size=2 >EDIT/DELETE</font></td>
                               ...
                               //    String p_type=request.getParameter("p_type");
                                  ...
                                  // String emp=request.getParameter("idname");
                                   ...
                                   rs5 = st5.executeQuery("select * from systembackupschdaytime where empno='"+p+"'");
                                   %>
                                   <%while(rs5.next())
                                       {%>
	                                     <tr>
	                                         <td><input type="hidden" name="desg" id="iddesg" value="<%=rs5.getString(1)%>" size=10 readonly></td>
                                             <td align="center"><font size=2><input type="text" name="desg" id="iddesg" value="<%=rs5.getString(3)%>" size=10 readonly></font></td>
                                             <td align="center"><font size=2><input type="text" name="dept" id="iddept" value="<%=rs5.getString(4)%>" size=10 readonly></font></td>
                                             <td align="center"><font size=2><input type="text" name="desg" id="iddesg" value="<%=rs5.getString(5)%>" size=10 readonly></font></td>
                                             <td align="center"><font size=2><input type="text" name="dept" id="iddept" value="<%=rs5.getString(6)%>" size=10 readonly></font></td>
                                             <td align="CENTER" colspan=2 >  <input type="submit"  value="EDIT" name=button1  onclick="editRecord(<%=rs5.getString(1)%>);"/></td>
                                             <td align="CENTER" colspan=2 >  <input type="submit"  value="DELETE" name=button1 onclick="deleteRecord(<%=rs5.getString(1)%>);" /></td>
                                        </tr>
                                      <%}p=null;}%> --%>
