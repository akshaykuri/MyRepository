...
<center>
     <br />
  	 <table border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
		...
		<td bgcolor="white" width="120" align=center><font size="2" color="black"><b>SCHEDULE FOR</b></font></td>
		<td bgcolor="white" width="120" align=center><font size="2" color="black"><b>SCHEDULE DAY</b></font></td>
		<td bgcolor="white" width="120" align=center><font size="2" color="black"><b>SCHEDULE TIME</b></font></td>
		<td bgcolor="white" width="120" align=center><font size="2" color="black"><b>SOFTWARE USED</b></font></td>
		</tr>
	    <%Connection con = null;
          ...
          try
               ...
               if(b_no1.equals("10"))
                   query = "select * from systembackupchecklist where bno='"+b_no1+"' ORDER BY  empname ASC";
                   ...
                   query = "select * from systembackupchecklist where bno='"+b_no1+"' ORDER BY  empname ASC";
                    ...
                    query = "select * from systembackupchecklist ORDER BY bno ASC, empname ASC";
		...
		<tr>
          ...
          <table border=1>
          <%
          query1 = "select * from systembackupschdaytime where empno='"+rs.getString("empno")+"' ";
          st1 = con.createStatement();
          rs1 = st1.executeQuery(query1);
          while(rs1.next())
              {
              String sfor = rs1.getString(3);
              String sday = rs1.getString(4);
              String stime = rs1.getString(5);
              String suse = rs1.getString(6);%>
              <tr>
                  <td width="118" align=center><%=rs1.getString(3)%></td>
                  <td width="122" align=center><%=rs1.getString(4)%></td>
                  <td width="120" align=center><%=rs1.getString(5)%></td>
                  <td width="120" align=center><%=rs1.getString(6)%></td>
              </tr>  <%}%>
            </table>
          </td>
