...
{  
	//alert(id);
	if(confirm('You are above to delete a Software Type'))
	{
var f=document.form;    
f.method="post";    
...
<center>
	...
	<table border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
		...
		<td height="20" bgcolor="white" width="120" align=center style="background-color:grey"><font size="2" color="black"><b>SOFTWARE NAME</b></font></td>
...
String query = "select * from systemuserbackupswlist ORDER BY sname ASC";
