...
<table width="1118" align="center" border="0" cellspacing="0" cellpadding="0">
  <tr align="center">
    <td bgcolor="#ec691f"><strong><font size ="4" color="white"><b>SOFTWARE MASTER</b><br />
      </font></strong></td>
  </tr>
 <tr align="center">
 <td bgcolor="#2f4377"><strong><font size ="4" color="white">CONNECT TO IT (C2IT)</font></strong></td>
  ...
  <form name="form" method="post"  action="softwaremasterback.jsp">
...
<table width="920" height="3" cellpadding="0" cellspacing="0" ID="Table1">
  ...
  <td width="25%" align="justify" valign="top"></td>
    <td width="21%" align="justify" valign="top">
      <p> <img src="../images/soft.jpg" height="180" width="340">
</td>
...
<tr>
      ...
      <font color=darkblue size=3 > CREATE SOFTWARE MASTER</font>
     </td>
</tr>
<tr>
   <td><font size="2">SOFTWARE NAME:</font><font color=red>*</font></td>
...
<tr>
	<td><a href="DisplayProb.jsp" onclick="return popitup('softwarebackupdisp.jsp')">View All</a> </td>
