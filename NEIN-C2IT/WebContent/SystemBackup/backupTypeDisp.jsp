...
var f=document.form;    
f.method="post";    
f.action='backupTypeEdit.jsp?id='+id;    
f.submit();
}
function deleteRecord(id)
{  
	//alert(id);
	if(confirm('You are above to delete a Backup Type'))
	{
var f=document.form;    
f.method="post";    
f.action='backupTypeDelete.jsp?id='+id;    
f.submit();
}
	else{}
}
...
<center>
	...
	<table border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
		...
		<td height="20" bgcolor="white" width="120" align=center style="background-color:grey"><font size="2" color="black"><b>NAME</b></font></td>
...
String query = "select * from backuptypemaster ORDER BY sname ASC";
