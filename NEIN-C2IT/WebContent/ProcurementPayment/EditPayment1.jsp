...
<form method="post" name="form1" action="UpdatePayment1.jsp" >
...
<table  align="center" border="1" width="90%" style="margin-left:110px;"> 
    ...
    <tr>
            <td ><span style="color:red;">*</span>Shipping Location:</td>                   
            ...
            <td><input type="text" name="vendorName" id="vendorName"  value="<%=rsx.getString("vendorName")%>" readonly size="40"></td>
     </tr>
     <tr>
             <td ><b style="color:red">*</b>Description of Item</td>
			 <td><input type="text" name="item_desc" id="item_desc"  value="<%=rsx.getString("item_name")%>" readonly size="40"></td>			
    ...
    <tr>
	        ...
	        <td><input type="text" name="cgst" id="cgst" size="4" value="<%=rsx.getString("cgst_per")%>" readonly>&nbsp &nbsp
            ...
            <td><input type="text" name="sgst" id="sgst" size="4" value="<%=rsx.getString("sgst_per")%>" readonly>&nbsp &nbsp
            ...
            <td><input type="text" name="igst" id="igst" size="4" value="<%=rsx.getString("igst_per")%>" readonly>&nbsp &nbsp
     ...
     <tr>   
	        ...
	        <td><input type="text" name="deliveryDate" id="deliveryDate" value="<%=rsx.getString("delivery_date")%>" size="25" readonly></td>
	        <td><span style="color:red;">*</span>Bill No:</td>
	        <td><input type="text" name="billNo" id="billNo" value="<%=rsx.getString("bill_no")%>" size="25" readonly></td>
	        <td><span style="color:red;">*</span>Bill Date:</td>
	        <td><input type="text" name="billDate" id="billDate" value="<%=rsx.getString("bill_date")%>" size="25" readonly></td>
    ...
    <td>    <span style="color:red;">*</span>Cheque Number:</td>
	       ...
	       <td colspan="7"><textarea rows="4" cols="40" name="remarks" id="remarks" readonly><%=rsx.getString("remarks")%></textarea></td>
   </tr>
   <tr>  <% }
