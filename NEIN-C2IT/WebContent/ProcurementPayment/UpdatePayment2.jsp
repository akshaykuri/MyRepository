...
<%@ page import="org.apache.commons.fileupload.FileUploadException"%>
 ...
 <%
		      ...
		      float amount=0,per_item_amt=0,cgst_per=0,cgst_amt=0,sgst_per=0,sgst_amt=0,igst_per=0,igst_amt=0,totalPayment=0,tds_amt=0,tds_per=0;
        ...
        int j=0;
		    ...
		    if(rs2.next()){	 
		          ...
		          i1=st2.executeUpdate("UPDATE `procurement_payment` SET `branchId`='"+branchId+"',`branchNo`='"+branchNo+"',"+
		    		                   ...
		    		                   "`tds_per`='"+tds_per+"',`tds_amt`='"+tds_amt+"'  WHERE `id`='"+id+"'");   
