             ...
             <%               float total=0,amount=0;
                           ...
                           try
                              {
                        	   Connection2 dbConn = new Connection2();
   							 ...
   							 query =    " SELECT  s.b_name,mb.m_b_name,u.full_name,`po_number`, `po_date`, `vendorName`, `item_name`, `per_item_amt`, "+
   							            ...
   							            " `payment_date`, `delivery_date`, `bill_no`, `bill_date`, `remarks`, `file_path`,c.`id`, `igst_per`, `igst_amt` "+
	              ...
	              %>
					<tr class="bluetd1">
						...
						<td ><a href="EditPayment.jsp?id=<%=rs1.getString("id")%>&fromdate=<%=fromdate1%>&todate=<%=todate1%>&branchId=<%=branchId%>">Edit/Update</a></td>	
