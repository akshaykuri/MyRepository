...
psmt4 = cn2.prepareStatement("SELECT mail,emp FROM form4_accesscard_item WHERE form4_no=? AND status=?");
...
System.out.println("FORM 4  : "+form_no);
psmt2 = cn2.prepareStatement("INSERT INTO form4_accesscard_item(form4_no,desg,emp,status,remarks,f_date,mail,presence) VALUES(?,?,?,?,?,?,?,?)");
...
{
	postMail.postMail(i_email_id,"pass1234",mail,"ACCESS CARD FORM :  " +form_no+ " ",i_name+  " "+  "approved your request " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> Local LAN (Within Office) -  http://10.206.10.3:8185/NEIN-C2IT/HOME.jsp  <br> Public Domain (Outside Office) - http://203.124.152.2:8185/NEIN-C2IT/HOME.jsp  <br><br><br><br>"+message);
}
if(mmdradio!=null && mmdradio.equals("Not Approved"))
{
	postMail.postMail(i_email_id,"pass1234",mail," ACCESS CARD FORM :  " +form_no+ " ",initiatorNameIfNotApproved+  " "+  "request Is NOT Approved " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> Local LAN (Within Office) -  http://10.206.10.3:8185/NEIN-C2IT/HOME.jsp  <br> Public Domain (Outside Office) - http://203.124.152.2:8185/NEIN-C2IT/HOME.jsp  <br><br><br><br>");
} */
...
{   // if Approved and sending again to Higher authority 
	postMail.postMail(i_email_id,i_name,"pass1234",mail," ACCESS CARD FORM :  " +form_no+ " ",i_name+  " "+  "request you to Approved " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  https://ninsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
}
...
{   // if Approved and want to send directly to IT nonIT persons of HO and ONE copy to Initiator
	postMail.postMail(i_email_id,i_name,"pass1234",mail,"ACCESS CARD FORM :  " +form_no+ " ",i_name+  " "+  "approved your request " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  https://ninsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
	postMail.postMail(i_email_id,i_name,"pass1234",allMails," ACCESS CARD FORM :  " +form_no+ " ",initiatorNameIfNotApproved+  " "+  "approved your request " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  https://ninsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>");
}
...
{   // if NOT Approved , so a copy to Initaior 
	postMail.postMail(i_email_id,i_name,"pass1234",mail," ACCESS CARD FORM :  " +form_no+ " ",initiatorNameIfNotApproved+  " "+  "request Is NOT Approved " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> Local LAN (Within Office) -  http://10.206.10.18:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>");
} */
...
{	
   System.out.println("IF NOT APPROVED THIS LOOP WILL RUN");
	...
	psmt4 = cn2.prepareStatement("SELECT mail,emp FROM form4_accesscard_item WHERE form4_no=?");
	psmt4.setString(1,form_no);
	...
	// if NOT Approved , so a copy to Initaior 
   postMail.postMail(i_email_id,i_name,"pass1234",allMails1," ACCESS CARD FORM :  " +form_no+ " ",initiatorNameIfNotApproved+  " "+  "request Is NOT Approved for the Form No." +form_no+ " <br>Remarks : "+txtmail_msg+"<br><b><u> Open the following URL</u> </b><br> C2IT LINK -  https://ninsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://ninsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br><br><br><br>");
   }
}

message = null;

msg = "ACCESS__CARD__FORM__NO__:__'"+form_no+"'__SAVED__AND__SENT__SUCCESSFULLY";
