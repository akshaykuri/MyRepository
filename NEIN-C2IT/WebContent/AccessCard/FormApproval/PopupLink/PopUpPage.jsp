...
<%
 ...
 %>
 <br /><center><label style="font: bold; size: 3">ACCESS CARD FORM NO : <%=no%> IS SAVED AND SENT SUCCESSFULLY</label></center> <br />
 <%
 ...
 Connection conn = DriverManager.getConnection(url+dbName,userName,password); 
  String query2 = "SELECT form4_no FROM form4_accesscard  WHERE SUBSTRING(form4_no,9,20)='"+second+"'";
