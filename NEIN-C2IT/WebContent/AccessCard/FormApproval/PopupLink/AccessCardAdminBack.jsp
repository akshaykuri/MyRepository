...
psmt = cn2.prepareStatement("UPDATE form4_accesscard_item SET status=?,remarks=?,presence=?,f_date=? WHERE form4_no=? and presence='now'");
psmt.setString(1,mmdradio);
psmt.setString(2,txtmail_msg);
psmt.setString(3,"over");
psmt.setDate(4,form_date);
...
if(senddirect.equals("sendonly"))
	...
	psmt4 = cn2.prepareStatement("SELECT mail,emp FROM form4_accesscard_item WHERE form2_no=?");
	psmt4.setString(1,form_no);
	 message = mailMessage.getMailMessageCard(form_no.trim());
