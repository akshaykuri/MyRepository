...
rs100 = st100.executeQuery("select * from form4_accesscard WHERE form4_no='"+values[0]+"'"); 
while(rs100.next())
{
...
<table id="tableData" name="tableData" width="100%" border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
	  ...
	  rs1 = st1.executeQuery("select form4_no,desg,emp,status,remarks,f_date,mail from form4_accesscard_item WHERE form4_no='"+values[0]+"' AND desg <> 'none' ORDER BY id ASC"); 
	  while(rs1.next())
	  {
