...
psmt11 = cn2.prepareStatement("UPDATE form4_accesscard SET reminder=?,f_date=? WHERE form4_no=?");
...
msg2 = "ACCESS__CARD__REMINDER__FORM__NO__:__'"+form_no+"'__SAVED__SUCCESSFULLY";
System.out.println("result..date..........."+form_date);
response.sendRedirect("AccessCardReminder.jsp?msg2="+msg2);
