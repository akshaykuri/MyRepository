...
System.out.println("wat is the getting value ACCESSS CARDDDD :"+no); 
/* String req4 = request.getParameter(no);
System.out.println("wat is the getting value 2 req 4 :"+req4); */



System.out.println("ACCES CARD REMINDER tttttttt "+SessionName+"   -- FOR THE REQUEST : "+no);
cn1 = con.getConnection2();
st1 = cn1.createStatement();
rs1 = st1.executeQuery("select * from form4_accesscard WHERE form4_no='"+no+"'"); 
if(!rs1.next())
{
...
rs100 = st100.executeQuery("select * from form4_accesscard WHERE form4_no='"+no+"'"); 
while(rs100.next())
{
...
<form name="form" action="AccessCardReminderBack.jsp" method="post"  ><center>
<label> <font color="black"><u><b>ACCESS CARD REQUEST-REMINDER</b></u></font> </label> 
<br/>
...
<input name="form_no" value="<%=form4_no%>" size="31" readonly="readonly"/> </td>
</tr>
<tr>
