...
<body>
<form action="AccessCardPageBack.jsp" method="post" name="form">
...
<table width="907"  cellspacing="0" cellpadding="0" bgcolor="grey" align="center">
	<tr>
		...
		<b><label>
		ISSUE OF ACCESS CARD FORM</label>
		</b></font></center> 
		</td>
		</tr>
		<tr style="visibility: hidden;display: none;">
		<td>
		<input type="text" readonly="readonly" name="i_name" value="<%=Name%>" />
		<input type="text" readonly="readonly" name="i_desg" value="<%=desg%>" />
		<input type="text" readonly="readonly" name="i_city" value="<%=city%>" />
		<input type="hidden" name="i_b_no" value="<%=b_no%>" />
		<input type="hidden" name="i_admin" value="<%=admin%>" />
		<input type="text" readonly="readonly" name="i_email_id" value="<%=email_id%>" />
		<input type="text" readonly="readonly" name="f_date" value="<%= po_date.format(new java.util.Date())%>"/>
		<input type="hidden" name="r_remarks" value="extra_value"/>
		</td>
		
	</tr>
	<tr><td width="165"><%=Name%></td>
...
rs3 = st3.executeQuery("SELECT max(idextend) FROM form4_accesscard WHERE form4_no IN(SELECT form4_no FROM form4_accesscard LEFT JOIN branch_master b ON(substr(form4_no,15,2)=b.b_no) WHERE '"+b_no+"'=b.b_no GROUP BY form4_no)");
...
<tr>
      ...
      <td style="text-align:left;"><input type="text" name="emp_code" id="ecode" size="29" maxlength="44" onkeypress="return isNumber(event)" onkeyup="sendInfo(this.value);"/></td>
...
<tr>
     ...
     <%-- <td style="text-align:left;width:33%;"><select name="branch"  id="hiderow" style="font-size : 8pt">
					...
					<%} %> </select></td>  --%>
	<td style="text-align:left;"><input type="text" name="branch" size="29" id="idbranch" maxlength="44" readonly/></td>				
    ...
    <%-- <td style="text-align:left;"><select name="depart"  id="hiderow" style="font-size : 8pt">
					<option value="" style="background: lightgrey;" > ---Select---</option>
					<%while(rs2.next()){ %>
					<option> <%=rs2.getString(1)%> </option> fname,iddesg,idbranch,iddept,rofficer
					<%} %> </select></td>  --%>
	<td style="text-align:left;"><input type="text" name="depart" size="29" id="iddept" maxlength="44" readonly/></td>					
</tr>
<tr>
   ...
   <%-- <td style="text-align:left;"><select name="designation"  id="hiderow" style="font-size : 8pt">
					...
					<%} %> </select></td> --%>
   <td style="text-align:left;"><input type="text" name="designation" size="29" id="iddesg" maxlength="44" readonly/></td>						
...
<tr>
	...
	<td style="text-align: left;"><input type="text" size="29" name="scopeOfWork" id="sow" maxlength="44"/>	</td>
    <td style="text-align: right;"><font color=red>*</font>Requested By :</td>
    <td style="text-align:left;"><input type="text" name="requestBy" id="req" value="<%=Name%>" size="29" maxlength="44" readonly/></td>
</tr>
...
<td style="font-weight:bold;font-style:italic;width:23%;" colspan="3"> 
     ...
     <input type ="radio" name = "requestOption" value ="Change" />Change</td>
