...
System.out.println("OTHER ADMIN ***********************************************************");
try{
...
String ToMail="";
psmtt = cn2.prepareStatement("SELECT mail,emp FROM form4_accesscard_item WHERE form4_no=? AND status!='Initiator'");
...
psmt = cn2.prepareStatement("UPDATE form4_accesscard_item SET status=?,remarks=?,presence=? WHERE form4_no=? and presence='now'");
...
if(senddirect.equals("sendonly"))
     {//System.out.println("Send direct 33:"+senddirect);
    	 ...
    	 psmt2 = cn2.prepareStatement("INSERT INTO form4_accesscard_item(form4_no,desg,emp,status,remarks,f_date,mail,presence,empid,levelno) VALUES(?,?,?,?,?,?,?,?,?,?)");
     ...
     postMail.postMail(i_email_id,i_name,"pass1234",mail," ACCESS CARD FORM :  " +form_no+ " ",i_name+  " "+  "request you to Approve - ACCESS CARD FORM : " +form_no+ " <br><br><b><u> Open the following URL</u> </b><br> C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
	 ...
	 if(higherAuthority.equals("direct"))
	     ...
	     int j = psmt2.executeUpdate();
	     message = mailMessage.getMailMessageCard(form_no.trim());
		 //postMail.postMail(i_email_id,i_name,"pass1234",allMails," ACCESS CARD FORM :  " +form_no+ " ",initiatorNameIfNotApproved+  " "+  "your request for ACCESS CARD FORM "+form_no+" is been approved by " +i_name+ " <br><br><b><u> Open the following URL</u> </b><br>C2IT LINK -  http://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - http://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>");
	     ...
	     String mailingCheck[] = request.getParameterValues("mailingCheck");
		   ...
		   if((SendExtraMails!="NULL")||(mmdradioBcc=="Yes"))
			  ...
			  postMail.sendMailCC(i_email_id,i_name,allMails,CCList," ACCESS CARD FORM :  " +form_no+ " ",initiatorNameIfNotApproved+  " "+  "your request for ACCESS CARD FORM "+form_no+" is been approved by " +i_name+ " <br><br><b><u> Open the following URL</u> </b><br>C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp  <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
		   }
	...
	psmt4 = cn2.prepareStatement("SELECT mail,emp FROM form2_domain_item WHERE form4_no=?");
	psmt4.setString(1,form_no);
	 message = mailMessage.getMailMessageCard(form_no.trim());
	...
	while(rs1.next())
	    ...
	    postMail.postMail(i_email_id,i_name,"pass1234",allMails1," ACCESS CARD FORM :  " +form_no+ " ",initiatorNameIfNotApproved+  " "+  "request Is NOT Approved by "+i_name+" for the Form No." +form_no+ " <br>Remarks : "+txtmail_msg+"<br><b><u> Open the following URL</u> </b><br> C2IT LINK -  https://neinsoft.nittsu.co.in:8185/NEIN-C2IT/HOME.jsp <br> COMMON LINK - https://neinsoft.nittsu.co.in:8185/NEIN  <br><br><br><br>"+message);
	    }
    }
...
msg = "ACCESS__CARD__SAVED__AND__SENT__SUCCESSFULLY";
System.out.println("result..date..........."+form_date);
//response.sendRedirect("AccessCardSelectAdmin.jsp?msg=" +msg);
response.sendRedirect("AccessCardSelectLocalAdmin.jsp?msg=" +msg);
}
