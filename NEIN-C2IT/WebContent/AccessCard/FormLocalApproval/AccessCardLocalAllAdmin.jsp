...
<table id="tableData" name="tableData" width="895" border="1"  align="center" bgcolor="#F0F0F0" bordercolor="grey">
	  ...
	  rs1 = st1.executeQuery("select form4_no,desg,emp,status,remarks,DATE_FORMAT(f_date,'%d/%m/%Y'),mail from form4_accesscard_item WHERE form4_no='"+req+"'"); 
	  while(rs1.next())
	  {
		  String form4_noD= rs1.getString(1);
 ...
 <table style="margin-left: auto;margin-right: auto;" ><tr>
     ...
     <td style="font-size:1" id="hiderow">&nbsp;&nbsp;<!-- <input style="size:1;font-size: 1.1em;" type="button"  value="BACK" onclick="window.location.href='AccessCardSelectAdmin.jsp?msg=1'"/>  -->
