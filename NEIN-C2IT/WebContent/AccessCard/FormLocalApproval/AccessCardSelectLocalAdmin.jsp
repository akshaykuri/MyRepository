...
<form name="form" method="post" action="AccessCardLocalAdmin.jsp?msg=1">
...
rs9 = st9.executeQuery("SELECT DISTINCT form4_no FROM form4_accesscard_item WHERE ((emp='"+AdminName+"' and desg='"+desg+"')OR(empid='"+(String) session.getAttribute("EmpNo")+"')) and status='Pending' AND form4_no LIKE 'NEIN/CS/Acard%' ORDER BY id DESC");
