...
<form name="form" method="post" action="AccessCardLocalAllAdmin.jsp?msg=1">
...
if(b_no.equals("90"))
	rs9 = st9.executeQuery("SELECT DISTINCT form4_no,full_name FROM form4_accesscard WHERE form4_no LIKE 'NEIN/CS/Acard%' ORDER BY form4_no DESC");
else if(b_no.equals("30"))
	rs9 = st9.executeQuery("SELECT DISTINCT form4_no,full_name FROM form4_accesscard WHERE i_b_no in('30','32','11','53') and  form4_no LIKE 'NEIN/CS/Acard%' ORDER BY form4_no DESC");

else
   rs9 = st9.executeQuery("SELECT DISTINCT form4_no,full_name FROM form4_accesscard WHERE i_b_no='"+b_no+"' AND form4_no LIKE 'NEIN/CS/Acard%' ORDER BY idextend DESC");
